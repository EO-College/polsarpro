...
Description :  Creation of the POLAR HSV BMP file
Hue = 3*(90-alpha)
Sat = 1. - Entropy
Val = Span_dB=10log(Span)
...
/* MATRIX ALLOCATION */
  ...
  datatmp = vector_float(Sub_Nlig*Sub_NcolBMP);
