...
File   : create_pauli_rgb_file_T6.c
...
for (lig = 0; lig < Sub_Nlig; lig++) {
  ...
  for (col = 0; col < Sub_Ncol; col++) {
    if (ValidMask[col + Off_col] == 1.) {  
      NptsRGB++;
      if (MasterSlave == 1) datatmpRGB[NptsRGB] =  fabs(M_in[T622][0][col + Off_col]);
      if (MasterSlave == 2) datatmpRGB[NptsRGB] =  fabs(M_in[T655][0][col + Off_col]);
...
for (lig = 0; lig < Sub_Nlig; lig++) {
  ...
  for (col = 0; col < Sub_Ncol; col++) {
    if (ValidMask[col + Off_col] == 1.) {  
      NptsRGB++;
      if (MasterSlave == 1) datatmpRGB[NptsRGB] =  fabs(M_in[T633][0][col + Off_col]);
      if (MasterSlave == 2) datatmpRGB[NptsRGB] =  fabs(M_in[T666][0][col + Off_col]);
      if (datatmpRGB[NptsRGB] > eps) datatmpRGB[NptsRGB] = 10. * log10(datatmpRGB[NptsRGB]);
      else NptsRGB--;
      } // valid 
    } // col
...
for (lig = 0; lig < Sub_Nlig; lig++) {
  ...
  for (col = 0; col < Sub_Ncol; col++) {
    if (ValidMask[col + Off_col] == 1.) {  
      NptsRGB++;
      if (MasterSlave == 1) datatmpRGB[NptsRGB] =  fabs(M_in[T611][0][col + Off_col]);
      if (MasterSlave == 2) datatmpRGB[NptsRGB] =  fabs(M_in[T644][0][col + Off_col]);
      if (datatmpRGB[NptsRGB] > eps) datatmpRGB[NptsRGB] = 10. * log10(datatmpRGB[NptsRGB]);
      else NptsRGB--;
      } // valid 
    } // col
...
#pragma omp parallel for private(xx, l)
  for (col = 0; col < Sub_Ncol; col++) {
    if (ValidMask[col + Off_col] == 1.) {  
      if (MasterSlave == 1) xx = fabs(M_in[T611][0][col + Off_col]);
      if (MasterSlave == 2) xx = fabs(M_in[T644][0][col + Off_col]);
      if (xx <= eps) xx = eps;
      xx = 10 * log10(xx);
      ...
      if (MasterSlave == 1) xx = fabs(M_in[T633][0][col + Off_col]);
      if (MasterSlave == 2) xx = fabs(M_in[T666][0][col + Off_col]);
      if (xx <= eps) xx = eps;
      xx = 10 * log10(xx);
      ...
      if (MasterSlave == 1) xx = fabs(M_in[T622][0][col + Off_col]);
      if (MasterSlave == 2) xx = fabs(M_in[T655][0][col + Off_col]);
      if (xx <= eps) xx = eps;
      xx = 10 * log10(xx);
