  ...
  for (col = 0; col < Sub_Ncol; col++) {
    if (ValidMask[col + Off_col] == 1.) {  
      ...
      if (strcmp(RGBFormat,"RGB1") == 0) {
        if (MasterSlave == 1) datatmpRGB[NptsRGB] =  0.5*fabs(M_in[T411][0][col + Off_col]+M_in[T422][0][col + Off_col]-2.*M_in[T412_re][0][col + Off_col]);
        if (MasterSlave == 2) datatmpRGB[NptsRGB] =  0.5*fabs(M_in[T433][0][col + Off_col]+M_in[T444][0][col + Off_col]-2.*M_in[T434_re][0][col + Off_col]);
        }
...
for (lig = 0; lig < Sub_Nlig; lig++) {
  ...
  for (col = 0; col < Sub_Ncol; col++) {
    if (ValidMask[col + Off_col] == 1.) {  
      NptsRGB++;
      if (MasterSlave == 1) datatmpRGB[NptsRGB] =  fabs(2.*M_in[T422][0][col + Off_col]);
      if (MasterSlave == 2) datatmpRGB[NptsRGB] =  fabs(2.*M_in[T444][0][col + Off_col]);
      if (datatmpRGB[NptsRGB] > eps) datatmpRGB[NptsRGB] = 10. * log10(datatmpRGB[NptsRGB]);
      else NptsRGB--;
      } // valid 
    } // col
...
#pragma omp parallel for private(xx, l)
  for (col = 0; col < Sub_Ncol; col++) {
    if (ValidMask[col + Off_col] == 1.) {  
      if (strcmp(RGBFormat,"RGB1") == 0) {
        if (MasterSlave == 1) xx =  0.5*fabs(M_in[T411][0][col + Off_col]+M_in[T422][0][col + Off_col]+2.*M_in[T412_re][0][col + Off_col]);
        if (MasterSlave == 2) xx =  0.5*fabs(M_in[T433][0][col + Off_col]+M_in[T444][0][col + Off_col]+2.*M_in[T434_re][0][col + Off_col]);
        }
      if (strcmp(RGBFormat,"RGB2") == 0) {
        if (MasterSlave == 1) xx =  0.5*fabs(M_in[T411][0][col + Off_col]+M_in[T422][0][col + Off_col]-2.*M_in[T412_re][0][col + Off_col]);
        if (MasterSlave == 2) xx =  0.5*fabs(M_in[T433][0][col + Off_col]+M_in[T444][0][col + Off_col]-2.*M_in[T434_re][0][col + Off_col]);
      ...
      if (MasterSlave == 1) xx =  fabs(2.*M_in[T422][0][col + Off_col]);
      if (MasterSlave == 2) xx =  fabs(2.*M_in[T444][0][col + Off_col]);
      if (xx <= eps) xx = eps;
      xx = 10 * log10(xx);
