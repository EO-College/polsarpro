...
for (lig = 0; lig < Sub_Nlig; lig++) {
  ...
  for (col = 0; col < Sub_Ncol; col++) {
    if (ValidMask[col + Off_col] == 1.) {  
      NptsRGB++;
      g0 =  M_in[C211][0][col + Off_col]+M_in[C222][0][col + Off_col];
      g1 =  M_in[C211][0][col + Off_col]-M_in[C222][0][col + Off_col];
      g2 =  2.*M_in[C212_re][0][col + Off_col];
      g3 =  -2.*M_in[C212_im][0][col + Off_col];
      datatmpRGB[NptsRGB] =  g2 / g0;
      } /* valid */
    } /*col*/
