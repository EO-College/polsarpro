...
/*******************************************************************/
  ...
  /* BMP HDR FILE */
  write_bmp_hdr(Nlig, Ncol, Max, Min, 8, FileOutput);
...
#pragma omp parallel for private(col)
  for (lig = 0; lig < NligInit; lig++) {
    for (col = 0; col < NcolInit; col++) {
      bmpfinal[col][NligInit-1-lig] = bmpimage[lig][col];
      } /* col */
    } /* lig */
  }
...
#pragma omp parallel for private(col)
  for (lig = 0; lig < NligInit; lig++) {
    for (col = 0; col < NcolInit; col++) {
      bmpfinal[NcolInit-1-col][lig] = bmpimage[lig][col];
      } /* col */
    } /* lig */
  }
...
#pragma omp parallel for private(col)
  for (lig = 0; lig < NligInit; lig++) {
    for (col = 0; col < NcolInit; col++) {
      bmpfinal[lig][NcolInit-1-col] = bmpimage[lig][col];
      } /* col */
    } /* lig */
  }
...
#pragma omp parallel for private(col)
  for (lig = 0; lig < NligInit; lig++) {
    for (col = 0; col < NcolInit; col++) {
      bmpfinal[NligInit-1-lig][col] = bmpimage[lig][col];
      } /* col */
    } /* lig */
  }
