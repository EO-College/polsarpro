...
/******************************************************************************/
  if (argc < 21) {
  printf("TYPE: rawbinary_convert_RealImag_MLK_T3 DirOutput Ncol OffsetLig OffsetCol\n");
...
for (lig = 0; lig < Nligfin; lig++) {
  ...
  for (ii = 0; ii < Nlook_lig; ii++) {
    ...
    for (col = 0; col < Ncol; col++) {
      M_in[T311][ii][col] = M_tmp[T311][ii][col];
      M_in[T312_re][ii][col] = M_tmp[T312_re][ii][col];
      M_in[T312_im][ii][col] = M_tmp[T312_im][ii][col];
      M_in[T313_re][ii][col] = M_tmp[T313_re][ii][col];
      M_in[T313_im][ii][col] = M_tmp[T313_im][ii][col];
      M_in[T322][ii][col] = M_tmp[T322][ii][col];
      M_in[T323_re][ii][col] = M_tmp[T323_re][ii][col];
      M_in[T323_im][ii][col] = M_tmp[T323_im][ii][col];
      M_in[T333][ii][col] = M_tmp[T333][ii][col];
