...
File   : rawbinary_convert_ModPha_MLK_T3.c
...
/******************************************************************************/
  if (argc < 21) {
  printf("TYPE: rawbinary_convert_ModPha_MLK_T3 DirOutput Ncol OffsetLig OffsetCol\n");
...
for (lig = 0; lig < Nligfin; lig++) {
  ...
  for (ii = 0; ii < Nlook_lig; ii++) {
    ...
    for (col = 0; col < Ncol; col++) {
      M_in[T311][ii][col] = M_tmp[T11m][ii][col];
      M_in[T312_re][ii][col] = M_tmp[T12m][ii][col]*cos(M_tmp[T12p][ii][col]);
      M_in[T312_im][ii][col] = M_tmp[T12m][ii][col]*sin(M_tmp[T12p][ii][col]);
      M_in[T313_re][ii][col] = M_tmp[T13m][ii][col]*cos(M_tmp[T13p][ii][col]);
      M_in[T313_im][ii][col] = M_tmp[T13m][ii][col]*sin(M_tmp[T13p][ii][col]);
      M_in[T322][ii][col] = M_tmp[T22m][ii][col];
      M_in[T323_re][ii][col] = M_tmp[T23m][ii][col]*cos(M_tmp[T23p][ii][col]);
      M_in[T323_im][ii][col] = M_tmp[T23m][ii][col]*sin(M_tmp[T23p][ii][col]);
      M_in[T333][ii][col] = M_tmp[T33m][ii][col];
