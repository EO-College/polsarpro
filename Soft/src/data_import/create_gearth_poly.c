...
if(argc < 23) {
  ...
  get_commandline_prm(argc,argv,"-la00",flt_cmd_prm,&Lat00,1,UsageHelp);
  get_commandline_prm(argc,argv,"-lo00",flt_cmd_prm,&Lon00,1,UsageHelp);
  get_commandline_prm(argc,argv,"-la0N",flt_cmd_prm,&Lat0N,1,UsageHelp);
  get_commandline_prm(argc,argv,"-lo0N",flt_cmd_prm,&Lon0N,1,UsageHelp);
  get_commandline_prm(argc,argv,"-laN0",flt_cmd_prm,&LatN0,1,UsageHelp);
  get_commandline_prm(argc,argv,"-loN0",flt_cmd_prm,&LonN0,1,UsageHelp);
