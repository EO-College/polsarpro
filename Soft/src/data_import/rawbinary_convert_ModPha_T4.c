...
File   : rawbinary_convert_ModPha_T4.c
...
for (lig = 0; lig < Nligfin; lig++) {
  if (lig%(int)(Nligfin/20) == 0) {printf("%f\r", 100. * lig / (Nligfin - 1));fflush(stdout);}
   ...
   for (col = 0; col < Ncol; col++) {
     M_in[T411][col] = M_tmp[T11m][col];
     M_in[T412_re][col] = M_tmp[T12m][col]*cos(M_tmp[T12p][col]);
     M_in[T412_im][col] = M_tmp[T12m][col]*sin(M_tmp[T12p][col]);
     M_in[T413_re][col] = M_tmp[T13m][col]*cos(M_tmp[T13p][col]);
     M_in[T413_im][col] = M_tmp[T13m][col]*sin(M_tmp[T13p][col]);
     M_in[T414_re][col] = M_tmp[T14m][col]*cos(M_tmp[T14p][col]);
     M_in[T414_im][col] = M_tmp[T14m][col]*sin(M_tmp[T14p][col]);
     M_in[T422][col] = M_tmp[T22m][col];
     M_in[T423_re][col] = M_tmp[T23m][col]*cos(M_tmp[T23p][col]);
     M_in[T423_im][col] = M_tmp[T23m][col]*sin(M_tmp[T23p][col]);
     M_in[T424_re][col] = M_tmp[T24m][col]*cos(M_tmp[T24p][col]);
     M_in[T424_im][col] = M_tmp[T24m][col]*sin(M_tmp[T24p][col]);
     M_in[T433][col] = M_tmp[T33m][col];
     M_in[T434_re][col] = M_tmp[T34m][col]*cos(M_tmp[T34p][col]);
     M_in[T434_im][col] = M_tmp[T34m][col]*sin(M_tmp[T34p][col]);
     M_in[T444][col] = M_tmp[T44m][col];
