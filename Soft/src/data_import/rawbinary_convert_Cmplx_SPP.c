...
File   : rawbinary_convert_Cmplx_SPP.c
...
/******************************************************************************/
  ...
  if (argc < 15) {
  printf("TYPE: rawbinary_convert_Cmplx_SPP DirOutput Ncol OffsetLig OffsetCol\n");
...
/******************************************************************************/
  ...
  if (strcmp(DataFormat, "IPP") == 0) {
    if (strcmp(PolarType, "pp1") == 0) sprintf(file_name, "%s%s", DirOutput, FileOutputIPP5[np]);
    if (strcmp(PolarType, "pp2") == 0) sprintf(file_name, "%s%s", DirOutput, FileOutputIPP6[np]);
    if (strcmp(PolarType, "pp3") == 0) sprintf(file_name, "%s%s", DirOutput, FileOutputIPP7[np]);
    }
