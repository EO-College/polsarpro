...
File   : rawbinary_convert_RealImag_MLK_T4.c
...
/******************************************************************************/
  ...
  if (argc < 28) {
  printf("TYPE: rawbinary_convert_RealImag_MLK_T4 DirOutput Ncol OffsetLig OffsetCol\n");
...
for (lig = 0; lig < Nligfin; lig++) {
  ...
  for (ii = 0; ii < Nlook_lig; ii++) {
    ...
    for (col = 0; col < Ncol; col++) {
      M_in[T411][ii][col] = M_tmp[T411][ii][col];
      M_in[T412_re][ii][col] = M_tmp[T412_re][ii][col];
      M_in[T412_im][ii][col] = M_tmp[T412_im][ii][col];
      M_in[T413_re][ii][col] = M_tmp[T413_re][ii][col];
      M_in[T413_im][ii][col] = M_tmp[T413_im][ii][col];
      M_in[T414_re][ii][col] = M_tmp[T414_re][ii][col];
      M_in[T414_im][ii][col] = M_tmp[T414_im][ii][col];
      M_in[T422][ii][col] = M_tmp[T422][ii][col];
      M_in[T423_re][ii][col] = M_tmp[T423_re][ii][col];
      M_in[T423_im][ii][col] = M_tmp[T423_im][ii][col];
      M_in[T424_re][ii][col] = M_tmp[T424_re][ii][col];
      M_in[T424_im][ii][col] = M_tmp[T424_im][ii][col];
      M_in[T433][ii][col] = M_tmp[T433][ii][col];
      M_in[T434_re][ii][col] = M_tmp[T434_re][ii][col];
      M_in[T434_im][ii][col] = M_tmp[T434_im][ii][col];
      M_in[T444][ii][col] = M_tmp[T444][ii][col];
