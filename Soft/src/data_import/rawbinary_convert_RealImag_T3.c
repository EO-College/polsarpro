...
File   : rawbinary_convert_RealImag_T3.c
...
/******************************************************************************/
  ...
  if (argc < 21) {
  printf("TYPE: rawbinary_convert_RealImag_T3 DirOutput Ncol OffsetLig OffsetCol\n");
...
for (lig = 0; lig < Nligfin; lig++) {
  if (lig%(int)(Nligfin/20) == 0) {printf("%f\r", 100. * lig / (Nligfin - 1));fflush(stdout);}
   ...
   for (col = 0; col < Ncol; col++) {
     M_in[T311][col] = M_tmp[T311][col];
     M_in[T312_re][col] = M_tmp[T312_re][col];
     M_in[T312_im][col] = M_tmp[T312_im][col];
     M_in[T313_re][col] = M_tmp[T313_re][col];
     M_in[T313_im][col] = M_tmp[T313_im][col];
     M_in[T322][col] = M_tmp[T322][col];
     M_in[T323_re][col] = M_tmp[T323_re][col];
     M_in[T323_im][col] = M_tmp[T323_im][col];
     M_in[T333][col] = M_tmp[T333][col];
