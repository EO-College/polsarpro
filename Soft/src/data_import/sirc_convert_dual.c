...
strcat(UsageHelpDataFormat," C2 	output : covariance C2\n");
  ...
  for (lig = 0; lig < NligBlock[Nb]; lig++) {
    ...
    for (col = 0; col < Ncol; col++) {
      ...
      if (strcmp(PolarType,"pp1") == 0) {
        M_in[C22][lig][col] = lookup1[b[2]] * scale;
        M_in[C11][lig][col] = scale - 2.*M_in[C22][lig][col];
        M_in[C12_re][lig][col] = lookup3[b[3]] * scale;
        M_in[C12_im][lig][col] = lookup3[b[4]] * scale;
        }
      if (strcmp(PolarType,"pp2") == 0) {
        //M_in[C11][lig][col] = lookup1[b[2]] * scale;
        //M_in[C22][lig][col] = scale - 2.*M_in[C11][lig][col];
        M_in[C22][lig][col] = lookup1[b[2]] * scale;
        M_in[C11][lig][col] = scale - 2.*M_in[C22][lig][col];
        M_in[C12_re][lig][col] = lookup3[b[3]] * scale;
        M_in[C12_im][lig][col] = lookup3[b[4]] * scale;
      ...
      if (strcmp(PolarType,"pp3") == 0) {
        M_in[C22][lig][col] = lookup2[b[2]] * scale;
        M_in[C11][lig][col] = scale - M_in[C22][lig][col];
        M_in[C12_re][lig][col] = lookup4[b[3]] * scale;
        M_in[C12_im][lig][col] = lookup4[b[4]] * scale;
        }
