...
/* Strings */
  char file_name[FilePathLength], area_file[FilePathLength], mask_file[FilePathLength];
...
strcpy(UsageHelp,"\ncreate_mask_file.exe\n");
strcat(UsageHelp,"\nParameters:\n");
strcat(UsageHelp," (string)	-id  	input directory\n");
strcat(UsageHelp," (string)	-od  	output directory\n");
strcat(UsageHelp," (string)	-af  	input area file\n");
strcat(UsageHelp," (string)	-mf  	output mask file\n");
strcat(UsageHelp,"\nOptional Parameters:\n");
...
if(argc < 9) {
  ...
  get_commandline_prm(argc,argv,"-mf",str_cmd_prm,mask_file,1,UsageHelp);
  }
