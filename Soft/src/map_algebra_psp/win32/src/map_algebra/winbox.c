...
#define GL_GPU_MEM_INFO_CURRENT_AVAILABLE_MEM_NVX 0x9049
	...
	void operationThread(void* data)
	{		
...
#else		
		iret = pthread_create( &thread1, NULL, (void*)operationThread, (void*) oi);
		if(iret)
		{
	...
	void save()
	{
		...
		iret = pthread_create(&thread1, NULL, (void*)saveThread, (void *)((imageTexs [sliceOver]) ));
		if (iret)
		{
	...
	void runInThread(void(__cdecl * _StartAddress) (void *))
	{
		...
		iret = pthread_create(&thread1, NULL, (void*)_StartAddress, NULL)));
		if (iret)
		{
			_StartAddress(0);
		}
	...
	void savePolygonsThread(void *nul)
	{
