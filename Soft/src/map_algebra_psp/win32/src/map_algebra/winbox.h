...
void savePolygonsThread_OPCE(void * parg);
void savePolygons_StatHistoROI();
void savePolygonsThread_StatHistoROI(void * parg);
void savePolygons_MaskArea();
void savePolygonsThread_MaskArea(void * parg);
void savePolygons_TrainingArea();
void savePolygonsThread_TrainingArea(void * parg);
