...
k1r = k1i = k2r = k2i = k3r = k3i = k4r = k4i = 0.;
#pragma omp parallel for private(col) firstprivate(k1r, k1i, k2r, k2i, k3r, k3i, k4r, k4i)
  for (lig = 0; lig < Nlig + NwinLig; lig++) {
    for (col = 0; col < Ncol + NwinCol; col++) {
      k1r = S_in[hh][lig][2*col];
      k1i = S_in[hh][lig][2*col+1];
...
k1r = k1i = k2r = k2i = k3r = k3i = k4r = k4i = k5r = k5i = k6r = k6i = 0.;
#pragma omp parallel for private(col) firstprivate(k1r, k1i, k2r, k2i, k3r, k3i, k4r, k4i, k5r, k5i, k6r, k6i)
  for (lig = 0; lig < Nlig + NwinLig; lig++) {
    for (col = 0; col < Ncol + NwinCol; col++) {
...
k1r = k1i = k2r = k2i = 0.;
#pragma omp parallel for private(col) firstprivate(k1r, k1i, k2r, k2i)
  for (lig = 0; lig < Nlig + NwinLig; lig++) {
    for (col = 0; col < Ncol + NwinCol; col++) {
...
#pragma omp parallel for private(col) firstprivate(k1r, k1i, k2r, k2i)
  ...
  if (pp == 4) {
k1r = k1i = k2r = k2i = 0.;
k1r0 = k1i0 = k2r0 = k2i0 = 0.;
#pragma omp parallel for private(col) firstprivate(k1r, k1i, k2r, k2i, k1r0, k1i0, k2r0, k2i0)
    for (lig = 0; lig < Nlig + NwinLig; lig++) {
      for (col = 0; col < Ncol + NwinCol; col++) {
...
C11 = C12_re = C12_im = C13_re = C13_im = C14_re = C14_im = 0.;
C22 = C23_re = C23_im = C24_re = C24_im = C33 = C34_re = C34_im = C44 = 0.;
#pragma omp parallel for private(col) firstprivate(C11, C12_re, C12_im, C13_re, C13_im, C14_re, C14_im, C22, C23_re, C23_im, C24_re, C24_im, C33, C34_re, C34_im, C44)
  for (lig = 0; lig < Nlig + NwinLig; lig++) {
    for (col = 0; col < Ncol + NwinCol; col++) {
...
C11 = C12_re = C12_im = C13_re = C13_im = C14_re = C14_im = 0.;
C22 = C23_re = C24_re = C24_im = C33 = C34_re = C34_im = C44 = 0.;
#pragma omp parallel for private(col) firstprivate(C11, C12_re, C12_im, C13_re, C13_im, C14_re, C14_im, C22, C23_re, C24_re, C24_im, C33, C34_re, C34_im, C44)
  for (lig = 0; lig < Nlig + NwinLig; lig++) {
    for (col = 0; col < Ncol + NwinCol; col++) {
      C11 = M_in[C411][lig][col]; 
      C12_re = M_in[C412_re][lig][col]; C12_im = M_in[C412_im][lig][col];
...
T11 = T12_re = T12_im = T13_re = T13_im = T14_re = T14_im = 0.;
T22 = T23_re = T23_im = T24_re = T24_im = T33 = T34_re = T34_im = T44 = 0.;
#pragma omp parallel for private(col) firstprivate(T11, T12_re, T12_im, T13_re, T13_im, T14_re, T14_im, T22, T23_re, T23_im, T24_re, T24_im, T33, T34_re, T34_im, T44)
  for (lig = 0; lig < Nlig + NwinLig; lig++) {
    for (col = 0; col < Ncol + NwinCol; col++) {
...
C11 = C12_re = C12_im = C22 = 0.;
#pragma omp parallel for private(col) firstprivate(C11, C12_re, C12_im, C22)
  for (lig = 0; lig < Nlig + NwinLig; lig++) {
    for (col = 0; col < Ncol + NwinCol; col++) {
...
T11 = T12_re = T12_im = T22 = 0.;
#pragma omp parallel for private(col) firstprivate(T11, T12_re, T12_im, T22)
  for (lig = 0; lig < Nlig + NwinLig; lig++) {
    for (col = 0; col < Ncol + NwinCol; col++) {
