...
mean = Nvalid = 0.;
#pragma omp parallel for private(col, k, l) firstprivate(mean, Nvalid)
      ...
      if (col == 0) {
        ...
        for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++)
          for (l = -NwinCM1S2; l < 1 +NwinCM1S2; l++) {
            mean = mean + M_in[NwinLM1S2+lig+k][NwinCM1S2+col+l]*Valid[NwinLM1S2+lig+k][NwinCM1S2+col+l];
            Nvalid = Nvalid + Valid[NwinLM1S2+lig+k][NwinCM1S2+col+l];
            }
        } else {
        for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++) {
          mean = mean - M_in[NwinLM1S2+lig+k][col-1]*Valid[NwinLM1S2+lig+k][col-1];
          mean = mean + M_in[NwinLM1S2+lig+k][NwinC-1+col]*Valid[NwinLM1S2+lig+k][NwinC-1+col];
          Nvalid = Nvalid - Valid[NwinLM1S2+lig+k][col-1] + Valid[NwinLM1S2+lig+k][NwinC-1+col];
          }
        }
      if (Nvalid != 0.) M_out[lig][col] = mean/Nvalid;
      }
    }
