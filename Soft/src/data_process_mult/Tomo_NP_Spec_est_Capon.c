...
Description :  Polarimetry Tomography Specrtum Estimation : Capon
...
void Capon_Full_Rank_tomo_profile(float ****R_profile,float ****Tomo_FR,float *z_ax,int Nr, int Nim, int Npol, int Nz,float ***kz_vec, int Nmed);
void B_L_Capon(float **Tomo,float **a,float ***L, float *** mvecs,int Nim, int Npol, float ****dum);
...
********************************************************************/
 ...
 Capon_Full_Rank_tomo_profile(R_profile,Tomo,z_ax,Nr,Nim,Npol,Nz,kz_strip,Nmed);
...
/********************************************************************
********************************************************************/
void Capon_Full_Rank_tomo_profile(float ****R_profile,float ****Tomo_FR,float *z_ax,int Nr, int Nim, int Npol, int Nz,float ***kz_strip,int Nmed)
{
 float ***L, ***iL,**a,***mvecs;
 float ****dum; 
 int i,indz,row;
 ...
 for(row=0;row<Nr;row++) {
  ...
  for(indz=0;indz<Nz;indz++)
  {
   ...
   B_L_Capon(Tomo_FR[row][indz],a,iL,mvecs,Nim,Npol,dum); 
  }
 }
...
void B_L_Capon(float **Tomo,float **a,float ***L, float *** mvecs,int Nim, int Npol,float ****dum)
{
 int pol1, pol2, i, j, ind_pol, istop;
