...
File   : interferogram_estimation_PP.c
...
/* Internal variables */
  int ii, lig, col;
  float w1r1, w1i1, w2r1, w2i1;
  float w1r2, w1i2, w2r2, w2i2;
  float ar, ai, br, bi, xre, xim;
...
strcat(UsageHelp," (string)	-im1 	Image 1 : Ch1, Ch2, Ch1pCh2, Ch1mCh2\n");
strcat(UsageHelp," (string)	-im2 	Image 2 : Ch1, Ch2, Ch1pCh2, Ch1mCh2\n");
strcat(UsageHelp,"\nOptional Parameters:\n");
...
/* Polarisation Vector */
if (strcmp(Im1,"Ch1") == 0) {
  w1r1 = 1./sqrt(2.); w1i1 = 0.; w2r1 = 1./sqrt(2.); w2i1 = 0.;
  }
if (strcmp(Im1,"Ch2") == 0) {
  w1r1 = 1./sqrt(2.); w1i1 = 0.; w2r1 = -1./sqrt(2.); w2i1 = 0.;
  }
if (strcmp(Im1,"Ch1pCh2") == 0) {
  w1r1 = 1.; w1i1 = 0.; w2r1 = 0.; w2i1 = 0.;
  }
if (strcmp(Im1,"Ch1mCh2") == 0) {
  w1r1 = 0.; w1i1 = 0.; w2r1 = 1.; w2i1 = 0.;
  }
if (strcmp(Im2,"Ch1") == 0) {
  w1r2 = 1./sqrt(2.); w1i2 = 0.; w2r2 = 1./sqrt(2.); w2i2 = 0.;
  }
if (strcmp(Im2,"Ch2") == 0) {
  w1r2 = 1./sqrt(2.); w1i2 = 0.; w2r2 = -1./sqrt(2.); w2i2 = 0.;
  }
if (strcmp(Im2,"Ch1pCh2") == 0) {
  w1r2 = 1.; w1i2 = 0.; w2r2 = 0.; w2i2 = 0.;
  }
if (strcmp(Im2,"Ch1mCh2") == 0) {
  w1r2 = 0.; w1i2 = 0.; w2r2 = 1.; w2i2 = 0.;
  }
...
ar = ai = br = bi = xre = xim = 0.;
#pragma omp parallel for private(col) firstprivate(ar, ai, br, bi, xre, xim)
  for (lig = 0; lig < NligBlock[Nb]; lig++) {
    ...
    for (col = 0; col < Sub_Ncol; col++) {
      ...
      if (Valid[NwinLM1S2+lig][NwinCM1S2+col] == 1.) {
        ar = (w1r1*M_in[3][lig][col]+w1i1*M_in[4][lig][col]) + (w2r1*M_in[8][lig][col]+w2i1*M_in[9][lig][col]);
        ai = (w1r1*M_in[4][lig][col]-w1i1*M_in[3][lig][col]) + (w2r1*M_in[9][lig][col]-w2i1*M_in[8][lig][col]);
        br = (w1r1*M_in[5][lig][col]+w1i1*M_in[6][lig][col]) + (w2r1*M_in[10][lig][col]+w2i1*M_in[11][lig][col]);
        bi = (w1r1*M_in[6][lig][col]-w1i1*M_in[5][lig][col]) + (w2r1*M_in[11][lig][col]-w2i1*M_in[10][lig][col]);

        xre = (ar * w1r2 - ai * w1i2) + (br * w2r2 - bi * w2i2);
        xim = (ar * w1i2 + ai * w1r2) + (br * w2i2 + bi * w2r2);
