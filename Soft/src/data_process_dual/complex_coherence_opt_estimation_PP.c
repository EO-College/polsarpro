...
File   : complex_coherence_opt_estimation_PP.c
...
strcpy(UsageHelp,"\ncomplex_coherence_opt_estimation_PP.exe\n");
strcat(UsageHelp,"\nParameters:\n");
...
Nvalid = 0.;
#pragma omp parallel for private(col, Np, k, l, Mean, Buffer, TT11, TT12, TT22, iTT11, hTT12, iTT22, Tmp11, Tmp12, Tmp22, Tmp, V1, hV1, V2, hV2, L, phi) firstprivate(Nvalid)
