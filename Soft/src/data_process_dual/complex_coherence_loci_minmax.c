...
File   : complex_coherence_loci_minmax.c
...
strcpy(UsageHelp,"\ncomplex_coherence_loci_minmax.exe\n");
strcat(UsageHelp,"\nParameters:\n");
...
ks = ls = kss = lss = 0;
theta = coh_pha_max = coh_mag_max = 0.;  
Nvalid = 0.;
#pragma omp parallel for private(col, Np, i, k, l, Mean, Buffer, coh_pha, coh_mag, gmin2, gmax2, T, iT, TT11, TT12, TT22, TT12p, hTT12p, Tmp11, Tmp12, Tmp, V1, hV1, L) firstprivate(Nvalid, ks, ls, kss, lss, theta, coh_pha_max, coh_mag_max)
