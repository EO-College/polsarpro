...
/******************/
 ...
 forest_image_filename	= (char*) calloc (strlen(pPR->pMasterDirectory)+strlen("ground_image.gri")+1, sizeof(char));
 strcpy  (forest_image_filename, pPR->pMasterDirectory);
 strcat  (forest_image_filename, "ground_image.gri");
...
/****************************/
 ...
 forest_image_filename	= (char*) calloc (strlen(pPR->pMasterDirectory)+strlen("ground_image.bmp")+1, sizeof(char));
 strcpy  (forest_image_filename, pPR->pMasterDirectory);
 strcat  (forest_image_filename, "ground_image.bmp");
