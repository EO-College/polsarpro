    ...
    for (col = 0; col < Sub_Ncol; col++) {
      ...
      if (col == 0) {
        ...
        for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++) {
          ...
          for (Np = 0; Np < NpolarOut; Np++) {
            mean[Np] = mean[Np] - M_in[Np][idxY][col-1]*Valid[idxY][col-1]*Edge[idxY][col-1];
            mean[Np] = mean[Np] + M_in[Np][idxY][NwinC-1+col]*Valid[idxY][NwinC-1+col]*Edge[idxY][NwinC-1+col];
            }
          Nvalid = Nvalid - Valid[idxY][col-1]*Edge[idxY][col-1] + Valid[idxY][NwinC-1+col]*Edge[idxY][NwinC-1+col];
          }
        }
