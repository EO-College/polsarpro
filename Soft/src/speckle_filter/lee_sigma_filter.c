...
/* SIGMA FILTERING */
#pragma omp parallel for private(col,Np,k,l,det1,det2,det3,det4,total,mz3x3,varZ3x3,varX3x3,b3x3,mea,del1,del2,del3,del4,delT,span,totalT,mz,varz,varx,bb,mTT) shared(ligDone) schedule(dynamic)
for (lig = 0; lig < NligBlock[Nb]; lig++) {
  ligDone++;
