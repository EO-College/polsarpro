...
IF NOT EXIST "..\..\bin\PolSARproSIM" mkdir "..\..\bin\PolSARproSIM"
...
gcc -o ..\..\bin\PolSARproSIM\PolSARproSim_ImgSize.exe PolSARproSim_ImgSize.c -lm -static -lcomdlg32 -lole32 -fopenmp
gcc -o ..\..\bin\PolSARproSIM\PolSARproSim_FE_Kz.exe ../lib/PolSARproLib.c PolSARproSim_FE_Kz.c -lm -static -lcomdlg32 -lole32 -fopenmp
del *.o
cd ..\..\src\PolSARproSIMgr
Makefile_PolSARproSIMgr_all.bat
