...
G0 = G1 = G2 = G3 = DP = alphas = alpha = rsov = 0.;
#pragma omp parallel for private(col, k, M, V, lambda, M_avg) firstprivate(p, G0, G1, G2, G3, DP, alphas, alpha, rsov) shared(ligDone)
