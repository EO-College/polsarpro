    ...
    for (lig = 0; lig < NligBlock[Nb]; lig++) {
      ...
      for (col = 0; col < Sub_Ncol; col++) {
        ...
        if (col == 0) {
          ...
          for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++) {
            indXy = NwinLM1S2+lig+k;
            MmuX1 -= M_inX[indXy][col-1]*Valid[indXy][col-1];
            MmuX1 += M_inX[indXy][NwinC-1+col]*Valid[indXy][NwinC-1+col];
            Xvalid = Xvalid - Valid[indXy][col-1] + Valid[indXy][NwinC-1+col];
            MmuY1 -= M_inY[indXy][col-1]*Valid[indXy][col-1];
            MmuY1 += M_inY[indXy][NwinC-1+col]*Valid[indXy][NwinC-1+col];
            Yvalid = Yvalid - Valid[indXy][col-1] + Valid[indXy][NwinC-1+col];
            }
          }
    ...
    for (lig = 0; lig < NligBlock[Nb]; lig++) {
      ...
      for (col = 0; col < Sub_Ncol; col++) {
        ...
        if (col == 0) {
          ...
          for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++) {
            indXy = NwinLM1S2+lig+k;
            value = M_inX[indXy][col-1]*Valid[indXy][col-1];
            MmuX1 -= value; MmuX2 -= value*value;
            value = M_inX[indXy][NwinC-1+col]*Valid[indXy][NwinC-1+col];
            MmuX1 += value; MmuX2 += value*value;
            Xvalid = Xvalid - Valid[indXy][col-1] + Valid[indXy][NwinC-1+col];
            value = M_inY[indXy][col-1]*Valid[indXy][col-1];
            MmuY1 -= value; MmuY2 -= value*value;
            value = M_inY[indXy][NwinC-1+col]*Valid[indXy][NwinC-1+col];
            MmuY1 += value; MmuY2 += value*value;
            Yvalid = Yvalid - Valid[indXy][col-1] + Valid[indXy][NwinC-1+col];
            }
          }
...
//            muY4 = (MmuY4/Yvalid) - 4.*muY1*(MmuY3/Yvalid) + 6.*muY1*muY1*(MmuY2/Yvalid) - 3.*muY1*muY1*muY1*muY1;
          ...
          for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++) {
            indXy = NwinLM1S2+lig+k;
            Xp = (M_inX[indXy][col-1] - muX1)/sqrt(muX2+eps);
            MmuXp2 -= (Xp-muXp1)*(Xp-muXp1)*Valid[indXy][col-1];
            MmuXp3 -= (Xp-muXp1)*(Xp-muXp1)*(Xp-muXp1)*Valid[indXy][col-1];
            MmuXp4 -= (Xp-muXp1)*(Xp-muXp1)*(Xp-muXp1)*(Xp-muXp1)*Valid[indXy][col-1];
            Yp = (M_inY[indXy][col-1] - muY1)/sqrt(muY2+eps);
            MmuYp2 -= (Yp-muYp1)*(Yp-muYp1)*Valid[indXy][col-1];
            MmuYp3 -= (Yp-muYp1)*(Yp-muYp1)*(Yp-muYp1)*Valid[indXy][col-1];
            MmuYp4 -= (Yp-muYp1)*(Yp-muYp1)*(Yp-muYp1)*(Yp-muYp1)*Valid[indXy][col-1];
            }
          for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++) {
            indXy = NwinLM1S2+lig+k;
            Xp = (M_inX[indXy][col-1] - muX1)/sqrt(muX2+eps);
            MmuXp1 -= Xp*Valid[indXy][col-1];
            Yp = (M_inY[indXy][col-1] - muY1)/sqrt(muY2+eps);
            MmuYp1 -= Yp*Valid[indXy][col-1];
            }
          for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++) {
            indXy = NwinLM1S2+lig+k;
            value = M_inX[indXy][col-1]*Valid[indXy][col-1];
            MmuX1 -= value; MmuX2 -= value*value; MmuX3 -= value*value*value; MmuX4 -= value*value*value*value;
            Xvalid -= Valid[indXy][col-1];
            value = M_inY[indXy][col-1]*Valid[indXy][col-1];
            MmuY1 -= value; MmuY2 -= value*value; MmuY3 -= value*value*value; MmuY4 -= value*value*value*value;
            Yvalid += Valid[indXy][col-1];
            value = M_inX[indXy][NwinC-1+col]*Valid[indXy][NwinC-1+col];
            MmuX1 += value; MmuX2 += value*value; MmuX3 += value*value*value; MmuX4 += value*value*value*value;
            Xvalid += Valid[indXy][NwinC-1+col];
            value = M_inY[indXy][NwinC-1+col]*Valid[indXy][NwinC-1+col];
            MmuY1 += value; MmuY2 += value*value; MmuY3 += value*value*value; MmuY4 += value*value*value*value;
            Yvalid += Valid[indXy][NwinC-1+col];
            }
          if (Xvalid != 0.) muX1 = (MmuX1/Xvalid);
          if (Yvalid != 0.) muY1 = (MmuY1/Yvalid);
          if (Xvalid != 0.) {
...
//            muY4 = (MmuY4/Yvalid) - 4.*muY1*(MmuY3/Yvalid) + 6.*muY1*muY1*(MmuY2/Yvalid) - 3.*muY1*muY1*muY1*muY1;
          ...
          for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++) {
            indXy = NwinLM1S2+lig+k;
            Xp = (M_inX[indXy][NwinC-1+col] - muX1)/sqrt(muX2+eps);
            MmuXp1 -= Xp*Valid[indXy][NwinC-1+col];
            Yp = (M_inY[indXy][NwinC-1+col] - muY1)/sqrt(muY2+eps);
            MmuYp1 -= Yp*Valid[indXy][NwinC-1+col];
            }
          if (Xvalid != 0.) muXp1 = MmuXp1/Xvalid;
          if (Yvalid != 0.) muYp1 = MmuYp1/Yvalid;
          for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++) {
            indXy = NwinLM1S2+lig+k;
            Xp = (M_inX[indXy][NwinC-1+col] - muX1)/sqrt(muX2+eps);
            MmuXp2 -= (Xp-muXp1)*(Xp-muXp1)*Valid[indXy][NwinC-1+col];
            MmuXp3 -= (Xp-muXp1)*(Xp-muXp1)*(Xp-muXp1)*Valid[indXy][NwinC-1+col];
            MmuXp4 -= (Xp-muXp1)*(Xp-muXp1)*(Xp-muXp1)*(Xp-muXp1)*Valid[indXy][NwinC-1+col];
            Yp = (M_inY[indXy][NwinC-1+col] - muY1)/sqrt(muY2+eps);
            MmuYp2 -= (Yp-muYp1)*(Yp-muYp1)*Valid[indXy][NwinC-1+col];
            MmuYp3 -= (Yp-muYp1)*(Yp-muYp1)*(Yp-muYp1)*Valid[indXy][NwinC-1+col];
            MmuYp4 -= (Yp-muYp1)*(Yp-muYp1)*(Yp-muYp1)*(Yp-muYp1)*Valid[indXy][NwinC-1+col];
            }
          if (Xvalid != 0.) {muXp2 = MmuXp2/Xvalid; muXp3 = MmuXp3/Xvalid; muXp4 = MmuXp4/Xvalid;}
          if (Yvalid != 0.) {muYp2 = MmuYp2/Yvalid; muYp3 = MmuYp3/Yvalid; muYp4 = MmuYp4/Yvalid;}          
          }
