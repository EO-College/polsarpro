...
Description :  Huynen decomposition
...
M2A0 = MC = MD = MG = MH = k1r = k1i = k2r = k2i = k3r = k3i = 0.;
#pragma omp parallel for private(col, Np, M_avg) firstprivate(M2A0, MC, MD, MG, MH, k1r, k1i, k2r, k2i, k3r, k3i) shared(ligDone)
