...
/* OUTPUT FILE OPENING*/
  ...
  if ((out_phi = fopen(file_name, "wb")) == NULL)
...
Phi = 0.;
#pragma omp parallel for private(col, M_avg) firstprivate(Phi) shared(ligDone)
  ...
  write_block_matrix_float(out_phi, M_phi, NligBlock[Nb], Sub_Ncol, 0, 0, Sub_Ncol);
  } // NbBlock
