...
Description :  Barnes1 decomposition
    ...
    for (col = 0; col < Sub_Ncol; col++) {
      if (Valid[NwinLM1S2+lig][NwinCM1S2+col] == 1.) {
        if (strcmp(PolTypeOut,"T3")==0) {
          ...
          k1r = (MC - MG) / sqrt(2. * (MB0 - MF));
          k1i = (MH - MD) / sqrt(2. * (MB0 - MF));
          k2r = (MB0pB - MF) / sqrt(2. * (MB0 - MF));
          k2i = ME / sqrt(2. * (MB0 - MF));
          k3r = ME / sqrt(2. * (MB0 - MF));
          k3i = (MB0mB - MF) / sqrt(2. * (MB0 - MF));
          }
        ...
        if (strcmp(PolTypeOut,"C3")==0) {
          ...
          k1r = (MC - MG + MB0pB - MF) / 2. / sqrt(MB0 - MF);
          k1i = (MH - MD + ME) / 2. / sqrt(MB0 - MF);
          k2r = sqrt(2.) * ME / 2. / sqrt(MB0 - MF);
          k2i = sqrt(2.) * (MB0mB - MF) / 2. / sqrt(MB0 - MF);
          k3r = (MC - MG - MB0pB + MF) / 2. / sqrt(MB0 - MF);
          k3i = (MH - MD - ME) / 2. / sqrt(MB0 - MF);
          }
