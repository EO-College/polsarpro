...
#pragma omp parallel for private(col, Shhr, Shhi, Shvr, Shvi, Svvr, Svvi, SMhhr,SMhhi,SMhvr,SMhvi,SMvvr,SMvvi, alphar, betar, gammar, alphai, betai, gammai, alpham2, betam2, gammam2, reelle, diff_abs, Psimax, Xi,sinXi,cosXi, epsilonr,epsiloni, SsM1r,SsM1i,SsM2r,SsM2i, mod2_SsM1,mod2_SsM2, z_SsMr,z_SsMi, mod2_z_SsM, c_plan,c_diedre,c_quartp,c_dipole,c_cylindre,c_diedre_etroit,c_quartm, c_hel_d,c_hel_g, tau, temp, norm, prod_scal_r, prod_scal_i) firstprivate(ligg) shared(ligDone)
