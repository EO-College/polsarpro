...
Authors  : Eric POTTIER, Sophie ALLAIN (v2.0), Jacek STRZELCZYK
Version  : 3.0
Creation : 07/2015
Update  :
*--------------------------------------------------------------------
...
pos = valid = 0;
x = sinxx = braggs = braggp = t11est = t12est = t22est = t33est = 0.;
se = al = minliadis = minimumdis = substraction = entropyest = alphaest = epsilon = 0.;
#pragma omp parallel for private(col, k, i, id, ib, M_avg, T, V, lambda) firstprivate(alpha, p, pos, valid, x, sinxx, braggs, braggp, t11est, t12est, t22est, t33est, se, al, minliadis, minimumdis, substraction, entropyest, alphaest, epsilon) shared(ligDone)
