...
Nvalid = value = 0.;
mean = mean0 = mean2 = mean3 = mean4 = 0.;
Mmean = Mmean2 = Mmean3 = Mmean4 = 0.;
Npts = Npts0 = 0;
#pragma omp parallel for private(col, k, l) firstprivate(Nvalid, value, mean, mean0, mean2, mean3, mean4, Mmean, Mmean2, Mmean3, Mmean4, Npts, Npts0)
