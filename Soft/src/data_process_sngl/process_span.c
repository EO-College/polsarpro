  ...
  for (lig = 0; lig < NligBlock[Nb]; lig++) {
    ...
    for (col = 0; col < Sub_Ncol; col++) {
      if (Valid[NwinLM1S2+lig][NwinCM1S2+col] == 1.) {
        if (strcmp(PolTypeOut, "IPPpp5") == 0) M_out[lig][col] = M_avg[0][col]+M_avg[1][col];
        if (strcmp(PolTypeOut, "IPPpp6") == 0) M_out[lig][col] = M_avg[0][col]+M_avg[1][col]; 
        if (strcmp(PolTypeOut, "IPPpp7") == 0) M_out[lig][col] = M_avg[0][col]+M_avg[1][col];
        if (strcmp(PolTypeOut, "IPPpp4") == 0) M_out[lig][col] = M_avg[0][col]+2*M_avg[1][col]+M_avg[2][col];
        if (strcmp(PolTypeOut, "IPPfull") == 0) M_out[lig][col] = M_avg[0][col]+M_avg[1][col]+M_avg[2][col]+M_avg[3][col];
        if ((strcmp(PolTypeOut,"C2")==0)||(strcmp(PolTypeOut,"C2pp1")==0)||(strcmp(PolTypeOut,"C2pp2")==0)||(strcmp(PolTypeOut,"C2pp3")==0)) {
          M_out[lig][col] = M_avg[C211][col]+M_avg[C222][col];
          }
        if ((strcmp(PolTypeOut,"C3")==0)||(strcmp(PolTypeOut,"T3")==0)) {
          M_out[lig][col] = M_avg[C311][col]+M_avg[C322][col]+M_avg[C333][col];
          } 
        if ((strcmp(PolTypeOut,"C4")==0)||(strcmp(PolTypeOut,"T4")==0)) {
          M_out[lig][col] = M_avg[C411][col]+M_avg[C422][col]+M_avg[C433][col]+M_avg[C444][col];
          }
