...
/* LOCAL VARIABLES */
  int Config;
  char *PolTypeConf[NPolType] = { "S2T6" };
...
for (Nb = 0; Nb < NbBlock; Nb++) {
  ...
  read_block_S2_noavg(in_datafile1, S_in1, "S2", 4, Nb, NbBlock, NligBlock[Nb], Ncol, 1, 1, Off_lig, Off_col, Ncol);
  read_block_S2_noavg(in_datafile2, S_in2, "S2", 4, Nb, NbBlock, NligBlock[Nb], Ncol, 1, 1, Off_lig, Off_col, Ncol);

  S2_to_T6(S_in1, S_in2, M_in, NligBlock[Nb], Ncol, 0, 0);
