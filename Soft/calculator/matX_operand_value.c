...
Description :  MatX (operand) value = MatX
...
/* DATA PROCESSING */
   if (strcmp(operand,"addval") == 0 ) {
     for (lig = 0; lig < MatXdim; lig++) {
       for (col = 0; col < MatXdim; col++) {
         M_out[lig][col][0] = MatX1[lig][col][0] + valR;
         M_out[lig][col][1] = MatX1[lig][col][1] + valI;
         }
      }
    }
   ...
   if (strcmp(operand,"mulval") == 0 ) {
     for (lig = 0; lig < MatXdim; lig++) {
       for (col = 0; col < MatXdim; col++) {
         M_out[lig][col][0] = MatX1[lig][col][0] * valR - MatX1[lig][col][1] * valI;
         M_out[lig][col][1] = MatX1[lig][col][1] * valR + MatX1[lig][col][0] * valI;
         }
      }
    }
   if (strcmp(operand,"divval") == 0 ) {
     for (lig = 0; lig < MatXdim; lig++) {
       for (col = 0; col < MatXdim; col++) {
         M_out[lig][col][0] = (MatX1[lig][col][0] * valR + MatX1[lig][col][1] * valI)/(valR*valR+valI*valI);
         M_out[lig][col][1] = (MatX1[lig][col][1] * valR - MatX1[lig][col][0] * valI)/(valR*valR+valI*valI);
         }
      }
    }
