    ...
    for (col = 0; col < Sub_Ncol; col++) {
      if (Valid[lig][col] == 1.) {
        if (strcmp(PolTypeOut,"T3")==0) {
          MB0 = (M_avg[T322][lig][col] + M_avg[T333][lig][col]) / 2.;
          MB0pB = M_avg[T322][lig][col]; MB0mB = M_avg[T333][lig][col];
          MC = M_avg[T312_re][lig][col]; MD = -M_avg[T312_im][lig][col];
          MH = M_avg[T313_re][lig][col]; MG = M_avg[T313_im][lig][col];
          ME = M_avg[T323_re][lig][col]; MF = M_avg[T323_im][lig][col];
        ...
        if (strcmp(PolTypeOut,"C3")==0) {
          MC = (M_avg[C311][lig][col] - M_avg[C333][lig][col]) / 2;
          MD = M_avg[C313_im][lig][col];
          MH = (M_avg[C312_re][lig][col] + M_avg[C323_re][lig][col]) / sqrt(2);
          MG = (M_avg[C312_im][lig][col] - M_avg[C323_im][lig][col]) / sqrt(2);
          ME = (M_avg[C312_re][lig][col] - M_avg[C323_re][lig][col]) / sqrt(2);
          MF = (M_avg[C312_im][lig][col] + M_avg[C323_im][lig][col]) / sqrt(2);
          MB0pB = (M_avg[C311][lig][col] - 2 * M_avg[C313_re][lig][col] + M_avg[C333][lig][col]) / 2;
          MB0mB = M_avg[C322][lig][col];
          MB0 = (MB0pB + MB0mB) / 2.;
