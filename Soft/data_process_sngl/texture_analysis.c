    ...
    for (col = 0; col < Sub_Ncol; col++) {
      ...
      if (strcmp(TextAnal,"U")==0) {
        if (col == 0) {
          ...
          for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++)
            for (l = -NwinCM1S2; l < 1 +NwinCM1S2; l++) {
              value = M_in[NwinLM1S2+lig+k][NwinCM1S2+col+l];
              Mmean += value*Valid[NwinLM1S2+lig+k][NwinCM1S2+col+l]; Mmean2 += log(fabs(value)+eps)*Valid[NwinLM1S2+lig+k][NwinCM1S2+col+l];
              Nvalid += Valid[NwinLM1S2+lig+k][NwinCM1S2+col+l];
              }
          } else {
          for (k = -NwinLM1S2; k < 1 + NwinLM1S2; k++) {
            value = M_in[NwinLM1S2+lig+k][col-1];
            Mmean -= value*Valid[NwinLM1S2+lig+k][col-1]; Mmean2 -= log(fabs(value)+eps)*Valid[NwinLM1S2+lig+k][col-1];
            value = M_in[NwinLM1S2+lig+k][NwinC-1+col];
            Mmean += value*Valid[NwinLM1S2+lig+k][NwinC-1+col]; Mmean2 += log(fabs(value)+eps)*Valid[NwinLM1S2+lig+k][NwinC-1+col];
            Nvalid = Nvalid - Valid[NwinLM1S2+lig+k][col-1] + Valid[NwinLM1S2+lig+k][NwinC-1+col];
            }
          }
        if (Nvalid != 0.) mean = Mmean/Nvalid; else mean = INIT_MINMAX;
