...
for (Nb = 0; Nb < NbBlock; Nb++) {
  ...
  for (lig = 0; lig < NligBlock[Nb]; lig++) {
    ...
    for (col = 0; col < Sub_Ncol; col++) {
      if (Valid[lig][col] == 1.) {
        a = M_avg[T323_re][lig][col]*M_avg[T323_re][lig][col];
        b = M_avg[T323_im][lig][col]*M_avg[T323_im][lig][col];
        c = (M_avg[T322][lig][col]/2. - M_avg[T333][lig][col]/2.)*(M_avg[T322][lig][col]/2. - M_avg[T333][lig][col]/2.);
        d = (M_avg[T322][lig][col]/2. + M_avg[T333][lig][col]/2.)*(M_avg[T322][lig][col]/2. + M_avg[T333][lig][col]/2.);
