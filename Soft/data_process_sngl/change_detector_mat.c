...
/*-----------------------------------------------------------------*/   
  ...
  M_in1 = matrix3d_float(NpolarOut, NligBlock[0], Sub_Ncol);
  M_in2 = matrix3d_float(NpolarOut, NligBlock[0], Sub_Ncol);
...
for (Nb = 0; Nb < NbBlock; Nb++) {
  ...
  if ((strcmp(PolTypeIn,"S2")==0) || (strcmp(PolTypeIn,"SPP") == 0) 
    ...
    if (strcmp(PolTypeIn,"S2")==0) {
      read_block_S2_avg(in_datafile1, M_in1, PolTypeOut, NpolarOut, Nb, NbBlock, NligBlock[Nb], Sub_Ncol, NwinL, NwinC, Off_lig, Off_col, Ncol);
      read_block_S2_avg(in_datafile2, M_in2, PolTypeOut, NpolarOut, Nb, NbBlock, NligBlock[Nb], Sub_Ncol, NwinL, NwinC, Off_lig, Off_col, Ncol);
      } else {
      read_block_SPP_avg(in_datafile1, M_in1, PolTypeOut, NpolarOut, Nb, NbBlock, NligBlock[Nb], Sub_Ncol, NwinL, NwinC, Off_lig, Off_col, Ncol);
      read_block_SPP_avg(in_datafile2, M_in2, PolTypeOut, NpolarOut, Nb, NbBlock, NligBlock[Nb], Sub_Ncol, NwinL, NwinC, Off_lig, Off_col, Ncol);
      }
    } else {
    /* Case of C,T or I */
    read_block_TCI_avg(in_datafile1, M_in1, NpolarOut, Nb, NbBlock, NligBlock[Nb], Sub_Ncol, NwinL, NwinC, Off_lig, Off_col, Ncol);
    read_block_TCI_avg(in_datafile2, M_in2, NpolarOut, Nb, NbBlock, NligBlock[Nb], Sub_Ncol, NwinL, NwinC, Off_lig, Off_col, Ncol);
    }
    ...
    for (col = 0; col < Sub_Ncol; col++) {
      if (Valid[lig][col] == 1.) {
          if ((strcmp(PolTypeOut,"C2")==0)||(strcmp(PolTypeOut,"T2")==0)) {
            M1[0][0][0] = eps + M_in1[0][lig][col];
            M1[0][0][1] = 0.;
            M1[0][1][0] = eps + M_in1[1][lig][col];
            M1[0][1][1] = eps + M_in1[2][lig][col];
            M1[1][0][0] =  M1[0][1][0];
            M1[1][0][1] = -M1[0][1][1];
            M1[1][1][0] = eps + M_in1[3][lig][col];
            M1[1][1][1] = 0.;
            DeterminantHermitianMatrix2(M1,det1);
            M2[0][0][0] = eps + M_in2[0][lig][col];
            M2[0][0][1] = 0.;
            M2[0][1][0] = eps + M_in2[1][lig][col];
            M2[0][1][1] = eps + M_in2[2][lig][col];
            M2[1][0][0] =  M2[0][1][0];
            M2[1][0][1] = -M2[0][1][1];
            M2[1][1][0] = eps + M_in2[3][lig][col];
            M2[1][1][1] = 0.;
          ...
          if ((strcmp(PolTypeOut,"C3")==0)||(strcmp(PolTypeOut,"T3")==0)) {
            ...
            M1[0][1][0] = eps + M_in1[1][lig][col];
            M1[0][1][1] = eps + M_in1[2][lig][col];
            M1[0][2][0] = eps + M_in1[3][lig][col];
            M1[0][2][1] = eps + M_in1[4][lig][col];
            M1[1][0][0] =  M1[0][1][0];
            M1[1][0][1] = -M1[0][1][1];
            M1[1][1][0] = eps + M_in1[5][lig][col];
            M1[1][1][1] = 0.;
            M1[1][2][0] = eps + M_in1[6][lig][col];
            M1[1][2][1] = eps + M_in1[7][lig][col];
            M1[2][0][0] =  M1[0][2][0];
            M1[2][0][1] = -M1[0][2][1];
            M1[2][1][0] =  M1[1][2][0];
            M1[2][1][1] = -M1[1][2][1];
            M1[2][2][0] = eps + M_in1[8][lig][col];
            M1[2][2][1] = 0.;
            ...
            M2[0][1][0] = eps + M_in2[1][lig][col];
            M2[0][1][1] = eps + M_in2[2][lig][col];
            M2[0][2][0] = eps + M_in2[3][lig][col];
            M2[0][2][1] = eps + M_in2[4][lig][col];
            M2[1][0][0] =  M2[0][1][0];
            M2[1][0][1] = -M2[0][1][1];
            M2[1][1][0] = eps + M_in2[5][lig][col];
            M2[1][1][1] = 0.;
            M2[1][2][0] = eps + M_in2[6][lig][col];
            M2[1][2][1] = eps + M_in2[7][lig][col];
            M2[2][0][0] =  M2[0][2][0];
            M2[2][0][1] = -M2[0][2][1];
            M2[2][1][0] =  M2[1][2][0];
            M2[2][1][1] = -M2[1][2][1];
            M2[2][2][0] = eps + M_in2[8][lig][col];
            M2[2][2][1] = 0.;
          ...
          if ((strcmp(PolTypeOut,"C4")==0)||(strcmp(PolTypeOut,"T4")==0)) {
            ...
            M1[0][2][0] = eps + M_in1[3][lig][col];
            M1[0][2][1] = eps + M_in1[4][lig][col];
            M1[0][3][0] = eps + M_in1[5][lig][col];
            M1[0][3][1] = eps + M_in1[6][lig][col];
            M1[1][0][0] =  M1[0][1][0];
            M1[1][0][1] = -M1[0][1][1];
            M1[1][1][0] = eps + M_in1[7][lig][col];
            M1[1][1][1] = 0.;
            M1[1][2][0] = eps + M_in1[8][lig][col];
            M1[1][2][1] = eps + M_in1[9][lig][col];
            M1[1][3][0] = eps + M_in1[10][lig][col];
            M1[1][3][1] = eps + M_in1[11][lig][col];
            M1[2][0][0] =  M1[0][2][0];
            M1[2][0][1] = -M1[0][2][1];
            M1[2][1][0] =  M1[1][2][0];
            M1[2][1][1] = -M1[1][2][1];
            M1[2][2][0] = eps + M_in1[12][lig][col];
            M1[2][2][1] = 0.;
            M1[2][3][0] = eps + M_in1[13][lig][col];
            M1[2][3][1] = eps + M_in1[14][lig][col];
            M1[3][0][0] =  M1[0][3][0];
            M1[3][0][1] = -M1[0][3][1];
            M1[3][1][0] =  M1[1][3][0];
            M1[3][1][1] = -M1[1][3][1];
            ...
            M2[0][2][0] = eps + M_in2[3][lig][col];
            M2[0][2][1] = eps + M_in2[4][lig][col];
            M2[0][3][0] = eps + M_in2[5][lig][col];
            M2[0][3][1] = eps + M_in2[6][lig][col];
            M2[1][0][0] =  M2[0][1][0];
            M2[1][0][1] = -M2[0][1][1];
            M2[1][1][0] = eps + M_in2[7][lig][col];
            M2[1][1][1] = 0.;
            M2[1][2][0] = eps + M_in2[8][lig][col];
            M2[1][2][1] = eps + M_in2[9][lig][col];
            M2[1][3][0] = eps + M_in2[10][lig][col];
            M2[1][3][1] = eps + M_in2[11][lig][col];
            M2[2][0][0] =  M2[0][2][0];
            M2[2][0][1] = -M2[0][2][1];
            M2[2][1][0] =  M2[1][2][0];
            M2[2][1][1] = -M2[1][2][1];
            M2[2][2][0] = eps + M_in2[12][lig][col];
            M2[2][2][1] = 0.;
            M2[2][3][0] = eps + M_in2[13][lig][col];
            M2[2][3][1] = eps + M_in2[14][lig][col];
            M2[3][0][0] =  M2[0][3][0];
            M2[3][0][1] = -M2[0][3][1];
            M2[3][1][0] =  M2[1][3][0];
            M2[3][1][1] = -M2[1][3][1];
...
/*
  ...
  free_matrix3d_float(M_in1, NpolarOut, NligBlock[0]);
  free_matrix3d_float(M_in2, NpolarOut, NligBlock[0]);
