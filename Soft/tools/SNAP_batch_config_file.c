...
/* LOCAL VARIABLES */
  ...
  char SNAPDEM[1000], SNAPRadioCorrec[1000];
...
/*******************************************************************/
  ...
  fprintf(filename,"  <node id=\"1-Read\">\n");
  ...
  fprintf(filename,"  <node id=\"2-Read\">\n");
  fprintf(filename,"   <operator>Read</operator>\n");
  fprintf(filename,"    <sources/>\n");
  fprintf(filename,"    <parameters class=\"com.bc.ceres.binding.dom.XppDomElement\">\n");
  ...
  fprintf(filename,"  <node id=\"3-Multilook\">\n");
  fprintf(filename,"    <operator>Multilook</operator>\n");
  fprintf(filename,"    <sources>\n");
  fprintf(filename,"      <sourceProduct refid=\"2-Read\"/>\n");
  fprintf(filename,"    </sources>\n");
  fprintf(filename,"    <parameters class=\"com.bc.ceres.binding.dom.XppDomElement\">\n");
  ...
  fprintf(filename,"      <note>Currently, detection for complex data is performed without any resampling</note>\n");
  fprintf(filename,"    </parameters>\n");
  fprintf(filename,"  </node>\n");
  
  fprintf(filename,"  <node id=\"4-ReplaceMetadata\">\n");
  fprintf(filename,"    <operator>ReplaceMetadata</operator>\n");
  fprintf(filename,"    <sources>\n");
  fprintf(filename,"      <sourceProduct refid=\"1-Read\"/>\n");
  fprintf(filename,"      <sourceProduct refid=\"3-Multilook\"/>\n");
  fprintf(filename,"    </sources>\n");
  fprintf(filename,"    <parameters class=\"com.bc.ceres.binding.dom.XppDomElement\">\n");
  fprintf(filename,"      <note>Replace the metadata of the first product with that of the second</note>\n");
  fprintf(filename,"    </parameters>\n");
  fprintf(filename,"  </node>\n");

  fprintf(filename,"  <node id=\"5-Multilook\">\n");
  fprintf(filename,"    <operator>Multilook</operator>\n");
  fprintf(filename,"    <sources>\n");
  fprintf(filename,"      <sourceProduct refid=\"4-ReplaceMetadata\"/>\n");
  fprintf(filename,"    </sources>\n");
  fprintf(filename,"    <parameters class=\"com.bc.ceres.binding.dom.XppDomElement\">\n");
  fprintf(filename,"      <sourceBands/>\n");
  ...
  fprintf(filename,"  <node id=\"6-Terrain-Correction\">\n");
  fprintf(filename,"    <operator>Terrain-Correction</operator>\n");
  fprintf(filename,"    <sources>\n");
  fprintf(filename,"      <sourceProduct refid=\"5-Multilook\"/>\n");
  fprintf(filename,"    </sources>\n");
  fprintf(filename,"    <parameters class=\"com.bc.ceres.binding.dom.XppDomElement\">\n");
  fprintf(filename,"      <sourceBands/>\n");
  ...
  fprintf(filename,"  <node id=\"7-Write\">\n");
  fprintf(filename,"    <operator>Write</operator>\n");
  fprintf(filename,"    <sources>\n");
  fprintf(filename,"      <sourceProduct refid=\"6-Terrain-Correction\"/>\n");
  fprintf(filename,"    </sources>\n");
  fprintf(filename,"    <parameters class=\"com.bc.ceres.binding.dom.XppDomElement\">\n");
