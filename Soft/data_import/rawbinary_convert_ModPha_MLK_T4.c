...
File   : rawbinary_convert_ModPha_MLK_T4.c
...
//  Symmetrisation = atoi(argv[8]); 
  ...
  printf("TYPE: rawbinary_convert_ModPha_T4 DirOutput Ncol OffsetLig OffsetCol\n");
...
for (lig = 0; lig < Nligfin; lig++) {
  ...
  for (ii = 0; ii < Nlook_lig; ii++) {
    ...
    for (col = 0; col < Ncol; col++) {
      M_in[T411][ii][col] = M_tmp[T11m][ii][col];
      M_in[T412_re][ii][col] = M_tmp[T12m][ii][col]*cos(M_tmp[T12p][ii][col]);
      M_in[T412_im][ii][col] = M_tmp[T12m][ii][col]*sin(M_tmp[T12p][ii][col]);
      M_in[T413_re][ii][col] = M_tmp[T13m][ii][col]*cos(M_tmp[T13p][ii][col]);
      M_in[T413_im][ii][col] = M_tmp[T13m][ii][col]*sin(M_tmp[T13p][ii][col]);
      M_in[T414_re][ii][col] = M_tmp[T14m][ii][col]*cos(M_tmp[T14p][ii][col]);
      M_in[T414_im][ii][col] = M_tmp[T14m][ii][col]*sin(M_tmp[T14p][ii][col]);
      M_in[T422][ii][col] = M_tmp[T22m][ii][col];
      M_in[T423_re][ii][col] = M_tmp[T23m][ii][col]*cos(M_tmp[T23p][ii][col]);
      M_in[T423_im][ii][col] = M_tmp[T23m][ii][col]*sin(M_tmp[T23p][ii][col]);
      M_in[T424_re][ii][col] = M_tmp[T24m][ii][col]*cos(M_tmp[T24p][ii][col]);
      M_in[T424_im][ii][col] = M_tmp[T24m][ii][col]*sin(M_tmp[T24p][ii][col]);
      M_in[T433][ii][col] = M_tmp[T33m][ii][col];
      M_in[T434_re][ii][col] = M_tmp[T34m][ii][col]*cos(M_tmp[T34p][ii][col]);
      M_in[T434_im][ii][col] = M_tmp[T34m][ii][col]*sin(M_tmp[T34p][ii][col]);
      M_in[T444][ii][col] = M_tmp[T44m][ii][col];
