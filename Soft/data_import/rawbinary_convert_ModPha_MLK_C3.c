...
File   : rawbinary_convert_ModPha_MLK_C3.c
...
//  Symmetrisation = atoi(argv[8]);
  ...
  printf("TYPE: rawbinary_convert_ModPha_MLK_C3 DirOutput Ncol OffsetLig OffsetCol\n");
...
for (lig = 0; lig < Nligfin; lig++) {
  ...
  for (ii = 0; ii < Nlook_lig; ii++) {
    ...
    for (col = 0; col < Ncol; col++) {
      M_in[C311][ii][col] = M_tmp[C11m][ii][col];
      M_in[C312_re][ii][col] = M_tmp[C12m][ii][col]*cos(M_tmp[C12p][ii][col]);
      M_in[C312_im][ii][col] = M_tmp[C12m][ii][col]*sin(M_tmp[C12p][ii][col]);
      M_in[C313_re][ii][col] = M_tmp[C13m][ii][col]*cos(M_tmp[C13p][ii][col]);
      M_in[C313_im][ii][col] = M_tmp[C13m][ii][col]*sin(M_tmp[C13p][ii][col]);
      M_in[C322][ii][col] = M_tmp[C22m][ii][col];
      M_in[C323_re][ii][col] = M_tmp[C23m][ii][col]*cos(M_tmp[C23p][ii][col]);
      M_in[C323_im][ii][col] = M_tmp[C23m][ii][col]*sin(M_tmp[C23p][ii][col]);
      M_in[C333][ii][col] = M_tmp[C33m][ii][col];
