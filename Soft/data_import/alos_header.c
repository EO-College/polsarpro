...
"ALOS/PALSAR Level 1 product - Format Description, vol2, 
level 1.1/1.5" Revision G, October 2005, JAXA, Earth Observation
...
*
*           DirOutput / leader_ceos.txt
*           DirOutput / image_ceos.txt
*           DirOutput / trailer_ceos.txt
*
********************************************************************/
...
/*******************************************************************/
  ...
  sprintf(leader_ascii, "%s%s", DirOutput,"leader_ceos.txt");
  check_file(leader_ascii);

  /* SAR Trailer ascii filename */
  sprintf(trailer_ascii, "%s%s", DirOutput,"trailer_ceos.txt");
  check_file(trailer_ascii);

  /* Imagery Options ascii filename */
  sprintf(image_ascii, "%s%s", DirOutput,"image_ceos.txt");
