...
File   : rawbinary_convert_RealImag_MLK_C3.c
...
//  Symmetrisation = atoi(argv[8]);
  ...
  printf("TYPE: rawbinary_convert_RealImag_MLK_C3 DirOutput Ncol OffsetLig OffsetCol\n");
...
for (lig = 0; lig < Nligfin; lig++) {
  ...
  for (ii = 0; ii < Nlook_lig; ii++) {
    ...
    for (col = 0; col < Ncol; col++) {
      M_in[C311][ii][col] = M_tmp[C311][ii][col];
      M_in[C312_re][ii][col] = M_tmp[C312_re][ii][col];
      M_in[C312_im][ii][col] = M_tmp[C312_im][ii][col];
      M_in[C313_re][ii][col] = M_tmp[C313_re][ii][col];
      M_in[C313_im][ii][col] = M_tmp[C313_im][ii][col];
      M_in[C322][ii][col] = M_tmp[C322][ii][col];
      M_in[C323_re][ii][col] = M_tmp[C323_re][ii][col];
      M_in[C323_im][ii][col] = M_tmp[C323_im][ii][col];
      M_in[C333][ii][col] = M_tmp[C333][ii][col];
