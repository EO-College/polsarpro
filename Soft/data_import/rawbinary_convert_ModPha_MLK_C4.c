...
File   : rawbinary_convert_ModPha_MLK_C4.c
...
//  Symmetrisation = atoi(argv[8]);
  ...
  printf("TYPE: rawbinary_convert_ModPha_C4 DirOutput Ncol OffsetLig OffsetCol\n");
...
for (lig = 0; lig < Nligfin; lig++) {
  ...
  for (ii = 0; ii < Nlook_lig; ii++) {
    ...
    for (col = 0; col < Ncol; col++) {
      M_in[C411][ii][col] = M_tmp[C11m][ii][col];
      M_in[C412_re][ii][col] = M_tmp[C12m][ii][col]*cos(M_tmp[C12p][ii][col]);
      M_in[C412_im][ii][col] = M_tmp[C12m][ii][col]*sin(M_tmp[C12p][ii][col]);
      M_in[C413_re][ii][col] = M_tmp[C13m][ii][col]*cos(M_tmp[C13p][ii][col]);
      M_in[C413_im][ii][col] = M_tmp[C13m][ii][col]*sin(M_tmp[C13p][ii][col]);
      M_in[C414_re][ii][col] = M_tmp[C14m][ii][col]*cos(M_tmp[C14p][ii][col]);
      M_in[C414_im][ii][col] = M_tmp[C14m][ii][col]*sin(M_tmp[C14p][ii][col]);
      M_in[C422][ii][col] = M_tmp[C22m][ii][col];
      M_in[C423_re][ii][col] = M_tmp[C23m][ii][col]*cos(M_tmp[C23p][ii][col]);
      M_in[C423_im][ii][col] = M_tmp[C23m][ii][col]*sin(M_tmp[C23p][ii][col]);
      M_in[C424_re][ii][col] = M_tmp[C24m][ii][col]*cos(M_tmp[C24p][ii][col]);
      M_in[C424_im][ii][col] = M_tmp[C24m][ii][col]*sin(M_tmp[C24p][ii][col]);
      M_in[C433][ii][col] = M_tmp[C33m][ii][col];
      M_in[C434_re][ii][col] = M_tmp[C34m][ii][col]*cos(M_tmp[C34p][ii][col]);
      M_in[C434_im][ii][col] = M_tmp[C34m][ii][col]*sin(M_tmp[C34p][ii][col]);
      M_in[C444][ii][col] = M_tmp[C44m][ii][col];
