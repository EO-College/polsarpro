...
File   : rawbinary_convert_RealImag_MLK_C4.c
...
//  Symmetrisation = atoi(argv[8]);
  ...
  printf("TYPE: rawbinary_convert_RealImag_MLK_C4 DirOutput Ncol OffsetLig OffsetCol\n");
...
for (lig = 0; lig < Nligfin; lig++) {
  ...
  for (ii = 0; ii < Nlook_lig; ii++) {
    ...
    for (col = 0; col < Ncol; col++) {
      M_in[C411][ii][col] = M_tmp[C411][ii][col];
      M_in[C412_re][ii][col] = M_tmp[C412_re][ii][col];
      M_in[C412_im][ii][col] = M_tmp[C412_im][ii][col];
      M_in[C413_re][ii][col] = M_tmp[C413_re][ii][col];
      M_in[C413_im][ii][col] = M_tmp[C413_im][ii][col];
      M_in[C414_re][ii][col] = M_tmp[C414_re][ii][col];
      M_in[C414_im][ii][col] = M_tmp[C414_im][ii][col];
      M_in[C422][ii][col] = M_tmp[C422][ii][col];
      M_in[C423_re][ii][col] = M_tmp[C423_re][ii][col];
      M_in[C423_im][ii][col] = M_tmp[C423_im][ii][col];
      M_in[C424_re][ii][col] = M_tmp[C424_re][ii][col];
      M_in[C424_im][ii][col] = M_tmp[C424_im][ii][col];
      M_in[C433][ii][col] = M_tmp[C433][ii][col];
      M_in[C434_re][ii][col] = M_tmp[C434_re][ii][col];
      M_in[C434_im][ii][col] = M_tmp[C434_im][ii][col];
      M_in[C444][ii][col] = M_tmp[C444][ii][col];
