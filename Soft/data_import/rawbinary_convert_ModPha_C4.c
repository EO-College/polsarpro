...
File   : rawbinary_convert_ModPha_C4.c
...
for (lig = 0; lig < Nligfin; lig++) {
  if (lig%(int)(Nligfin/20) == 0) {printf("%f\r", 100. * lig / (Nligfin - 1));fflush(stdout);}
   ...
   for (col = 0; col < Ncol; col++) {
     M_in[C411][col] = M_tmp[C11m][col];
     M_in[C412_re][col] = M_tmp[C12m][col]*cos(M_tmp[C12p][col]);
     M_in[C412_im][col] = M_tmp[C12m][col]*sin(M_tmp[C12p][col]);
     M_in[C413_re][col] = M_tmp[C13m][col]*cos(M_tmp[C13p][col]);
     M_in[C413_im][col] = M_tmp[C13m][col]*sin(M_tmp[C13p][col]);
     M_in[C414_re][col] = M_tmp[C14m][col]*cos(M_tmp[C14p][col]);
     M_in[C414_im][col] = M_tmp[C14m][col]*sin(M_tmp[C14p][col]);
     M_in[C422][col] = M_tmp[C22m][col];
     M_in[C423_re][col] = M_tmp[C23m][col]*cos(M_tmp[C23p][col]);
     M_in[C423_im][col] = M_tmp[C23m][col]*sin(M_tmp[C23p][col]);
     M_in[C424_re][col] = M_tmp[C24m][col]*cos(M_tmp[C24p][col]);
     M_in[C424_im][col] = M_tmp[C24m][col]*sin(M_tmp[C24p][col]);
     M_in[C433][col] = M_tmp[C33m][col];
     M_in[C434_re][col] = M_tmp[C34m][col]*cos(M_tmp[C34p][col]);
     M_in[C434_im][col] = M_tmp[C34m][col]*sin(M_tmp[C34p][col]);
     M_in[C444][col] = M_tmp[C44m][col];
