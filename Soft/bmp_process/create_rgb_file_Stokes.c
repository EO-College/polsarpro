...
for (Nb = 0; Nb < NbBlock; Nb++) {
  ...
  for (lig = 0; lig < NligBlock[Nb]; lig++) {
    for (col = 0; col < Sub_Ncol; col++) {
      if (Valid[lig][col] == 1.) {  
        Npts++;
        g0 =  M_in[C211][lig][col]+M_in[C222][lig][col];
        g1 =  M_in[C211][lig][col]-M_in[C222][lig][col];
        datatmp[Npts] =  g1 / g0;
        } /* valid */
      } /*col*/
    } /*lig*/
  ...
  for (lig = 0; lig < NligBlock[Nb]; lig++) {
    for (col = 0; col < Sub_Ncol; col++) {
      if (Valid[NligBlock[Nb] - 1 - lig][col] == 1.) {  
        ...
        g1 = M_in[C211][NligBlock[Nb] - 1 - lig][col]-M_in[C222][NligBlock[Nb] - 1 - lig][col];
        g2 = 2.*M_in[C212_re][NligBlock[Nb] - 1 - lig][col];
        g3 = -2.*M_in[C212_im][NligBlock[Nb] - 1 - lig][col];
