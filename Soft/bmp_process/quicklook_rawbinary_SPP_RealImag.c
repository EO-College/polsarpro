...
File   : quicklook_rawbinary_SPP_RealImag.c
...
/******************************************************************************/
  ...
  printf("TYPE: quicklook_rawbinary_SPP_RealImag FileInput1 FileInput2 FileInput3 FileInput4\n");
...
for (lig = 0; lig < Nligfin; lig++) {
  ...
  for (col = 0; col < Ncolfin; col++) {
    ind = col * Coeff;
    M_out[T11][lig][col] = fabs(M_in[ch1r][ind] * M_in[ch1r][ind] + M_in[ch1i][ind] * M_in[ch1i][ind]);
    M_out[T22][lig][col] = fabs(M_in[ch2r][ind] * M_in[ch2r][ind] + M_in[ch2i][ind] * M_in[ch2i][ind]);
    M_out[T33][lig][col] = fabs(M_in[ch1r][ind] - M_in[ch2r][ind])*(M_in[ch1r][ind] - M_in[ch2r][ind]);
    M_out[T33][lig][col] = fabs(M_out[T33][lig][col] + (M_in[ch1i][ind] - M_in[ch2i][ind])*(M_in[ch1i][ind] - M_in[ch2i][ind]));
