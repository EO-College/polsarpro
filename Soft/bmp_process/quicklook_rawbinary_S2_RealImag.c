...
File   : quicklook_rawbinary_S2_RealImag.c
...
/******************************************************************************/
  ...
  printf("TYPE: quicklook_rawbinary_S2_RealImag FileInput1 FileInput2 FileInput3 FileInput4\n");
...
for (lig = 0; lig < Nligfin; lig++) {
  ...
  for (col = 0; col < Ncolfin; col++) {
    ind = col * Coeff;
    k1r = (M_in[hhr][ind] + M_in[vvr][ind]) / sqrt(2.);
    k1i = (M_in[hhi][ind] + M_in[vvi][ind]) / sqrt(2.);
    k2r = (M_in[hhr][ind] - M_in[vvr][ind]) / sqrt(2.);
    k2i = (M_in[hhi][ind] - M_in[vvi][ind]) / sqrt(2.);
    k3r = (M_in[hvr][ind] + M_in[vhr][ind]) / sqrt(2.);
    k3i = (M_in[hvi][ind] + M_in[vhi][ind]) / sqrt(2.);
