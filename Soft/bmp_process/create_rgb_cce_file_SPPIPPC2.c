...
File   : create_rgb_cce_file_SPPIPPC2.c
...
Description :  Creation of the RGB BMP file
...
/* LOCAL VARIABLES */
  int Config;
  char *PolTypeConf[NPolType] = {"SPP", "C2", "T2", "IPP"};
...
strcpy(UsageHelp,"\ncreate_rgb_cce_file_SPPIPPC2.exe\n");
strcat(UsageHelp,"\nParameters:\n");
...
strcat(UsageHelp," (string)	-rgbf	RGB format : RGB1 or RGB2\n");
...
for (Nb = 0; Nb < NbBlock; Nb++) {
  ...
  if ((strcmp(PolTypeIn,"SPP") == 0) 
    ...
    read_block_SPP_noavg(in_datafile, M_in, "C2", 4, Nb, NbBlock, NligBlock[Nb], Sub_Ncol, 1, 1, Off_lig, Off_col, Ncol);
    ...
    if (strcmp(PolTypeIn,"T2")==0) T2_to_C2(M_in, NligBlock[Nb], Sub_Ncol, 0, 0);

    }

  if ((strcmp(PolTypeIn,"C2")==0) || (strcmp(PolTypeIn,"T2")==0)
    || (strcmp(PolTypeIn,"SPP") == 0) 
    || (strcmp(PolTypeIn,"SPPpp1") == 0)
    || (strcmp(PolTypeIn,"SPPpp2") == 0)
    || (strcmp(PolTypeIn,"SPPpp3") == 0)) {
    for (lig = 0; lig < NligBlock[Nb]; lig++) {
      for (col = 0; col < Sub_Ncol; col++) {
        if (Valid[lig][col] == 1.) {  
          Npts++;
          if (strcmp(RGBFormat,"RGB1") == 0) datatmp[Npts] =  fabs(M_in[C211][lig][col]);
          if (strcmp(RGBFormat,"RGB2") == 0) datatmp[Npts] =  fabs(M_in[C222][lig][col]);
    ...
    for (lig = 0; lig < NligBlock[Nb]; lig++) {
      for (col = 0; col < Sub_Ncol; col++) {
        if (Valid[lig][col] == 1.) {  
          Npts++;
          if (strcmp(PolTypeIn,"IPPfull") == 0) datatmp[Npts] =  fabs(M_in[I411][lig][col]);
          if (strcmp(PolTypeIn,"IPPpp4") == 0) datatmp[Npts] =  fabs(M_in[I311][lig][col]);
          if ((strcmp(PolTypeIn,"IPPpp5") == 0)||(strcmp(PolTypeIn,"IPPpp6") == 0)||(strcmp(PolTypeIn,"IPPpp7") == 0)) {
            if (strcmp(RGBFormat,"RGB1") == 0) datatmp[Npts] =  fabs(M_in[I211][lig][col]);
            if (strcmp(RGBFormat,"RGB2") == 0) datatmp[Npts] =  fabs(M_in[I212][lig][col]);
            }
          if (datatmp[Npts] > eps) datatmp[Npts] = 10. * log10(datatmp[Npts]);
          else Npts--;
          } /* valid */
  ...
  if ((strcmp(PolTypeIn,"C2")==0) || (strcmp(PolTypeIn,"T2")==0)
    ...
    for (lig = 0; lig < NligBlock[Nb]; lig++) {
      for (col = 0; col < Sub_Ncol; col++) {
        if (Valid[lig][col] == 1.) {  
          Npts++;
          if (strcmp(RGBFormat,"RGB1") == 0) datatmp[Npts] =  fabs(M_in[C222][lig][col]);
          if (strcmp(RGBFormat,"RGB2") == 0) datatmp[Npts] =  fabs(M_in[C211][lig][col]);
          if (datatmp[Npts] > eps) datatmp[Npts] = 10. * log10(datatmp[Npts]);
          else Npts--;
          } /* valid */
        } /*col*/
    ...
    for (lig = 0; lig < NligBlock[Nb]; lig++) {
      for (col = 0; col < Sub_Ncol; col++) {
        if (Valid[lig][col] == 1.) {  
          Npts++;
          if (strcmp(PolTypeIn,"IPPfull") == 0) datatmp[Npts] =  fabs(M_in[I422][lig][col]);
          if (strcmp(PolTypeIn,"IPPpp4") == 0) datatmp[Npts] =  fabs(M_in[I322][lig][col]);
          if ((strcmp(PolTypeIn,"IPPpp5") == 0)||(strcmp(PolTypeIn,"IPPpp6") == 0)||(strcmp(PolTypeIn,"IPPpp7") == 0)) {
            if (strcmp(RGBFormat,"RGB1") == 0) datatmp[Npts] =  fabs(M_in[I212][lig][col]);
            if (strcmp(RGBFormat,"RGB2") == 0) datatmp[Npts] =  fabs(M_in[I211][lig][col]);
            }
          if (datatmp[Npts] > eps) datatmp[Npts] = 10. * log10(datatmp[Npts]);
          else Npts--;
          } /* valid */
  ...
  if ((strcmp(PolTypeIn,"C2")==0) || (strcmp(PolTypeIn,"T2")==0)
    ...
    for (lig = 0; lig < NligBlock[Nb]; lig++) {
      for (col = 0; col < Sub_Ncol; col++) {
        if (Valid[lig][col] == 1.) {  
          Npts++;
          if (strcmp(RGBFormat,"RGB1") == 0) datatmp[Npts] =  fabs(M_in[C211][lig][col] - 2.*M_in[C212_re][lig][col] + M_in[C222][lig][col]);
          if (strcmp(RGBFormat,"RGB2") == 0) datatmp[Npts] =  fabs(M_in[C222][lig][col] - 2.*M_in[C212_re][lig][col] + M_in[C211][lig][col]);
          if (datatmp[Npts] > eps) datatmp[Npts] = 10. * log10(datatmp[Npts]);
          else Npts--;
          } /* valid */
        } /*col*/
    ...
    for (lig = 0; lig < NligBlock[Nb]; lig++) {
      for (col = 0; col < Sub_Ncol; col++) {
        if (Valid[lig][col] == 1.) {  
          Npts++;
          if (strcmp(PolTypeIn,"IPPfull") == 0) datatmp[Npts] =  fabs(M_in[I412][lig][col]);
          if (strcmp(PolTypeIn,"IPPpp4") == 0) datatmp[Npts] =  fabs(M_in[I312][lig][col]);
          if ((strcmp(PolTypeIn,"IPPpp5") == 0)||(strcmp(PolTypeIn,"IPPpp6") == 0)||(strcmp(PolTypeIn,"IPPpp7") == 0))
            datatmp[Npts] =  fabs(M_in[I211][lig][col]-M_in[I212][lig][col]);
          if (datatmp[Npts] > eps) datatmp[Npts] = 10. * log10(datatmp[Npts]);
          else Npts--;
          } /* valid */
        } /*col*/
...
for (Nb = 0; Nb < NbBlock; Nb++) {
  ...
  if ((strcmp(PolTypeIn,"C2")==0) || (strcmp(PolTypeIn,"T2")==0)
    ...
    for (lig = 0; lig < NligBlock[Nb]; lig++) {
      for (col = 0; col < Sub_Ncol; col++) {
        if (Valid[NligBlock[Nb] - 1 - lig][col] == 1.) {  
          if (strcmp(RGBFormat,"RGB1") == 0) xx = fabs(M_in[C211][NligBlock[Nb] - 1 - lig][col]);
          if (strcmp(RGBFormat,"RGB2") == 0) xx = fabs(M_in[C222][NligBlock[Nb] - 1 - lig][col]);
          if (xx <= eps) xx = eps;
          xx = 10 * log10(xx);
          ...
          if (strcmp(RGBFormat,"RGB1") == 0) xx = fabs(M_in[C211][NligBlock[Nb] - 1 - lig][col] - 2.*M_in[C212_re][NligBlock[Nb] - 1 - lig][col] + M_in[C222][NligBlock[Nb] - 1 - lig][col]);
          if (strcmp(RGBFormat,"RGB2") == 0) xx = fabs(M_in[C222][NligBlock[Nb] - 1 - lig][col] - 2.*M_in[C212_re][NligBlock[Nb] - 1 - lig][col] + M_in[C211][NligBlock[Nb] - 1 - lig][col]);
          if (xx <= eps) xx = eps;
          xx = 10 * log10(xx);
          ...
          if (strcmp(RGBFormat,"RGB1") == 0) xx = fabs(M_in[C222][NligBlock[Nb] - 1 - lig][col]);
          if (strcmp(RGBFormat,"RGB2") == 0) xx = fabs(M_in[C211][NligBlock[Nb] - 1 - lig][col]);
          if (xx <= eps) xx = eps;
          xx = 10 * log10(xx);
    ...
    for (lig = 0; lig < NligBlock[Nb]; lig++) {
      for (col = 0; col < Sub_Ncol; col++) {
        if (Valid[NligBlock[Nb] - 1 - lig][col] == 1.) {  
          if (strcmp(PolTypeIn,"IPPfull") == 0) xx = fabs(M_in[I411][NligBlock[Nb] - 1 - lig][col]);
          if (strcmp(PolTypeIn,"IPPpp4") == 0) xx = fabs(M_in[I311][NligBlock[Nb] - 1 - lig][col]);
          if ((strcmp(PolTypeIn,"IPPpp5") == 0)||(strcmp(PolTypeIn,"IPPpp6") == 0)||(strcmp(PolTypeIn,"IPPpp7") == 0)) {
            if (strcmp(RGBFormat,"RGB1") == 0) xx = fabs(M_in[I211][NligBlock[Nb] - 1 - lig][col]);
            if (strcmp(RGBFormat,"RGB2") == 0) xx = fabs(M_in[I212][NligBlock[Nb] - 1 - lig][col]);
            }
          if (xx <= eps) xx = eps;
          xx = 10 * log10(xx);
          if (xx > maxblue) xx = maxblue;
          ...
          if (strcmp(PolTypeIn,"IPPfull") == 0) xx = fabs(M_in[I412][NligBlock[Nb] - 1 - lig][col]);
          if (strcmp(PolTypeIn,"IPPpp4") == 0) xx = fabs(M_in[I312][NligBlock[Nb] - 1 - lig][col]);
          if ((strcmp(PolTypeIn,"IPPpp5") == 0)||(strcmp(PolTypeIn,"IPPpp6") == 0)||(strcmp(PolTypeIn,"IPPpp7") == 0))
            xx = fabs(M_in[I211][NligBlock[Nb] - 1 - lig][col]-M_in[I212][NligBlock[Nb] - 1 - lig][col]);
          if (xx <= eps) xx = eps;
          xx = 10 * log10(xx);
          if (xx > maxgreen) xx = maxgreen;
          if (xx < mingreen) xx = mingreen;
          ...
          if (strcmp(PolTypeIn,"IPPfull") == 0) xx = fabs(M_in[I422][NligBlock[Nb] - 1 - lig][col]);
          if (strcmp(PolTypeIn,"IPPpp4") == 0) xx = fabs(M_in[I322][NligBlock[Nb] - 1 - lig][col]);
          if ((strcmp(PolTypeIn,"IPPpp5") == 0)||(strcmp(PolTypeIn,"IPPpp6") == 0)||(strcmp(PolTypeIn,"IPPpp7") == 0)) {
            if (strcmp(RGBFormat,"RGB1") == 0) xx = fabs(M_in[I212][NligBlock[Nb] - 1 - lig][col]);
            if (strcmp(RGBFormat,"RGB2") == 0) xx = fabs(M_in[I211][NligBlock[Nb] - 1 - lig][col]);
            }
          if (xx <= eps) xx = eps;
          xx = 10 * log10(xx);
          if (xx > maxred) xx = maxred;
