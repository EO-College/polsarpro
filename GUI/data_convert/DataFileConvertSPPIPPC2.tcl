...
#############################################################################
## Procedure:  ConvertRGBSPP_SPP

proc ::ConvertRGBSPP_SPP {} {
...
#############################################################################
## Procedure:  ConvertRGBSPP_IPP

proc ::ConvertRGBSPP_IPP {} {
global ConvertDirOutput BMPDirInput PolarType
global VarError ErrorMessage Fonction Fonction2
global NligFullSize NcolFullSize PSPViewGimpBMP
global ProgressLine TMPMemoryAllocError 
...
#############################################################################
## Procedure:  ConvertRGBSPP_C2

proc ::ConvertRGBSPP_C2 {} {
...
proc vTclWindow.top415 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 500x340+10+110; update
    wm maxsize $top 1604 1184
    wm minsize $top 116 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Data File Conversion"
    vTcl:DefineAlias "$top" "Toplevel415" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd75 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd75" "Frame2" vTcl:WidgetProc "Toplevel415" 1
    set site_3_0 $top.cpd75
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame4" vTcl:WidgetProc "Toplevel415" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh2" vTcl:WidgetProc "Toplevel415" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame11" vTcl:WidgetProc "Toplevel415" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd86 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd86" "Button34" vTcl:WidgetProc "Toplevel415" 1
    pack $site_6_0.cpd86 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel415" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel415" 1
    frame $site_5_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd74" "Frame1" vTcl:WidgetProc "Toplevel415" 1
    set site_6_0 $site_5_0.cpd74
    label $site_6_0.lab75 \
        -text {/ } 
    vTcl:DefineAlias "$site_6_0.lab75" "Label1" vTcl:WidgetProc "Toplevel415" 1
    entry $site_6_0.cpd77 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ConvertOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd77" "Entry1" vTcl:WidgetProc "Toplevel415" 1
    pack $site_6_0.lab75 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame12" vTcl:WidgetProc "Toplevel415" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != "" } {
    ...
    if {"$VarWarning"=="ok"} {
        ...
        set SubSampRow " "
        set SubSampCol " "
        $widget(Label415_1) configure -state disable
        $widget(Label415_2) configure -state disable
        $widget(Label415_3) configure -state disable
        $widget(Label415_4) configure -state disable
        $widget(Entry415_1) configure -state disable
        $widget(Entry415_2) configure -state disable
        $widget(Entry415_3) configure -state disable
        $widget(Entry415_4) configure -state disable
        } else {
    ...
    vTcl:DefineAlias "$top.fra27" "Frame9" vTcl:WidgetProc "Toplevel415" 1
    set site_3_0 $top.fra27
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel415" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel415" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel415" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel415" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel415" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel415" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel415" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel415" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.fra96 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra96" "Frame3" vTcl:WidgetProc "Toplevel415" 1
    set site_3_0 $top.fra96
    frame $site_3_0.fra97 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra97" "Frame4" vTcl:WidgetProc "Toplevel415" 1
    set site_4_0 $site_3_0.fra97
    frame $site_4_0.fra102 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra102" "Frame6" vTcl:WidgetProc "Toplevel415" 1
    set site_5_0 $site_4_0.fra102
...
$widget(Entry415_3) configure -state disable
$widget(Entry415_4) configure -state disable
if {$DataFormatActive == "SPP"} { $widget(Radiobutton415_1) configure -state normal }} \
        -text {Full Resolution} -value Full -variable ConvertExtractFonction 
    vTcl:DefineAlias "$site_5_0.cpd105" "Radiobutton4151" vTcl:WidgetProc "Toplevel415" 1
    pack $site_5_0.cpd105 \
        -in $site_5_0 -anchor center -expand 0 -fill x -side left 
    frame $site_4_0.fra103 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra103" "Frame7" vTcl:WidgetProc "Toplevel415" 1
    set site_5_0 $site_4_0.fra103
...
set SubSampRow " ? "
set SubSampCol " ? "
$widget(Label415_1) configure -state normal
$widget(Label415_2) configure -state normal
$widget(Label415_3) configure -state disable
$widget(Label415_4) configure -state disable
$widget(Entry415_1) configure -state normal
$widget(Entry415_2) configure -state normal
$widget(Entry415_3) configure -state disable
$widget(Entry415_4) configure -state disable
if {$DataFormatActive == "SPP"} { $widget(Radiobutton415_1) configure -state disable }} \
        -text {Sub Sampling} -value SubSamp -variable ConvertExtractFonction 
    vTcl:DefineAlias "$site_5_0.cpd66" "Radiobutton4152" vTcl:WidgetProc "Toplevel415" 1
    pack $site_5_0.cpd66 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    frame $site_4_0.fra104 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra104" "Frame8" vTcl:WidgetProc "Toplevel415" 1
    set site_5_0 $site_4_0.fra104
...
$widget(Label415_1) configure -state disable
$widget(Label415_2) configure -state disable
$widget(Label415_3) configure -state normal
$widget(Label415_4) configure -state normal
$widget(Entry415_1) configure -state disable
$widget(Entry415_2) configure -state disable
$widget(Entry415_3) configure -state normal
$widget(Entry415_4) configure -state normal
if {$DataFormatActive == "SPP"} { $widget(Radiobutton415_1) configure -state disable }} \
        -text {Multi Look} -value MultiLook -variable ConvertExtractFonction 
    vTcl:DefineAlias "$site_5_0.cpd107" "Radiobutton4153" vTcl:WidgetProc "Toplevel415" 1
    ...
    frame $site_3_0.cpd98 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd98" "Frame5" vTcl:WidgetProc "Toplevel415" 1
    set site_4_0 $site_3_0.cpd98
    frame $site_4_0.cpd111 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd111" "Frame153" vTcl:WidgetProc "Toplevel415" 1
    set site_5_0 $site_4_0.cpd111
    label $site_5_0.lab23 \
        -padx 1 
    vTcl:DefineAlias "$site_5_0.lab23" "Label203" vTcl:WidgetProc "Toplevel415" 1
    label $site_5_0.lab25 \
        -padx 1 
    vTcl:DefineAlias "$site_5_0.lab25" "Label204" vTcl:WidgetProc "Toplevel415" 1
    pack $site_5_0.lab23 \
    ...
    frame $site_4_0.cpd109 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd109" "Frame154" vTcl:WidgetProc "Toplevel415" 1
    set site_5_0 $site_4_0.cpd109
    label $site_5_0.lab25 \
        -padx 1 -text Row 
    vTcl:DefineAlias "$site_5_0.lab25" "Label415_1" vTcl:WidgetProc "Toplevel415" 1
    ...
    vTcl:DefineAlias "$site_5_0.ent26" "Entry415_1" vTcl:WidgetProc "Toplevel415" 1
    label $site_5_0.lab23 \
        -padx 1 -text Col 
    vTcl:DefineAlias "$site_5_0.lab23" "Label415_2" vTcl:WidgetProc "Toplevel415" 1
    entry $site_5_0.ent24 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable SubSampCol -width 7 
    vTcl:DefineAlias "$site_5_0.ent24" "Entry415_2" vTcl:WidgetProc "Toplevel415" 1
    pack $site_5_0.lab25 \
        -in $site_5_0 -anchor center -expand 1 -fill none -padx 10 -side left 
    pack $site_5_0.ent26 \
    ...
    frame $site_4_0.cpd110 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd110" "Frame155" vTcl:WidgetProc "Toplevel415" 1
    set site_5_0 $site_4_0.cpd110
    label $site_5_0.lab25 \
        -padx 1 -text Row 
    vTcl:DefineAlias "$site_5_0.lab25" "Label415_3" vTcl:WidgetProc "Toplevel415" 1
    entry $site_5_0.ent26 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable MultiLookRow -width 7 
    vTcl:DefineAlias "$site_5_0.ent26" "Entry415_3" vTcl:WidgetProc "Toplevel415" 1
    label $site_5_0.lab23 \
        -padx 1 -text Col 
    vTcl:DefineAlias "$site_5_0.lab23" "Label415_4" vTcl:WidgetProc "Toplevel415" 1
    entry $site_5_0.ent24 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable MultiLookCol -width 7 
    vTcl:DefineAlias "$site_5_0.ent24" "Entry415_4" vTcl:WidgetProc "Toplevel415" 1
    pack $site_5_0.lab25 \
        -in $site_5_0 -anchor center -expand 1 -fill none -padx 10 -side left 
    pack $site_5_0.ent26 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.cpd77 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd77" "Frame13" vTcl:WidgetProc "Toplevel415" 1
    set site_3_0 $top.cpd77
    label $site_3_0.lab80 \
        -text { Input Data Format   } 
    vTcl:DefineAlias "$site_3_0.lab80" "Label3" vTcl:WidgetProc "Toplevel415" 1
    entry $site_3_0.ent81 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ConvertInputFormat -width 40 
    vTcl:DefineAlias "$site_3_0.ent81" "Entry3" vTcl:WidgetProc "Toplevel415" 1
    pack $site_3_0.lab80 \
    ...
    vTcl:DefineAlias "$top.cpd70" "TitleFrame3" vTcl:WidgetProc "Toplevel415" 1
    ...
    frame $site_4_0.fra83 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra83" "Frame16" vTcl:WidgetProc "Toplevel415" 1
    set site_5_0 $site_4_0.fra83
    frame $site_5_0.cpd75 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd75" "Frame17" vTcl:WidgetProc "Toplevel415" 1
    set site_6_0 $site_5_0.cpd75
...
set ConvertOutputFormatPP " "} \
    ...
    vTcl:DefineAlias "$site_6_0.cpd70" "Radiobutton415_1" vTcl:WidgetProc "Toplevel415" 1
    radiobutton $site_6_0.cpd71 \
        \
        -command {global ConvertOutputSubDir ConvertOutputFormatPP

set ConvertOutputSubDir ""
set ConvertOutputFormatPP "pp4"} \
        -text {( SPP ) >> ( IPP )} -value SPPIPP \
        -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_6_0.cpd71" "Radiobutton415_2" vTcl:WidgetProc "Toplevel415" 1
...
set ConvertOutputFormatPP " "} \
    ...
    vTcl:DefineAlias "$site_6_0.cpd72" "Radiobutton415_3" vTcl:WidgetProc "Toplevel415" 1
    pack $site_6_0.cpd70 \
    ...
    frame $site_5_0.cpd76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd76" "Frame18" vTcl:WidgetProc "Toplevel415" 1
    set site_6_0 $site_5_0.cpd76
...
set ConvertOutputSubDir ""
set ConvertOutputFormatPP " "} \
        -text {( IPP ) >> ( IPP )} -value IPP -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_6_0.cpd73" "Radiobutton415_4" vTcl:WidgetProc "Toplevel415" 1
...
set ConvertOutputFormatPP " "} \
    ...
    vTcl:DefineAlias "$site_6_0.cpd74" "Radiobutton415_5" vTcl:WidgetProc "Toplevel415" 1
    pack $site_6_0.cpd73 \
        -in $site_6_0 -anchor center -expand 1 -fill none -side left 
    pack $site_6_0.cpd74 \
        -in $site_6_0 -anchor center -expand 1 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.fra41" "Frame20" vTcl:WidgetProc "Toplevel415" 1
...
if {$ConvertDirOutput == $ConvertDirInput} {
    ...
    if {"$VarWarning"=="ok"} {
        ...
        if {$TestVarError == "ok"} {
            ...
            LoadConfig
            if {"$ErrorMessage" == ""} {
                if {$ConvertOutputFormat == "IPP"} {set DataFormatActive "IPP"}
                if {$ConvertOutputFormat == "SPP"} {set DataFormatActive "SPP"}
                if {$ConvertOutputFormat == "SPPIPP"} {set DataFormatActive "IPP"}
            ...
            MenuOn
            Window hide $widget(Toplevel415); TextEditorRunTrace "Close Window Data File Convert" "b"
            }
        } else {
        if {"$VarWarning"=="no"} {Window hide $widget(Toplevel415); TextEditorRunTrace "Close Window Data File Convert" "b"}
        }
}
}
}} \
        -cursor {} -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel415" 1
    ...
    button $site_3_0.but23 \
        ...
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel415" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel415); TextEditorRunTrace "Close Window Convert Data" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel415" 1
