...
#############################################################################
## Procedure:  ConvertRGBC4_T3

proc ::ConvertRGBC4_T3 {} {
...
#############################################################################
## Procedure:  ConvertRGBC4_T4

proc ::ConvertRGBC4_T4 {} {
global ConvertDirOutput BMPDirInput
global VarError ErrorMessage Fonction Fonction2
global NligFullSize NcolFullSize PSPViewGimpBMP
global ProgressLine PSPMemory TMPMemoryAllocError 
...
#############################################################################
## Procedure:  ConvertRGBC4_C3

proc ::ConvertRGBC4_C3 {} {
global ConvertDirOutput BMPDirInput
global VarError ErrorMessage Fonction Fonction2
global NligFullSize NcolFullSize PSPViewGimpBMP
global ProgressLine PSPMemory TMPMemoryAllocError 
...
#############################################################################
## Procedure:  ConvertRGBC4_C4

proc ::ConvertRGBC4_C4 {} {
global ConvertDirOutput BMPDirInput
global VarError ErrorMessage Fonction Fonction2
global NligFullSize NcolFullSize PSPViewGimpBMP
global ProgressLine PSPMemory TMPMemoryAllocError 
...
#############################################################################
## Procedure:  ConvertRGBC4_C2

proc ::ConvertRGBC4_C2 {} {
global ConvertDirOutput BMPDirInput
global VarError ErrorMessage Fonction Fonction2
global NligFullSize NcolFullSize PSPViewGimpBMP
global ProgressLine PSPMemory TMPMemoryAllocError 
...
#############################################################################
## Procedure:  ConvertRGBC4_IPP

proc ::ConvertRGBC4_IPP {} {
...
if {$ConvertOutputFormat == "C4IPPfull"} {
    if {$ConvertSymmetrisation == "1"} { set ConvertOutputFormat "C4IPPpp4" }
    }
...
proc vTclWindow.top414 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel414" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd75 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd75" "Frame2" vTcl:WidgetProc "Toplevel414" 1
    set site_3_0 $top.cpd75
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame4" vTcl:WidgetProc "Toplevel414" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh2" vTcl:WidgetProc "Toplevel414" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame11" vTcl:WidgetProc "Toplevel414" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd86 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd86" "Button34" vTcl:WidgetProc "Toplevel414" 1
    pack $site_6_0.cpd86 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel414" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel414" 1
    frame $site_5_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd74" "Frame1" vTcl:WidgetProc "Toplevel414" 1
    set site_6_0 $site_5_0.cpd74
    label $site_6_0.lab75 \
        -text {/ } 
    vTcl:DefineAlias "$site_6_0.lab75" "Label1" vTcl:WidgetProc "Toplevel414" 1
    entry $site_6_0.cpd77 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ConvertOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd77" "Entry1" vTcl:WidgetProc "Toplevel414" 1
    pack $site_6_0.lab75 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame12" vTcl:WidgetProc "Toplevel414" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != "" } {
    ...
    if {"$VarWarning"=="ok"} {
        ...
        set SubSampRow ""
        set SubSampCol ""
        $widget(Label414_1) configure -state disable
        $widget(Label414_2) configure -state disable
        $widget(Label414_3) configure -state disable
        $widget(Label414_4) configure -state disable
        $widget(Entry414_1) configure -state disable
        $widget(Entry414_2) configure -state disable
        $widget(Entry414_3) configure -state disable
        $widget(Entry414_4) configure -state disable
        } else {
    ...
    vTcl:DefineAlias "$top.fra27" "Frame9" vTcl:WidgetProc "Toplevel414" 1
    set site_3_0 $top.fra27
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel414" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel414" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel414" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel414" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel414" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel414" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel414" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel414" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.fra79 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra79" "Frame10" vTcl:WidgetProc "Toplevel414" 1
...
if {$ConvertSymmetrisation == 1} {
    $widget(Radiobutton414_4) configure -state disable
    $widget(Radiobutton414_5) configure -state disable
...
if {$ConvertSymmetrisation == 0} {
    $widget(Radiobutton414_4) configure -state normal
    $widget(Radiobutton414_5) configure -state normal
    }} \
        -text {Symmetrisation ( S12 = S21 )} -variable ConvertSymmetrisation 
    vTcl:DefineAlias "$site_3_0.che74" "Checkbutton414_1" vTcl:WidgetProc "Toplevel414" 1
    pack $site_3_0.che74 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    frame $top.fra96 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra96" "Frame3" vTcl:WidgetProc "Toplevel414" 1
    set site_3_0 $top.fra96
    frame $site_3_0.fra97 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra97" "Frame4" vTcl:WidgetProc "Toplevel414" 1
    set site_4_0 $site_3_0.fra97
    frame $site_4_0.fra102 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra102" "Frame6" vTcl:WidgetProc "Toplevel414" 1
    set site_5_0 $site_4_0.fra102
...
$widget(Entry414_4) configure -state disable
    ...
    vTcl:DefineAlias "$site_5_0.cpd105" "Radiobutton414_1" vTcl:WidgetProc "Toplevel414" 1
    pack $site_5_0.cpd105 \
        -in $site_5_0 -anchor center -expand 0 -fill x -side left 
    frame $site_4_0.fra103 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra103" "Frame7" vTcl:WidgetProc "Toplevel414" 1
    set site_5_0 $site_4_0.fra103
...
set SubSampRow " ? "
set SubSampCol " ? "
$widget(Label414_1) configure -state normal
$widget(Label414_2) configure -state normal
$widget(Label414_3) configure -state disable
$widget(Label414_4) configure -state disable
$widget(Entry414_1) configure -state normal
$widget(Entry414_2) configure -state normal
$widget(Entry414_3) configure -state disable
$widget(Entry414_4) configure -state disable
} \
        -text {Sub Sampling} -value SubSamp -variable ConvertExtractFonction 
    vTcl:DefineAlias "$site_5_0.cpd106" "Radiobutton414_2" vTcl:WidgetProc "Toplevel414" 1
    pack $site_5_0.cpd106 \
        -in $site_5_0 -anchor center -expand 0 -fill x -side left 
    frame $site_4_0.fra104 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra104" "Frame8" vTcl:WidgetProc "Toplevel414" 1
    set site_5_0 $site_4_0.fra104
...
$widget(Label414_1) configure -state disable
$widget(Label414_2) configure -state disable
$widget(Label414_3) configure -state normal
$widget(Label414_4) configure -state normal
$widget(Entry414_1) configure -state disable
$widget(Entry414_2) configure -state disable
$widget(Entry414_3) configure -state normal
$widget(Entry414_4) configure -state normal
ConvertDataFormatMLK_ON} \
        -text {Multi Look} -value MultiLook -variable ConvertExtractFonction 
    vTcl:DefineAlias "$site_5_0.cpd107" "Radiobutton414_3" vTcl:WidgetProc "Toplevel414" 1
    ...
    frame $site_3_0.cpd98 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd98" "Frame5" vTcl:WidgetProc "Toplevel414" 1
    set site_4_0 $site_3_0.cpd98
    frame $site_4_0.cpd111 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd111" "Frame153" vTcl:WidgetProc "Toplevel414" 1
    set site_5_0 $site_4_0.cpd111
    label $site_5_0.lab23 \
        -padx 1 
    vTcl:DefineAlias "$site_5_0.lab23" "Label203" vTcl:WidgetProc "Toplevel414" 1
    label $site_5_0.lab25 \
        -padx 1 
    vTcl:DefineAlias "$site_5_0.lab25" "Label204" vTcl:WidgetProc "Toplevel414" 1
    pack $site_5_0.lab23 \
    ...
    frame $site_4_0.cpd109 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd109" "Frame154" vTcl:WidgetProc "Toplevel414" 1
    set site_5_0 $site_4_0.cpd109
    label $site_5_0.lab25 \
        -padx 1 -text Row 
    vTcl:DefineAlias "$site_5_0.lab25" "Label414_1" vTcl:WidgetProc "Toplevel414" 1
    ...
    vTcl:DefineAlias "$site_5_0.ent26" "Entry414_1" vTcl:WidgetProc "Toplevel414" 1
    label $site_5_0.lab23 \
        -padx 1 -text Col 
    vTcl:DefineAlias "$site_5_0.lab23" "Label414_2" vTcl:WidgetProc "Toplevel414" 1
    entry $site_5_0.ent24 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable SubSampCol -width 7 
    vTcl:DefineAlias "$site_5_0.ent24" "Entry414_2" vTcl:WidgetProc "Toplevel414" 1
    pack $site_5_0.lab25 \
        -in $site_5_0 -anchor center -expand 1 -fill none -padx 10 -side left 
    pack $site_5_0.ent26 \
    ...
    frame $site_4_0.cpd110 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd110" "Frame155" vTcl:WidgetProc "Toplevel414" 1
    set site_5_0 $site_4_0.cpd110
    label $site_5_0.lab25 \
        -padx 1 -text Row 
    vTcl:DefineAlias "$site_5_0.lab25" "Label414_3" vTcl:WidgetProc "Toplevel414" 1
    entry $site_5_0.ent26 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable MultiLookRow -width 7 
    vTcl:DefineAlias "$site_5_0.ent26" "Entry414_3" vTcl:WidgetProc "Toplevel414" 1
    label $site_5_0.lab23 \
        -padx 1 -text Col 
    vTcl:DefineAlias "$site_5_0.lab23" "Label414_4" vTcl:WidgetProc "Toplevel414" 1
    entry $site_5_0.ent24 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable MultiLookCol -width 7 
    vTcl:DefineAlias "$site_5_0.ent24" "Entry414_4" vTcl:WidgetProc "Toplevel414" 1
    pack $site_5_0.lab25 \
        -in $site_5_0 -anchor center -expand 1 -fill none -padx 10 -side left 
    pack $site_5_0.ent26 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.cpd77 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd77" "Frame13" vTcl:WidgetProc "Toplevel414" 1
    set site_3_0 $top.cpd77
    label $site_3_0.lab80 \
        -text { Input Data Format   } 
    vTcl:DefineAlias "$site_3_0.lab80" "Label3" vTcl:WidgetProc "Toplevel414" 1
    entry $site_3_0.ent81 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ConvertInputFormat -width 40 
    vTcl:DefineAlias "$site_3_0.ent81" "Entry3" vTcl:WidgetProc "Toplevel414" 1
    pack $site_3_0.lab80 \
    ...
    vTcl:DefineAlias "$top.tit80" "TitleFrame2" vTcl:WidgetProc "Toplevel414" 1
    ...
    frame $site_4_0.fra83 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra83" "Frame15" vTcl:WidgetProc "Toplevel414" 1
    set site_5_0 $site_4_0.fra83
    frame $site_5_0.cpd75 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd75" "Frame25" vTcl:WidgetProc "Toplevel414" 1
    set site_6_0 $site_5_0.cpd75
    frame $site_6_0.cpd67 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd67" "Frame28" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.cpd67
...
set ConvertSymmetrisation 1} \
        -text {[ C4 ] >> [ T3 ]} -value C4T3 -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd84" "Radiobutton239" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd84 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.fra79 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra79" "Frame27" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.fra79
    radiobutton $site_7_0.cpd84 \
        \
        -command {global ConvertOutputSubDir ConvertOutputFormatPP ConvertSymmetrisation
...
set ConvertOutputFormatPP ""
set ConvertSymmetrisation 1} \
        -text {[ C4 ] >> [ C3 ]} -value C4C3 -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd84" "Radiobutton4144" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd84 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.fra81 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra81" "Frame29" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.fra81
...
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> [ C2 ] - pp1} -value C4C2pp1 \
        -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd86" "Radiobutton4149" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd86 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.cpd66 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd66" "Frame43" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.cpd66
    radiobutton $site_7_0.cpd86 \
        \
        -command {global ConvertOutputSubDir ConvertOutputFormatPP ConvertSymmetrisation
...
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> [ C2 ] - LHV} -value C4C2lhv \
        -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd86" "Radiobutton414" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd86 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.fra82 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra82" "Frame30" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.fra82
...
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> ( I11, I21)} -value C4IPPpp5 \
        -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd87" "Radiobutton41412" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd87 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.cpd67 \
    ...
    frame $site_5_0.fra88 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra88" "Frame31" vTcl:WidgetProc "Toplevel414" 1
    set site_6_0 $site_5_0.fra88
    frame $site_6_0.fra90 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra90" "Frame33" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.fra90
...
set ConvertOutputFormatPP ""
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> [ T4 ]} -value C4T4 -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd96" "Radiobutton414_4" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd96 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd92" "Frame34" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.cpd92
...
set ConvertOutputFormatPP ""
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> [ C4 ]} -value C4 -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd97" "Radiobutton414_5" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd97 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.cpd93 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd93" "Frame35" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.cpd93
...
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> [ C2 ] - pp2} -value C4C2pp2 \
        -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd98" "Radiobutton41410" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd98 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd73" "Frame49" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.cpd73
    radiobutton $site_7_0.cpd86 \
        \
        -command {global ConvertOutputSubDir ConvertOutputFormatPP ConvertSymmetrisation
...
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> [ C2 ] - RHV} -value C4C2rhv \
        -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd86" "Radiobutton243" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd86 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.cpd94 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd94" "Frame36" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.cpd94
...
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> ( I22, I12)} -value C4IPPpp6 \
        -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd99" "Radiobutton41413" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd99 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.fra89 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra89" "Frame32" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.fra89
...
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> [ I2 ]} -value C4IPPfull \
        -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd95" "Radiobutton4142" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd95 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.fra90 \
        -in $site_6_0 -anchor center -expand 0 -fill x -side top 
    ...
    frame $site_5_0.fra100 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra100" "Frame37" vTcl:WidgetProc "Toplevel414" 1
    set site_6_0 $site_5_0.fra100
    frame $site_6_0.fra102 \
        -borderwidth 3 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra102" "Frame39" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.fra102
    label $site_7_0.lab111
    vTcl:DefineAlias "$site_7_0.lab111" "Label7" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.lab111 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side top 
    frame $site_6_0.cpd68 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd68" "Frame44" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.cpd68
    label $site_7_0.lab111
    vTcl:DefineAlias "$site_7_0.lab111" "Label8" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.lab111 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side top 
    frame $site_6_0.fra104 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra104" "Frame41" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.fra104
...
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> [ C2 ] - pp3} -value C4C2pp3 \
        -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd108" "Radiobutton41411" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd108 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd74" "Frame50" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.cpd74
    radiobutton $site_7_0.cpd86 \
        \
        -command {global ConvertOutputSubDir ConvertOutputFormatPP ConvertSymmetrisation
...
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> [ C2 ] - pi4} -value C4C2pi4 \
        -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd86" "Radiobutton244" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd86 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.fra105 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra105" "Frame42" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.fra105
...
set ConvertSymmetrisation 0} \
        -text {[ C4 ] >> ( I11, I22)} -value C4IPPpp7 \
        -variable ConvertOutputFormat 
    vTcl:DefineAlias "$site_7_0.cpd109" "Radiobutton41414" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.cpd109 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.cpd72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd72" "Frame48" vTcl:WidgetProc "Toplevel414" 1
    set site_7_0 $site_6_0.cpd72
    label $site_7_0.lab111
    vTcl:DefineAlias "$site_7_0.lab111" "Label9" vTcl:WidgetProc "Toplevel414" 1
    pack $site_7_0.lab111 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side top 
    ...
    vTcl:DefineAlias "$top.fra41" "Frame20" vTcl:WidgetProc "Toplevel414" 1
...
if {$ConvertDirOutput == $ConvertDirInput} {
    ...
    if {"$VarWarning"=="ok"} {
        ...
        if {$TestVarError == "ok"} {
            ...
            LoadConfig
            if {"$ErrorMessage" == ""} {
                if {$ConvertOutputFormat == "C4"} {set DataFormatActive "C4"}
                if {$ConvertOutputFormat == "C4C3"} {set DataFormatActive "C3"}
                if {$ConvertOutputFormat == "C4T3"} {set DataFormatActive "T3"}
                if {$ConvertOutputFormat == "C4T4"} {set DataFormatActive "T4"}
                if {$ConvertOutputFormat == "C4C2pp1"} {set DataFormatActive "C2"}
                if {$ConvertOutputFormat == "C4C2pp2"} {set DataFormatActive "C2"}
                if {$ConvertOutputFormat == "C4C2pp3"} {set DataFormatActive "C2"}
                if {$ConvertOutputFormat == "C4C2lhv"} {set DataFormatActive "C2"}
                if {$ConvertOutputFormat == "C4C2rhv"} {set DataFormatActive "C2"}
                if {$ConvertOutputFormat == "C4C2pi4"} {set DataFormatActive "C2"}
                if {$ConvertOutputFormat == "C4IPPfull"} {set DataFormatActive "IPP"}
                if {$ConvertOutputFormat == "C4IPPpp5"} {set DataFormatActive "IPP"}
                if {$ConvertOutputFormat == "C4IPPpp6"} {set DataFormatActive "IPP"}
                if {$ConvertOutputFormat == "C4IPPpp7"} {set DataFormatActive "IPP"}
            ...
            MenuOn
            Window hide $widget(Toplevel414); TextEditorRunTrace "Close Window Data File Convert" "b"
            }
        } else {
        if {"$VarWarning"=="no"} {Window hide $widget(Toplevel414); TextEditorRunTrace "Close Window Data File Convert" "b"}
        }
}
}
}} \
        -cursor {} -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel414" 1
    ...
    button $site_3_0.but23 \
        ...
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel414" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel414); TextEditorRunTrace "Close Window Convert Data" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel414" 1
