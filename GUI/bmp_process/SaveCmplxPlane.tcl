...
#############################################################################
## Procedure:  SaveCmplxPlaneExtractPlot

proc ::SaveCmplxPlaneExtractPlot {} {
...
proc vTclWindow.top331 {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Save Coherences - Complex Plane"
    vTcl:DefineAlias "$top" "Toplevel331" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd72" "Frame1" vTcl:WidgetProc "Toplevel331" 1
    set site_3_0 $top.cpd72
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Output Directory} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel331" 1
    ...
    entry $site_5_0.cpd85 \
        ...
        -textvariable CmplxPlaneOutputDir 
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel331" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame2" vTcl:WidgetProc "Toplevel331" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab74 \
        -text {/ } 
    vTcl:DefineAlias "$site_6_0.lab74" "Label1" vTcl:WidgetProc "Toplevel331" 1
    entry $site_6_0.cpd76 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable CmplxPlaneOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd76" "Entry1" vTcl:WidgetProc "Toplevel331" 1
    pack $site_6_0.lab74 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame12" vTcl:WidgetProc "Toplevel331" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd87 \
        \
        -command {global DirName DataDir CmplxPlaneOutputDir
global VarWarning WarningMessage WarningMessage2

set CmplxPlaneDirOutputTmp $CmplxPlaneOutputDir
set DirName ""
...
if {$DirName != "" } {
    ...
    if {"$VarWarning"=="ok"} {
        set CmplxPlaneOutputDir $DirName
        } else {
        set CmplxPlaneOutputDir $CmplxPlaneDirOutputTmp
        }
    } else {
    set CmplxPlaneOutputDir $CmplxPlaneDirOutputTmp
    }} \
    ...
    frame $site_3_0.cpd91 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd91" "Frame6" vTcl:WidgetProc "Toplevel331" 1
    set site_4_0 $site_3_0.cpd91
    TitleFrame $site_4_0.cpd92 \
        -ipad 0 -text {Coherences - Complex Plane Output File} 
    vTcl:DefineAlias "$site_4_0.cpd92" "TitleFrame9" vTcl:WidgetProc "Toplevel331" 1
    ...
    entry $site_6_0.cpd85 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -state normal \
        -textvariable CmplxPlaneOutputFile 
    vTcl:DefineAlias "$site_6_0.cpd85" "EntryTopXXCh7" vTcl:WidgetProc "Toplevel331" 1
    frame $site_6_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd73" "Frame9" vTcl:WidgetProc "Toplevel331" 1
    set site_7_0 $site_6_0.cpd73
    label $site_7_0.lab74 \
        -text . 
    vTcl:DefineAlias "$site_7_0.lab74" "Label2" vTcl:WidgetProc "Toplevel331" 1
    entry $site_7_0.cpd76 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable GnuOutputFormat -width 3 
    vTcl:DefineAlias "$site_7_0.cpd76" "Entry2" vTcl:WidgetProc "Toplevel331" 1
    pack $site_7_0.lab74 \
    ...
    frame $site_3_0.cpd95 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd95" "Frame11" vTcl:WidgetProc "Toplevel331" 1
    set site_4_0 $site_3_0.cpd95
    radiobutton $site_4_0.rad96 \
        -text cgm -value cgm -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.rad96" "Radiobutton1" vTcl:WidgetProc "Toplevel331" 1
    radiobutton $site_4_0.cpd97 \
        -text corel -value cdw -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd97" "Radiobutton2" vTcl:WidgetProc "Toplevel331" 1
    radiobutton $site_4_0.cpd98 \
        -text emf -value emf -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd98" "Radiobutton3" vTcl:WidgetProc "Toplevel331" 1
    radiobutton $site_4_0.cpd99 \
        -text png -value png -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd99" "Radiobutton4" vTcl:WidgetProc "Toplevel331" 1
    radiobutton $site_4_0.cpd100 \
        -text {postscript (eps)} -value eps -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd100" "Radiobutton7" vTcl:WidgetProc "Toplevel331" 1
    button $site_4_0.but101 \
        -background #ffff00 \
        -command {global VarSaveGnuPlotFile

set VarSaveGnuPlotFile "ok"
Window hide $widget(Toplevel331); TextEditorRunTrace "Close Window Save Coherences - Complex Plane" "b"} \
        -padx 4 -pady 2 -text Cancel 
    vTcl:DefineAlias "$site_4_0.but101" "Button6" vTcl:WidgetProc "Toplevel331" 1
    button $site_4_0.cpd102 \
        -background #ffff00 \
        -command {global CmplxPlaneDirOutput CmplxPlaneOutputDir CmplxPlaneOutputSubDir
global GnuOutputFile CmplxPlaneOutputFile CmplxPlaneOutputFormat
...
if {$CmplxPlaneOutputSubDir != ""} {append CmplxPlaneDirOutput "/$CmplxPlaneOutputSubDir"}
set GnuOutputFile "$CmplxPlaneDirOutput/$CmplxPlaneOutputFile"
...
Window hide $widget(Toplevel331); TextEditorRunTrace "Close Window Save Coherences - Complex Plane" "b"} \
    ...
    vTcl:DefineAlias "$site_4_0.cpd102" "Button7" vTcl:WidgetProc "Toplevel331" 1
    pack $site_4_0.rad96 \
