...
proc vTclWindow.top344 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 100x100+520+100; update
    wm maxsize $top 1604 1184
    wm minsize $top 115 2
    wm overrideredirect $top 0
    wm resizable $top 0 0
    wm title $top "View PCT Image"
    vTcl:DefineAlias "$top" "VIEWBMPPCT" vTcl:Toplevel:WidgetProc "" 1
    ...
    canvas $site_3_0.cpd80 \
        ...
        -width 200 
    vTcl:DefineAlias "$site_3_0.cpd80" "CANVASBMPPCT" vTcl:WidgetProc "VIEWBMPPCT" 1
