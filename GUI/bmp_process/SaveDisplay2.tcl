...
proc vTclWindow.top457 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 500x160+110+100; update
    wm maxsize $top 1604 1184
    wm minsize $top 116 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Save Display"
    vTcl:DefineAlias "$top" "Toplevel457" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd72" "Frame1" vTcl:WidgetProc "Toplevel457" 1
    set site_3_0 $top.cpd72
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Output Directory} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel457" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel457" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame12" vTcl:WidgetProc "Toplevel457" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != "" } {
    ...
    frame $site_3_0.cpd95 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd95" "Frame11" vTcl:WidgetProc "Toplevel457" 1
    set site_4_0 $site_3_0.cpd95
    button $site_4_0.but101 \
        -background #ffff00 \
        -command {global VarSaveGnuPlotFile
set VarSaveGnuPlotFile "ok"
Window hide $widget(Toplevel457); TextEditorRunTrace "Close Window Save Display 2" "b"} \
        -padx 4 -pady 2 -text Cancel 
    vTcl:DefineAlias "$site_4_0.but101" "Button6" vTcl:WidgetProc "Toplevel457" 1
    button $site_4_0.cpd102 \
        -background #ffff00 \
        -command {global SaveDisplayDirOutput  
global SaveDisplayFileOutput SaveDisplayOutputFile1 SaveDisplayOutputFile2 
global VarSaveGnuPlotFile TMPGnuPlotTk1 TMPGnuPlotTk2 
...
Window hide $widget(Toplevel457); TextEditorRunTrace "Close Window Save Display 2" "b"} \
    ...
    vTcl:DefineAlias "$site_4_0.cpd102" "Button7" vTcl:WidgetProc "Toplevel457" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd66" "TitleFrame10" vTcl:WidgetProc "Toplevel457" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel457" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame10" vTcl:WidgetProc "Toplevel457" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab74 \
        -text {  } 
    vTcl:DefineAlias "$site_6_0.lab74" "Label4" vTcl:WidgetProc "Toplevel457" 1
    label $site_6_0.cpd67 \
        -background #ffffff -foreground #0000ff -relief sunken \
        -text .gif 
    vTcl:DefineAlias "$site_6_0.cpd67" "Label5" vTcl:WidgetProc "Toplevel457" 1
    pack $site_6_0.lab74 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd67" "TitleFrame9" vTcl:WidgetProc "Toplevel457" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh7" vTcl:WidgetProc "Toplevel457" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame9" vTcl:WidgetProc "Toplevel457" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab74 \
        -text {  } 
    vTcl:DefineAlias "$site_6_0.lab74" "Label2" vTcl:WidgetProc "Toplevel457" 1
    label $site_6_0.cpd67 \
        -background #ffffff -foreground #0000ff -relief sunken \
        -text .gif 
    vTcl:DefineAlias "$site_6_0.cpd67" "Label3" vTcl:WidgetProc "Toplevel457" 1
    pack $site_6_0.lab74 \
        -in $site_6_0 -anchor center -expand 1 -fill x -side left 
    pack $site_6_0.cpd67 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
