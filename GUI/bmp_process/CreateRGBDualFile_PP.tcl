...
proc vTclWindow.top439 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel439" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd113 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd113" "Frame1" vTcl:WidgetProc "Toplevel439" 1
    set site_3_0 $top.cpd113
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame4" vTcl:WidgetProc "Toplevel439" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh2" vTcl:WidgetProc "Toplevel439" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame16" vTcl:WidgetProc "Toplevel439" 1
    set site_6_0 $site_5_0.cpd92
...
if {"$ErrorMessage" != ""} {
    ...
    set RGBDirInput ""
    set RGBDirOutput ""
    if {$VarError == "cancel"} {Window hide $widget(Toplevel439); TextEditorRunTrace "Close Window Create RGB Dual Files" "b"}
    } else {
    if { "$PolarType" == "full"} {
        ...
        -padx 1 -pady 0 -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd116" "Button36" vTcl:WidgetProc "Toplevel439" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel439" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel439" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame17" vTcl:WidgetProc "Toplevel439" 1
    set site_6_0 $site_5_0.cpd91
...
if {$RGBFormat == "sinclair"} {
    ...
    vTcl:DefineAlias "$top.fra41" "Frame9" vTcl:WidgetProc "Toplevel439" 1
    set site_3_0 $top.fra41
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel439" 1
    entry $site_3_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel439" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel439" 1
    entry $site_3_0.ent60 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel439" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel439" 1
    entry $site_3_0.ent62 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel439" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel439" 1
    entry $site_3_0.ent64 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel439" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.fra42 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra42" "Frame67" vTcl:WidgetProc "Toplevel439" 1
    set site_3_0 $top.fra42
    frame $site_3_0.fra38 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra38" "Frame85" vTcl:WidgetProc "Toplevel439" 1
    set site_4_0 $site_3_0.fra38
...
set RGBFormat "RGB1"
set RGBFileOutputT1 "$RGBDirOutput/RGB1_T1.bmp"
set RGBFileOutputT2 "$RGBDirOutput/RGB1_T2.bmp"} \
        -text {RGB Color Composition 1} -value RGB1 -variable RGBFormat 
    vTcl:DefineAlias "$site_4_0.rad67" "Radiobutton35" vTcl:WidgetProc "Toplevel439" 1
    radiobutton $site_4_0.rad68 \
        \
        -command {global RGBDirOutput RGBFileOutputT1 RGBFileOutputT2 RGBFormat

set RGBFormat "RGB2"
set RGBFileOutputT1 "$RGBDirOutput/RGB2_T1.bmp"
set RGBFileOutputT2 "$RGBDirOutput/RGB2_T2.bmp"} \
        -text {RGB Color Composition 2} -value RGB2 -variable RGBFormat 
    vTcl:DefineAlias "$site_4_0.rad68" "Radiobutton36" vTcl:WidgetProc "Toplevel439" 1
    pack $site_4_0.rad67 \
    ...
    frame $site_3_0.fra39 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra39" "Frame86" vTcl:WidgetProc "Toplevel439" 1
    set site_4_0 $site_3_0.fra39
    frame $site_4_0.fra42 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra42" "Frame68" vTcl:WidgetProc "Toplevel439" 1
    set site_5_0 $site_4_0.fra42
    label $site_5_0.lab47 \
        -foreground #0000ff -padx 1 -text {| Channel1 |} 
    vTcl:DefineAlias "$site_5_0.lab47" "Label53" vTcl:WidgetProc "Toplevel439" 1
    label $site_5_0.lab48 \
        -foreground #008000 -padx 1 -text {| Channel1 - Channel2 |} 
    vTcl:DefineAlias "$site_5_0.lab48" "Label54" vTcl:WidgetProc "Toplevel439" 1
    label $site_5_0.lab49 \
        -foreground #ff0000 -padx 1 -text {| Channel2 |} 
    vTcl:DefineAlias "$site_5_0.lab49" "Label55" vTcl:WidgetProc "Toplevel439" 1
    pack $site_5_0.lab47 \
    ...
    frame $site_4_0.fra43 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra43" "Frame69" vTcl:WidgetProc "Toplevel439" 1
    set site_5_0 $site_4_0.fra43
    label $site_5_0.lab52 \
        -foreground #0000ff -padx 1 -text {| Channel2 |} 
    vTcl:DefineAlias "$site_5_0.lab52" "Label57" vTcl:WidgetProc "Toplevel439" 1
    label $site_5_0.lab53 \
        -foreground #008000 -padx 1 -text {| Channel1 - Channel2 |} 
    vTcl:DefineAlias "$site_5_0.lab53" "Label58" vTcl:WidgetProc "Toplevel439" 1
    label $site_5_0.lab54 \
        -foreground #ff0000 -padx 1 -text {| Channel1 |} 
    vTcl:DefineAlias "$site_5_0.lab54" "Label59" vTcl:WidgetProc "Toplevel439" 1
    pack $site_5_0.lab52 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.lab53 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    ...
    frame $top.cpd115 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd115" "Frame3" vTcl:WidgetProc "Toplevel439" 1
    set site_3_0 $top.cpd115
    TitleFrame $site_3_0.cpd71 \
        -ipad 0 -text {Output RGB File - [T1]} 
    vTcl:DefineAlias "$site_3_0.cpd71" "TitleFrame10" vTcl:WidgetProc "Toplevel439" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh9" vTcl:WidgetProc "Toplevel439" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame23" vTcl:WidgetProc "Toplevel439" 1
    set site_6_0 $site_5_0.cpd91
    ...
    vTcl:DefineAlias "$site_3_0.cpd72" "TitleFrame11" vTcl:WidgetProc "Toplevel439" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh10" vTcl:WidgetProc "Toplevel439" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame24" vTcl:WidgetProc "Toplevel439" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd107 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
    ...
    vTcl:DefineAlias "$top.fra59" "Frame20" vTcl:WidgetProc "Toplevel439" 1
...
if {"$RGBDirInput"!=""} {
            ...
            if {$TestVarError == "ok"} {
                ...
                if {"$RGBFunction"=="T4"} {
                    ...
                    if [file exists $fichier] {
                        ...
                        set config "false"
                        set VarError ""
                        set ErrorMessage "THE FILE T34_real.bin MUST BE CREATED FIRST"
                        Window show $widget(Toplevel44); TextEditorRunTrace "Open Window Error" "b"
                        tkwait variable VarError
                        }
                    if {"$config"=="true"} {
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel439" 1
    ...
    button $site_3_0.but23 \
        ...
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel439" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel439); TextEditorRunTrace "Close Window Create RGB Dual Files" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel439" 1
