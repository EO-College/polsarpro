...
#############################################################################
## Procedure:  SavePlotProfile1D

proc ::SavePlotProfile1D {} {
...
if {$ProfileOutputFormat == "mod"} {puts $GnuplotPipeSave "set ylabel ''"; flush $GnuplotPipeSave}
if {$ProfileOutputFormat == "db10"} {puts $GnuplotPipeSave "set ylabel 'dB'"; flush $GnuplotPipeSave}
if {$ProfileOutputFormat == "db20"} {puts $GnuplotPipeSave "set ylabel 'dB'"; flush $GnuplotPipeSave}
if {$ProfileOutputFormat == "pha"} {puts $GnuplotPipeSave "set ylabel 'Arg(°)'"; flush $GnuplotPipeSave}
if {$ProfileOutputFormat == "real"} {puts $GnuplotPipeSave "set ylabel ''"; flush $GnuplotPipeSave}
if {$ProfileOutputFormat == "imag"} {puts $GnuplotPipeSave "set ylabel ''"; flush $GnuplotPipeSave}

puts $GnuplotPipeSave "set title '$GnuProfileTitle' textcolor lt 3"; flush $GnuplotPipeSave

if {$ProfileRepresentation == "xrange"} {puts $GnuplotPipeSave "plot '$TMPProfileXBin' using 1:2 notitle with lines"; flush $GnuplotPipeSave}
if {$ProfileRepresentation == "yrange"} {puts $GnuplotPipeSave "plot '$TMPProfileYBin' using 1:2 notitle with lines"; flush $GnuplotPipeSave}   
}
#############################################################################
## Procedure:  SavePlotProfile3D

proc ::SavePlotProfile3D {} {
...
GnuPlot3D $GnuplotPipeSave $TMPProfileXYTxt $TMPProfileXYBin "Pix" "Pix" $Unit $GnuXview $GnuZview $GnuProfileTitle 1 $ProfileRepresentation3D 1
...
proc vTclWindow.top258 {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Save Data Value - Profile"
    vTcl:DefineAlias "$top" "Toplevel258" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd72" "Frame1" vTcl:WidgetProc "Toplevel258" 1
    set site_3_0 $top.cpd72
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Output Directory} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel258" 1
    ...
    entry $site_5_0.cpd85 \
        ...
        -textvariable ProfileOutputDir 
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel258" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame2" vTcl:WidgetProc "Toplevel258" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab74 \
        -text {/ } 
    vTcl:DefineAlias "$site_6_0.lab74" "Label1" vTcl:WidgetProc "Toplevel258" 1
    entry $site_6_0.cpd76 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ProfileOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd76" "Entry1" vTcl:WidgetProc "Toplevel258" 1
    pack $site_6_0.lab74 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame12" vTcl:WidgetProc "Toplevel258" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd87 \
        \
        -command {global DirName DataDir ProfileOutputDir
global VarWarning WarningMessage WarningMessage2

set ProfileDirOutputTmp $ProfileOutputDir
set DirName ""
...
if {$DirName != "" } {
    ...
    if {"$VarWarning"=="ok"} {
        set ProfileOutputDir $DirName
        } else {
        set ProfileOutputDir $ProfileDirOutputTmp
        }
    } else {
    set ProfileOutputDir $ProfileDirOutputTmp
    }} \
    ...
    frame $site_3_0.cpd91 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd91" "Frame6" vTcl:WidgetProc "Toplevel258" 1
    set site_4_0 $site_3_0.cpd91
    TitleFrame $site_4_0.cpd92 \
        -ipad 0 -text {Profile Response Output File} 
    vTcl:DefineAlias "$site_4_0.cpd92" "TitleFrame9" vTcl:WidgetProc "Toplevel258" 1
    ...
    entry $site_6_0.cpd85 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -state normal \
        -textvariable ProfileOutputFile 
    vTcl:DefineAlias "$site_6_0.cpd85" "EntryTopXXCh7" vTcl:WidgetProc "Toplevel258" 1
    frame $site_6_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd73" "Frame9" vTcl:WidgetProc "Toplevel258" 1
    set site_7_0 $site_6_0.cpd73
    label $site_7_0.lab74 \
        -text . 
    vTcl:DefineAlias "$site_7_0.lab74" "Label2" vTcl:WidgetProc "Toplevel258" 1
    entry $site_7_0.cpd76 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable GnuOutputFormat -width 3 
    vTcl:DefineAlias "$site_7_0.cpd76" "Entry2" vTcl:WidgetProc "Toplevel258" 1
    pack $site_7_0.lab74 \
    ...
    frame $site_3_0.cpd95 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd95" "Frame11" vTcl:WidgetProc "Toplevel258" 1
    set site_4_0 $site_3_0.cpd95
    radiobutton $site_4_0.rad96 \
        -text cgm -value cgm -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.rad96" "Radiobutton1" vTcl:WidgetProc "Toplevel258" 1
    radiobutton $site_4_0.cpd97 \
        -text corel -value cdw -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd97" "Radiobutton2" vTcl:WidgetProc "Toplevel258" 1
    radiobutton $site_4_0.cpd98 \
        -text emf -value emf -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd98" "Radiobutton3" vTcl:WidgetProc "Toplevel258" 1
    radiobutton $site_4_0.cpd99 \
        -text png -value png -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd99" "Radiobutton4" vTcl:WidgetProc "Toplevel258" 1
    radiobutton $site_4_0.cpd100 \
        -text {postscript (eps)} -value eps -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd100" "Radiobutton7" vTcl:WidgetProc "Toplevel258" 1
    button $site_4_0.but101 \
        -background #ffff00 \
        -command {global VarSaveGnuPlotFile

set VarSaveGnuPlotFile "ok"
Window hide $widget(Toplevel258); TextEditorRunTrace "Close Window Save Data Value - Profile" "b"} \
        -padx 4 -pady 2 -text Cancel 
    vTcl:DefineAlias "$site_4_0.but101" "Button6" vTcl:WidgetProc "Toplevel258" 1
    button $site_4_0.cpd102 \
        -background #ffff00 \
        -command {global ProfileDirOutput ProfileOutputDir ProfileOutputSubDir
global GnuOutputFile ProfileOutputFile ProfileRepresentation
global GnuplotPipeFid GnuplotPipeSave GnuOutputFormat
global VarSaveGnuPlotFile

set ProfileDirOutput $ProfileOutputDir
if {$ProfileOutputSubDir != ""} {append ProfileDirOutput "/$ProfileOutputSubDir"}
set GnuOutputFile "$ProfileDirOutput/$ProfileOutputFile"
...
Window hide $widget(Toplevel258); TextEditorRunTrace "Close Window Save Data Value - Profile" "b"} \
    ...
    vTcl:DefineAlias "$site_4_0.cpd102" "Button7" vTcl:WidgetProc "Toplevel258" 1
    pack $site_4_0.rad96 \
