...
puts $GnuplotPipeSave "set xlabel 'Value'"; flush $GnuplotPipeSave
puts $GnuplotPipeSave "set ylabel 'Nb of Samples'"; flush $GnuplotPipeSave
puts $GnuplotPipeSave "set title '$GnuStatHistoLabel($GnuStatHistoIdLabel)' textcolor lt 3"; flush $GnuplotPipeSave

set xi $GnuStatHistoIdData
set yi [expr $xi + 1]
if {$GnuStatPdfFlag == 0} {
    puts $GnuplotPipeSave "plot '$TMPStatHistoTxt' using $xi:$yi title '$GnuStatHistoLabel($GnuStatHistoIdLabel)' with boxes"; flush $GnuplotPipeSave
    } else {
    if {$GnuStatPdfId != [expr $GnuStatPdfNum - 1] } {
        set yii [expr $xi + $GnuStatPdfId + 2]
        puts $GnuplotPipeSave "plot '$TMPStatHistoTxt' using $xi:$yii title 'Theoretical PDF : $GnuStatPdfLabel($GnuStatPdfId)' with lines, '$TMPStatHistoTxt' using $xi:$yi title '$GnuStatHistoLabel($GnuStatHistoIdLabel)' with boxes"; flush $GnuplotPipeSave
        } else {
        set yii $yi;
        ...
        puts $GnuplotPipeSave "$GnuCommand"; flush $GnuplotPipeSave
        }
    }
}
...
proc vTclWindow.top250 {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Save Statistics"
    vTcl:DefineAlias "$top" "Toplevel250" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd72" "Frame1" vTcl:WidgetProc "Toplevel250" 1
    set site_3_0 $top.cpd72
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Output Directory} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel250" 1
    ...
    entry $site_5_0.cpd85 \
        ...
        -textvariable StatOutputDir 
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel250" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame2" vTcl:WidgetProc "Toplevel250" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab74 \
        -text {/ } 
    vTcl:DefineAlias "$site_6_0.lab74" "Label1" vTcl:WidgetProc "Toplevel250" 1
    entry $site_6_0.cpd76 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable StatOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd76" "Entry1" vTcl:WidgetProc "Toplevel250" 1
    pack $site_6_0.lab74 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame12" vTcl:WidgetProc "Toplevel250" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd87 \
        \
        -command {global DirName DataDir StatOutputDir
global VarWarning WarningMessage WarningMessage2

set StatDirOutputTmp $StatOutputDir
set DirName ""
...
if {$DirName != "" } {
    ...
    if {"$VarWarning"=="ok"} {
        set StatOutputDir $DirName
        } else {
        set StatOutputDir $StatDirOutputTmp
        }
    } else {
    set StatOutputDir $StatDirOutputTmp
    }} \
    ...
    frame $site_3_0.cpd91 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd91" "Frame6" vTcl:WidgetProc "Toplevel250" 1
    set site_4_0 $site_3_0.cpd91
    TitleFrame $site_4_0.cpd92 \
        -ipad 0 -text {Statistics Output File} 
    vTcl:DefineAlias "$site_4_0.cpd92" "TitleFrame9" vTcl:WidgetProc "Toplevel250" 1
    ...
    entry $site_6_0.cpd85 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -state normal \
        -textvariable StatOutputFile 
    vTcl:DefineAlias "$site_6_0.cpd85" "EntryTopXXCh7" vTcl:WidgetProc "Toplevel250" 1
    frame $site_6_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd73" "Frame9" vTcl:WidgetProc "Toplevel250" 1
    set site_7_0 $site_6_0.cpd73
    label $site_7_0.lab74 \
        -text . 
    vTcl:DefineAlias "$site_7_0.lab74" "Label2" vTcl:WidgetProc "Toplevel250" 1
    entry $site_7_0.cpd76 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable GnuOutputFormat -width 3 
    vTcl:DefineAlias "$site_7_0.cpd76" "Entry2" vTcl:WidgetProc "Toplevel250" 1
    pack $site_7_0.lab74 \
    ...
    frame $site_3_0.cpd95 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd95" "Frame11" vTcl:WidgetProc "Toplevel250" 1
    set site_4_0 $site_3_0.cpd95
    radiobutton $site_4_0.rad96 \
        -text cgm -value cgm -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.rad96" "Radiobutton1" vTcl:WidgetProc "Toplevel250" 1
    radiobutton $site_4_0.cpd97 \
        -text corel -value cdw -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd97" "Radiobutton2" vTcl:WidgetProc "Toplevel250" 1
    radiobutton $site_4_0.cpd98 \
        -text emf -value emf -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd98" "Radiobutton3" vTcl:WidgetProc "Toplevel250" 1
    radiobutton $site_4_0.cpd99 \
        -text png -value png -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd99" "Radiobutton4" vTcl:WidgetProc "Toplevel250" 1
    radiobutton $site_4_0.cpd100 \
        -text {postscript (eps)} -value eps -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd100" "Radiobutton7" vTcl:WidgetProc "Toplevel250" 1
    button $site_4_0.but101 \
        -background #ffff00 \
        -command {global VarSaveGnuPlotFile

set VarSaveGnuPlotFile "ok"
Window hide $widget(Toplevel250); TextEditorRunTrace "Close Window Save Statistics" "b"} \
        -padx 4 -pady 2 -text Cancel 
    vTcl:DefineAlias "$site_4_0.but101" "Button6" vTcl:WidgetProc "Toplevel250" 1
    button $site_4_0.cpd102 \
        -background #ffff00 \
        -command {global StatDirOutput StatOutputDir StatOutputSubDir
global GnuOutputFile StatOutputFile
global GnuplotPipeFid GnuplotPipeSave GnuOutputFormat
global VarSaveGnuPlotFile

set StatDirOutput $StatOutputDir
if {$StatOutputSubDir != ""} {append StatDirOutput "/$StatOutputSubDir"}
set GnuOutputFile "$StatDirOutput/$StatOutputFile"
...
Window hide $widget(Toplevel250); TextEditorRunTrace "Close Window Save Statistics" "b"} \
    ...
    vTcl:DefineAlias "$site_4_0.cpd102" "Button7" vTcl:WidgetProc "Toplevel250" 1
    pack $site_4_0.rad96 \
