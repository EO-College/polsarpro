...
proc vTclWindow.top460 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel460" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd72" "Frame1" vTcl:WidgetProc "Toplevel460" 1
    set site_3_0 $top.cpd72
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Output Directory} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel460" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel460" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame12" vTcl:WidgetProc "Toplevel460" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != "" } {
    ...
    frame $site_3_0.cpd95 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd95" "Frame11" vTcl:WidgetProc "Toplevel460" 1
    set site_4_0 $site_3_0.cpd95
...
Window hide $widget(Toplevel460); TextEditorRunTrace "Close Window Save Display 1" "b"} \
    ...
    vTcl:DefineAlias "$site_4_0.but101" "Button6" vTcl:WidgetProc "Toplevel460" 1
    button $site_4_0.cpd102 \
        -background #ffff00 \
        -command {global SaveDisplayDirOutput 
global SaveDisplayFileOutput SaveDisplayOutputFile1 SaveDisplayOutputFileNum
global VarSaveGnuPlotFile TMPGnuPlotTk1 TMPGnuPlotTk2 TMPGnuPlotTk3 TMPGnuPlotTk4 TMPGnuPlotTk5 TMPGnuPlotTk6

set SaveDisplayFileOutput "$SaveDisplayDirOutput/$SaveDisplayOutputFile1"
append SaveDisplayFileOutput ".gif"
if {$SaveDisplayOutputFileNum == 1} { CopyFile $TMPGnuPlotTk1 $SaveDisplayFileOutput }
if {$SaveDisplayOutputFileNum == 2} { CopyFile $TMPGnuPlotTk2 $SaveDisplayFileOutput }
if {$SaveDisplayOutputFileNum == 3} { CopyFile $TMPGnuPlotTk3 $SaveDisplayFileOutput }
if {$SaveDisplayOutputFileNum == 4} { CopyFile $TMPGnuPlotTk4 $SaveDisplayFileOutput }
...
Window hide $widget(Toplevel460); TextEditorRunTrace "Close Window Save Display 1" "b"} \
    ...
    vTcl:DefineAlias "$site_4_0.cpd102" "Button7" vTcl:WidgetProc "Toplevel460" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd66" "TitleFrame10" vTcl:WidgetProc "Toplevel460" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel460" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame10" vTcl:WidgetProc "Toplevel460" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab74 \
        -text {  } 
    vTcl:DefineAlias "$site_6_0.lab74" "Label4" vTcl:WidgetProc "Toplevel460" 1
    label $site_6_0.cpd67 \
        -background #ffffff -foreground #0000ff -relief sunken \
        -text .gif 
    vTcl:DefineAlias "$site_6_0.cpd67" "Label5" vTcl:WidgetProc "Toplevel460" 1
    pack $site_6_0.lab74 \
