...
proc vTclWindow.top51 {base} {
    ...
    vTcl:DefineAlias "$top" "VIEWBMP1" vTcl:Toplevel:WidgetProc "" 1
    bindtags $top "$top Toplevel all _TopLevel"
    vTcl:FireEvent $top <<Create>>
    wm protocol $top WM_DELETE_WINDOW "vTcl:FireEvent $top <<>>"

    frame $top.cpd79
    vTcl:DefineAlias "$top.cpd79" "FRAMEBMP1" vTcl:WidgetProc "VIEWBMP1" 1
    set site_3_0 $top.cpd79
    canvas $site_3_0.cpd80 \
        -closeenough 1.0 -cursor {} -height 264 -highlightthickness 0 \
        -width 378 
    vTcl:DefineAlias "$site_3_0.cpd80" "CANVASBMP1" vTcl:WidgetProc "VIEWBMP1" 1
