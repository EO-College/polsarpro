...
proc vTclWindow.top458 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel458" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd72" "Frame1" vTcl:WidgetProc "Toplevel458" 1
    set site_3_0 $top.cpd72
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Output Directory} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel458" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel458" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame12" vTcl:WidgetProc "Toplevel458" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != "" } {
    ...
    frame $site_3_0.cpd95 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd95" "Frame11" vTcl:WidgetProc "Toplevel458" 1
    set site_4_0 $site_3_0.cpd95
    button $site_4_0.but101 \
        -background #ffff00 \
        -command {global VarSaveGnuPlotFile
set VarSaveGnuPlotFile "ok"
Window hide $widget(Toplevel458); TextEditorRunTrace "Close Window Save Display 3" "b"} \
        -padx 4 -pady 2 -text Cancel 
    vTcl:DefineAlias "$site_4_0.but101" "Button6" vTcl:WidgetProc "Toplevel458" 1
...
append SaveDisplayFileOutput ".gif"
CopyFile $TMPGnuPlotTk2 $SaveDisplayFileOutput
...
Window hide $widget(Toplevel458); TextEditorRunTrace "Close Window Save Display 3" "b"} \
    ...
    vTcl:DefineAlias "$site_4_0.cpd102" "Button7" vTcl:WidgetProc "Toplevel458" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd66" "TitleFrame10" vTcl:WidgetProc "Toplevel458" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel458" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame10" vTcl:WidgetProc "Toplevel458" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab74 \
        -text {  } 
    vTcl:DefineAlias "$site_6_0.lab74" "Label4" vTcl:WidgetProc "Toplevel458" 1
    label $site_6_0.cpd67 \
        -background #ffffff -foreground #0000ff -relief sunken \
        -text .gif 
    vTcl:DefineAlias "$site_6_0.cpd67" "Label5" vTcl:WidgetProc "Toplevel458" 1
    pack $site_6_0.lab74 \
    ...
    TitleFrame $site_3_0.cpd67 \
        -ipad 0 -text {Output File - Display n°2} 
    vTcl:DefineAlias "$site_3_0.cpd67" "TitleFrame9" vTcl:WidgetProc "Toplevel458" 1
    ...
    entry $site_5_0.cpd85 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -state normal \
        -textvariable SaveDisplayOutputFile2 
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh7" vTcl:WidgetProc "Toplevel458" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame9" vTcl:WidgetProc "Toplevel458" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab74 \
        -text {  } 
    vTcl:DefineAlias "$site_6_0.lab74" "Label2" vTcl:WidgetProc "Toplevel458" 1
    label $site_6_0.cpd67 \
        -background #ffffff -foreground #0000ff -relief sunken \
        -text .gif 
    vTcl:DefineAlias "$site_6_0.cpd67" "Label3" vTcl:WidgetProc "Toplevel458" 1
    pack $site_6_0.lab74 \
        -in $site_6_0 -anchor center -expand 1 -fill x -side left 
    pack $site_6_0.cpd67 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    ...
    TitleFrame $site_3_0.cpd68 \
        -ipad 0 -text {Output File - Display n°3} 
    vTcl:DefineAlias "$site_3_0.cpd68" "TitleFrame11" vTcl:WidgetProc "Toplevel458" 1
    ...
    entry $site_5_0.cpd85 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -state normal \
        -textvariable SaveDisplayOutputFile3 
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh9" vTcl:WidgetProc "Toplevel458" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame13" vTcl:WidgetProc "Toplevel458" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab74 \
        -text {  } 
    vTcl:DefineAlias "$site_6_0.lab74" "Label6" vTcl:WidgetProc "Toplevel458" 1
    label $site_6_0.cpd67 \
        -background #ffffff -foreground #0000ff -relief sunken \
        -text .gif 
    vTcl:DefineAlias "$site_6_0.cpd67" "Label7" vTcl:WidgetProc "Toplevel458" 1
    pack $site_6_0.lab74 \
        -in $site_6_0 -anchor center -expand 1 -fill x -side left 
    pack $site_6_0.cpd67 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
