...
proc vTclWindow.top254 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 500x200+520+100; update
...
set BluePalette(16) [expr round([lindex [winfo rgb $b $color] 2] / 256)]} \
    ...
    frame $top.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd73" "Frame264" vTcl:WidgetProc "Toplevel254" 1
    set site_3_0 $top.cpd73
    button $site_3_0.but36 \
        \
        -command {global ColorMapNumber

if { 17 <= $ColorMapNumber} {
set b .top254.cpd73.but36
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
...
if { 18 <= $ColorMapNumber} {
set b .top254.cpd73.but37
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
...
if { 19 <= $ColorMapNumber} {
set b .top254.cpd73.but38
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
...
set BluePalette(19) [expr round([lindex [winfo rgb $b $color] 2] / 256)]
    ...
    vTcl:DefineAlias "$site_3_0.but38" "ColorMapBut4" vTcl:WidgetProc "Toplevel254" 1
    button $site_3_0.but39 \
        \
        -command {global ColorMapNumber

if { 20 <= $ColorMapNumber} {
set b .top254.cpd73.but39
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
...
if { 21 <= $ColorMapNumber} {
set b .top254.cpd73.but40
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
...
if { 22 <= $ColorMapNumber} {
set b .top254.cpd73.but41
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
...
if { 23 <= $ColorMapNumber} {
set b .top254.cpd73.but42
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
...
if { 24 <= $ColorMapNumber} {
set b .top254.cpd73.but43
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
...
if { 25 <= $ColorMapNumber} {
set b .top254.cpd73.but44
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
...
if { 26 <= $ColorMapNumber} {
set b .top254.cpd73.but45
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
...
if { 27 <= $ColorMapNumber} {
set b .top254.cpd73.but46
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
...
if { 28 <= $ColorMapNumber} {
set b .top254.cpd73.but47
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
set RedPalette(28) [expr round([lindex [winfo rgb $b $color] 0] / 256)] 
set GreenPalette(28) [expr round([lindex [winfo rgb $b $color] 1] / 256)] 
set BluePalette(28) [expr round([lindex [winfo rgb $b $color] 2] / 256)]
}} \
        -padx 0 -pady 0 -text 28 
    button $site_3_0.but48 \
        \
        -command {global ColorMapNumber

if { 29 <= $ColorMapNumber} {
set b .top254.cpd73.but48
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
set RedPalette(29) [expr round([lindex [winfo rgb $b $color] 0] / 256)] 
set GreenPalette(29) [expr round([lindex [winfo rgb $b $color] 1] / 256)] 
set BluePalette(29) [expr round([lindex [winfo rgb $b $color] 2] / 256)]
}} \
        -padx 0 -pady 0 -text 29 
    button $site_3_0.but49 \
        \
        -command {global ColorMapNumber

if { 30 <= $ColorMapNumber} {
set b .top254.cpd73.but49
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
set RedPalette(30) [expr round([lindex [winfo rgb $b $color] 0] / 256)] 
set GreenPalette(30) [expr round([lindex [winfo rgb $b $color] 1] / 256)] 
set BluePalette(30) [expr round([lindex [winfo rgb $b $color] 2] / 256)]
}} \
        -padx 0 -pady 0 -text 30 
    button $site_3_0.but50 \
        \
        -command {global ColorMapNumber

if { 31 <= $ColorMapNumber} {
set b .top254.cpd73.but50
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
set RedPalette(31) [expr round([lindex [winfo rgb $b $color] 0] / 256)] 
set GreenPalette(31) [expr round([lindex [winfo rgb $b $color] 1] / 256)] 
set BluePalette(31) [expr round([lindex [winfo rgb $b $color] 2] / 256)]
}} \
        -padx 0 -pady 0 -text 31 
    button $site_3_0.but51 \
        \
        -command {global ColorMapNumber

if { 32 <= $ColorMapNumber} {
set b .top254.cpd73.but51
set initialColor [$b cget -background]
set color [tk_chooseColor -title "Choose a color" -initialcolor $initialColor]
if {$color == ""} {set color $initialColor}
$b configure -background $color
set RedPalette(32) [expr round([lindex [winfo rgb $b $color] 0] / 256)] 
set GreenPalette(32) [expr round([lindex [winfo rgb $b $color] 1] / 256)] 
set BluePalette(32) [expr round([lindex [winfo rgb $b $color] 2] / 256)]
}} \
        -padx 0 -pady 0 -text 32 
    pack $site_3_0.but36 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    pack $site_3_0.but37 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
...
Window hide $widget(Toplevel254); TextEditorRunTrace "Close Window Colormap" "b"
    ...
    button $site_3_0.but71 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/colormap2.pdf"} \
