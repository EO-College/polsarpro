...
proc vTclWindow.top408 {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Save Scatter Plot"
    vTcl:DefineAlias "$top" "Toplevel408" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd72" "Frame1" vTcl:WidgetProc "Toplevel408" 1
    set site_3_0 $top.cpd72
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Output Directory} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel408" 1
    ...
    entry $site_5_0.cpd85 \
        ...
        -textvariable ScatterPlotDirOutput 
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel408" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame12" vTcl:WidgetProc "Toplevel408" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd87 \
        \
        -command {global DirName DataDir ScatterPlotDirOutput
global VarWarning WarningMessage WarningMessage2

set ScatterPlotDirOutputTmp $ScatterPlotDirOutput
set DirName ""
...
if {$DirName != "" } {
    ...
    if {"$VarWarning"=="ok"} {
        set ScatterPlotDirOutput $DirName
        } else {
        set ScatterPlotDirOutput $ScatterPlotDirOutputTmp
        }
    } else {
    set ScatterPlotDirOutput $ScatterPlotDirOutputTmp
    }} \
    ...
    frame $site_3_0.cpd91 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd91" "Frame6" vTcl:WidgetProc "Toplevel408" 1
    set site_4_0 $site_3_0.cpd91
    TitleFrame $site_4_0.cpd92 \
        -ipad 0 -text {Scatter Plot Output File} 
    vTcl:DefineAlias "$site_4_0.cpd92" "TitleFrame9" vTcl:WidgetProc "Toplevel408" 1
    ...
    entry $site_6_0.cpd85 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -state normal \
        -textvariable ScatterPlotOutputFile 
    vTcl:DefineAlias "$site_6_0.cpd85" "EntryTopXXCh7" vTcl:WidgetProc "Toplevel408" 1
    frame $site_6_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd73" "Frame9" vTcl:WidgetProc "Toplevel408" 1
    set site_7_0 $site_6_0.cpd73
    label $site_7_0.lab74 \
        -text . 
    vTcl:DefineAlias "$site_7_0.lab74" "Label2" vTcl:WidgetProc "Toplevel408" 1
    entry $site_7_0.cpd76 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable GnuOutputFormat -width 3 
    vTcl:DefineAlias "$site_7_0.cpd76" "Entry2" vTcl:WidgetProc "Toplevel408" 1
    pack $site_7_0.lab74 \
    ...
    frame $site_3_0.cpd95 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd95" "Frame11" vTcl:WidgetProc "Toplevel408" 1
    set site_4_0 $site_3_0.cpd95
    radiobutton $site_4_0.rad96 \
        -text cgm -value cgm -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.rad96" "Radiobutton1" vTcl:WidgetProc "Toplevel408" 1
    radiobutton $site_4_0.cpd97 \
        -text corel -value cdw -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd97" "Radiobutton2" vTcl:WidgetProc "Toplevel408" 1
    radiobutton $site_4_0.cpd98 \
        -text emf -value emf -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd98" "Radiobutton3" vTcl:WidgetProc "Toplevel408" 1
    radiobutton $site_4_0.cpd99 \
        -text png -value png -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd99" "Radiobutton4" vTcl:WidgetProc "Toplevel408" 1
    radiobutton $site_4_0.cpd100 \
        -text {postscript (eps)} -value eps -variable GnuOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd100" "Radiobutton7" vTcl:WidgetProc "Toplevel408" 1
    button $site_4_0.but101 \
        -background #ffff00 \
        -command {global VarSaveGnuPlotFile

set VarSaveGnuPlotFile "ok"
Window hide $widget(Toplevel408); TextEditorRunTrace "Close Window Save Scatter Plot" "b"} \
        -padx 4 -pady 2 -text Cancel 
    vTcl:DefineAlias "$site_4_0.but101" "Button6" vTcl:WidgetProc "Toplevel408" 1
    button $site_4_0.cpd102 \
        -background #ffff00 \
        -command {global ScatterPlotDirOutput GnuOutputFile ScatterPlotOutputFile
global GnuOutputFormat GnuplotPipeFid GnuplotPipeSave
...
set GnuOutputFile "$ScatterPlotDirOutput/$ScatterPlotOutputFile"
...
if [file exists $TMPScatterPlotFileOutputXYtxt] {
    ...
    set GnuXview "0"; set GnuZview "0"; set Unit ""; set GnuSurface "surface"
    GnuPlot3D $GnuplotPipeSave $TMPScatterPlotFileOutputXYtxt $TMPScatterPlotFileOutputXYbin $ScatterPlotLabelX $ScatterPlotLabelY $Unit $GnuXview $GnuZview "$ScatterPlotTitle - (Scale: 10^n)" 1 $GnuSurface 3
    catch "close $GnuplotPipeSave"
    }
set GnuplotPipeSave ""
set VarSaveGnuPlotFile "ok"
Window hide $widget(Toplevel408); TextEditorRunTrace "Close Window Save Scatter Plot File" "b"} \
        -padx 4 -pady 2 -text OK 
    vTcl:DefineAlias "$site_4_0.cpd102" "Button7" vTcl:WidgetProc "Toplevel408" 1
    pack $site_4_0.rad96 \
