...
proc vTclWindow.top313PP {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel313PP" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.tit71" "TitleFrame1" vTcl:WidgetProc "Toplevel313PP" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd72" "Entry313PP_149" vTcl:WidgetProc "Toplevel313PP" 1
    frame $site_4_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame1" vTcl:WidgetProc "Toplevel313PP" 1
    set site_5_0 $site_4_0.cpd74
    button $site_5_0.but75 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_5_0.but75" "Button1" vTcl:WidgetProc "Toplevel313PP" 1
    pack $site_5_0.but75 \
    ...
    vTcl:DefineAlias "$top.tit76" "TitleFrame2" vTcl:WidgetProc "Toplevel313PP" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd82" "Entry313PP_73" vTcl:WidgetProc "Toplevel313PP" 1
    frame $site_4_0.cpd72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd72" "Frame13" vTcl:WidgetProc "Toplevel313PP" 1
    set site_5_0 $site_4_0.cpd72
    label $site_5_0.lab73 \
        -text / 
    vTcl:DefineAlias "$site_5_0.lab73" "Label1" vTcl:WidgetProc "Toplevel313PP" 1
    entry $site_5_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ForestHeightOutputSubDir -width 3 
    vTcl:DefineAlias "$site_5_0.cpd75" "Entry1" vTcl:WidgetProc "Toplevel313PP" 1
    pack $site_5_0.lab73 \
    ...
    frame $site_4_0.cpd84 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd84" "Frame2" vTcl:WidgetProc "Toplevel313PP" 1
    set site_5_0 $site_4_0.cpd84
...
if {$DirName != "" } {
    ...
    set ForestHeightOutputDir $ForestHeightOutputDirTmp
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd85" "Button313PP_92" vTcl:WidgetProc "Toplevel313PP" 1
    ...
    vTcl:DefineAlias "$top.fra74" "Frame9" vTcl:WidgetProc "Toplevel313PP" 1
    set site_3_0 $top.fra74
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label313PP_01" vTcl:WidgetProc "Toplevel313PP" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry313PP_01" vTcl:WidgetProc "Toplevel313PP" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label313PP_02" vTcl:WidgetProc "Toplevel313PP" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry313PP_02" vTcl:WidgetProc "Toplevel313PP" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label313PP_03" vTcl:WidgetProc "Toplevel313PP" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry313PP_03" vTcl:WidgetProc "Toplevel313PP" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label313PP_04" vTcl:WidgetProc "Toplevel313PP" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry313PP_04" vTcl:WidgetProc "Toplevel313PP" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.che71" "Checkbutton1" vTcl:WidgetProc "Toplevel313PP" 1
    label $top.lab66 \
        \
        -text {( Complex Coherences : Opt1, Opt2, Ch1, Ch2, Ch1pCh2, Ch1mCh2 )} 
    vTcl:DefineAlias "$top.lab66" "Label2" vTcl:WidgetProc "Toplevel313PP" 1
    TitleFrame $top.tit92 \
        -ipad 2 -text {2D Kz File} 
    vTcl:DefineAlias "$top.tit92" "TitleFrame5" vTcl:WidgetProc "Toplevel313PP" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd76" "Frame111" vTcl:WidgetProc "Toplevel313PP" 1
    set site_5_0 $site_4_0.cpd76
    frame $site_5_0.fra88 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra88" "Frame16" vTcl:WidgetProc "Toplevel313PP" 1
    set site_6_0 $site_5_0.fra88
    entry $site_6_0.cpd89 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable KzFile -width 40 
    vTcl:DefineAlias "$site_6_0.cpd89" "Entry234_13" vTcl:WidgetProc "Toplevel313PP" 1
    pack $site_6_0.cpd89 \
        -in $site_6_0 -anchor center -expand 1 -fill x -side top 
    frame $site_5_0.fra90 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra90" "Frame17" vTcl:WidgetProc "Toplevel313PP" 1
    set site_6_0 $site_5_0.fra90
...
if {$FileName != ""} {
    set KzFile $FileName
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd72" "Button2" vTcl:WidgetProc "Toplevel313PP" 1
    ...
    vTcl:DefineAlias "$top.fra83" "Frame20" vTcl:WidgetProc "Toplevel313PP" 1
...
if {$ForestHeightCohAvg == "0"} {
    ...
    if [file exists "$ForestHeightDirInput/cmplx_coh_Ch1.bin"] { } else { set config "false" }
    if [file exists "$ForestHeightDirInput/cmplx_coh_Ch2.bin"] { } else { set config "false" }
    if [file exists "$ForestHeightDirInput/cmplx_coh_Ch1pCh2.bin"] { } else { set config "false" }
    if [file exists "$ForestHeightDirInput/cmplx_coh_Ch1mCh2.bin"] { } else { set config "false" }
    }
if {$ForestHeightCohAvg == "1"} {
    ...
    if [file exists "$ForestHeightDirInput/cmplx_coh_avg_Ch1.bin"] { } else { set config "false" }
    if [file exists "$ForestHeightDirInput/cmplx_coh_avg_Ch2.bin"] { } else { set config "false" }
    if [file exists "$ForestHeightDirInput/cmplx_coh_avg_Ch1pCh2.bin"] { } else { set config "false" }
    if [file exists "$ForestHeightDirInput/cmplx_coh_avg_Ch1mCh2.bin"] { } else { set config "false" }
    }
...
if {"$VarWarning"=="ok"} {
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel313PP); TextEditorRunTrace "Close Window Vegetation Height Estimation" "b"}
    }
}
}} \
        -cursor {} -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel313PP" 1
    ...
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel313PP" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel313PP); TextEditorRunTrace "Close Window Vegetation Height Estimation" "b"
set ProgressLine "0"; update
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel313PP" 1
