...
proc vTclWindow.top355PP {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel355PP" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.tit71" "TitleFrame1" vTcl:WidgetProc "Toplevel355PP" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd72" "Entry355PP_149" vTcl:WidgetProc "Toplevel355PP" 1
    frame $site_4_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame1" vTcl:WidgetProc "Toplevel355PP" 1
    set site_5_0 $site_4_0.cpd74
    button $site_5_0.but75 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_5_0.but75" "Button1" vTcl:WidgetProc "Toplevel355PP" 1
    pack $site_5_0.but75 \
    ...
    vTcl:DefineAlias "$top.cpd83" "TitleFrame7" vTcl:WidgetProc "Toplevel355PP" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd72" "Entry234" vTcl:WidgetProc "Toplevel355PP" 1
    frame $site_4_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame26" vTcl:WidgetProc "Toplevel355PP" 1
    set site_5_0 $site_4_0.cpd74
    button $site_5_0.but75 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_5_0.but75" "Button5" vTcl:WidgetProc "Toplevel355PP" 1
    pack $site_5_0.but75 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    pack $site_4_0.cpd72 \
        -in $site_4_0 -anchor center -expand 1 -fill x -side left 
    ...
    vTcl:DefineAlias "$top.cpd72" "TitleFrame8" vTcl:WidgetProc "Toplevel355PP" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd72" "Entry235" vTcl:WidgetProc "Toplevel355PP" 1
    frame $site_4_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame27" vTcl:WidgetProc "Toplevel355PP" 1
    set site_5_0 $site_4_0.cpd74
    button $site_5_0.but75 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_5_0.but75" "Button6" vTcl:WidgetProc "Toplevel355PP" 1
    pack $site_5_0.but75 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    pack $site_4_0.cpd72 \
        -in $site_4_0 -anchor center -expand 1 -fill x -side left 
    ...
    vTcl:DefineAlias "$top.fra74" "Frame9" vTcl:WidgetProc "Toplevel355PP" 1
    set site_3_0 $top.fra74
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label355PP_01" vTcl:WidgetProc "Toplevel355PP" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry355PP_01" vTcl:WidgetProc "Toplevel355PP" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label355PP_02" vTcl:WidgetProc "Toplevel355PP" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry355PP_02" vTcl:WidgetProc "Toplevel355PP" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label355PP_03" vTcl:WidgetProc "Toplevel355PP" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry355PP_03" vTcl:WidgetProc "Toplevel355PP" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label355PP_04" vTcl:WidgetProc "Toplevel355PP" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry355PP_04" vTcl:WidgetProc "Toplevel355PP" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.cpd76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd76" "Frame13" vTcl:WidgetProc "Toplevel355PP" 1
    set site_3_0 $top.cpd76
    TitleFrame $site_3_0.cpd72 \
        -ipad 0 -text Channel 
    vTcl:DefineAlias "$site_3_0.cpd72" "TitleFrame6" vTcl:WidgetProc "Toplevel355PP" 1
    ...
    frame $site_5_0.fra73 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra73" "Frame14" vTcl:WidgetProc "Toplevel355PP" 1
    set site_6_0 $site_5_0.fra73
...
global FlatEarthChannel PolarType
...
if {$PolarType == "pp3"} {
    ...
    set FlatEarthSlaveFile "$FlatEarthSlaveDirInput/s11.bin"
        ...
        -text {Ch 1} -value Ch1 -variable FlatEarthChannel 
    vTcl:DefineAlias "$site_6_0.rad75" "Radiobutton8" vTcl:WidgetProc "Toplevel355PP" 1
...
if {$PolarType == "pp3"} {
    ...
    set FlatEarthSlaveFile "$FlatEarthSlaveDirInput/s22.bin"
        ...
        -text {Ch 2} -value Ch2 -variable FlatEarthChannel 
    vTcl:DefineAlias "$site_6_0.cpd76" "Radiobutton9" vTcl:WidgetProc "Toplevel355PP" 1
    pack $site_6_0.rad75 \
    ...
    frame $site_3_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd73" "Frame15" vTcl:WidgetProc "Toplevel355PP" 1
    set site_4_0 $site_3_0.cpd73
    frame $site_4_0.fra67 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra67" "Frame16" vTcl:WidgetProc "Toplevel355PP" 1
    set site_5_0 $site_4_0.fra67
    label $site_5_0.lab68 \
        -text {Window Size ( Row )} 
    vTcl:DefineAlias "$site_5_0.lab68" "Label5" vTcl:WidgetProc "Toplevel355PP" 1
    entry $site_5_0.ent69 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable FlatEarthNwinRow -width 5 
    vTcl:DefineAlias "$site_5_0.ent69" "Entry5" vTcl:WidgetProc "Toplevel355PP" 1
    pack $site_5_0.lab68 \
    ...
    frame $site_4_0.cpd70 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd70" "Frame17" vTcl:WidgetProc "Toplevel355PP" 1
    set site_5_0 $site_4_0.cpd70
    label $site_5_0.lab68 \
        -text {Window Size ( Col )} 
    vTcl:DefineAlias "$site_5_0.lab68" "Label6" vTcl:WidgetProc "Toplevel355PP" 1
    entry $site_5_0.ent69 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable FlatEarthNwinCol -width 5 
    vTcl:DefineAlias "$site_5_0.ent69" "Entry6" vTcl:WidgetProc "Toplevel355PP" 1
    pack $site_5_0.lab68 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.ent69 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 10 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd77" "TitleFrame4" vTcl:WidgetProc "Toplevel355PP" 1
    ...
    frame $site_5_0.fra73 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra73" "Frame5" vTcl:WidgetProc "Toplevel355PP" 1
    set site_6_0 $site_5_0.fra73
    radiobutton $site_6_0.rad75 \
        -text {real ( deg )} -value realdeg -variable FlatEarthFormat 
    vTcl:DefineAlias "$site_6_0.rad75" "Radiobutton4" vTcl:WidgetProc "Toplevel355PP" 1
    radiobutton $site_6_0.cpd76 \
        -text {real ( rad )} -value realrad -variable FlatEarthFormat 
    vTcl:DefineAlias "$site_6_0.cpd76" "Radiobutton5" vTcl:WidgetProc "Toplevel355PP" 1
    pack $site_6_0.rad75 \
    ...
    frame $site_5_0.cpd66 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd66" "Frame6" vTcl:WidgetProc "Toplevel355PP" 1
    set site_6_0 $site_5_0.cpd66
    radiobutton $site_6_0.cpd77 \
        -text {cmplx ( cos, sin )} -value cmplx -variable FlatEarthFormat 
    vTcl:DefineAlias "$site_6_0.cpd77" "Radiobutton11" vTcl:WidgetProc "Toplevel355PP" 1
    pack $site_6_0.cpd77 \
    ...
    pack $site_5_0.cpd66 \
        -in $site_5_0 -anchor center -expand 0 -fill x -side top 
    pack $site_3_0.cpd72 \
        -in $site_3_0 -anchor center -expand 1 -fill none -ipadx 15 \
        -side left 
    pack $site_3_0.cpd73 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    pack $site_3_0.cpd77 \
    ...
    vTcl:DefineAlias "$top.fra83" "Frame20" vTcl:WidgetProc "Toplevel355PP" 1
...
if {"$VarWarning"=="ok"} {
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel355PP); TextEditorRunTrace "Close Window POLinSAR Flat Earth Estimation" "b"}
    }
}} \
        -cursor {} -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel355PP" 1
    ...
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel355PP" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel355PP); TextEditorRunTrace "Close Window POLinSAR Flat Earth Estimation" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel355PP" 1
