...
proc vTcl:project:info {} {
    ...
    set site_10_0 $site_9_0.fra84
    namespace eval ::widgets::$site_10_0.cpd80 {
        array set save {-text 1 -variable 1}
    }
    namespace eval ::widgets::$site_9_0.cpd71 {
        array set save {-height 1 -relief 1 -width 1}
    ...
    namespace eval ::vTcl::modules::main {
        set procs {
            ...
            vTclWindow.
            vTclWindow.top330
            CmplxPlaneCloseFiles
            CmplxPlaneOpenFiles
            CmplxPlaneExtract
            CmplxPlaneInputFile
            CmplxPlaneExtractPlot
...
#############################################################################
## Procedure:  CmplxPlaneCloseFiles

proc ::CmplxPlaneCloseFiles {} {
...
set CB_VV .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd73.fra84.cpd80
set CB_HHpVV .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd75.cpd71.cpd75
set CB_HHmVV .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd72.cpd71.cpd78
set CB_HVpVH .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd73.cpd71.cpd81
set CB_RR .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd75.cpd72.cpd76
set CB_LR .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd72.cpd73.cpd79 
set CB_LL .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd73.cpd73.cpd82
set CB_Opt1 .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd75.cpd89.cpd76
set CB_Opt2 .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd72.cpd90.cpd76
set CB_Opt3 .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd73.cpd91.cpd76
set CB_NR1 .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd75.cpd67.cpd76
set CB_NR2 .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd72.cpd77.cpd76
set CB_NR3 .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd73.cpd83.cpd76
set CB_PDH .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd75.cpd68.cpd76 
set CB_PDL .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd72.cpd78.cpd76
set CB_MaxMag .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd75.cpd69.cpd76
set CB_MinMag .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd72.cpd79.cpd76
set CB_MaxPha .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd75.cpd70.cpd76
set CB_MinPha .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd72.cpd80.cpd76
set CB_MagHigh .top330.fra71.fra72.cpd77.f.cpd85.cpd86.cpd75.cpd73.cpd76
...
if {$CmplxPlaneExecFid != "" } {
    ...
    $CB_HH configure -state disable; $CB_HV configure -state disable; $CB_VV configure -state disable;
    $CB_HHpVV configure -state disable; $CB_HHmVV configure -state disable; $CB_HVpVH configure -state disable;
    $CB_RR configure -state disable; $CB_LR configure -state disable; $CB_LL configure -state disable;
    $CB_Opt1 configure -state disable; $CB_Opt2 configure -state disable; $CB_Opt3 configure -state disable;
    $CB_NR1 configure -state disable; $CB_NR2 configure -state disable; $CB_NR3 configure -state disable;
...
#############################################################################
## Procedure:  CmplxPlaneOpenFiles

proc ::CmplxPlaneOpenFiles {} {
...
if {$CmplxPlaneAvgCoh == 0} {
    ...
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_HH.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "HH"
        set CmplxPlaneHH 1; $CB_HH configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_HV.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "HV"
        set CmplxPlaneHV 1; $CB_HV configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_VV.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "VV"
        set CmplxPlaneVV 1; $CB_VV configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_HHpVV.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "HHpVV"
        set CmplxPlaneHHpVV 1; $CB_HHpVV configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_HHmVV.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "HHmVV"
        set CmplxPlaneHHmVV 1; $CB_HHmVV configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_HVpVH.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "HVpVH"
        set CmplxPlaneHVpVH 1; $CB_HVpVH configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_RR.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "RR"
        set CmplxPlaneRR 1; $CB_RR configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_LR.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "LR"
        set CmplxPlaneLR 1; $CB_LR configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_LL.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "LL"
        set CmplxPlaneLL 1; $CB_LL configure -state normal
        incr CmplxPlaneNopen
        }
    ...
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_Opt3.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "Opt3"
        set CmplxPlaneOpt3 1; $CB_Opt3 configure -state normal
        incr CmplxPlaneNopen
        }
    ...
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_Opt_NR3.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "NR3"
        set CmplxPlaneNR3 1; $CB_NR3 configure -state normal
        incr CmplxPlaneNopen
        }
    ...
    set CmplxPlaneNopen 0
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_avg_HH.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "HH"
        set CmplxPlaneHH 1; $CB_HH configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_avg_HV.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "HV"
        set CmplxPlaneHV 1; $CB_HV configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_avg_VV.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "VV"
        set CmplxPlaneVV 1; $CB_VV configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_avg_HHpVV.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "HHpVV"
        set CmplxPlaneHHpVV 1; $CB_HHpVV configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_avg_HHmVV.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "HHmVV"
        set CmplxPlaneHHmVV 1; $CB_HHmVV configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_avg_HVpVH.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "HVpVH"
        set CmplxPlaneHVpVH 1; $CB_HVpVH configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_avg_RR.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "RR"
        set CmplxPlaneRR 1; $CB_RR configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_avg_LR.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "LR"
        set CmplxPlaneLR 1; $CB_LR configure -state normal
        incr CmplxPlaneNopen
        }
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_avg_LL.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "LL"
        set CmplxPlaneLL 1; $CB_LL configure -state normal
        incr CmplxPlaneNopen
        }
    ...
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_avg_Opt3.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "Opt3"
        set CmplxPlaneOpt3 1; $CB_Opt3 configure -state normal
        incr CmplxPlaneNopen
        }
    ...
    if [file exists "$CmplxPlaneDirInput/cmplx_coh_avg_Opt_NR3.bin"] {
        set CmplxPlaneTitle($CmplxPlaneNopen) "NR3"
        set CmplxPlaneNR3 1; $CB_NR3 configure -state normal
        incr CmplxPlaneNopen
        }
...
#############################################################################
## Procedure:  CmplxPlaneExtract

proc ::CmplxPlaneExtract {} {
...
set config 0
if {$CmplxPlaneHH == 1} { incr config }
if {$CmplxPlaneHV == 1} { incr config }
if {$CmplxPlaneVV == 1} { incr config }
if {$CmplxPlaneHHpVV == 1} { incr config }
if {$CmplxPlaneHHmVV == 1} { incr config }
if {$CmplxPlaneHVpVH == 1} { incr config }
if {$CmplxPlaneRR == 1} { incr config }
if {$CmplxPlaneLR == 1} { incr config }
if {$CmplxPlaneLL == 1} { incr config }
if {$CmplxPlaneOpt1 == 1} { incr config }
if {$CmplxPlaneOpt2 == 1} { incr config }
if {$CmplxPlaneOpt3 == 1} { incr config }
if {$CmplxPlaneNR1 == 1} { incr config }
if {$CmplxPlaneNR2 == 1} { incr config }
if {$CmplxPlaneNR3 == 1} { incr config }
...
if {$CmplxPlaneExecFid != ""} {
    ...
    set CmplxPlaneN 0
    if {$CmplxPlaneHH == 1} {
        set CmplxPlaneTitle($CmplxPlaneN) "HH"
        incr CmplxPlaneN
        }
    if {$CmplxPlaneHV == 1} {
        set CmplxPlaneTitle($CmplxPlaneN) "HV"
        incr CmplxPlaneN
        }
    if {$CmplxPlaneVV == 1} {
        set CmplxPlaneTitle($CmplxPlaneN) "VV"
        incr CmplxPlaneN
        }
    if {$CmplxPlaneHHpVV == 1} {
        set CmplxPlaneTitle($CmplxPlaneN) "HH + VV"
        incr CmplxPlaneN
        }
    if {$CmplxPlaneHHmVV == 1} {
        set CmplxPlaneTitle($CmplxPlaneN) "HH - VV"
        incr CmplxPlaneN
        }
    if {$CmplxPlaneHVpVH == 1} {
        set CmplxPlaneTitle($CmplxPlaneN) "HV + VH"
        incr CmplxPlaneN
        }
    if {$CmplxPlaneRR == 1} {
        set CmplxPlaneTitle($CmplxPlaneN) "RR"
        incr CmplxPlaneN
        }
    if {$CmplxPlaneLR == 1} {
        set CmplxPlaneTitle($CmplxPlaneN) "LR"
        incr CmplxPlaneN
        }
    if {$CmplxPlaneLL == 1} {
        set CmplxPlaneTitle($CmplxPlaneN) "LL"
        incr CmplxPlaneN
        }
    if {$CmplxPlaneOpt1 == 1} {
    ...
    if {$CmplxPlaneOpt3 == 1} {
        set CmplxPlaneTitle($CmplxPlaneN) "Opt 3"
        incr CmplxPlaneN
        }
    if {$CmplxPlaneNR1 == 1} {
    ...
    if {$CmplxPlaneNR3 == 1} {
        set CmplxPlaneTitle($CmplxPlaneN) "NR 3"
        incr CmplxPlaneN
        }
    if {$CmplxPlanePDH == 1} {
    ...
    for {set i 0} {$i < $CmplxPlaneN } {incr i} { CmplxPlaneInputFile $CmplxPlaneTitle($i) $i }
...
#############################################################################
## Procedure:  CmplxPlaneInputFile

proc ::CmplxPlaneInputFile {namefile numfile} {
global CmplxPlaneExecFid CmplxPlaneLabel

if {$CmplxPlaneExecFid != ""} {
    set ProgressLine ""
    set nf $namefile
    if {$namefile == "HH + VV"} { set nf "HHpVV" } 
    if {$namefile == "HH - VV"} { set nf "HHmVV" } 
    if {$namefile == "HV + VH"} { set nf "HVpVH" } 
    if {$namefile == "Opt 1"} { set nf "Opt1" } 
    if {$namefile == "Opt 2"} { set nf "Opt2" } 
    if {$namefile == "Opt 3"} { set nf "Opt3" } 
    if {$namefile == "NR 1"} { set nf "NR1" } 
    if {$namefile == "NR 2"} { set nf "NR2" } 
    if {$namefile == "NR 3"} { set nf "NR3" } 
...
#############################################################################
## Procedure:  CmplxPlaneExtractPlot

proc ::CmplxPlaneExtractPlot {} {
...
if {$CmplxPlaneExecFid != ""} { CmplxPlaneExtract }
...
if {$CmplxPlaneExtractVar == "true"} {
    ...
    .top330.fra71.fra72.fra79.but81 configure -state normal
    .top330.fra71.fra72.fra79.but83 configure -state normal
    .top330.fra71.fra72.fra79.but71 configure -state normal
...
#############################################################################
## Procedure:  CmplxPlaneExtractPlotThumb

proc ::CmplxPlaneExtractPlotThumb {} {
global CmplxPlaneExecFid GnuplotPipeFid
global GnuOutputFormat GnuOutputFile GnuplotPipeCmplxPlane
global CmplxPlaneTitle CmplxPlaneLabel
global CmplxPlaneExtractVar
...
proc vTclWindow.top330 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel330" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.tit73" "TitleFrame1" vTcl:WidgetProc "Toplevel330" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd75" "Entry1" vTcl:WidgetProc "Toplevel330" 1
...
if [file exists "$CmplxPlaneDirInput/config.txt"] {
            ...
            if {$VarWarning == "ok"} {
                ...
                if {$FileName != ""} {
                  ...
                  if {$bmphdr == "OK"} {
                    ...
                    set GnuplotPipeFid ""
                    .top330.fra71.fra72.fra79.but81 configure -state disable
                    .top330.fra71.fra72.fra79.but83 configure -state disable
                    .top330.fra71.fra72.fra79.but71 configure -state disable
                    .top330.fra71.fra72.fra79.but66 configure -state disable
    ...
    tkwait variable VarError
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_4_0.but76" "Button2" vTcl:WidgetProc "Toplevel330" 1
    pack $site_4_0.cpd75 \
    ...
    vTcl:DefineAlias "$top.fra71" "Frame3" vTcl:WidgetProc "Toplevel330" 1
    set site_3_0 $top.fra71
    frame $site_3_0.cpd78 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd78" "Frame8" vTcl:WidgetProc "Toplevel330" 1
    set site_4_0 $site_3_0.cpd78
    canvas $site_4_0.can73 \
        -borderwidth 2 -closeenough 1.0 -height 200 -relief ridge -width 200 
    vTcl:DefineAlias "$site_4_0.can73" "CANVASLENSCMPLXPLANE" vTcl:WidgetProc "Toplevel330" 1
    bind $site_4_0.can73 <Button-1> {
        MouseButtonDownLens %x %y
    }
    TitleFrame $site_4_0.cpd80 \
        -ipad 2 -text {Mouse Position} 
    vTcl:DefineAlias "$site_4_0.cpd80" "TitleFrame3" vTcl:WidgetProc "Toplevel330" 1
    ...
    vTcl:DefineAlias "$site_6_0.cpd75" "Frame29" vTcl:WidgetProc "Toplevel330" 1
    set site_7_0 $site_6_0.cpd75
    frame $site_7_0.fra84 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.fra84" "Frame30" vTcl:WidgetProc "Toplevel330" 1
    set site_8_0 $site_7_0.fra84
    label $site_8_0.lab76 \
        -relief groove -text X -width 2 
    vTcl:DefineAlias "$site_8_0.lab76" "Label27" vTcl:WidgetProc "Toplevel330" 1
    entry $site_8_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable BMPMouseX -width 4 
    vTcl:DefineAlias "$site_8_0.ent78" "Entry52" vTcl:WidgetProc "Toplevel330" 1
    pack $site_8_0.lab76 \
    ...
    frame $site_7_0.fra85 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.fra85" "Frame31" vTcl:WidgetProc "Toplevel330" 1
    set site_8_0 $site_7_0.fra85
    label $site_8_0.lab76 \
        -relief groove -text Y -width 2 
    vTcl:DefineAlias "$site_8_0.lab76" "Label28" vTcl:WidgetProc "Toplevel330" 1
    entry $site_8_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable BMPMouseY -width 4 
    vTcl:DefineAlias "$site_8_0.ent78" "Entry53" vTcl:WidgetProc "Toplevel330" 1
    pack $site_8_0.lab76 \
        -in $site_8_0 -anchor center -expand 1 -fill none -side left 
    pack $site_8_0.ent78 \
        -in $site_8_0 -anchor center -expand 1 -fill none -side right 
    frame $site_7_0.cpd75 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.cpd75" "Frame32" vTcl:WidgetProc "Toplevel330" 1
    set site_8_0 $site_7_0.cpd75
    label $site_8_0.lab76 \
        -relief groove -text Val -width 4 
    vTcl:DefineAlias "$site_8_0.lab76" "Label29" vTcl:WidgetProc "Toplevel330" 1
    entry $site_8_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable BMPValue -width 6 
    vTcl:DefineAlias "$site_8_0.ent78" "Entry54" vTcl:WidgetProc "Toplevel330" 1
    pack $site_8_0.lab76 \
        -in $site_8_0 -anchor center -expand 1 -fill none -side left 
    pack $site_8_0.ent78 \
        -in $site_8_0 -anchor center -expand 1 -fill none -side right 
    ...
    vTcl:DefineAlias "$site_4_0.cpd75" "TitleFrame8" vTcl:WidgetProc "Toplevel330" 1
    ...
    frame $site_6_0.cpd75 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd75" "Frame45" vTcl:WidgetProc "Toplevel330" 1
    set site_7_0 $site_6_0.cpd75
    frame $site_7_0.fra84 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.fra84" "Frame46" vTcl:WidgetProc "Toplevel330" 1
    set site_8_0 $site_7_0.fra84
    label $site_8_0.lab76 \
        -relief groove -text X -width 2 
    vTcl:DefineAlias "$site_8_0.lab76" "Label33" vTcl:WidgetProc "Toplevel330" 1
    entry $site_8_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable BMPCmplxPlaneX -width 5 
    vTcl:DefineAlias "$site_8_0.ent78" "Entry58" vTcl:WidgetProc "Toplevel330" 1
    pack $site_8_0.lab76 \
        -in $site_8_0 -anchor center -expand 1 -fill none -side left 
    pack $site_8_0.ent78 \
        -in $site_8_0 -anchor center -expand 1 -fill none -side right 
    frame $site_7_0.fra85 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.fra85" "Frame47" vTcl:WidgetProc "Toplevel330" 1
    set site_8_0 $site_7_0.fra85
    label $site_8_0.lab76 \
        -relief groove -text Y -width 2 
    vTcl:DefineAlias "$site_8_0.lab76" "Label34" vTcl:WidgetProc "Toplevel330" 1
    entry $site_8_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable BMPCmplxPlaneY -width 5 
    vTcl:DefineAlias "$site_8_0.ent78" "Entry59" vTcl:WidgetProc "Toplevel330" 1
    pack $site_8_0.lab76 \
        -in $site_8_0 -anchor center -expand 1 -fill none -side left 
    pack $site_8_0.ent78 \
        -in $site_8_0 -anchor center -expand 1 -fill none -side right 
    frame $site_7_0.cpd75 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.cpd75" "Frame48" vTcl:WidgetProc "Toplevel330" 1
    set site_8_0 $site_7_0.cpd75
    label $site_8_0.lab76 \
        -relief groove -text Val -width 4 
    vTcl:DefineAlias "$site_8_0.lab76" "Label35" vTcl:WidgetProc "Toplevel330" 1
    entry $site_8_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable BMPCmplxPlaneValue -width 6 
    vTcl:DefineAlias "$site_8_0.ent78" "Entry60" vTcl:WidgetProc "Toplevel330" 1
    pack $site_8_0.lab76 \
        -in $site_8_0 -anchor center -expand 1 -fill none -side left 
    pack $site_8_0.ent78 \
        -in $site_8_0 -anchor center -expand 1 -fill none -side right 
    ...
    vTcl:DefineAlias "$site_3_0.fra72" "Frame4" vTcl:WidgetProc "Toplevel330" 1
    set site_4_0 $site_3_0.fra72
    TitleFrame $site_4_0.cpd77 \
        -ipad 1 -text Representation 
    vTcl:DefineAlias "$site_4_0.cpd77" "TitleFrame6" vTcl:WidgetProc "Toplevel330" 1
    ...
    frame $site_6_0.cpd85 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd85" "Frame1" vTcl:WidgetProc "Toplevel330" 1
    set site_7_0 $site_6_0.cpd85
    frame $site_7_0.cpd87 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.cpd87" "Frame2" vTcl:WidgetProc "Toplevel330" 1
    set site_8_0 $site_7_0.cpd87
    checkbutton $site_8_0.che88 \
        -borderwidth 0 -command {CmplxPlaneCloseFiles
CmplxPlaneOpenFiles} \
        -text {Averaged Coherences} -variable CmplxPlaneAvgCoh 
    vTcl:DefineAlias "$site_8_0.che88" "Checkbutton330_0" vTcl:WidgetProc "Toplevel330" 1
    pack $site_8_0.che88 \
    ...
    frame $site_8_0.cpd75 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd75" "Frame52" vTcl:WidgetProc "Toplevel330" 1
    set site_9_0 $site_8_0.cpd75
    frame $site_9_0.fra84 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.fra84" "Frame53" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.fra84
    checkbutton $site_10_0.che74 \
        -text HH -variable CmplxPlaneHH 
    vTcl:DefineAlias "$site_10_0.che74" "Checkbutton330_1" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.che74 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd71 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd71" "Frame54" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd71
    checkbutton $site_10_0.cpd75 \
        -text {HH + VV} -variable CmplxPlaneHHpVV 
    vTcl:DefineAlias "$site_10_0.cpd75" "Checkbutton330_4" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd75 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd72 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd72" "Frame55" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd72
    checkbutton $site_10_0.cpd76 \
        -text RR -variable CmplxPlaneRR 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_7" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd89 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd89" "Frame64" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd89
    checkbutton $site_10_0.cpd76 \
        -text {Opt 1} -variable CmplxPlaneOpt1 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_10" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd67 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd67" "Frame67" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd67
    checkbutton $site_10_0.cpd76 \
        -text {NR 1} -variable CmplxPlaneNR1 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_13" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd68 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd68" "Frame68" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd68
    checkbutton $site_10_0.cpd76 \
        -text {PD High} -variable CmplxPlanePDH 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_16" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd69 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd69" "Frame69" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd69
    checkbutton $site_10_0.cpd76 \
        -text {Max Mag} -variable CmplxPlaneMaxMag 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_18" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd70 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd70" "Frame70" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd70
    checkbutton $site_10_0.cpd76 \
        -text {Max Pha} -variable CmplxPlaneMaxPha 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_20" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd73 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd73" "Frame71" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd73
    checkbutton $site_10_0.cpd76 \
        -text {Mag High} -variable CmplxPlaneMagHigh 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_22" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd74 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd74" "Frame72" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd74
    checkbutton $site_10_0.cpd76 \
        -text {Pha High} -variable CmplxPlanePhaHigh 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_24" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    pack $site_9_0.fra84 \
    ...
    frame $site_8_0.cpd72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd72" "Frame56" vTcl:WidgetProc "Toplevel330" 1
    set site_9_0 $site_8_0.cpd72
    frame $site_9_0.fra84 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.fra84" "Frame57" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.fra84
    checkbutton $site_10_0.cpd77 \
        -text HV -variable CmplxPlaneHV 
    vTcl:DefineAlias "$site_10_0.cpd77" "Checkbutton330_2" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd77 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd71 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd71" "Frame58" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd71
    checkbutton $site_10_0.cpd78 \
        -text {HH - VV} -variable CmplxPlaneHHmVV 
    vTcl:DefineAlias "$site_10_0.cpd78" "Checkbutton330_5" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd78 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd73 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd73" "Frame59" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd73
    checkbutton $site_10_0.cpd79 \
        -text LR -variable CmplxPlaneLR 
    vTcl:DefineAlias "$site_10_0.cpd79" "Checkbutton330_8" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd79 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd90 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd90" "Frame65" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd90
    checkbutton $site_10_0.cpd76 \
        -text {Opt 2} -variable CmplxPlaneOpt2 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_11" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd77 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd77" "Frame73" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd77
    checkbutton $site_10_0.cpd76 \
        -text {NR 2} -variable CmplxPlaneNR2 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_14" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd78 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd78" "Frame74" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd78
    checkbutton $site_10_0.cpd76 \
        -text {PD Low} -variable CmplxPlanePDL 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_17" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd79 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd79" "Frame75" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd79
    checkbutton $site_10_0.cpd76 \
        -text {Min Mag} -variable CmplxPlaneMinMag 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_19" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd80 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd80" "Frame76" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd80
    checkbutton $site_10_0.cpd76 \
        -text {Min Pha} -variable CmplxPlaneMinPha 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_21" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd81 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd81" "Frame77" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd81
    checkbutton $site_10_0.cpd76 \
        -text {Mag Low} -variable CmplxPlaneMagLow 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_23" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd82 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd82" "Frame78" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd82
    checkbutton $site_10_0.cpd76 \
        -text {Pha Low} -variable CmplxPlanePhaLow 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_25" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    pack $site_9_0.fra84 \
        -in $site_9_0 -anchor center -expand 0 -fill x -side top 
    ...
    frame $site_8_0.cpd73 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd73" "Frame60" vTcl:WidgetProc "Toplevel330" 1
    set site_9_0 $site_8_0.cpd73
    frame $site_9_0.fra84 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.fra84" "Frame61" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.fra84
    checkbutton $site_10_0.cpd80 \
        -text VV -variable CmplxPlaneVV 
    vTcl:DefineAlias "$site_10_0.cpd80" "Checkbutton330_3" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd80 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd71 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd71" "Frame62" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd71
    checkbutton $site_10_0.cpd81 \
        -text {HV + VH} -variable CmplxPlaneHVpVH 
    vTcl:DefineAlias "$site_10_0.cpd81" "Checkbutton330_6" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd81 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd73 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd73" "Frame63" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd73
    checkbutton $site_10_0.cpd82 \
        -text LL -variable CmplxPlaneLL 
    vTcl:DefineAlias "$site_10_0.cpd82" "Checkbutton330_9" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd82 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd91 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd91" "Frame66" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd91
    checkbutton $site_10_0.cpd76 \
        -text {Opt 3} -variable CmplxPlaneOpt3 
    vTcl:DefineAlias "$site_10_0.cpd76" "Checkbutton330_12" vTcl:WidgetProc "Toplevel330" 1
    pack $site_10_0.cpd76 \
        -in $site_10_0 -anchor center -expand 0 -fill none -side left 
    frame $site_9_0.cpd83 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_9_0.cpd83" "Frame79" vTcl:WidgetProc "Toplevel330" 1
    set site_10_0 $site_9_0.cpd83
    checkbutton $site_10_0.cpd76 \
        -text {NR 3} -variable CmplxPlaneNR3 
    ...
    vTcl:DefineAlias "$site_7_0.cpd74" "Frame6" vTcl:WidgetProc "Toplevel330" 1
    set site_8_0 $site_7_0.cpd74
    radiobutton $site_8_0.rad75 \
        \
        -command {$widget(Label330_1) configure -state disable
$widget(Entry330_1) configure -state disable} \
        -text Point -value point -variable CmplxPlaneRepresentation 
    vTcl:DefineAlias "$site_8_0.rad75" "Radiobutton1" vTcl:WidgetProc "Toplevel330" 1
    radiobutton $site_8_0.rad76 \
        \
        -command {$widget(Label330_1) configure -state normal
$widget(Entry330_1) configure -state normal} \
        -text Area -value area -variable CmplxPlaneRepresentation 
    vTcl:DefineAlias "$site_8_0.rad76" "Radiobutton2" vTcl:WidgetProc "Toplevel330" 1
    frame $site_8_0.fra77 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.fra77" "Frame9" vTcl:WidgetProc "Toplevel330" 1
    set site_9_0 $site_8_0.fra77
    label $site_9_0.lab78 \
        -text {Area Size (pix)} 
    vTcl:DefineAlias "$site_9_0.lab78" "Label330_1" vTcl:WidgetProc "Toplevel330" 1
    ...
    vTcl:DefineAlias "$site_9_0.ent79" "Entry330_1" vTcl:WidgetProc "Toplevel330" 1
    pack $site_9_0.lab78 \
    ...
    frame $site_4_0.fra79 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra79" "Frame5" vTcl:WidgetProc "Toplevel330" 1
    set site_5_0 $site_4_0.fra79
...
set plot2(lastY) 0} \
    ...
    vTcl:DefineAlias "$site_5_0.but80" "Button1" vTcl:WidgetProc "Toplevel330" 1
...
if {$GnuplotPipeCmplxPlane != ""} {
    ...
    vTcl:DefineAlias "$site_5_0.but81" "Button330_1" vTcl:WidgetProc "Toplevel330" 1
...
if {$GnuplotPipeFid == ""} {
    ...
    WidgetShowFromWidget $widget(Toplevel330) $widget(Toplevel456); TextEditorRunTrace "Open Window Save Display 1" "b"
    tkwait variable VarSaveGnuPlotFile
    }} \
        -image [vTcl:image:get_image [file join . GUI Images SaveFile.gif]] \
        -pady 0 
    vTcl:DefineAlias "$site_5_0.but83" "Button330_2" vTcl:WidgetProc "Toplevel330" 1
...
Gimp $TMPGnuPlotTk1} \
        ...
        -pady 0 -text { } 
    vTcl:DefineAlias "$site_5_0.but66" "Button330_4" vTcl:WidgetProc "Toplevel330" 1
...
.top330.fra71.fra72.fra79.but71 configure -state disable} \
    ...
    vTcl:DefineAlias "$site_5_0.but71" "Button330_3" vTcl:WidgetProc "Toplevel330" 1
    pack $site_5_0.but80 \
    ...
    vTcl:DefineAlias "$top.fra92" "Frame20" vTcl:WidgetProc "Toplevel330" 1
    ...
    button $site_3_0.but23 \
        ...
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel330" 1
...
set ProgressLine "0"; update
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button330_0" vTcl:WidgetProc "Toplevel330" 1
