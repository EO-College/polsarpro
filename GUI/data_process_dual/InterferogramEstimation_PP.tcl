...
proc vTcl:project:info {} {
    ...
    set site_7_0 [$site_5_0.cpd68 getframe]
    namespace eval ::widgets::$site_7_0 {
        array set save {}
    }
    set site_7_0 $site_7_0
    namespace eval ::widgets::$site_7_0.rad74 {
...
proc vTclWindow.top315PP {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel315PP" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd71 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd71" "Frame2" vTcl:WidgetProc "Toplevel315PP" 1
    set site_3_0 $top.cpd71
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Master Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame315PP_1" vTcl:WidgetProc "Toplevel315PP" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry315PP_01" vTcl:WidgetProc "Toplevel315PP" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame13" vTcl:WidgetProc "Toplevel315PP" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd86 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd86" "Button34" vTcl:WidgetProc "Toplevel315PP" 1
    pack $site_6_0.cpd86 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd81" "TitleFrame315PP_2" vTcl:WidgetProc "Toplevel315PP" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry315PP_02" vTcl:WidgetProc "Toplevel315PP" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel315PP" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd86 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd86" "Button35" vTcl:WidgetProc "Toplevel315PP" 1
    pack $site_6_0.cpd86 \
        -in $site_6_0 -anchor center -expand 1 -fill none -side top 
    pack $site_5_0.cpd85 \
        -in $site_5_0 -anchor center -expand 1 -fill x -side left 
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame315PP_3" vTcl:WidgetProc "Toplevel315PP" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry315PP_03" vTcl:WidgetProc "Toplevel315PP" 1
    frame $site_5_0.cpd95 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd95" "Frame1" vTcl:WidgetProc "Toplevel315PP" 1
    set site_6_0 $site_5_0.cpd95
    label $site_6_0.cpd97 \
        -text / 
    vTcl:DefineAlias "$site_6_0.cpd97" "Label315PP_01" vTcl:WidgetProc "Toplevel315PP" 1
    entry $site_6_0.ent94 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable CmplxCohOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.ent94" "Entry315PP_04" vTcl:WidgetProc "Toplevel315PP" 1
    pack $site_6_0.cpd97 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame14" vTcl:WidgetProc "Toplevel315PP" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != ""} {
    ...
    vTcl:DefineAlias "$site_6_0.cpd72" "Button315PP_01" vTcl:WidgetProc "Toplevel315PP" 1
    ...
    vTcl:DefineAlias "$top.fra29" "Frame9" vTcl:WidgetProc "Toplevel315PP" 1
    set site_3_0 $top.fra29
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel315PP" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel315PP" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel315PP" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel315PP" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel315PP" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel315PP" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel315PP" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel315PP" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.fra30 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra30" "Frame149" vTcl:WidgetProc "Toplevel315PP" 1
    set site_3_0 $top.fra30
    frame $site_3_0.fra22 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra22" "Frame248" vTcl:WidgetProc "Toplevel315PP" 1
    set site_4_0 $site_3_0.fra22
    frame $site_4_0.cpd70 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd70" "Frame4" vTcl:WidgetProc "Toplevel315PP" 1
    set site_5_0 $site_4_0.cpd70
    TitleFrame $site_5_0.cpd68 \
        -text {Image 1} 
    vTcl:DefineAlias "$site_5_0.cpd68" "TitleFrame7" vTcl:WidgetProc "Toplevel315PP" 1
    bind $site_5_0.cpd68 <Destroy> {
        Widget::destroy %W; rename %W {}
    }
    set site_7_0 [$site_5_0.cpd68 getframe]
    radiobutton $site_7_0.rad74 \
        -command {} -text {Ch 1} -value Ch1 -variable CmplxCohI1 
    vTcl:DefineAlias "$site_7_0.rad74" "Radiobutton4" vTcl:WidgetProc "Toplevel315PP" 1
    radiobutton $site_7_0.cpd75 \
        -command {} -text {Ch 2} -value Ch2 -variable CmplxCohI1 
    vTcl:DefineAlias "$site_7_0.cpd75" "Radiobutton9" vTcl:WidgetProc "Toplevel315PP" 1
    radiobutton $site_7_0.cpd77 \
        -command {} -text {Ch 1 + Ch 2} -value Ch1pCh2 -variable CmplxCohI1 
    vTcl:DefineAlias "$site_7_0.cpd77" "Radiobutton10" vTcl:WidgetProc "Toplevel315PP" 1
    radiobutton $site_7_0.cpd79 \
        -command {} -text {Ch 1 - Ch 2} -value Ch1mCh2 -variable CmplxCohI1 
    vTcl:DefineAlias "$site_7_0.cpd79" "Radiobutton12" vTcl:WidgetProc "Toplevel315PP" 1
    pack $site_7_0.rad74 \
    ...
    TitleFrame $site_5_0.cpd69 \
        -text {Image 2} 
    vTcl:DefineAlias "$site_5_0.cpd69" "TitleFrame8" vTcl:WidgetProc "Toplevel315PP" 1
    bind $site_5_0.cpd69 <Destroy> {
        Widget::destroy %W; rename %W {}
    }
    set site_7_0 [$site_5_0.cpd69 getframe]
    radiobutton $site_7_0.rad74 \
        -command {} -text {Ch 1} -value Ch1 -variable CmplxCohI2 
    vTcl:DefineAlias "$site_7_0.rad74" "Radiobutton13" vTcl:WidgetProc "Toplevel315PP" 1
    radiobutton $site_7_0.cpd75 \
        -command {} -text {Ch 2} -value Ch2 -variable CmplxCohI2 
    vTcl:DefineAlias "$site_7_0.cpd75" "Radiobutton17" vTcl:WidgetProc "Toplevel315PP" 1
    radiobutton $site_7_0.cpd77 \
        -command {} -text {Ch 1 + Ch 2} -value Ch1pCh2 -variable CmplxCohI2 
    vTcl:DefineAlias "$site_7_0.cpd77" "Radiobutton18" vTcl:WidgetProc "Toplevel315PP" 1
    radiobutton $site_7_0.cpd79 \
        -command {} -text {Ch 1 - Ch 2} -value Ch1mCh2 -variable CmplxCohI2 
    vTcl:DefineAlias "$site_7_0.cpd79" "Radiobutton19" vTcl:WidgetProc "Toplevel315PP" 1
    pack $site_7_0.rad74 \
        -in $site_7_0 -anchor center -expand 1 -fill none -side left 
    pack $site_7_0.cpd75 \
        -in $site_7_0 -anchor center -expand 1 -fill none -side left 
    ...
    pack $site_7_0.cpd79 \
        -in $site_7_0 -anchor center -expand 1 -fill none -side left 
    pack $site_5_0.cpd68 \
        -in $site_5_0 -anchor center -expand 1 -fill none -ipadx 10 -side top 
    pack $site_5_0.cpd69 \
        -in $site_5_0 -anchor center -expand 1 -fill none -ipadx 10 -side top 
    frame $site_4_0.fra25 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra25" "Frame249" vTcl:WidgetProc "Toplevel315PP" 1
    set site_5_0 $site_4_0.fra25
...
if {$CmplxCohAvg == "1" } {
    ...
    $widget(TitleFrame315PP_4) configure -state normal; $widget(TitleFrame315PP_4) configure -text "Averaging Window"
    $widget(Entry315PP_4) configure -state normal; $widget(Entry315PP_4) configure -disabledbackground #FFFFFF; $widget(Label315PP_4) configure -state normal 
    $widget(Entry315PP_5) configure -state normal; $widget(Entry315PP_5) configure -disabledbackground #FFFFFF; $widget(Label315PP_5) configure -state normal 
    } else {
    ...
    vTcl:DefineAlias "$site_5_0.che71" "Checkbutton5" vTcl:WidgetProc "Toplevel315PP" 1
    TitleFrame $site_5_0.cpd75 \
        -text {Averaging Window} 
    vTcl:DefineAlias "$site_5_0.cpd75" "TitleFrame315PP_4" vTcl:WidgetProc "Toplevel315PP" 1
    ...
    frame $site_7_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.cpd73" "Frame7" vTcl:WidgetProc "Toplevel315PP" 1
    set site_8_0 $site_7_0.cpd73
    label $site_8_0.cpd81 \
        -padx 1 -text Row 
    vTcl:DefineAlias "$site_8_0.cpd81" "Label315PP_4" vTcl:WidgetProc "Toplevel315PP" 1
    ...
    vTcl:DefineAlias "$site_8_0.cpd82" "Entry315PP_4" vTcl:WidgetProc "Toplevel315PP" 1
    pack $site_8_0.cpd81 \
    ...
    frame $site_7_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.cpd74" "Frame8" vTcl:WidgetProc "Toplevel315PP" 1
    set site_8_0 $site_7_0.cpd74
    label $site_8_0.cpd81 \
        -padx 1 -text Col 
    vTcl:DefineAlias "$site_8_0.cpd81" "Label315PP_5" vTcl:WidgetProc "Toplevel315PP" 1
    entry $site_8_0.cpd82 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #ff0000 -justify center \
        -state disabled -textvariable FiltCol -width 5 
    vTcl:DefineAlias "$site_8_0.cpd82" "Entry315PP_5" vTcl:WidgetProc "Toplevel315PP" 1
    pack $site_8_0.cpd81 \
        -in $site_8_0 -anchor center -expand 1 -fill none -side left 
    pack $site_8_0.cpd82 \
        -in $site_8_0 -anchor center -expand 1 -fill none -padx 10 -side left 
    ...
    vTcl:DefineAlias "$top.fra36" "Frame20" vTcl:WidgetProc "Toplevel315PP" 1
...
if {"$VarWarning"=="ok"} {
    ...
    if {$TestVarError == "ok"} {
        ...
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
        TextEditorRunTrace "Process The Function Soft/data_process_dual/interferogram_estimation_PP.exe" "k"
        if {$CmplxCohFonc == "SPP"} {
            TextEditorRunTrace "Arguments: -idm \x22$CmplxCohMasterDirInput\x22 -ids \x22$CmplxCohSlaveDirInput\x22 -od \x22$TMPDir\x22 -iodf SPPT4 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -im1 $CmplxCohI1 -im2 $CmplxCohI2 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/data_process_dual/interferogram_estimation_PP.exe -idm \x22$CmplxCohMasterDirInput\x22 -ids \x22$CmplxCohSlaveDirInput\x22 -od \x22$TMPDir\x22 -iodf SPPT4 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -im1 $CmplxCohI1 -im2 $CmplxCohI2 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            }
        if {$CmplxCohFonc == "T4"} {
            TextEditorRunTrace "Arguments: -id \x22$CmplxCohMasterDirInput\x22 -od \x22$TMPDir\x22 -iodf T4 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -im1 $CmplxCohI1 -im2 $CmplxCohI2 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/data_process_dual/interferogram_estimation_PP.exe -id \x22$CmplxCohMasterDirInput\x22 -od \x22$TMPDir\x22 -iodf T4 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -im1 $CmplxCohI1 -im2 $CmplxCohI2 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            }
        PsPprogressBar $f
        TextEditorRunTrace "Check RunTime Errors" "r"
        CheckRunTimeError
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel315PP); TextEditorRunTrace "Close Window Interferogram Estimation" "b"}
    }
}
}
}} \
        -cursor {} -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel315PP" 1
    ...
    button $site_3_0.but23 \
        ...
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel315PP" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel315PP); TextEditorRunTrace "Close Window Interferogram Estimation" "b"
set ProgressLine "0"; update
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel315PP" 1
