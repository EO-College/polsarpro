...
proc vTclWindow.top378 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel378" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd71 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd71" "Frame2" vTcl:WidgetProc "Toplevel378" 1
    set site_3_0 $top.cpd71
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Master Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame378_1" vTcl:WidgetProc "Toplevel378" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry378_01" vTcl:WidgetProc "Toplevel378" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame13" vTcl:WidgetProc "Toplevel378" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd86 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd86" "Button34" vTcl:WidgetProc "Toplevel378" 1
    pack $site_6_0.cpd86 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd81" "TitleFrame378_2" vTcl:WidgetProc "Toplevel378" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry378_02" vTcl:WidgetProc "Toplevel378" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel378" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd86 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd86" "Button35" vTcl:WidgetProc "Toplevel378" 1
    pack $site_6_0.cpd86 \
        -in $site_6_0 -anchor center -expand 1 -fill none -side top 
    pack $site_5_0.cpd85 \
        -in $site_5_0 -anchor center -expand 1 -fill x -side left 
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame378_3" vTcl:WidgetProc "Toplevel378" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry378_03" vTcl:WidgetProc "Toplevel378" 1
    frame $site_5_0.cpd95 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd95" "Frame1" vTcl:WidgetProc "Toplevel378" 1
    set site_6_0 $site_5_0.cpd95
    label $site_6_0.cpd97 \
        -text / 
    vTcl:DefineAlias "$site_6_0.cpd97" "Label378_01" vTcl:WidgetProc "Toplevel378" 1
    entry $site_6_0.ent94 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable RoOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.ent94" "Entry378_04" vTcl:WidgetProc "Toplevel378" 1
    pack $site_6_0.cpd97 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame14" vTcl:WidgetProc "Toplevel378" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != ""} {
    ...
    vTcl:DefineAlias "$site_6_0.cpd72" "Button378_01" vTcl:WidgetProc "Toplevel378" 1
    ...
    vTcl:DefineAlias "$top.fra29" "Frame9" vTcl:WidgetProc "Toplevel378" 1
    set site_3_0 $top.fra29
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel378" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel378" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel378" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel378" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel378" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel378" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel378" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel378" 1
    pack $site_3_0.lab57 \
    ...
    TitleFrame $top.cpd70 \
        -ipad 0 -text Master 
    vTcl:DefineAlias "$top.cpd70" "TitleFrame2" vTcl:WidgetProc "Toplevel378" 1
    ...
    frame $site_4_0.fra69 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra69" "Frame5" vTcl:WidgetProc "Toplevel378" 1
    set site_5_0 $site_4_0.fra69
    checkbutton $site_5_0.che71 \
        -text {Ro12 = ( HH1 , HV1 )} -variable Ro12 
    vTcl:DefineAlias "$site_5_0.che71" "Checkbutton378_1" vTcl:WidgetProc "Toplevel378" 1
    checkbutton $site_5_0.cpd72 \
        -text {Ro13 = ( HH1 , VV1 )} -variable Ro13 
    vTcl:DefineAlias "$site_5_0.cpd72" "Checkbutton378_2" vTcl:WidgetProc "Toplevel378" 1
    checkbutton $site_5_0.cpd73 \
        -text {Ro23 = ( HV1 , VV1 )} -variable Ro23 
    vTcl:DefineAlias "$site_5_0.cpd73" "Checkbutton378_3" vTcl:WidgetProc "Toplevel378" 1
    pack $site_5_0.che71 \
    ...
    TitleFrame $top.cpd66 \
        -ipad 0 -text Slave 
    vTcl:DefineAlias "$top.cpd66" "TitleFrame3" vTcl:WidgetProc "Toplevel378" 1
    ...
    frame $site_4_0.fra69 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra69" "Frame6" vTcl:WidgetProc "Toplevel378" 1
    set site_5_0 $site_4_0.fra69
    checkbutton $site_5_0.che71 \
        -text {Ro45 = ( HH2 , HV2 )} -variable Ro45 
    vTcl:DefineAlias "$site_5_0.che71" "Checkbutton378_4" vTcl:WidgetProc "Toplevel378" 1
    checkbutton $site_5_0.cpd72 \
        -text {Ro46 = ( HH2 , VV2 )} -variable Ro46 
    vTcl:DefineAlias "$site_5_0.cpd72" "Checkbutton378_5" vTcl:WidgetProc "Toplevel378" 1
    checkbutton $site_5_0.cpd73 \
        -text {Ro56 = ( HV2 , VV2 )} -variable Ro56 
    vTcl:DefineAlias "$site_5_0.cpd73" "Checkbutton378_6" vTcl:WidgetProc "Toplevel378" 1
    pack $site_5_0.che71 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    pack $site_5_0.cpd72 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.cpd67" "TitleFrame4" vTcl:WidgetProc "Toplevel378" 1
    ...
    frame $site_4_0.fra69 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra69" "Frame7" vTcl:WidgetProc "Toplevel378" 1
    set site_5_0 $site_4_0.fra69
    checkbutton $site_5_0.che71 \
        -text {Ro14 = ( HH1 , HH2 )} -variable Ro14 
    vTcl:DefineAlias "$site_5_0.che71" "Checkbutton378_7" vTcl:WidgetProc "Toplevel378" 1
    checkbutton $site_5_0.cpd72 \
        -text {Ro15 = ( HH1 , HV2 )} -variable Ro15 
    vTcl:DefineAlias "$site_5_0.cpd72" "Checkbutton378_8" vTcl:WidgetProc "Toplevel378" 1
    checkbutton $site_5_0.cpd73 \
        -text {Ro16 = ( HH1 , VV2 )} -variable Ro16 
    vTcl:DefineAlias "$site_5_0.cpd73" "Checkbutton378_9" vTcl:WidgetProc "Toplevel378" 1
    pack $site_5_0.che71 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    pack $site_5_0.cpd72 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $site_4_0.cpd71 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd71" "Frame11" vTcl:WidgetProc "Toplevel378" 1
    set site_5_0 $site_4_0.cpd71
    checkbutton $site_5_0.che71 \
        -text {Ro24 = ( HV1 , HH2 )} -variable Ro24 
    vTcl:DefineAlias "$site_5_0.che71" "Checkbutton378_10" vTcl:WidgetProc "Toplevel378" 1
    checkbutton $site_5_0.cpd72 \
        -text {Ro25 = ( HV1 , HV2 )} -variable Ro25 
    vTcl:DefineAlias "$site_5_0.cpd72" "Checkbutton378_11" vTcl:WidgetProc "Toplevel378" 1
    checkbutton $site_5_0.cpd73 \
        -text {Ro26 = ( HV1 , VV2 )} -variable Ro26 
    vTcl:DefineAlias "$site_5_0.cpd73" "Checkbutton378_12" vTcl:WidgetProc "Toplevel378" 1
    pack $site_5_0.che71 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    pack $site_5_0.cpd72 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $site_4_0.cpd72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd72" "Frame12" vTcl:WidgetProc "Toplevel378" 1
    set site_5_0 $site_4_0.cpd72
    checkbutton $site_5_0.che71 \
        -text {Ro34 = ( VV1 , HH2 )} -variable Ro34 
    vTcl:DefineAlias "$site_5_0.che71" "Checkbutton378_13" vTcl:WidgetProc "Toplevel378" 1
    checkbutton $site_5_0.cpd72 \
        -text {Ro35 = ( VV1 , HV2 )} -variable Ro35 
    vTcl:DefineAlias "$site_5_0.cpd72" "Checkbutton378_14" vTcl:WidgetProc "Toplevel378" 1
    checkbutton $site_5_0.cpd73 \
        -text {Ro36 = ( VV1 , VV2 )} -variable Ro36 
    vTcl:DefineAlias "$site_5_0.cpd73" "Checkbutton378_15" vTcl:WidgetProc "Toplevel378" 1
    pack $site_5_0.che71 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    pack $site_5_0.cpd72 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.fra73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra73" "Frame3" vTcl:WidgetProc "Toplevel378" 1
    set site_3_0 $top.fra73
    checkbutton $site_3_0.che78 \
        -text {BMP ( Mod / Phase )} -variable BMPmodphaRo 
    vTcl:DefineAlias "$site_3_0.che78" "Checkbutton378_16" vTcl:WidgetProc "Toplevel378" 1
    frame $site_3_0.fra74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra74" "Frame4" vTcl:WidgetProc "Toplevel378" 1
    set site_4_0 $site_3_0.fra74
    label $site_4_0.lab75 \
        -text {Window Size : Row} 
    vTcl:DefineAlias "$site_4_0.lab75" "Label1" vTcl:WidgetProc "Toplevel378" 1
    entry $site_4_0.ent76 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NwinLRo -width 5 
    vTcl:DefineAlias "$site_4_0.ent76" "Entry1" vTcl:WidgetProc "Toplevel378" 1
    pack $site_4_0.lab75 \
    ...
    frame $site_3_0.cpd66 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd66" "Frame8" vTcl:WidgetProc "Toplevel378" 1
    set site_4_0 $site_3_0.cpd66
    label $site_4_0.lab75 \
        -text { Col} 
    vTcl:DefineAlias "$site_4_0.lab75" "Label2" vTcl:WidgetProc "Toplevel378" 1
    entry $site_4_0.ent76 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NwinCRo -width 5 
    vTcl:DefineAlias "$site_4_0.ent76" "Entry2" vTcl:WidgetProc "Toplevel378" 1
    pack $site_4_0.lab75 \
        -in $site_4_0 -anchor center -expand 0 -fill none -padx 2 -side left 
    pack $site_4_0.ent76 \
        -in $site_4_0 -anchor center -expand 0 -fill none -padx 2 -side left 
    button $site_3_0.cpd67 \
        -background #ffff00 \
        -command {global NwinLRo NwinCRo Ro12 Ro13 Ro23 Ro45 Ro46 Ro56
global Ro14 Ro15 Ro16 Ro24 Ro25 Ro26
global Ro34 Ro35 Ro36 BMPmodphaRo

set NwinLRo "?"
set NwinCRo "?"
set Ro12 "1"; set Ro13 "1"; set Ro23 "1"
set Ro45 "1"; set Ro46 "1"; set Ro56 "1"
set Ro14 "1"; set Ro15 "1"; set Ro16 "1"
set Ro24 "1"; set Ro25 "1"; set Ro26 "1"
set Ro34 "1"; set Ro35 "1"; set Ro36 "1"
set BMPmodphaRo "1"} \
        -padx 4 -pady 2 -text {Select All} 
    vTcl:DefineAlias "$site_3_0.cpd67" "Button2" vTcl:WidgetProc "Toplevel378" 1
...
set BMPmodphaRo "0"} \
    ...
    vTcl:DefineAlias "$site_3_0.but77" "Button1" vTcl:WidgetProc "Toplevel378" 1
    ...
    vTcl:DefineAlias "$top.fra36" "Frame20" vTcl:WidgetProc "Toplevel378" 1
...
if {"$VarWarning"=="ok"} {
    ...
    if {$CorrelationFonction == "S2"} { set CorrelFonction "S2T6" }


    if {"$Ro12" == 1} {
        set RoElmt 12
        set RoFile "$RoDirOutput/RoHH1_HV1"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
        TextEditorRunTrace "Process The Function Soft/data_process_dual/process_corr.exe" "k"
        if {$CorrelationFonction == "S2"} {
           ...
           set f [ open "| Soft/data_process_dual/process_corr.exe -idm \x22$RoMasterDirInput\x22 -ids \x22$RoSlaveDirInput\x22 -od \x22$RoDirOutput\x22 -iodf $CorrelFonction -elt $RoElmt -nwr $NwinLRo -nwc $NwinCRo -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
           }
        if {$CorrelationFonction == "T6"} {
           ...
           set f [ open "| Soft/data_process_dual/process_corr.exe -id \x22$RoMasterDirInput\x22 -od \x22$RoDirOutput\x22 -iodf $CorrelFonction -elt $RoElmt -nwr $NwinLRo -nwc $NwinCRo -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
           }
        PsPprogressBar $f
        TextEditorRunTrace "Check RunTime Errors" "r"
        CheckRunTimeError
    ...
    if {"$Ro13" == 1} {
        set RoElmt 13
        set RoFile "$RoDirOutput/RoHH1_VV1"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro23" == 1} {
        set RoElmt 23
        set RoFile "$RoDirOutput/RoHV1_VV1"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro45" == 1} {
        set RoElmt 45
        set RoFile "$RoDirOutput/RoHH2_HV2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro46" == 1} {
        set RoElmt 46
        set RoFile "$RoDirOutput/RoHH2_VV2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro56" == 1} {
        set RoElmt 56
        set RoFile "$RoDirOutput/RoHV2_VV2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro14" == 1} {
        set RoElmt 14
        set RoFile "$RoDirOutput/RoHH1_HH2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro15" == 1} {
        set RoElmt 15
        set RoFile "$RoDirOutput/RoHH1_HV2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro16" == 1} {
        set RoElmt 16
        set RoFile "$RoDirOutput/RoHH1_VV2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro24" == 1} {
        set RoElmt 24
        set RoFile "$RoDirOutput/RoHV1_HH2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro25" == 1} {
        set RoElmt 25
        set RoFile "$RoDirOutput/RoHV1_HV2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro26" == 1} {
        set RoElmt 26
        set RoFile "$RoDirOutput/RoHV1_VV2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro34" == 1} {
        set RoElmt 34
        set RoFile "$RoDirOutput/RoVV1_HH2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro35" == 1} {
        set RoElmt 35
        set RoFile "$RoDirOutput/RoVV1_HV2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$Ro36" == 1} {
        set RoElmt 36
        set RoFile "$RoDirOutput/RoVV1_VV2"
        set Fonction "Creation of the Binary Data File :"
        set Fonction2 "$RoFile.bin"
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel378); TextEditorRunTrace "Close Window Correlation Coefficients 6" "b"}
    }
}} \
        -cursor {} -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel378" 1
    ...
    button $site_3_0.but23 \
        ...
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel378" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel378); TextEditorRunTrace "Close Window Correlation Coefficients 6" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel378" 1
