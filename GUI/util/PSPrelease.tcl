...
foreach img {
        ...
        {{[file join . GUI Images PSPrelease.gif]} {user image} user {}}
...
proc vTclWindow.top464 {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "New PolSARpro Release Available"
    vTcl:DefineAlias "$top" "Toplevel464" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.fra69" "Frame1" vTcl:WidgetProc "Toplevel464" 1
    set site_3_0 $top.fra69
    button $site_3_0.but70 \
		-activebackground #ffff00 -background #ffff00 \
		-command {global VarPSPrelease

set VarPSPrelease "quit"
Window hide $widget(Toplevel464); TextEditorRunTrace "Close Window PolSARpro v6.0 (Biomass Edition) new release" "b"} \
		-pady 0 -text {Quit this current version} 
    vTcl:DefineAlias "$site_3_0.but70" "Button1" vTcl:WidgetProc "Toplevel464" 1
    button $site_3_0.cpd66 \
		-activebackground #ffff00 -background #ffff00 \
		-command {global VarPSPrelease

set VarPSPrelease "ok"
Window hide $widget(Toplevel464); TextEditorRunTrace "Close Window PolSARpro v6.0 (Biomass Edition) new release" "b"} \
		-pady 0 -text {Continue with this current version} 
    vTcl:DefineAlias "$site_3_0.cpd66" "Button2" vTcl:WidgetProc "Toplevel464" 1
    pack $site_3_0.but70 \
    ...
    label $top.lab71 \
		-borderwidth 0 \
		-image [vTcl:image:get_image [file join . GUI Images PSPrelease.gif]] \
		-text label 
    vTcl:DefineAlias "$top.lab71" "Label1" vTcl:WidgetProc "Toplevel464" 1
    ###################
    # SETTING GEOMETRY
    ###################
    pack $top.fra69 \
