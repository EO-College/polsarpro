...
proc vTclWindow.top31 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel31" vTcl:Toplevel:WidgetProc "" 1
...
Window hide $widget(Toplevel31); TextEditorRunTrace "Close Window Environment" "b"
    ...
    vTcl:DefineAlias "$site_4_0.cpd79" "EntryTop31" vTcl:WidgetProc "Toplevel31" 1
    ...
    frame $site_4_0.fra81 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra81" "Frame5" vTcl:WidgetProc "Toplevel31" 1
    set site_5_0 $site_4_0.fra81
    button $site_5_0.cpd82 \
        \
        -command {global ActiveProgram ConfigFile PolarType
global DirName DataDir BMPDirInput DataDirTmp 
...
CheckEnvBinData} \
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd82" "Button28" vTcl:WidgetProc "Toplevel31" 1
    ...
    button $site_5_0.cpd72 \
        \
        -command {global DataDir OpenDirFile DataDirTmp 

if {$OpenDirFile == 0} {
set DataDirTmp $DataDir
MenuOff
set DataDir [file dirname $DataDir]
CheckEnvBinData
}} \
        -image [vTcl:image:get_image [file join . GUI Images DecrDir.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd72" "Button11" vTcl:WidgetProc "Toplevel31" 1
...
CheckEnvBinData
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd73" "Button13" vTcl:WidgetProc "Toplevel31" 1
