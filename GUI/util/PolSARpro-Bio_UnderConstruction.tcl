...
proc vTclWindow.top035 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 300x50+150+150; update
    wm maxsize $top 1284 1008
    wm minsize $top 120 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "UNDER CONSTRUCTION"
    vTcl:DefineAlias "$top" "Toplevel035" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.fra36" "Frame441" vTcl:WidgetProc "Toplevel035" 1
    set site_3_0 $top.fra36
    label $site_3_0.lab40 \
		\
		-image [vTcl:image:get_image [file join . GUI Images Construction2.gif]] \
		-text label 
    vTcl:DefineAlias "$site_3_0.lab40" "Label480" vTcl:WidgetProc "Toplevel035" 1
    button $site_3_0.cpd66 \
		-background {#ffff00} -command {Window hide $widget(Toplevel035)} \
