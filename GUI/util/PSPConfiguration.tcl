...
foreach img {
        ...
        {{[file join . GUI Images PSPWidget28.gif]} {user image} user {}}
...
proc vTclWindow.top11 {base} {
    ...
    frame $site_4_0.cpd75 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd75" "Frame1" vTcl:WidgetProc "Toplevel11" 1
    set site_5_0 $site_4_0.cpd75
    label $site_5_0.cpd72 \
        \
        -image [vTcl:image:get_image [file join . GUI Images PSPWidget28.gif]] \
        -text label 
    vTcl:DefineAlias "$site_5_0.cpd72" "Label4" vTcl:WidgetProc "Toplevel11" 1
    pack $site_5_0.cpd72 \
...
if {$WidgetPosition == 1} {
    ...
    frame $site_4_0.cpd82 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd82" "Frame7" vTcl:WidgetProc "Toplevel11" 1
    set site_5_0 $site_4_0.cpd82
    label $site_5_0.cpd80 \
        \
        -image [vTcl:image:get_image [file join . GUI Images PSPTransparent.gif]] \
        -text label 
    vTcl:DefineAlias "$site_5_0.cpd80" "Label6" vTcl:WidgetProc "Toplevel11" 1
    label $site_5_0.cpd91 \
        -text {DISPLAY "PROGRESS-BAR" WIDGET} 
    vTcl:DefineAlias "$site_5_0.cpd91" "Label8" vTcl:WidgetProc "Toplevel11" 1
    frame $site_5_0.fra92 \
        -borderwidth 2 -relief sunken -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra92" "Frame8" vTcl:WidgetProc "Toplevel11" 1
    set site_6_0 $site_5_0.fra92
    radiobutton $site_6_0.rad93 \
        -text yes -value 1 -variable PSPShow28 
    vTcl:DefineAlias "$site_6_0.rad93" "Radiobutton1" vTcl:WidgetProc "Toplevel11" 1
    radiobutton $site_6_0.cpd94 \
        -text no -value 0 -variable PSPShow28 
    vTcl:DefineAlias "$site_6_0.cpd94" "Radiobutton2" vTcl:WidgetProc "Toplevel11" 1
    pack $site_6_0.rad93 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.cpd94 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
...
if {$PSPThumb == 0} { set PSPThumb 100 }} \
    ...
    set site_6_0 $site_5_0.cpd95
    radiobutton $site_6_0.rad93 \
        -text yes -value 1 -variable PSPViewGimpBMP 
    ...
    set site_7_0 $site_6_0.cpd105
    label $site_7_0.lab81 \
        -text {BMP and RGB FILES WITH GIMP} 
    ...
    button $site_3_0.but107 \
        -background #ffff00 \
        -command [list vTcl:DoCmdOption $site_3_0.but107 {global PSPThumb PSPThumbnails WidgetPosition
global OpenDirFile

if {$OpenDirFile == 0} {
set PSPThumbnails [expr ($PSPThumb / 10)]
