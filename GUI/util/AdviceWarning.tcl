...
proc vTclWindow.top388 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 400x50+200+200; update
    wm maxsize $top 1604 1184
    wm minsize $top 113 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "ADVICE WARNING"
    vTcl:DefineAlias "$top" "Toplevel388" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.fra33" "Frame77" vTcl:WidgetProc "Toplevel388" 1
    set site_3_0 $top.fra33
    frame $site_3_0.fra35 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra35" "Frame79" vTcl:WidgetProc "Toplevel388" 1
    set site_4_0 $site_3_0.fra35
    label $site_4_0.lab37 \
        -image [vTcl:image:get_image [file join . GUI Images Warning.gif]] \
        -text label 
    vTcl:DefineAlias "$site_4_0.lab37" "Label65" vTcl:WidgetProc "Toplevel388" 1
    pack $site_4_0.lab37 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side top 
    frame $site_3_0.fra36 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra36" "Frame80" vTcl:WidgetProc "Toplevel388" 1
    set site_4_0 $site_3_0.fra36
    ...
    frame $site_3_0.cpd76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd76" "Frame78" vTcl:WidgetProc "Toplevel388" 1
    set site_4_0 $site_3_0.cpd76
    button $site_4_0.but41 \
        -background #ffff00 \
        -command {global VarWarning
set VarWarning "ok"
Window hide $widget(Toplevel388); TextEditorRunTrace "Close Window Advice Warning" "b"} \
        -padx 1 -pady 0 -text OK -width 2 
    vTcl:DefineAlias "$site_4_0.but41" "Button25" vTcl:WidgetProc "Toplevel388" 1
    pack $site_4_0.but41 \
