...
proc vTclWindow.top7 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 500x150+200+100; update
    wm maxsize $top 1284 1008
    wm minsize $top 113 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "References"
    vTcl:DefineAlias "$top" "Toplevel7" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.fra96" "Frame477" vTcl:WidgetProc "Toplevel7" 1
    set site_3_0 $top.fra96
    button $site_3_0.but102 \
        -background #ffff00 \
        -command {global OpenDirFile
if {$OpenDirFile == 0} {
.top7.fra97.tex100 delete 1.0 end
Window hide $widget(Toplevel7); TextEditorRunTrace "Close Window References" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but102" "Button67" vTcl:WidgetProc "Toplevel7" 1
    ...
    vTcl:DefineAlias "$top.fra97" "Frame478" vTcl:WidgetProc "Toplevel7" 1
    set site_3_0 $top.fra97
    scrollbar $site_3_0.scr98 \
        -command "$site_3_0.tex100 xview" -orient horizontal 
    vTcl:DefineAlias "$site_3_0.scr98" "Scrollbar1" vTcl:WidgetProc "Toplevel7" 1
    scrollbar $site_3_0.scr99 \
        -command "$site_3_0.tex100 yview" 
    vTcl:DefineAlias "$site_3_0.scr99" "Scrollbar2" vTcl:WidgetProc "Toplevel7" 1
    text $site_3_0.tex100 \
        -background white -xscrollcommand "$site_3_0.scr98 set" \
        -yscrollcommand "$site_3_0.scr99 set" 
    vTcl:DefineAlias "$site_3_0.tex100" "Text1" vTcl:WidgetProc "Toplevel7" 1
    pack $site_3_0.scr98 \
