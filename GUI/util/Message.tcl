...
foreach img {
        ...
        {{[file join . GUI Images sablier3.gif]} {user image} user {}}
...
proc vTcl:project:info {} {
    ...
    namespace eval ::widgets::$site_3_0.lab68 {
...
proc vTclWindow.top28 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 230x55+50+100; update
    wm maxsize $top 1604 1184
    wm minsize $top 113 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "PROCESSING IN PROGRESS"
    vTcl:DefineAlias "$top" "Toplevel28" vTcl:Toplevel:WidgetProc "" 1
    bindtags $top "$top Toplevel all _TopLevel"
    vTcl:FireEvent $top <<Create>>
    wm protocol $top WM_DELETE_WINDOW "vTcl:FireEvent $top <<>>"

    ::progressbar::progressbar $top.pro35 \
        -borderwidth 2 -variable ProgressLine -width 220 
    vTcl:DefineAlias "$top.pro35" "Progressbar2" vTcl:WidgetProc "Toplevel28" 1
    frame $top.fra66 \
        -borderwidth 2 -relief sunken -height 75 -width 125 
    vTcl:DefineAlias "$top.fra66" "Frame1" vTcl:WidgetProc "Toplevel28" 1
    set site_3_0 $top.fra66
    label $site_3_0.lab67 \
        \
        -image [vTcl:image:get_image [file join . GUI Images sablier3.gif]] \
        -text . 
    vTcl:DefineAlias "$site_3_0.lab67" "Label1" vTcl:WidgetProc "Toplevel28" 1
    label $site_3_0.lab68 \
        -background #ffff00 -foreground #ff0000 \
        -text {  .... PROCESSING DATA ....  } 
    vTcl:DefineAlias "$site_3_0.lab68" "Label2" vTcl:WidgetProc "Toplevel28" 1
    pack $site_3_0.lab67 \
