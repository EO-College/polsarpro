...
proc vTclWindow.top85 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 450x330+30+30; update
    wm maxsize $top 1604 1185
    wm minsize $top 116 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "About PolSARpro"
    vTcl:DefineAlias "$top" "Toplevel85" vTcl:Toplevel:WidgetProc "" 1
    ...
    TitleFrame $top.tit66 \
        ...
        -text Contractor 
    vTcl:DefineAlias "$top.tit66" "TitleFrame1" vTcl:WidgetProc "Toplevel85" 1
    ...
    label $site_4_0.lab68 \
        ...
        -text label 
    vTcl:DefineAlias "$site_4_0.lab68" "Label27" vTcl:WidgetProc "Toplevel85" 1
    frame $site_4_0.fra66 \
        -borderwidth 2 -background #ffffff -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra66" "Frame1" vTcl:WidgetProc "Toplevel85" 1
    set site_5_0 $site_4_0.fra66
    ...
    vTcl:DefineAlias "$site_5_0.cpd67" "Label1" vTcl:WidgetProc "Toplevel85" 1
    label $site_5_0.cpd68 \
        -activebackground #ffffff -background #ffffff -foreground #0000ff \
        -text {Research & Development Section (Y.L. Desnos)} 
    vTcl:DefineAlias "$site_5_0.cpd68" "Label2" vTcl:WidgetProc "Toplevel85" 1
    pack $site_5_0.cpd67 \
    ...
    vTcl:DefineAlias "$top.cpd70" "TitleFrame2" vTcl:WidgetProc "Toplevel85" 1
    ...
    frame $site_4_0.fra74 \
        -borderwidth 2 -background #ffffff -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra74" "Frame3" vTcl:WidgetProc "Toplevel85" 1
    set site_5_0 $site_4_0.fra74
    label $site_5_0.cpd75 \
        -background #ffffff \
        -image [vTcl:image:get_image [file join . GUI Images 0ietr.gif]] \
        -text label 
    vTcl:DefineAlias "$site_5_0.cpd75" "Label29" vTcl:WidgetProc "Toplevel85" 1
    label $site_5_0.cpd76 \
        -background #ffffff \
        -image [vTcl:image:get_image [file join . GUI Images 0UR1.gif]] \
        -text label 
    vTcl:DefineAlias "$site_5_0.cpd76" "Label31" vTcl:WidgetProc "Toplevel85" 1
    pack $site_5_0.cpd75 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    pack $site_5_0.cpd76 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    frame $site_4_0.cpd69 \
        -borderwidth 2 -background #ffffff -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd69" "Frame2" vTcl:WidgetProc "Toplevel85" 1
    set site_5_0 $site_4_0.cpd69
    label $site_5_0.cpd67 \
        -activebackground #ffffff -background #ffffff -foreground #0000ff \
        -text {I.E.T.R - UMR CNRS 6164 - University of Rennes 1} 
    vTcl:DefineAlias "$site_5_0.cpd67" "Label3" vTcl:WidgetProc "Toplevel85" 1
    label $site_5_0.cpd77 \
        -activebackground #ffffff -background #ffffff -foreground #0000ff \
        -text {Campus de Beaulieu - Batiment 11D} 
    vTcl:DefineAlias "$site_5_0.cpd77" "Label5" vTcl:WidgetProc "Toplevel85" 1
    label $site_5_0.cpd78 \
        -activebackground #ffffff -background #ffffff -foreground #0000ff \
        -text {263 avenue General Leclerc} 
    vTcl:DefineAlias "$site_5_0.cpd78" "Label6" vTcl:WidgetProc "Toplevel85" 1
    label $site_5_0.cpd79 \
        -activebackground #ffffff -background #ffffff -foreground #0000ff \
        -text {F-35042 Rennes cedex - France} 
    vTcl:DefineAlias "$site_5_0.cpd79" "Label7" vTcl:WidgetProc "Toplevel85" 1
    label $site_5_0.cpd68 \
        -activebackground #ffffff -background #ffffff -foreground #0000ff \
        -text {E. Pottier (eric.pottier@univ-rennes1.fr)} 
    vTcl:DefineAlias "$site_5_0.cpd68" "Label4" vTcl:WidgetProc "Toplevel85" 1
    pack $site_5_0.cpd67 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    pack $site_5_0.cpd77 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
...
WidgetShow $widget(Toplevel256); TextEditorRunTrace "Open Window PolSARpro v5.0 Contributors" "b"} \
    ...
    frame $top.fra102 \
        -borderwidth 2 -background #ffffff -height 75 -width 125 
    vTcl:DefineAlias "$top.fra102" "Frame426" vTcl:WidgetProc "Toplevel85" 1
...
Window hide $widget(Toplevel85); TextEditorRunTrace "Close Window About PolSARpro" "b"} \
    ...
    vTcl:DefineAlias "$site_3_0.fra66" "Frame4" vTcl:WidgetProc "Toplevel85" 1
    set site_4_0 $site_3_0.fra66
    label $site_4_0.lab67 \
        -background #ffffff -text Version 
    vTcl:DefineAlias "$site_4_0.lab67" "Label8" vTcl:WidgetProc "Toplevel85" 1
    ...
    vTcl:DefineAlias "$site_4_0.ent68" "Entry1" vTcl:WidgetProc "Toplevel85" 1
    pack $site_4_0.lab67 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent68 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
