...
proc vTcl:project:info {} {
    ...
    namespace eval ::widgets::$site_5_0.cpd324 {
        array set save {-borderwidth 1 -height 1 -width 1}
    }
    set site_6_0 $site_5_0.cpd324
    ...
    namespace eval ::widgets::$site_3_0.che88 {
        array set save {-command 1 -text 1 -variable 1}
    }
    namespace eval ::widgets::$site_3_0.che89 {
        array set save {-text 1 -variable 1}
    }
...
proc vTclWindow.top324 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel324" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd88 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd88" "Frame4" vTcl:WidgetProc "Toplevel324" 1
    set site_3_0 $top.cpd88
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame8" vTcl:WidgetProc "Toplevel324" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel324" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel324" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button40" vTcl:WidgetProc "Toplevel324" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame9" vTcl:WidgetProc "Toplevel324" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel324" 1
    frame $site_5_0.cpd324 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd324" "Frame16" vTcl:WidgetProc "Toplevel324" 1
    set site_6_0 $site_5_0.cpd324
    label $site_6_0.cpd78 \
        -text / 
    vTcl:DefineAlias "$site_6_0.cpd78" "Label14" vTcl:WidgetProc "Toplevel324" 1
    entry $site_6_0.cpd77 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable HAAlpOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd77" "EntryTopXXCh9" vTcl:WidgetProc "Toplevel324" 1
    pack $site_6_0.cpd78 \
    ...
    frame $site_5_0.cpd76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd76" "Frame17" vTcl:WidgetProc "Toplevel324" 1
    set site_6_0 $site_5_0.cpd76
...
if {$DirName != ""} {
    ...
    vTcl:DefineAlias "$top.fra36" "Frame9" vTcl:WidgetProc "Toplevel324" 1
    set site_3_0 $top.fra36
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel324" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel324" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel324" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel324" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel324" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel324" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel324" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel324" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.fra41 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra41" "Frame35" vTcl:WidgetProc "Toplevel324" 1
    set site_3_0 $top.fra41
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$alpha1234"=="1"} {
    $widget(Checkbutton324_1) configure -state normal 
    } else {
    $widget(Checkbutton324_1) configure -state disable
    set BMPalpha1234 "0"
    }} \
        -text {Alpha1, Alpha2, Alpha3, Alpha4} -variable alpha1234 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton324_154" vTcl:WidgetProc "Toplevel324" 1
    checkbutton $site_3_0.che39 \
        -text BMP -variable BMPalpha1234 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton324_1" vTcl:WidgetProc "Toplevel324" 1
    pack $site_3_0.che38 \
    ...
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$beta1234"=="1"} {
    $widget(Checkbutton324_2) configure -state normal
    } else {
    $widget(Checkbutton324_2) configure -state disable
    set BMPbeta1234 "0"
    }} \
        -padx 1 -text {Beta1, Beta2, Beta3, Beta4} -variable beta1234 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton324_156" vTcl:WidgetProc "Toplevel324" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPbeta1234 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton324_2" vTcl:WidgetProc "Toplevel324" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    ...
    checkbutton $site_3_0.che88 \
        \
        -command {if {"$epsilon1234"=="1"} {
    $widget(Checkbutton324_3) configure -state normal
    } else {
    $widget(Checkbutton324_3) configure -state disable
    set BMPepsilon1234 "0"
    }} \
        -text {Epsilon1, Epsilon2, Epsilon3, Epsilon4} -variable epsilon1234 
    vTcl:DefineAlias "$site_3_0.che88" "Checkbutton324_158" vTcl:WidgetProc "Toplevel324" 1
    checkbutton $site_3_0.che89 \
        -text BMP -variable BMPepsilon1234 
    vTcl:DefineAlias "$site_3_0.che89" "Checkbutton324_3" vTcl:WidgetProc "Toplevel324" 1
    pack $site_3_0.che88 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che89 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra43 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra43" "Frame37" vTcl:WidgetProc "Toplevel324" 1
    set site_3_0 $top.fra43
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$delta1234"=="1"} {
    $widget(Checkbutton324_4) configure -state normal
    } else {
    $widget(Checkbutton324_4) configure -state disable
    set BMPdelta1234 "0"
    }} \
        -text {Delta1, Delta2, Delta3, Delta4} -variable delta1234 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton324_160" vTcl:WidgetProc "Toplevel324" 1
    checkbutton $site_3_0.che39 \
        -text BMP -variable BMPdelta1234 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton324_4" vTcl:WidgetProc "Toplevel324" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra44 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra44" "Frame325" vTcl:WidgetProc "Toplevel324" 1
    set site_3_0 $top.fra44
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$gamma1234"=="1"} {
    $widget(Checkbutton324_5) configure -state normal
    } else {
    $widget(Checkbutton324_5) configure -state disable
    set BMPgamma1234 "0"
    }} \
        -padx 1 -text {Gamma1, Gamma2, Gamma3, Gamma4} -variable gamma1234 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton324_162" vTcl:WidgetProc "Toplevel324" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPgamma1234 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton324_5" vTcl:WidgetProc "Toplevel324" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra90 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra90" "Frame324" vTcl:WidgetProc "Toplevel324" 1
    set site_3_0 $top.fra90
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$nhu1234"=="1"} {
    $widget(Checkbutton324_6) configure -state normal
    } else {
    $widget(Checkbutton324_6) configure -state disable
    set BMPnhu1234 "0"
    }} \
        -text {Nhu1, Nhu2, Nhu3, Nhu4} -variable nhu1234 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton324_164" vTcl:WidgetProc "Toplevel324" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPnhu1234 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton324_6" vTcl:WidgetProc "Toplevel324" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.cpd72 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd72" "Frame326" vTcl:WidgetProc "Toplevel324" 1
    set site_3_0 $top.cpd72
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$alpbetepsdelgamnhu"=="1"} {
    $widget(Checkbutton324_8) configure -state normal
    } else {
    $widget(Checkbutton324_8) configure -state disable
    set BMPalpbetepsdelgamnhu "0"
    }} \
        -text {Alpha, Beta, Epsilon, Delta, Gamme, Nhu} \
        -variable alpbetepsdelgamnhu 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton324_165" vTcl:WidgetProc "Toplevel324" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPalpbetepsdelgamnhu 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton324_8" vTcl:WidgetProc "Toplevel324" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    ...
    vTcl:DefineAlias "$top.fra55" "Frame47" vTcl:WidgetProc "Toplevel324" 1
    set site_3_0 $top.fra55
    frame $site_3_0.fra24 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.fra24" "Frame48" vTcl:WidgetProc "Toplevel324" 1
    set site_4_0 $site_3_0.fra24
    label $site_4_0.lab57 \
        -text {Window Size Row} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label34" vTcl:WidgetProc "Toplevel324" 1
    entry $site_4_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinHAAlpL -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry22" vTcl:WidgetProc "Toplevel324" 1
    pack $site_4_0.lab57 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent58 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    frame $site_3_0.cpd101 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.cpd101" "Frame49" vTcl:WidgetProc "Toplevel324" 1
    set site_4_0 $site_3_0.cpd101
    label $site_4_0.lab57 \
        -text {Window Size Col} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label35" vTcl:WidgetProc "Toplevel324" 1
    entry $site_4_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinHAAlpC -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry23" vTcl:WidgetProc "Toplevel324" 1
    pack $site_4_0.lab57 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent58 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
...
$widget(Checkbutton324_8) configure -state normal} \
    ...
    vTcl:DefineAlias "$site_3_0.cpd71" "Button104" vTcl:WidgetProc "Toplevel324" 1
...
$widget(Checkbutton324_8) configure -state disable} \
    ...
    vTcl:DefineAlias "$site_3_0.but25" "Button103" vTcl:WidgetProc "Toplevel324" 1
    ...
    frame $top.cpd100 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd100" "Frame1" vTcl:WidgetProc "Toplevel324" 1
    set site_3_0 $top.cpd100
    frame $site_3_0.fra78 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra78" "Frame2" vTcl:WidgetProc "Toplevel324" 1
    set site_4_0 $site_3_0.fra78
    checkbutton $site_4_0.che80 \
        -text {Equivalence between [ T ] and  [ C ] eigen-decompositions.} \
        -variable EquivHAAlpDecomp 
    vTcl:DefineAlias "$site_4_0.che80" "Checkbutton324_7" vTcl:WidgetProc "Toplevel324" 1
    pack $site_4_0.che80 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_3_0.fra78 \
    ...
    vTcl:DefineAlias "$top.fra59" "Frame20" vTcl:WidgetProc "Toplevel324" 1
...
set config "false"
if {"$alpha1234"=="1"} { set config "true" }
if {"$beta1234"=="1"} { set config "true" }
if {"$epsilon1234"=="1"} { set config "true" }
if {"$delta1234"=="1"} { set config "true" }
if {"$gamma1234"=="1"} { set config "true" }
if {"$nhu1234"=="1"} { set config "true" }
...
if {"$config"=="true"} {
    ...
    if {"$VarWarning"=="ok"} {
        ...
        if {$TestVarError == "ok"} {
            ...
            TextEditorRunTrace "Arguments: -id \x22$HAAlpDirInput\x22 -od \x22$HAAlpDirOutput\x22 -iodf $HAAlphaDecompositionF -nwr $NwinHAAlpL -nwc $NwinHAAlpC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -fl1 $alpbetepsdelgamnhu -fl2 $alpha1234 -fl3 $beta1234 -fl4 $delta1234 -fl5 $gamma1234 -fl6 $epsilon1234 -fl7 $nhu1234 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/data_process_sngl/h_a_alpha_eigenvector_set.exe -id \x22$HAAlpDirInput\x22 -od \x22$HAAlpDirOutput\x22 -iodf $HAAlphaDecompositionF -nwr $NwinHAAlpL -nwc $NwinHAAlpC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -fl1 $alpbetepsdelgamnhu -fl2 $alpha1234 -fl3 $beta1234 -fl4 $delta1234 -fl5 $gamma1234 -fl6 $epsilon1234 -fl7 $nhu1234 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            ...
            if {"$alpha1234"=="1"} {
                ...
                if [file exists "$HAAlpDirOutput/alpha4.bin"] {EnviWriteConfig "$HAAlpDirOutput/alpha4.bin" $FinalNlig $FinalNcol 4}
                }
            if {"$beta1234"=="1"} { 
                ...
                if [file exists "$HAAlpDirOutput/beta4.bin"] {EnviWriteConfig "$HAAlpDirOutput/beta4.bin" $FinalNlig $FinalNcol 4}
                }
            if {"$epsilon1234"=="1"} {
                if [file exists "$HAAlpDirOutput/epsilon1.bin"] {EnviWriteConfig "$HAAlpDirOutput/epsilon1.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$HAAlpDirOutput/epsilon2.bin"] {EnviWriteConfig "$HAAlpDirOutput/epsilon2.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$HAAlpDirOutput/epsilon3.bin"] {EnviWriteConfig "$HAAlpDirOutput/epsilon3.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$HAAlpDirOutput/epsilon4.bin"] {EnviWriteConfig "$HAAlpDirOutput/epsilon4.bin" $FinalNlig $FinalNcol 4}
                }
            if {"$delta1234"=="1"} {
                ...
                if [file exists "$HAAlpDirOutput/delta4.bin"] {EnviWriteConfig "$HAAlpDirOutput/delta4.bin" $FinalNlig $FinalNcol 4}
                }
            if {"$gamma1234"=="1"} { 
                ...
                if [file exists "$HAAlpDirOutput/gamma4.bin"] {EnviWriteConfig "$HAAlpDirOutput/gamma4.bin" $FinalNlig $FinalNcol 4}
                }
            if {"$nhu1234"=="1"} {
                if [file exists "$HAAlpDirOutput/nhu1.bin"] {EnviWriteConfig "$HAAlpDirOutput/nhu1.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$HAAlpDirOutput/nhu2.bin"] {EnviWriteConfig "$HAAlpDirOutput/nhu2.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$HAAlpDirOutput/nhu3.bin"] {EnviWriteConfig "$HAAlpDirOutput/nhu3.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$HAAlpDirOutput/nhu4.bin"] {EnviWriteConfig "$HAAlpDirOutput/nhu4.bin" $FinalNlig $FinalNcol 4}
                }
        ...
        if {"$BMPalpha1234"=="1"} {
            if [file exists "$HAAlpDirOutput/alpha1.bin"] {
                ...
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real jet  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 0 90
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/alpha4.bin"
                set BMPFileOutput "$HAAlpDirOutput/alpha4.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real jet  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 0 90
                } else {
                set VarError ""
        ...
        if {"$BMPbeta1234"=="1"} {
            if [file exists "$HAAlpDirOutput/beta1.bin"] {
                ...
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real jet  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 0 90
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/beta4.bin"
                set BMPFileOutput "$HAAlpDirOutput/beta4.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real jet  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 0 90
                } else {
                set VarError ""
                set ErrorMessage "IMPOSSIBLE TO OPEN THE BIN FILES" 
        ...
        if {"$BMPepsilon1234"=="1"} {
            if [file exists "$HAAlpDirOutput/epsilon1.bin"] {
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/epsilon1.bin"
                set BMPFileOutput "$HAAlpDirOutput/epsilon1.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real jet  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 0 90
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/epsilon2.bin"
                set BMPFileOutput "$HAAlpDirOutput/epsilon2.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real jet  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 0 90
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/epsilon3.bin"
                set BMPFileOutput "$HAAlpDirOutput/epsilon3.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real jet  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 0 90
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/epsilon4.bin"
                set BMPFileOutput "$HAAlpDirOutput/epsilon4.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real jet  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 0 90
                } else {
                set VarError ""
                set ErrorMessage "IMPOSSIBLE TO OPEN THE BIN FILES" 
        ...
        if {"$BMPdelta1234"=="1"} {
            if [file exists "$HAAlpDirOutput/delta1.bin"] {
                ...
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real hsv  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 -180 180
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/delta4.bin"
                set BMPFileOutput "$HAAlpDirOutput/delta4.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real hsv  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 -180 180
                } else {
                set VarError ""
                set ErrorMessage "IMPOSSIBLE TO OPEN THE BIN FILES" 
        ...
        if {"$BMPgamma1234"=="1"} {
            if [file exists "$HAAlpDirOutput/gamma1.bin"] {
                ...
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real hsv  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 -180 180
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/gamma4.bin"
                set BMPFileOutput "$HAAlpDirOutput/gamma4.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real hsv  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 -180 180
                } else {
                set VarError ""
                set ErrorMessage "IMPOSSIBLE TO OPEN THE BIN FILES" 
        ...
        if {"$BMPnhu1234"=="1"} {
            if [file exists "$HAAlpDirOutput/nhu1.bin"] {
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/nhu1.bin"
                set BMPFileOutput "$HAAlpDirOutput/nhu1.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real hsv  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 -180 180
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/nhu2.bin"
                set BMPFileOutput "$HAAlpDirOutput/nhu2.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real hsv  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 -180 180
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/nhu3.bin"
                set BMPFileOutput "$HAAlpDirOutput/nhu3.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real hsv  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 -180 180
                set BMPDirInput $HAAlpDirOutput
                set BMPFileInput "$HAAlpDirOutput/nhu4.bin"
                set BMPFileOutput "$HAAlpDirOutput/nhu4.bmp"
                PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float real hsv  $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol 0 -180 180
                } else {
                set VarError ""
                set ErrorMessage "IMPOSSIBLE TO OPEN THE BIN FILES" 
        ...
        if {"$VarWarning"=="no"} {Window hide $widget(Toplevel324); TextEditorRunTrace "Close Window H A Alpha Eigenvector Set Parameters 4" "b"}
        }
    }
}} \
        -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel324" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/HAAlphaDecomposition4_2.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel324" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel324); TextEditorRunTrace "Close Window H A Alpha Eigenvector Set Parameters 4" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel324" 1
