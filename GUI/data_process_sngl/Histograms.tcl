...
if {$GnuplotPipeFid == ""} {
    ...
    WidgetShowFromWidget .top260 .top456; TextEditorRunTrace "Open Window Save Display 1" "b"
    tkwait variable VarSaveGnuPlotFile
    }
}
#############################################################################
## Procedure:  PlotHisto1D
...
proc vTclWindow.top260 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel260" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd75 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd75" "Frame2" vTcl:WidgetProc "Toplevel260" 1
    set site_3_0 $top.cpd75
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Input Data File} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame7" vTcl:WidgetProc "Toplevel260" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh7" vTcl:WidgetProc "Toplevel260" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame19" vTcl:WidgetProc "Toplevel260" 1
    set site_6_0 $site_5_0.cpd91
...
$widget(Radiobutton260_3) configure -state disable
$widget(Radiobutton260_4) configure -state disable
...
if {$FileName != ""} {
    ...
    vTcl:DefineAlias "$top.tit81" "TitleFrame1" vTcl:WidgetProc "Toplevel260" 1
    ...
    radiobutton $site_4_0.cpd82 \
        \
        -command {$widget(Radiobutton260_3) configure -state normal
$widget(Radiobutton260_4) configure -state normal} \
        -padx 1 -text Complex -value cmplx -variable HistoInputFormat 
    radiobutton $site_4_0.cpd83 \
        \
        -command {$widget(Radiobutton260_3) configure -state disable
$widget(Radiobutton260_4) configure -state disable} \
...
$widget(Radiobutton260_4) configure -state disable} \
    ...
    TitleFrame $top.tit85 \
        -ipad 0 -text Show 
    vTcl:DefineAlias "$top.tit85" "TitleFrame2" vTcl:WidgetProc "Toplevel260" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd86" "Radiobutton35" vTcl:WidgetProc "Toplevel260" 1
    radiobutton $site_4_0.cpd71 \
        -padx 1 -text 10log(Mod) -value db10 -variable HistoOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd71" "Radiobutton43" vTcl:WidgetProc "Toplevel260" 1
    radiobutton $site_4_0.cpd87 \
        -padx 1 -text 20log(Mod) -value db20 -variable HistoOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd87" "Radiobutton36" vTcl:WidgetProc "Toplevel260" 1
    radiobutton $site_4_0.cpd89 \
        -padx 1 -text Phase -value pha -variable HistoOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd89" "Radiobutton260_3" vTcl:WidgetProc "Toplevel260" 1
    radiobutton $site_4_0.cpd90 \
        -padx 1 -text Real -value real -variable HistoOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd90" "Radiobutton38" vTcl:WidgetProc "Toplevel260" 1
    radiobutton $site_4_0.cpd92 \
        -padx 1 -text Imag -value imag -variable HistoOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd92" "Radiobutton260_4" vTcl:WidgetProc "Toplevel260" 1
    pack $site_4_0.cpd86 \
        -in $site_4_0 -anchor center -expand 1 -fill none -side left 
    pack $site_4_0.cpd71 \
        -in $site_4_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.fra178 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.fra178" "Frame7" vTcl:WidgetProc "Toplevel260" 1
    set site_3_0 $top.fra178
    TitleFrame $site_3_0.tit179 \
        -ipad 2 -text {Histogram Title} 
    vTcl:DefineAlias "$site_3_0.tit179" "TitleFrame3" vTcl:WidgetProc "Toplevel260" 1
    ...
    vTcl:DefineAlias "$site_5_0.ent180" "Entry1" vTcl:WidgetProc "Toplevel260" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd181" "TitleFrame4" vTcl:WidgetProc "Toplevel260" 1
    ...
    vTcl:DefineAlias "$site_5_0.ent180" "Entry2" vTcl:WidgetProc "Toplevel260" 1
    pack $site_5_0.ent180 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 10 -side top 
    ...
    vTcl:DefineAlias "$top.tit97" "TitleFrame260_1" vTcl:WidgetProc "Toplevel260" 1
    ...
    frame $site_5_0.fra77 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra77" "Frame3" vTcl:WidgetProc "Toplevel260" 1
    set site_6_0 $site_5_0.fra77
...
if {"$MinMaxAutoHisto" == "1"} {
    ...
    $widget(Label260_1) configure -state normal
    $widget(Entry260_1) configure -state normal
    $widget(Label260_2) configure -state normal
    $widget(Entry260_2) configure -state normal
    $widget(Button260_1) configure -state normal
    set MinHisto "?"
    set MaxHisto "?"
    }} \
        -padx 1 -text Automatic -variable MinMaxAutoHisto 
    vTcl:DefineAlias "$site_6_0.cpd78" "Checkbutton260_1" vTcl:WidgetProc "Toplevel260" 1
    pack $site_6_0.cpd78 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side top 
    pack $site_5_0.fra77 \
    ...
    frame $site_5_0.cpd102 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd102" "Frame69" vTcl:WidgetProc "Toplevel260" 1
    set site_6_0 $site_5_0.cpd102
    label $site_6_0.lab32 \
        -padx 1 -text Min 
    vTcl:DefineAlias "$site_6_0.lab32" "Label260_1" vTcl:WidgetProc "Toplevel260" 1
    entry $site_6_0.ent33 \
        -background white -foreground #ff0000 -justify center \
        -textvariable MinHisto -width 12 
    vTcl:DefineAlias "$site_6_0.ent33" "Entry260_1" vTcl:WidgetProc "Toplevel260" 1
    label $site_6_0.lab34 \
        -padx 1 -text Max 
    vTcl:DefineAlias "$site_6_0.lab34" "Label260_2" vTcl:WidgetProc "Toplevel260" 1
    entry $site_6_0.ent35 \
        -background white -foreground #ff0000 -justify center \
        -textvariable MaxHisto -width 12 
    vTcl:DefineAlias "$site_6_0.ent35" "Entry260_2" vTcl:WidgetProc "Toplevel260" 1
...
if [file exists $TMPStatResultsTxt] {
    ...
    tkwait variable VarError
        ...
        -pady 2 -text MinMax 
    vTcl:DefineAlias "$site_6_0.cpd75" "Button260_1" vTcl:WidgetProc "Toplevel260" 1
...
if [file exists $TMPStatisticsTxt] {
    ...
    if [file exists $TMPStatisticsBin] {
        set VarHistoSave "ok"
        $widget(Button260_3) configure -state normal
        $widget(Button260_4) configure -state disable
        $widget(Button260_5) configure -state disable
        $widget(Button260_6) configure -state disable
        $widget(Radiobutton260_1) configure -state disable
        $widget(Radiobutton260_2) configure -state disable
        $widget(TitleFrame260_1) configure -state normal
        $widget(Checkbutton260_1) configure -state normal
        if {$MinMaxAutoHisto == 1} {
            $widget(Label260_1) configure -state disable
            $widget(Entry260_1) configure -state disable
            $widget(Label260_2) configure -state disable
...
tkwait variable VarError
    ...
    frame $site_3_0.fra76 \
        -borderwidth 2 -relief sunken -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra76" "Frame6" vTcl:WidgetProc "Toplevel260" 1
    set site_4_0 $site_3_0.fra76
...
if {$VarHistoSave == "ok"} {
    ...
    if [file exists $TMPStatHistoTxt] {
        ...
        $widget(Radiobutton260_1) configure -state normal
        $widget(Radiobutton260_2) configure -state normal
    ...
    vTcl:DefineAlias "$site_4_0.but82" "Button260_3" vTcl:WidgetProc "Toplevel260" 1
    frame $site_4_0.fra182 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra182" "Frame8" vTcl:WidgetProc "Toplevel260" 1
    set site_5_0 $site_4_0.fra182
    radiobutton $site_5_0.rad183 \
        -borderwidth 0 -command PlotHisto1D -text line -value lines \
        -variable GnuHistoStyle 
    vTcl:DefineAlias "$site_5_0.rad183" "Radiobutton260_1" vTcl:WidgetProc "Toplevel260" 1
    radiobutton $site_5_0.cpd184 \
        -borderwidth 0 -command PlotHisto1D -text box -value boxes \
        -variable GnuHistoStyle 
    vTcl:DefineAlias "$site_5_0.cpd184" "Radiobutton260_2" vTcl:WidgetProc "Toplevel260" 1
...
PlotHistoSave
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_4_0.but83" "Button260_4" vTcl:WidgetProc "Toplevel260" 1
...
Gimp $TMPGnuPlotTk1} \
        ...
        -text { } 
    vTcl:DefineAlias "$site_4_0.cpd66" "Button260_6" vTcl:WidgetProc "Toplevel260" 1
    button $site_4_0.but84 \
        -background #ffff00 \
        -command {PlotHistoClose
$widget(Button260_4) configure -state disable} \
        -padx 4 -pady 2 -text Close 
    vTcl:DefineAlias "$site_4_0.but84" "Button260_5" vTcl:WidgetProc "Toplevel260" 1
    pack $site_4_0.but82 \
        -in $site_4_0 -anchor center -expand 1 -fill none -padx 5 -pady 5 \
        -side left 
...
set ProgressLine "0"; update
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel260" 1
