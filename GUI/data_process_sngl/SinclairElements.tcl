...
proc vTclWindow.top86 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel86" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd77 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd77" "Frame4" vTcl:WidgetProc "Toplevel86" 1
    set site_3_0 $top.cpd77
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame8" vTcl:WidgetProc "Toplevel86" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel86" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel86" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button40" vTcl:WidgetProc "Toplevel86" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame9" vTcl:WidgetProc "Toplevel86" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel86" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame16" vTcl:WidgetProc "Toplevel86" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd78 \
        \
        -command {global DirName DataDir SlrDirOutput

set SlrDirOutputTmp $SlrDirOutput
set DirName ""
OpenDir $DataDir "DATA OUTPUT DIRECTORY"
if {$DirName != "" } {
    set SlrDirOutput $DirName
    } else {
    set SlrDirOutput $SlrDirOutputTmp
    }} \
    ...
    vTcl:DefineAlias "$top.fra88" "Frame9" vTcl:WidgetProc "Toplevel86" 1
    set site_3_0 $top.fra88
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel86" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel86" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel86" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel86" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel86" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel86" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel86" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel86" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.fra90 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra90" "Frame430" vTcl:WidgetProc "Toplevel86" 1
    set site_3_0 $top.fra90
    label $site_3_0.lab47 \
        -padx 1 -text S11 
    vTcl:DefineAlias "$site_3_0.lab47" "Label86_1" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad48 \
        -command {$widget(Checkbutton86_1) configure -state normal} -padx 1 \
        -text A11 -value A -variable SlrtoS11 
    vTcl:DefineAlias "$site_3_0.rad48" "Radiobutton86_1" vTcl:WidgetProc "Toplevel86" 1
    checkbutton $site_3_0.che51 \
        -padx 1 -text BMP -variable BMPSlrtoS11 
    vTcl:DefineAlias "$site_3_0.che51" "Checkbutton86_1" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad24 \
        -command {$widget(Checkbutton86_1) configure -state normal} -padx 1 \
        -text I11 -value I -variable SlrtoS11 
    vTcl:DefineAlias "$site_3_0.rad24" "Radiobutton86_2" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad28 \
        -command {$widget(Checkbutton86_1) configure -state normal} -padx 1 \
        -text {A11 (dB) = I11 (dB)} -value Idb -variable SlrtoS11 
    vTcl:DefineAlias "$site_3_0.rad28" "Radiobutton86_3" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad50 \
        -command {$widget(Checkbutton86_1) configure -state normal} -padx 1 \
        -text Phase -value pha -variable SlrtoS11 
    vTcl:DefineAlias "$site_3_0.rad50" "Radiobutton86_4" vTcl:WidgetProc "Toplevel86" 1
    pack $site_3_0.lab47 \
    ...
    frame $top.fra91 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra91" "Frame431" vTcl:WidgetProc "Toplevel86" 1
    set site_3_0 $top.fra91
    label $site_3_0.lab47 \
        -padx 1 -text S21 
    vTcl:DefineAlias "$site_3_0.lab47" "Label86_2" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad48 \
        -command {$widget(Checkbutton86_2) configure -state normal} -padx 1 \
        -text A21 -value A -variable SlrtoS21 
    vTcl:DefineAlias "$site_3_0.rad48" "Radiobutton86_5" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad25 \
        -command {$widget(Checkbutton86_2) configure -state normal} -padx 1 \
        -text I21 -value I -variable SlrtoS21 
    vTcl:DefineAlias "$site_3_0.rad25" "Radiobutton86_6" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad29 \
        -command {$widget(Checkbutton86_2) configure -state normal} -padx 1 \
        -text {A21 (dB) = I21 (dB)} -value Idb -variable SlrtoS21 
    vTcl:DefineAlias "$site_3_0.rad29" "Radiobutton86_7" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad50 \
        -command {$widget(Checkbutton86_2) configure -state normal} -padx 1 \
        -text Phase -value pha -variable SlrtoS21 
    vTcl:DefineAlias "$site_3_0.rad50" "Radiobutton86_8" vTcl:WidgetProc "Toplevel86" 1
    checkbutton $site_3_0.che51 \
        -padx 1 -text BMP -variable BMPSlrtoS21 
    vTcl:DefineAlias "$site_3_0.che51" "Checkbutton86_2" vTcl:WidgetProc "Toplevel86" 1
    pack $site_3_0.lab47 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 10 -side left 
    pack $site_3_0.rad48 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.fra92 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra92" "Frame432" vTcl:WidgetProc "Toplevel86" 1
    set site_3_0 $top.fra92
    label $site_3_0.lab47 \
        -text S12 
    vTcl:DefineAlias "$site_3_0.lab47" "Label86_3" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad48 \
        -command {$widget(Checkbutton86_3) configure -state normal} -padx 1 \
        -text A12 -value A -variable SlrtoS12 
    vTcl:DefineAlias "$site_3_0.rad48" "Radiobutton86_9" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad26 \
        -command {$widget(Checkbutton86_3) configure -state normal} -padx 1 \
        -text I12 -value I -variable SlrtoS12 
    vTcl:DefineAlias "$site_3_0.rad26" "Radiobutton86_10" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad30 \
        -command {$widget(Checkbutton86_3) configure -state normal} -padx 1 \
        -text {A12 (dB) = I12 (dB)} -value Idb -variable SlrtoS12 
    vTcl:DefineAlias "$site_3_0.rad30" "Radiobutton86_11" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad50 \
        -command {$widget(Checkbutton86_3) configure -state normal} -padx 1 \
        -text Phase -value pha -variable SlrtoS12 
    vTcl:DefineAlias "$site_3_0.rad50" "Radiobutton86_12" vTcl:WidgetProc "Toplevel86" 1
    checkbutton $site_3_0.che51 \
        -text BMP -variable BMPSlrtoS12 
    vTcl:DefineAlias "$site_3_0.che51" "Checkbutton86_3" vTcl:WidgetProc "Toplevel86" 1
    pack $site_3_0.lab47 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 10 -side left 
    pack $site_3_0.rad48 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.fra95 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra95" "Frame433" vTcl:WidgetProc "Toplevel86" 1
    set site_3_0 $top.fra95
    label $site_3_0.lab47 \
        -text S22 
    vTcl:DefineAlias "$site_3_0.lab47" "Label86_4" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad48 \
        -command {$widget(Checkbutton86_4) configure -state normal} -padx 1 \
        -text A22 -value A -variable SlrtoS22 
    vTcl:DefineAlias "$site_3_0.rad48" "Radiobutton86_13" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad27 \
        -command {$widget(Checkbutton86_4) configure -state normal} -padx 1 \
        -text I22 -value I -variable SlrtoS22 
    vTcl:DefineAlias "$site_3_0.rad27" "Radiobutton86_14" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad31 \
        -command {$widget(Checkbutton86_4) configure -state normal} -padx 1 \
        -text {A22 (dB) = I22 (dB)} -value Idb -variable SlrtoS22 
    vTcl:DefineAlias "$site_3_0.rad31" "Radiobutton86_15" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad50 \
        -command {$widget(Checkbutton86_4) configure -state normal} -padx 1 \
        -text Phase -value pha -variable SlrtoS22 
    vTcl:DefineAlias "$site_3_0.rad50" "Radiobutton86_16" vTcl:WidgetProc "Toplevel86" 1
    checkbutton $site_3_0.che51 \
        -text BMP -variable BMPSlrtoS22 
    vTcl:DefineAlias "$site_3_0.che51" "Checkbutton86_4" vTcl:WidgetProc "Toplevel86" 1
    pack $site_3_0.lab47 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 10 -side left 
    pack $site_3_0.rad48 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.cpd66 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd66" "Frame435" vTcl:WidgetProc "Toplevel86" 1
    set site_3_0 $top.cpd66
    label $site_3_0.lab47 \
        -text Pauli 
    vTcl:DefineAlias "$site_3_0.lab47" "Label86_6" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad48 \
        -command {$widget(Checkbutton86_6) configure -state disable} -padx 1 \
        -text Cmplx -value cmplx -variable SlrtoPauli 
    vTcl:DefineAlias "$site_3_0.rad48" "Radiobutton86_19" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad27 \
        -command {$widget(Checkbutton86_6) configure -state normal} -padx 1 \
        -text Mod -value mod -variable SlrtoPauli 
    vTcl:DefineAlias "$site_3_0.rad27" "Radiobutton86_20" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad31 \
        -command {$widget(Checkbutton86_6) configure -state normal} -padx 1 \
        -text {20log10(Mod) (dB)} -value db -variable SlrtoPauli 
    vTcl:DefineAlias "$site_3_0.rad31" "Radiobutton86_21" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad50 \
        -command {$widget(Checkbutton86_6) configure -state normal} -padx 1 \
        -text Phase -value pha -variable SlrtoPauli 
    vTcl:DefineAlias "$site_3_0.rad50" "Radiobutton86_22" vTcl:WidgetProc "Toplevel86" 1
    checkbutton $site_3_0.che51 \
        -text BMP -variable BMPSlrtoPauli 
    vTcl:DefineAlias "$site_3_0.che51" "Checkbutton86_6" vTcl:WidgetProc "Toplevel86" 1
    pack $site_3_0.lab47 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 10 -side left 
    pack $site_3_0.rad48 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.fra96 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra96" "Frame434" vTcl:WidgetProc "Toplevel86" 1
    set site_3_0 $top.fra96
    label $site_3_0.lab47 \
        -cursor {} -padx 1 -text Span 
    vTcl:DefineAlias "$site_3_0.lab47" "Label86_5" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad48 \
        -command {$widget(Checkbutton86_5) configure -state normal} -padx 1 \
        -text Linear -value lin -variable SlrtoSpan 
    vTcl:DefineAlias "$site_3_0.rad48" "Radiobutton86_17" vTcl:WidgetProc "Toplevel86" 1
    radiobutton $site_3_0.rad49 \
        -command {$widget(Checkbutton86_5) configure -state normal} -padx 1 \
        -text {DeciBel = 10log(Span)} -value db -variable SlrtoSpan 
    vTcl:DefineAlias "$site_3_0.rad49" "Radiobutton86_18" vTcl:WidgetProc "Toplevel86" 1
    checkbutton $site_3_0.che51 \
        -padx 1 -text BMP -variable BMPSlrtoSpan 
    vTcl:DefineAlias "$site_3_0.che51" "Checkbutton86_5" vTcl:WidgetProc "Toplevel86" 1
    pack $site_3_0.lab47 \
    ...
    frame $top.fra68 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra68" "Frame1" vTcl:WidgetProc "Toplevel86" 1
...
set SlrtoSpan "db"
set BMPSlrtoSpan "1"
$widget(Checkbutton86_5) configure -state normal
...
if {$PolarType == "full"} {
    ...
    set BMPSlrtoPauli "1"
    $widget(Checkbutton86_1) configure -state normal
    $widget(Checkbutton86_2) configure -state normal
    $widget(Checkbutton86_3) configure -state normal
    $widget(Checkbutton86_4) configure -state normal
    $widget(Checkbutton86_6) configure -state normal
    }
if {$PolarType == "pp1"} {
    set SlrtoS11 "Idb"; set SlrtoS21 "Idb"
    set BMPSlrtoS11 "1"; set BMPSlrtoS21 "1"
...
if {$PolarType == "pp3"} {
    ...
    vTcl:DefineAlias "$site_3_0.cpd69" "Button587" vTcl:WidgetProc "Toplevel86" 1
...
$widget(Checkbutton86_6) configure -state disable} \
    ...
    vTcl:DefineAlias "$site_3_0.cpd70" "Button588" vTcl:WidgetProc "Toplevel86" 1
    ...
    vTcl:DefineAlias "$top.fra94" "Frame20" vTcl:WidgetProc "Toplevel86" 1
    set site_3_0 $top.fra94
    button $site_3_0.but93 \
        -background #ffff00 \
        -command {global SlrDirInput SlrDirOutput SinclairFonction OpenDirFile
...
if {"$VarWarning"=="ok"} {
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel86); TextEditorRunTrace "Close Window Sinclair Elements" "b"}
    }
}} \
        -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel86" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/SinclairElements.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel86" 1
...
Window hide $widget(Toplevel86); TextEditorRunTrace "Close Window Sinclair Elements" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel86" 1
