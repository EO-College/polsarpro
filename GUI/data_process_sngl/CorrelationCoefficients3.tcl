...
proc vTclWindow.top79 {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Data Processing: Correlation Coefficients (3x3)"
    vTcl:DefineAlias "$top" "Toplevel79" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd80 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd80" "Frame4" vTcl:WidgetProc "Toplevel79" 1
    set site_3_0 $top.cpd80
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame8" vTcl:WidgetProc "Toplevel79" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel79" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel79" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button39" vTcl:WidgetProc "Toplevel79" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame9" vTcl:WidgetProc "Toplevel79" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel79" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame16" vTcl:WidgetProc "Toplevel79" 1
    set site_6_0 $site_5_0.cpd91
    label $site_6_0.cpd73 \
        -text / 
    vTcl:DefineAlias "$site_6_0.cpd73" "Label14" vTcl:WidgetProc "Toplevel79" 1
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable RoOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd72" "EntryTopXXCh9" vTcl:WidgetProc "Toplevel79" 1
    pack $site_6_0.cpd73 \
    ...
    frame $site_5_0.cpd71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd71" "Frame17" vTcl:WidgetProc "Toplevel79" 1
    set site_6_0 $site_5_0.cpd71
...
if {$DirName != ""} {
    ...
    set RoOutputDir $RoDirOutputTmp
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd88" "Button533" vTcl:WidgetProc "Toplevel79" 1
    ...
    vTcl:DefineAlias "$top.fra67" "Frame9" vTcl:WidgetProc "Toplevel79" 1
    set site_3_0 $top.fra67
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel79" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel79" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel79" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel79" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel79" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel79" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel79" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel79" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.fra68 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra68" "Frame33" vTcl:WidgetProc "Toplevel79" 1
    set site_3_0 $top.fra68
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$Ro12"=="1"} {
    $widget(Checkbutton79_2) configure -state normal
    $widget(Checkbutton79_3) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton79_1" vTcl:WidgetProc "Toplevel79" 1
    checkbutton $site_3_0.che69 \
        -text {BMP Phase} -variable BMPphaRo12 
    vTcl:DefineAlias "$site_3_0.che69" "Checkbutton79_3" vTcl:WidgetProc "Toplevel79" 1
    checkbutton $site_3_0.che78 \
        -command {} -padx 1 -text {BMP Modulus} -variable BMPmodRo12 
    vTcl:DefineAlias "$site_3_0.che78" "Checkbutton79_2" vTcl:WidgetProc "Toplevel79" 1
    pack $site_3_0.che38 \
    ...
    frame $top.fra70 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra70" "Frame299" vTcl:WidgetProc "Toplevel79" 1
    set site_3_0 $top.fra70
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$Ro13"=="1"} {
    $widget(Checkbutton79_5) configure -state normal
    $widget(Checkbutton79_6) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton79_4" vTcl:WidgetProc "Toplevel79" 1
    checkbutton $site_3_0.che39 \
        -text {BMP Phase} -variable BMPphaRo13 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton79_6" vTcl:WidgetProc "Toplevel79" 1
    checkbutton $site_3_0.che69 \
        -padx 1 -text {BMP Modulus} -variable BMPmodRo13 
    vTcl:DefineAlias "$site_3_0.che69" "Checkbutton79_5" vTcl:WidgetProc "Toplevel79" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 50 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 50 \
    ...
    frame $top.fra72 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra72" "Frame301" vTcl:WidgetProc "Toplevel79" 1
    set site_3_0 $top.fra72
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$Ro23"=="1"} {
    $widget(Checkbutton79_8) configure -state normal
    $widget(Checkbutton79_9) configure -state normal
    } else {
    ...
    set BMPphaRo23 "0"
        ...
        -padx 1 -text Ro23 -variable Ro23 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton79_7" vTcl:WidgetProc "Toplevel79" 1
    checkbutton $site_3_0.che39 \
        -text {BMP Phase} -variable BMPphaRo23 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton79_9" vTcl:WidgetProc "Toplevel79" 1
    checkbutton $site_3_0.che69 \
        -padx 1 -text {BMP Modulus} -variable BMPmodRo23 
    vTcl:DefineAlias "$site_3_0.che69" "Checkbutton79_8" vTcl:WidgetProc "Toplevel79" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 50 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 50 \
    ...
    frame $top.fra24 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra24" "Frame440" vTcl:WidgetProc "Toplevel79" 1
    set site_3_0 $top.fra24
    checkbutton $site_3_0.che26 \
        \
        -command {if {"$CCC"=="1"} {
    $widget(Checkbutton79_11) configure -state normal
    $widget(Checkbutton79_12) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_3_0.che26" "Checkbutton79_10" vTcl:WidgetProc "Toplevel79" 1
    checkbutton $site_3_0.che27 \
        -command {} -text {BMP Phase} -variable BMPphaCCC 
    vTcl:DefineAlias "$site_3_0.che27" "Checkbutton79_12" vTcl:WidgetProc "Toplevel79" 1
    checkbutton $site_3_0.che28 \
        -padx 1 -text {BMP Modulus} -variable BMPmodCCC 
    vTcl:DefineAlias "$site_3_0.che28" "Checkbutton79_11" vTcl:WidgetProc "Toplevel79" 1
    pack $site_3_0.che26 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 50 -side left 
    pack $site_3_0.che27 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 50 \
    ...
    frame $top.cpd73 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd73" "Frame441" vTcl:WidgetProc "Toplevel79" 1
    set site_3_0 $top.cpd73
    checkbutton $site_3_0.che26 \
        \
        -command {if {"$CCCnorm"=="1"} {
    $widget(Checkbutton79_14) configure -state normal
    } else {
    $widget(Checkbutton79_14) configure -state disable
    set BMPmodCCCnorm "0"
    }} \
        -padx 1 -text {Normalized. | C.C.C |} -variable CCCnorm 
    vTcl:DefineAlias "$site_3_0.che26" "Checkbutton79_13" vTcl:WidgetProc "Toplevel79" 1
    label $site_3_0.lab74 \
        -text {                           } 
    vTcl:DefineAlias "$site_3_0.lab74" "Label1" vTcl:WidgetProc "Toplevel79" 1
    checkbutton $site_3_0.che28 \
        -padx 1 -text {BMP Modulus} -variable BMPmodCCCnorm 
    vTcl:DefineAlias "$site_3_0.che28" "Checkbutton79_14" vTcl:WidgetProc "Toplevel79" 1
    pack $site_3_0.che26 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 50 -side left 
    pack $site_3_0.lab74 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 50 \
    ...
    vTcl:DefineAlias "$top.fra76" "Frame47" vTcl:WidgetProc "Toplevel79" 1
    set site_3_0 $top.fra76
    frame $site_3_0.fra24 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.fra24" "Frame48" vTcl:WidgetProc "Toplevel79" 1
    set site_4_0 $site_3_0.fra24
    label $site_4_0.lab57 \
        -text {Window Size Row} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label34" vTcl:WidgetProc "Toplevel79" 1
    entry $site_4_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinRoL -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry22" vTcl:WidgetProc "Toplevel79" 1
    pack $site_4_0.lab57 \
    ...
    frame $site_3_0.cpd73 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.cpd73" "Frame49" vTcl:WidgetProc "Toplevel79" 1
    set site_4_0 $site_3_0.cpd73
    label $site_4_0.lab57 \
        -text {Window Size Col} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label35" vTcl:WidgetProc "Toplevel79" 1
    entry $site_4_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinRoC -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry23" vTcl:WidgetProc "Toplevel79" 1
    pack $site_4_0.lab57 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent58 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
...
$widget(Checkbutton79_14) configure -state normal} \
    ...
    vTcl:DefineAlias "$site_3_0.cpd66" "Button104" vTcl:WidgetProc "Toplevel79" 1
...
$widget(Checkbutton79_14) configure -state disable} \
    ...
    vTcl:DefineAlias "$site_3_0.but25" "Button103" vTcl:WidgetProc "Toplevel79" 1
    ...
    vTcl:DefineAlias "$top.fra77" "Frame20" vTcl:WidgetProc "Toplevel79" 1
...
if {"$VarWarning"=="ok"} {
    ...
    if {"$Ro12" == 1} {
        ...
        set CorrelationF $CorrelationFonction; if {$CorrelationFonction == "S2"} { set CorrelationF "S2m" }
        set MaskCmd ""
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel79); TextEditorRunTrace "Close Window Correlation Coefficients 3" "b"}
    }
}} \
        -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel79" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command { HelpPdfEdit "Help/CorrelationCoefficients3.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel79" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel79); TextEditorRunTrace "Close Window Correlation Coefficients 3" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel79" 1
