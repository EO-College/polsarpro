...
WidgetShowFromWidget $widget(Toplevel445) $widget(Toplevel47); TextEditorRunTrace "Open Window Graphic Editor" "b"
...
MouseActiveFunction ""
if {"$VarTrainingArea"=="ok"} { $widget(Button445_3) configure -state normal }
...
TextEditorFromWidget .top445 $FileTrainingArea

}} \
        -padx 4 -pady 2 -text {Text Editor} 
    vTcl:DefineAlias "$site_6_0.but68" "Button643" vTcl:WidgetProc "Toplevel445" 1
