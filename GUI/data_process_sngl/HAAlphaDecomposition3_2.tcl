...
proc vTclWindow.top321 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel321" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd86 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd86" "Frame4" vTcl:WidgetProc "Toplevel321" 1
    set site_3_0 $top.cpd86
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame8" vTcl:WidgetProc "Toplevel321" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel321" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel321" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button40" vTcl:WidgetProc "Toplevel321" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame9" vTcl:WidgetProc "Toplevel321" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel321" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame16" vTcl:WidgetProc "Toplevel321" 1
    set site_6_0 $site_5_0.cpd91
    label $site_6_0.cpd81 \
        -padx 1 -text / 
    vTcl:DefineAlias "$site_6_0.cpd81" "Label14" vTcl:WidgetProc "Toplevel321" 1
    entry $site_6_0.cpd80 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable HAAlpOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd80" "EntryTopXXCh9" vTcl:WidgetProc "Toplevel321" 1
    pack $site_6_0.cpd81 \
    ...
    frame $site_5_0.cpd79 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd79" "Frame17" vTcl:WidgetProc "Toplevel321" 1
    set site_6_0 $site_5_0.cpd79
...
if {$DirName != ""} {
    ...
    vTcl:DefineAlias "$top.fra36" "Frame9" vTcl:WidgetProc "Toplevel321" 1
    set site_3_0 $top.fra36
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel321" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel321" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel321" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel321" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel321" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel321" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel321" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel321" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.fra41 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra41" "Frame35" vTcl:WidgetProc "Toplevel321" 1
    set site_3_0 $top.fra41
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$alpha123"=="1"} {
    $widget(Checkbutton321_1) configure -state normal 
    } else {
    $widget(Checkbutton321_1) configure -state disable
    set BMPalpha123 "0"
    }} \
        -padx 1 -text {Alpha1, Alpha2, Alpha3} -variable alpha123 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton321_13" vTcl:WidgetProc "Toplevel321" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPalpha123 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton321_1" vTcl:WidgetProc "Toplevel321" 1
    pack $site_3_0.che38 \
    ...
    $widget(Checkbutton321_2) configure -state normal
    } else {
    $widget(Checkbutton321_2) configure -state disable
    set BMPbeta123 "0"
    }} \
        -padx 1 -text {Beta1, Beta2, Beta3} -variable beta123 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton321_15" vTcl:WidgetProc "Toplevel321" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPbeta123 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton321_2" vTcl:WidgetProc "Toplevel321" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra43 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra43" "Frame37" vTcl:WidgetProc "Toplevel321" 1
    set site_3_0 $top.fra43
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$delta123"=="1"} {
    $widget(Checkbutton321_3) configure -state normal
    } else {
    $widget(Checkbutton321_3) configure -state disable
    set BMPdelta123 "0"
    }} \
        -padx 1 -text {Delta1, Delta2, Delta3} -variable delta123 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton321_17" vTcl:WidgetProc "Toplevel321" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPdelta123 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton321_3" vTcl:WidgetProc "Toplevel321" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    ...
    $widget(Checkbutton321_4) configure -state normal
    } else {
    $widget(Checkbutton321_4) configure -state disable
    set BMPgamma123 "0"
    }} \
        -padx 1 -text {Gamma1, Gamma2, Gamma3} -variable gamma123 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton321_19" vTcl:WidgetProc "Toplevel321" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPgamma123 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton321_4" vTcl:WidgetProc "Toplevel321" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    ...
    $widget(Checkbutton321_6) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton321_21" vTcl:WidgetProc "Toplevel321" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPalpbetdelgam 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton321_6" vTcl:WidgetProc "Toplevel321" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    ...
    vTcl:DefineAlias "$top.fra55" "Frame47" vTcl:WidgetProc "Toplevel321" 1
    set site_3_0 $top.fra55
    frame $site_3_0.fra24 \
        -borderwidth 2 -cursor {} -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.fra24" "Frame48" vTcl:WidgetProc "Toplevel321" 1
    set site_4_0 $site_3_0.fra24
    label $site_4_0.lab57 \
        -padx 1 -text {Window Size Row} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label321" vTcl:WidgetProc "Toplevel321" 1
    ...
    vTcl:DefineAlias "$site_4_0.ent58" "Entry22" vTcl:WidgetProc "Toplevel321" 1
    pack $site_4_0.lab57 \
    ...
    frame $site_3_0.cpd92 \
        -borderwidth 2 -cursor {} -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.cpd92" "Frame49" vTcl:WidgetProc "Toplevel321" 1
    set site_4_0 $site_3_0.cpd92
    label $site_4_0.lab57 \
        -padx 1 -text {Window Size Col} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label322" vTcl:WidgetProc "Toplevel321" 1
    entry $site_4_0.ent58 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable NwinHAAlpC -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry23" vTcl:WidgetProc "Toplevel321" 1
    pack $site_4_0.lab57 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent58 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
...
$widget(Checkbutton321_6) configure -state normal} \
    ...
    vTcl:DefineAlias "$site_3_0.cpd67" "Button104" vTcl:WidgetProc "Toplevel321" 1
...
$widget(Checkbutton321_6) configure -state disable} \
    ...
    vTcl:DefineAlias "$site_3_0.but25" "Button103" vTcl:WidgetProc "Toplevel321" 1
    ...
    frame $top.cpd91 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd91" "Frame5" vTcl:WidgetProc "Toplevel321" 1
    set site_3_0 $top.cpd91
    frame $site_3_0.fra72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra72" "Frame6" vTcl:WidgetProc "Toplevel321" 1
    set site_4_0 $site_3_0.fra72
    checkbutton $site_4_0.che75 \
        -text {Equivalence between [ T ]  and  [ C ] eigen-decompositions. } \
        -variable EquivHAAlpDecomp 
    vTcl:DefineAlias "$site_4_0.che75" "Checkbutton321_5" vTcl:WidgetProc "Toplevel321" 1
    pack $site_4_0.che75 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_3_0.fra72 \
    ...
    vTcl:DefineAlias "$top.fra59" "Frame20" vTcl:WidgetProc "Toplevel321" 1
...
if {"$config"=="true"} {
    ...
    if {"$VarWarning"=="ok"} {
        ...
        if {"$VarWarning"=="no"} {Window hide $widget(Toplevel321); TextEditorRunTrace "Close Window H A Alpha Eigenvector Set Parameters 3" "b"}
        }
    }
}} \
        -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel321" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/HAAlphaDecomposition3_2.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel321" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel321); TextEditorRunTrace "Close Window H A Alpha Eigenvector Set Parameters 3" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel321" 1
