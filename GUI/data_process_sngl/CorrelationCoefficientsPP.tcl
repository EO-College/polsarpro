...
proc vTcl:project:info {} {
    ...
    namespace eval ::widgets::$site_3_0.ent72 {
        array set save {-background 1 -disabledbackground 1 -disabledforeground 1 -foreground 1 -justify 1 -state 1 -textvariable 1 -width 1}
    }
    namespace eval ::widgets::$site_3_0.lab73 {
        array set save {-text 1}
    }
    namespace eval ::widgets::$site_3_0.ent74 {
        array set save {-background 1 -disabledbackground 1 -disabledforeground 1 -foreground 1 -justify 1 -state 1 -textvariable 1 -width 1}
    }
...
proc vTclWindow.top237 {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Data Processing: Correlation Coefficients (2x2)"
    vTcl:DefineAlias "$top" "Toplevel237" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd73 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd73" "Frame3" vTcl:WidgetProc "Toplevel237" 1
    set site_3_0 $top.cpd73
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame6" vTcl:WidgetProc "Toplevel237" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh3" vTcl:WidgetProc "Toplevel237" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame13" vTcl:WidgetProc "Toplevel237" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button38" vTcl:WidgetProc "Toplevel237" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame7" vTcl:WidgetProc "Toplevel237" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh7" vTcl:WidgetProc "Toplevel237" 1
    frame $site_5_0.cpd72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd72" "Frame1" vTcl:WidgetProc "Toplevel237" 1
    set site_6_0 $site_5_0.cpd72
    label $site_6_0.lab73 \
        -text / 
    vTcl:DefineAlias "$site_6_0.lab73" "Label1" vTcl:WidgetProc "Toplevel237" 1
    entry $site_6_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable RoOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd75" "Entry1" vTcl:WidgetProc "Toplevel237" 1
    pack $site_6_0.lab73 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame14" vTcl:WidgetProc "Toplevel237" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != ""} {
    ...
    vTcl:DefineAlias "$top.fra67" "Frame9" vTcl:WidgetProc "Toplevel237" 1
    set site_3_0 $top.fra67
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel237" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel237" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel237" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel237" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel237" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel237" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel237" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel237" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.fra71 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra71" "Frame2" vTcl:WidgetProc "Toplevel237" 1
    set site_3_0 $top.fra71
    entry $site_3_0.ent72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable PolarType -width 4 
    vTcl:DefineAlias "$site_3_0.ent72" "Entry2" vTcl:WidgetProc "Toplevel237" 1
    label $site_3_0.lab73 \
        -text {Channel 1} 
    vTcl:DefineAlias "$site_3_0.lab73" "Label2" vTcl:WidgetProc "Toplevel237" 1
    entry $site_3_0.ent74 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable Channel1 -width 4 
    vTcl:DefineAlias "$site_3_0.ent74" "Entry3" vTcl:WidgetProc "Toplevel237" 1
    label $site_3_0.lab75 \
        -text {Channel 2} 
    vTcl:DefineAlias "$site_3_0.lab75" "Label3" vTcl:WidgetProc "Toplevel237" 1
    entry $site_3_0.ent76 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable Channel2 -width 4 
    vTcl:DefineAlias "$site_3_0.ent76" "Entry4" vTcl:WidgetProc "Toplevel237" 1
    pack $site_3_0.ent72 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    pack $site_3_0.lab73 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.fra68 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra68" "Frame33" vTcl:WidgetProc "Toplevel237" 1
    set site_3_0 $top.fra68
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$Ro12"=="1"} {
    $widget(Checkbutton237_2) configure -state normal
    $widget(Checkbutton237_3) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton237_1" vTcl:WidgetProc "Toplevel237" 1
    checkbutton $site_3_0.che69 \
        -command {} -text {BMP Phase} -variable BMPphaRo12 
    vTcl:DefineAlias "$site_3_0.che69" "Checkbutton237_3" vTcl:WidgetProc "Toplevel237" 1
    checkbutton $site_3_0.che78 \
        -padx 1 -text {BMP Modulus} -variable BMPmodRo12 
    vTcl:DefineAlias "$site_3_0.che78" "Checkbutton237_2" vTcl:WidgetProc "Toplevel237" 1
    pack $site_3_0.che38 \
    ...
    vTcl:DefineAlias "$top.fra76" "Frame47" vTcl:WidgetProc "Toplevel237" 1
    set site_3_0 $top.fra76
    frame $site_3_0.fra24 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.fra24" "Frame48" vTcl:WidgetProc "Toplevel237" 1
    set site_4_0 $site_3_0.fra24
    label $site_4_0.lab57 \
        -text {Window Size Row} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label34" vTcl:WidgetProc "Toplevel237" 1
    entry $site_4_0.ent58 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable NwinRoL -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry22" vTcl:WidgetProc "Toplevel237" 1
    pack $site_4_0.lab57 \
    ...
    frame $site_3_0.cpd75 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.cpd75" "Frame49" vTcl:WidgetProc "Toplevel237" 1
    set site_4_0 $site_3_0.cpd75
    label $site_4_0.lab57 \
        -text {Window Size Col} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label35" vTcl:WidgetProc "Toplevel237" 1
    entry $site_4_0.ent58 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable NwinRoC -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry23" vTcl:WidgetProc "Toplevel237" 1
    pack $site_4_0.lab57 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent58 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    button $site_3_0.but25 \
        -background #ffff00 \
        -command {global NwinRoL NwinRoC Ro12 BMPmodRo12 BMPphaRo12

set NwinRoL "1"; set NwinRoC "1"
set Ro12 "0"
set BMPmodRo12 "0"
set BMPphaRo12 "0"
$widget(Checkbutton237_2) configure -state disable
$widget(Checkbutton237_3) configure -state disable} \
    ...
    vTcl:DefineAlias "$site_3_0.but25" "Button103" vTcl:WidgetProc "Toplevel237" 1
    ...
    vTcl:DefineAlias "$top.fra77" "Frame20" vTcl:WidgetProc "Toplevel237" 1
...
if {"$VarWarning"=="ok"} {
    ...
    if {"$Ro12" == 1} {
        ...
        if {"$config"=="true"} {
            ...
            set VarError ""
            set ErrorMessage "THE FILES $Channel1 AND $Channel2 DO NOT EXIST"
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel237); TextEditorRunTrace "Close Window Correlation Coefficients PP" "b"}
    }
}} \
        -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel237" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/CorrelationCoefficientsPP.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel237" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel237); TextEditorRunTrace "Close Window Correlation Coefficients 2" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel237" 1
    ...
    pack $top.fra71 \
        -in $top -anchor center -expand 1 -fill none -ipadx 30 -ipady 5 \
        -side top 
    pack $top.fra68 \
        -in $top -anchor center -expand 1 -fill x -side top 
    pack $top.fra76 \
