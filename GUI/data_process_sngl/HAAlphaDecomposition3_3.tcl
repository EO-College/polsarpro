...
proc vTclWindow.top322 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel322" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd86 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd86" "Frame4" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.cpd86
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame8" vTcl:WidgetProc "Toplevel322" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel322" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel322" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button40" vTcl:WidgetProc "Toplevel322" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame9" vTcl:WidgetProc "Toplevel322" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel322" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame16" vTcl:WidgetProc "Toplevel322" 1
    set site_6_0 $site_5_0.cpd91
    label $site_6_0.cpd81 \
        -padx 1 -text / 
    vTcl:DefineAlias "$site_6_0.cpd81" "Label14" vTcl:WidgetProc "Toplevel322" 1
    entry $site_6_0.cpd80 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable HAAlpOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd80" "EntryTopXXCh9" vTcl:WidgetProc "Toplevel322" 1
    pack $site_6_0.cpd81 \
    ...
    frame $site_5_0.cpd79 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd79" "Frame17" vTcl:WidgetProc "Toplevel322" 1
    set site_6_0 $site_5_0.cpd79
...
if {$DirName != ""} {
    ...
    vTcl:DefineAlias "$top.fra36" "Frame9" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.fra36
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel322" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel322" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel322" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel322" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel322" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel322" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel322" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.cpd74 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd74" "Frame40" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.cpd74
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$eigenvalues"=="1"} {
    $widget(Checkbutton322_1) configure -state normal
    } else { 
    $widget(Checkbutton322_1) configure -state disable
    set BMPeigenvalues "0"
    }} \
        -padx 1 -text {Eigenvalues ( L1 , L2 , L3 )} -variable eigenvalues 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton20" vTcl:WidgetProc "Toplevel322" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPeigenvalues 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton322_1" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.che38 \
    ...
    frame $top.cpd75 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd75" "Frame41" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.cpd75
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$probabilities"=="1"} {
    $widget(Checkbutton322_2) configure -state normal 
    } else {
    ...
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton21" vTcl:WidgetProc "Toplevel322" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPprobabilities 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton322_2" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra48 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra48" "Frame42" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.fra48
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$anisotropy"=="1"} {
    $widget(Checkbutton322_3) configure -state normal
    } else {
    $widget(Checkbutton322_3) configure -state disable
    set BMPanisotropy "0"
    }} \
        -padx 1 -text {Anisotropy  ( A )  ( p2 , p3 ) } -variable anisotropy 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton27" vTcl:WidgetProc "Toplevel322" 1
    checkbutton $site_3_0.che39 \
        -command {} -padx 1 -text BMP -variable BMPanisotropy 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton322_3" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra30 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra30" "Frame269" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.fra30
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$anisotropy12"=="1"} {
    $widget(Checkbutton322_4) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton86" vTcl:WidgetProc "Toplevel322" 1
    checkbutton $site_3_0.che39 \
        -command {} -padx 1 -text BMP -variable BMPanisotropy12 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton322_4" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.cpd71 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd71" "Frame43" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.cpd71
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$erd"=="1"} {
    $widget(Checkbutton322_5) configure -state normal
    } else {
    ...
    set BMPerd "0"
        ...
        -variable erd 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton28" vTcl:WidgetProc "Toplevel322" 1
    checkbutton $site_3_0.che39 \
        -command {} -padx 1 -text BMP -variable BMPerd 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton322_5" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra22 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra22" "Frame319" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.fra22
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$polarisationasymetry"=="1"} {
    $widget(Checkbutton322_6) configure -state normal
    } else {
    $widget(Checkbutton322_6) configure -state disable
    set BMPpolarisationasymetry "0"
    }} \
        -padx 1 -text {Polarisation Asymmetry  ( p1-p3 , 1-3p3 )} \
        -variable polarisationasymetry 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton138" vTcl:WidgetProc "Toplevel322" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPpolarisationasymetry 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton322_6" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra23 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra23" "Frame320" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.fra23
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$polarisationfraction"=="1"} {
    $widget(Checkbutton322_7) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton322_30" vTcl:WidgetProc "Toplevel322" 1
    checkbutton $site_3_0.che39 \
        -command {} -padx 1 -text BMP -variable BMPpolarisationfraction 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton322_7" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    ...
    $widget(Checkbutton322_14) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton16" vTcl:WidgetProc "Toplevel322" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPlueneburganisotropy 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton322_14" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.cpd72 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd72" "Frame38" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.cpd72
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$vanzylrvi"=="1"} {
    $widget(Checkbutton322_10) configure -state normal
    } else {
    $widget(Checkbutton322_10) configure -state disable
    set BMPvanzylrvi "0"
    }} \
        -padx 1 -text {Radar Vegetation Index  ( R.V.I )} -variable vanzylrvi 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton18" vTcl:WidgetProc "Toplevel322" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPvanzylrvi 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton322_10" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.cpd73 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd73" "Frame39" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.cpd73
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$vanzylpedestal"=="1"} {
    $widget(Checkbutton322_11) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton19" vTcl:WidgetProc "Toplevel322" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPvanzylpedestal 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton322_11" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.cpd76 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd76" "Frame44" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.cpd76
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$shannon"=="1"} {
    $widget(Checkbutton322_13) configure -state normal
    } else {
    $widget(Checkbutton322_13) configure -state disable
    set BMPshannon "0"
    }} \
        -padx 1 -text {Shannon Entropy (H = Hi + Hp)} -variable shannon 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton22" vTcl:WidgetProc "Toplevel322" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPshannon 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton322_13" vTcl:WidgetProc "Toplevel322" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    ...
    vTcl:DefineAlias "$top.fra55" "Frame47" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.fra55
    frame $site_3_0.fra24 \
        -borderwidth 2 -cursor {} -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.fra24" "Frame48" vTcl:WidgetProc "Toplevel322" 1
    set site_4_0 $site_3_0.fra24
    label $site_4_0.lab57 \
        -padx 1 -text {Window Size Row} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label322" vTcl:WidgetProc "Toplevel322" 1
    ...
    vTcl:DefineAlias "$site_4_0.ent58" "Entry22" vTcl:WidgetProc "Toplevel322" 1
    pack $site_4_0.lab57 \
    ...
    frame $site_3_0.cpd94 \
        -borderwidth 2 -cursor {} -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.cpd94" "Frame49" vTcl:WidgetProc "Toplevel322" 1
    set site_4_0 $site_3_0.cpd94
    label $site_4_0.lab57 \
        -padx 1 -text {Window Size Col} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label323" vTcl:WidgetProc "Toplevel322" 1
    entry $site_4_0.ent58 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable NwinHAAlpC -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry23" vTcl:WidgetProc "Toplevel322" 1
    pack $site_4_0.lab57 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent58 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
...
$widget(Checkbutton322_14) configure -state normal} \
    ...
    vTcl:DefineAlias "$site_3_0.cpd68" "Button104" vTcl:WidgetProc "Toplevel322" 1
...
$widget(Checkbutton322_14) configure -state disable} \
    ...
    vTcl:DefineAlias "$site_3_0.but25" "Button103" vTcl:WidgetProc "Toplevel322" 1
    ...
    frame $top.cpd93 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd93" "Frame1" vTcl:WidgetProc "Toplevel322" 1
    set site_3_0 $top.cpd93
    frame $site_3_0.fra72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra72" "Frame2" vTcl:WidgetProc "Toplevel322" 1
    set site_4_0 $site_3_0.fra72
    checkbutton $site_4_0.che75 \
        -text {Equivalence between [ T ]  and  [ C ] eigen-decompositions. } \
        -variable EquivHAAlpDecomp 
    vTcl:DefineAlias "$site_4_0.che75" "Checkbutton322_12" vTcl:WidgetProc "Toplevel322" 1
    pack $site_4_0.che75 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_3_0.fra72 \
    ...
    vTcl:DefineAlias "$top.fra59" "Frame20" vTcl:WidgetProc "Toplevel322" 1
...
if {"$config"=="true"} {
    ...
    if {"$VarWarning"=="ok"} {
        ...
        if {"$VarWarning"=="no"} {Window hide $widget(Toplevel322); TextEditorRunTrace "Close Window H A Alpha Eigenvalue Set Parameters 3" "b"}
        }
    }
}} \
        -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel322" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/HAAlphaDecomposition3_3.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel322" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel322); TextEditorRunTrace "Close Window H A Alpha Eigenvalue Set Parameters 3" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel322" 1
