...
proc vTcl:project:info {} {
    ...
    namespace eval ::widgets::$site_5_0.tit83 {
        array set save {-text 1}
    }
    set site_7_0 [$site_5_0.tit83 getframe]
    namespace eval ::widgets::$site_7_0 {
        array set save {}
    }
    set site_7_0 $site_7_0
    ...
    set site_7_0 [$site_5_0.cpd66 getframe]
    namespace eval ::widgets::$site_7_0 {
        array set save {-borderwidth 1 -relief 1}
    }
    set site_7_0 $site_7_0
    namespace eval ::widgets::$site_7_0.rad67 {
...
proc vTclWindow.top373 {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Data Processing: Data Clustering Process"
    vTcl:DefineAlias "$top" "Toplevel373" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.tit71" "TitleFrame1" vTcl:WidgetProc "Toplevel373" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd72" "Entry373_149" vTcl:WidgetProc "Toplevel373" 1
    frame $site_4_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame1" vTcl:WidgetProc "Toplevel373" 1
    set site_5_0 $site_4_0.cpd74
    button $site_5_0.but75 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_5_0.but75" "Button1" vTcl:WidgetProc "Toplevel373" 1
    pack $site_5_0.but75 \
    ...
    vTcl:DefineAlias "$top.tit76" "TitleFrame2" vTcl:WidgetProc "Toplevel373" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd82" "Entry373_73" vTcl:WidgetProc "Toplevel373" 1
    frame $site_4_0.cpd72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd72" "Frame13" vTcl:WidgetProc "Toplevel373" 1
    set site_5_0 $site_4_0.cpd72
    label $site_5_0.lab73 \
        -text / 
    vTcl:DefineAlias "$site_5_0.lab73" "Label1" vTcl:WidgetProc "Toplevel373" 1
    entry $site_5_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ClusterOutputSubDir -width 3 
    vTcl:DefineAlias "$site_5_0.cpd75" "Entry1" vTcl:WidgetProc "Toplevel373" 1
    pack $site_5_0.lab73 \
    ...
    frame $site_4_0.cpd84 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd84" "Frame2" vTcl:WidgetProc "Toplevel373" 1
    set site_5_0 $site_4_0.cpd84
...
if {$DirName != "" } {
    ...
    set ClusterOutputDir $ClusterOutputDirTmp
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd85" "Button373_92" vTcl:WidgetProc "Toplevel373" 1
    ...
    vTcl:DefineAlias "$top.fra74" "Frame9" vTcl:WidgetProc "Toplevel373" 1
    set site_3_0 $top.fra74
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label373_01" vTcl:WidgetProc "Toplevel373" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry373_01" vTcl:WidgetProc "Toplevel373" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label373_02" vTcl:WidgetProc "Toplevel373" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry373_02" vTcl:WidgetProc "Toplevel373" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label373_03" vTcl:WidgetProc "Toplevel373" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry373_03" vTcl:WidgetProc "Toplevel373" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label373_04" vTcl:WidgetProc "Toplevel373" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry373_04" vTcl:WidgetProc "Toplevel373" 1
    pack $site_3_0.lab57 \
    ...
    TitleFrame $top.tit92 \
        -ipad 2 -text {Data Clustering Process} 
    vTcl:DefineAlias "$top.tit92" "TitleFrame5" vTcl:WidgetProc "Toplevel373" 1
    ...
    frame $site_4_0.fra72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra72" "Frame5" vTcl:WidgetProc "Toplevel373" 1
    set site_5_0 $site_4_0.fra72
    TitleFrame $site_5_0.cpd76 \
        -text {Input Segmentation File} 
    vTcl:DefineAlias "$site_5_0.cpd76" "TitleFrame373_1" vTcl:WidgetProc "Toplevel373" 1
    ...
    entry $site_7_0.cpd77 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable ClusterSegFile -width 60 
    vTcl:DefineAlias "$site_7_0.cpd77" "Entry373_1" vTcl:WidgetProc "Toplevel373" 1
    button $site_7_0.cpd78 \
        \
        -command {global FileName ClusterDirInput ClusterSegFile

set types {
{{BIN Files}        {.bin}        }
}
set FileName ""
OpenFile "$ClusterDirInput" $types "INPUT SEGMENTATION FILE"
if {$FileName != ""} { set ClusterSegFile $FileName }} \
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_7_0.cpd78" "Button373_1" vTcl:WidgetProc "Toplevel373" 1
    ...
    TitleFrame $site_5_0.cpd79 \
        -text {Input Value File} 
    vTcl:DefineAlias "$site_5_0.cpd79" "TitleFrame373_2" vTcl:WidgetProc "Toplevel373" 1
    ...
    entry $site_7_0.cpd77 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable ClusterValFile -width 60 
    vTcl:DefineAlias "$site_7_0.cpd77" "Entry373_2" vTcl:WidgetProc "Toplevel373" 1
    button $site_7_0.cpd78 \
        \
        -command {global FileName ClusterDirInput ClusterValFile

set types {
{{BIN Files}        {.bin}        }
}
set FileName ""
OpenFile "$ClusterDirInput" $types "INPUT VALUE FILE"
if {$FileName != ""} { set ClusterValFile $FileName }} \
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_7_0.cpd78" "Button373_2" vTcl:WidgetProc "Toplevel373" 1
    bindtags $site_7_0.cpd78 "$site_7_0.cpd78 Button $top all _vTclBalloon"
    bind $site_7_0.cpd78 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Open File}
    }
    ...
    TitleFrame $site_5_0.cpd80 \
        -text {Output Cluster File} 
    vTcl:DefineAlias "$site_5_0.cpd80" "TitleFrame373_3" vTcl:WidgetProc "Toplevel373" 1
    ...
    entry $site_7_0.cpd77 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 \
        -textvariable ClusterFile -width 60 
    vTcl:DefineAlias "$site_7_0.cpd77" "Entry373_3" vTcl:WidgetProc "Toplevel373" 1
    button $site_7_0.cpd78 \
        \
        -command {global FileName ClusterDirInput ClusterFile

set types {
{{BIN Files}        {.bin}        }
}
set FileName ""
OpenFile "$ClusterDirInput" $types "OUTPUT CLUSTER FILE"
if {$FileName != ""} { set ClusterFile $FileName }} \
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_7_0.cpd78" "Button373_3" vTcl:WidgetProc "Toplevel373" 1
    bindtags $site_7_0.cpd78 "$site_7_0.cpd78 Button $top all _vTclBalloon"
    bind $site_7_0.cpd78 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Open File}
    }
    ...
    frame $site_4_0.fra81 \
        -relief groove -height 75 -width 134 
    vTcl:DefineAlias "$site_4_0.fra81" "Frame8" vTcl:WidgetProc "Toplevel373" 1
    set site_5_0 $site_4_0.fra81
    TitleFrame $site_5_0.tit83 \
        -text Npix 
    vTcl:DefineAlias "$site_5_0.tit83" "TitleFrame373_10" vTcl:WidgetProc "Toplevel373" 1
    bind $site_5_0.tit83 <Destroy> {
        Widget::destroy %W; rename %W {}
    }
    set site_7_0 [$site_5_0.tit83 getframe]
    entry $site_7_0.cpd84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable ClusterNpix -width 5 
    vTcl:DefineAlias "$site_7_0.cpd84" "Entry373_4" vTcl:WidgetProc "Toplevel373" 1
    pack $site_7_0.cpd84 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side top 
    TitleFrame $site_5_0.cpd66 \
        -text Neighb 
    vTcl:DefineAlias "$site_5_0.cpd66" "TitleFrame373_11" vTcl:WidgetProc "Toplevel373" 1
    bind $site_5_0.cpd66 <Destroy> {
        Widget::destroy %W; rename %W {}
    }
    set site_7_0 [$site_5_0.cpd66 getframe]
    radiobutton $site_7_0.rad67 \
        -text 4 -value 4 -variable ClusterNeighb 
    vTcl:DefineAlias "$site_7_0.rad67" "Radiobutton373_7" vTcl:WidgetProc "Toplevel373" 1
    radiobutton $site_7_0.cpd66 \
        -text 8 -value 8 -variable ClusterNeighb 
    vTcl:DefineAlias "$site_7_0.cpd66" "Radiobutton373_8" vTcl:WidgetProc "Toplevel373" 1
    pack $site_7_0.rad67 \
    ...
    vTcl:DefineAlias "$top.fra83" "Frame20" vTcl:WidgetProc "Toplevel373" 1
...
global ClusterSegFile ClusterValFile ClusterFile ClusterNpix ClusterNeighb
global OpenDirFile ClusterProcess
...
if {$OpenDirFile == 0} {
    ...
    if {$VarWarning =="ok"} {
        ...
        set TestVarName(4) "Npix"; set TestVarType(4) "int"; set TestVarValue(4) $ClusterNpix; set TestVarMin(4) "1"; set TestVarMax(4) "1000"
        TestVar 5
        if {$TestVarError == "ok"} {
            set Fonction "Creation of the Cluster File"
            set Fonction2 ""
            set ProgressLine "0"
            ...
            if [file exists $ClusterFile] {EnviWriteConfig $ClusterFile $FinalNlig $FinalNcol 4}
            }
        } else {
        if {"$VarWarning"=="no"} {Window hide $widget(Toplevel373); TextEditorRunTrace "Close Window Data Clustering" "b"}
        }
    }
} \
        -cursor {} -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.cpd66" "Button373" vTcl:WidgetProc "Toplevel373" 1
    ...
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel373" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel373); TextEditorRunTrace "Close Window Data Clustering" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel373" 1
