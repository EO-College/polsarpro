...
WidgetShowFromWidget $widget(Toplevel53) $widget(Toplevel47); TextEditorRunTrace "Open Window Graphic Editor" "b"
...
MouseActiveFunction ""
if {"$VarTrainingArea"=="ok"} { $widget(Button53_3) configure -state normal }
...
TextEditorFromWidget .top53 $FileTrainingArea

}} \
        -padx 4 -pady 2 -text {Text Editor} 
    vTcl:DefineAlias "$site_6_0.but68" "Button643" vTcl:WidgetProc "Toplevel53" 1
...
if {"$VarWarning"=="ok"} {
    ...
    TextEditorRunTrace "Arguments: -id \x22$SupervisedDirInput\x22 -od \x22$SupervisedDirOutput\x22 -iodf $SupervisedF -af \x22$FileTrainingArea\x22 -cf \x22$FileTrainingSet\x22 -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
    set f [ open "| Soft/data_process_sngl/wishart_training_set_sampler.exe -id \x22$SupervisedDirInput\x22 -od \x22$SupervisedDirOutput\x22 -iodf $SupervisedF -af \x22$FileTrainingArea\x22 -cf \x22$FileTrainingSet\x22 -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
    PsPprogressBar $f
        ...
        if {$ColorMapSupervisedCoded == "1"} {
            ...
            if [file exists $ClassificationInputFile] {
                if {$ColorMapSupervisedCodedPauli == "1"} {
                    ...
                    TextEditorRunTrace "Arguments: -id \x22$SupervisedDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedF -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                    set f [ open "| Soft/bmp_process/classification_colormap_pauli.exe -id \x22$SupervisedDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedF -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                    PsPprogressBar $f
                    TextEditorRunTrace "Check RunTime Errors" "r"
                    CheckRunTimeError
                    WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
                ...
                if {$ColorMapSupervisedCodedSinclair == "1"} {
                    ...
                    TextEditorRunTrace "Arguments: -id \x22$SupervisedDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedF -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                    set f [ open "| Soft/bmp_process/classification_colormap_sinclair.exe -id \x22$SupervisedDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedF -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                    PsPprogressBar $f
                    TextEditorRunTrace "Check RunTime Errors" "r"
                    CheckRunTimeError
                    WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
