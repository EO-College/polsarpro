...
proc vTclWindow. {base} {
    ...
    wm geometry $top 200x200+220+220; update
...
proc vTclWindow.top53 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel53" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd88 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd88" "Frame5" vTcl:WidgetProc "Toplevel53" 1
    set site_3_0 $top.cpd88
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame8" vTcl:WidgetProc "Toplevel53" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel53" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame19" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button43" vTcl:WidgetProc "Toplevel53" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame9" vTcl:WidgetProc "Toplevel53" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel53" 1
    frame $site_5_0.cpd72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd72" "Frame1" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.cpd72
    label $site_6_0.lab73 \
        -text / 
    vTcl:DefineAlias "$site_6_0.lab73" "Label2" vTcl:WidgetProc "Toplevel53" 1
    entry $site_6_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SupervisedOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd75" "Entry1" vTcl:WidgetProc "Toplevel53" 1
    pack $site_6_0.lab73 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame21" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.cpd91
...
set AreaN 1} \
    ...
    vTcl:DefineAlias "$top.fra55" "Frame9" vTcl:WidgetProc "Toplevel53" 1
    set site_3_0 $top.fra55
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel53" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel53" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel53" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel53" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel53" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel53" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel53" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel53" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.lab82" "Label1" vTcl:WidgetProc "Toplevel53" 1
    TitleFrame $top.tit109 \
        -ipad 0 -text {Classification Configuration} 
    vTcl:DefineAlias "$top.tit109" "TitleFrame3" vTcl:WidgetProc "Toplevel53" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd110" "Frame260" vTcl:WidgetProc "Toplevel53" 1
    set site_5_0 $site_4_0.cpd110
    frame $site_5_0.fra23 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra23" "Frame265" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.fra23
    checkbutton $site_6_0.che24 \
        -text BMP -variable BMPSupervised 
    vTcl:DefineAlias "$site_6_0.che24" "Checkbutton84" vTcl:WidgetProc "Toplevel53" 1
    frame $site_6_0.fra25 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_6_0.fra25" "Frame266" vTcl:WidgetProc "Toplevel53" 1
    set site_7_0 $site_6_0.fra25
    label $site_7_0.lab57 \
        -padx 1 -text {Window Size : Row} -width 15 
    vTcl:DefineAlias "$site_7_0.lab57" "Label272" vTcl:WidgetProc "Toplevel53" 1
    entry $site_7_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinSupervisedL -width 5 
    vTcl:DefineAlias "$site_7_0.ent58" "Entry187" vTcl:WidgetProc "Toplevel53" 1
    label $site_7_0.cpd79 \
        -padx 1 -text Col 
    vTcl:DefineAlias "$site_7_0.cpd79" "Label273" vTcl:WidgetProc "Toplevel53" 1
    entry $site_7_0.cpd80 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinSupervisedC -width 5 
    vTcl:DefineAlias "$site_7_0.cpd80" "Entry190" vTcl:WidgetProc "Toplevel53" 1
    pack $site_7_0.lab57 \
    ...
    frame $site_5_0.fra26 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra26" "Frame267" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.fra26
...
if {$RejectClass == "1"} {
    $widget(Label53_7) configure -state normal
    $widget(Entry53_1) configure -state normal
    set RejectRatio "5.0"
    } else {
    ...
    vTcl:DefineAlias "$site_6_0.che27" "Checkbutton85" vTcl:WidgetProc "Toplevel53" 1
    frame $site_6_0.fra28 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_6_0.fra28" "Frame261" vTcl:WidgetProc "Toplevel53" 1
    set site_7_0 $site_6_0.fra28
    label $site_7_0.lab57 \
        -padx 1 -text {Reject Ratio} -width 10 
    vTcl:DefineAlias "$site_7_0.lab57" "Label53_7" vTcl:WidgetProc "Toplevel53" 1
    entry $site_7_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable RejectRatio -width 5 
    vTcl:DefineAlias "$site_7_0.ent58" "Entry53_1" vTcl:WidgetProc "Toplevel53" 1
    pack $site_7_0.lab57 \
    ...
    frame $site_5_0.fra29 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra29" "Frame268" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.fra29
    checkbutton $site_6_0.che30 \
        -text {Confusion Matrix} -variable ConfusionMatrix 
    vTcl:DefineAlias "$site_6_0.che30" "Checkbutton83" vTcl:WidgetProc "Toplevel53" 1
...
if {$ConfusionMatrix == 1} {
    ...
    TextEditorFromWidget .top53 $ConfusionMatrixFile
    }
}} \
        -padx 4 -pady 2 -text {CM Editor} 
    vTcl:DefineAlias "$site_6_0.but31" "Button53_1" vTcl:WidgetProc "Toplevel53" 1
...
if {$ConfusionMatrix == 1} {
    ...
    vTcl:DefineAlias "$site_6_0.but22" "Button53_2" vTcl:WidgetProc "Toplevel53" 1
    ...
    vTcl:DefineAlias "$top.cpd100" "TitleFrame2" vTcl:WidgetProc "Toplevel53" 1
    ...
    frame $site_4_0.fra90 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra90" "Frame2" vTcl:WidgetProc "Toplevel53" 1
    set site_5_0 $site_4_0.fra90
    frame $site_5_0.fra91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra91" "Frame8" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.fra91
    label $site_6_0.cpd95 \
        -text {ColorMap 16} 
    vTcl:DefineAlias "$site_6_0.cpd95" "Label126" vTcl:WidgetProc "Toplevel53" 1
    pack $site_6_0.cpd95 \
        -in $site_6_0 -anchor center -expand 1 -fill none -side top 
    frame $site_5_0.fra92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra92" "Frame10" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.fra92
...
if {$FileName != ""} {
    set ColorMapSupervised16 $FileName
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.but80" "Button1" vTcl:WidgetProc "Toplevel53" 1
...
WidgetShowFromWidget $widget(Toplevel53) $widget(Toplevel38); TextEditorRunTrace "Open Window Colormap" "b"
...
if {"$VarColorMap"=="ok"} {
   set ColorMapSupervised16 $ColorMapOut
    ...
    vTcl:DefineAlias "$site_6_0.cpd102" "Button42" vTcl:WidgetProc "Toplevel53" 1
    ...
    frame $site_5_0.fra93 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra93" "Frame11" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.fra93
    entry $site_6_0.cpd97 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable ColorMapSupervised16 -width 40 
    vTcl:DefineAlias "$site_6_0.cpd97" "Entry53" vTcl:WidgetProc "Toplevel53" 1
    pack $site_6_0.cpd97 \
    ...
    frame $site_4_0.cpd101 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd101" "Frame660" vTcl:WidgetProc "Toplevel53" 1
    set site_5_0 $site_4_0.cpd101
...
if {$ColorMapSupervisedCoded == "1"} {
    $widget(Checkbutton53_1) configure -state normal
    $widget(Checkbutton53_2) configure -state normal
    $widget(Label53_1) configure -state normal
    $widget(Label53_2) configure -state normal
    $widget(Label53_3) configure -state normal
    $widget(Label53_4) configure -state normal
    $widget(Label53_5) configure -state normal
    $widget(Label53_6) configure -state normal
    }} \
        -text {Coded Colormap} -variable ColorMapSupervisedCoded 
    vTcl:DefineAlias "$site_5_0.che24" "Checkbutton638" vTcl:WidgetProc "Toplevel53" 1
    frame $site_5_0.fra25 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra25" "Frame70" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.fra25
    frame $site_6_0.fra38 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra38" "Frame87" vTcl:WidgetProc "Toplevel53" 1
    set site_7_0 $site_6_0.fra38
    checkbutton $site_7_0.che29 \
        -text {Pauli    } -variable ColorMapSupervisedCodedPauli 
    vTcl:DefineAlias "$site_7_0.che29" "Checkbutton53_1" vTcl:WidgetProc "Toplevel53" 1
    checkbutton $site_7_0.che31 \
        -text Sinclair -variable ColorMapSupervisedCodedSinclair 
    vTcl:DefineAlias "$site_7_0.che31" "Checkbutton53_2" vTcl:WidgetProc "Toplevel53" 1
    pack $site_7_0.che29 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side top 
    pack $site_7_0.che31 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side top 
    frame $site_6_0.fra39 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra39" "Frame88" vTcl:WidgetProc "Toplevel53" 1
    set site_7_0 $site_6_0.fra39
    frame $site_7_0.fra42 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.fra42" "Frame71" vTcl:WidgetProc "Toplevel53" 1
    set site_8_0 $site_7_0.fra42
    label $site_8_0.lab47 \
        -foreground #0000ff -text |S11+S22| 
    vTcl:DefineAlias "$site_8_0.lab47" "Label53_1" vTcl:WidgetProc "Toplevel53" 1
    label $site_8_0.lab48 \
        -foreground #008000 -text |S12+S21| 
    vTcl:DefineAlias "$site_8_0.lab48" "Label53_2" vTcl:WidgetProc "Toplevel53" 1
    label $site_8_0.lab49 \
        -foreground #ff0000 -text |S11-S22| 
    vTcl:DefineAlias "$site_8_0.lab49" "Label53_3" vTcl:WidgetProc "Toplevel53" 1
    pack $site_8_0.lab47 \
    ...
    frame $site_7_0.fra43 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.fra43" "Frame72" vTcl:WidgetProc "Toplevel53" 1
    set site_8_0 $site_7_0.fra43
    label $site_8_0.lab52 \
        -foreground #0000ff -text |S11| 
    vTcl:DefineAlias "$site_8_0.lab52" "Label53_4" vTcl:WidgetProc "Toplevel53" 1
    label $site_8_0.lab53 \
        -foreground #008000 -text |(S12+S21)/2| 
    vTcl:DefineAlias "$site_8_0.lab53" "Label53_5" vTcl:WidgetProc "Toplevel53" 1
    label $site_8_0.lab54 \
        -foreground #ff0000 -text |S22| 
    vTcl:DefineAlias "$site_8_0.lab54" "Label53_6" vTcl:WidgetProc "Toplevel53" 1
    pack $site_8_0.lab52 \
        -in $site_8_0 -anchor center -expand 0 -fill none -side left 
    pack $site_8_0.lab53 \
        -in $site_8_0 -anchor center -expand 0 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.cpd103" "TitleFrame1" vTcl:WidgetProc "Toplevel53" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd93" "Frame270" vTcl:WidgetProc "Toplevel53" 1
    set site_5_0 $site_4_0.cpd93
    label $site_5_0.lab42 \
        -text {Areas File  } 
    vTcl:DefineAlias "$site_5_0.lab42" "Label275" vTcl:WidgetProc "Toplevel53" 1
    entry $site_5_0.ent44 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable FileTrainingArea 
    vTcl:DefineAlias "$site_5_0.ent44" "Entry188" vTcl:WidgetProc "Toplevel53" 1
    frame $site_5_0.cpd94 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd94" "Frame22" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.cpd94
...
if {$FileName != ""} {
    ...
    if {$tmp == "NB_TRAINING_CLASSES"} {
        ...
        $widget(Button53_3) configure -state normal     
        } else {
        ...
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd105" "Button19" vTcl:WidgetProc "Toplevel53" 1
    ...
    frame $site_4_0.cpd106 \
        -borderwidth 2 -height 123 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd106" "Frame279" vTcl:WidgetProc "Toplevel53" 1
    set site_5_0 $site_4_0.cpd106
    frame $site_5_0.fra23 \
        -borderwidth 2 -height 123 -width 125 
    vTcl:DefineAlias "$site_5_0.fra23" "Frame474" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.fra23
...
if {"$VarTrainingArea"=="no"} {
    ...
    vTcl:DefineAlias "$site_6_0.but67" "Button642" vTcl:WidgetProc "Toplevel53" 1
...
if {"$VarWarning"=="ok"} {
    ...
    set f [ open "| Soft/bin/data_process_sngl/wishart_training_set_sampler.exe -id \x22$SupervisedDirInput\x22 -od \x22$SupervisedDirOutput\x22 -iodf $SupervisedF -af \x22$FileTrainingArea\x22 -cf \x22$FileTrainingSet\x22 -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
    PsPprogressBar $f
    TextEditorRunTrace "Check RunTime Errors" "r"
    CheckRunTimeError
    WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
    $widget(Button53_4) configure -state normal
    }
    } else {
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel53); TextEditorRunTrace "Close Window Wishart Supervised Classification" "b"}
    }
}} \
        -padx 4 -pady 2 -text {Run Training Process} 
    vTcl:DefineAlias "$site_5_0.but68" "Button53_3" vTcl:WidgetProc "Toplevel53" 1
    ...
    frame $site_4_0.cpd107 \
        -relief groove -height 77 -width 437 
    vTcl:DefineAlias "$site_4_0.cpd107" "Frame271" vTcl:WidgetProc "Toplevel53" 1
    set site_5_0 $site_4_0.cpd107
    label $site_5_0.lab42 \
        -text {  Set File     } 
    vTcl:DefineAlias "$site_5_0.lab42" "Label276" vTcl:WidgetProc "Toplevel53" 1
    entry $site_5_0.ent44 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable FileTrainingSet 
    vTcl:DefineAlias "$site_5_0.ent44" "Entry189" vTcl:WidgetProc "Toplevel53" 1
    frame $site_5_0.cpd94 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd94" "Frame23" vTcl:WidgetProc "Toplevel53" 1
    set site_6_0 $site_5_0.cpd94
...
if {$FileName != ""} {
    ...
    if [file exists $FileTrainingArea] {
        ...
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd108" "Button20" vTcl:WidgetProc "Toplevel53" 1
    ...
    vTcl:DefineAlias "$top.fra59" "Frame20" vTcl:WidgetProc "Toplevel53" 1
...
global SupervisedClusterFonction SupervisedClassifierFonction SupervisedClassifierConfusionMatrixFonction PSPViewGimpBMP
...
if {"$VarWarning"=="ok"} {
    ...
    if [file exists $FileTrainingSet] {
        ...
        if {$ConfusionMatrix == "1"} {
            ...
            if {$RejectClass == "1"} {
                ...
                CheckRunTimeError
                WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
                $widget(Button53_2) configure -state normal
                }
            $widget(Button53_1) configure -state normal
            }        
        if {$ColorMapSupervisedCoded == "1"} {
            set ClassificationFile "$SupervisedDirOutput/wishart_supervised_class_"
            append ClassificationFile $NwinSupervisedL; append ClassificationFile "x"; append ClassificationFile $NwinSupervisedC
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button53_4" vTcl:WidgetProc "Toplevel53" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/WishartSupervisedClassification.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel53" 1
...
if {$OpenDirFile == 0} {
    ...
    Window hide $widget(Toplevel53); TextEditorRunTrace "Close Window Wishart Supervised Classification" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel53" 1
