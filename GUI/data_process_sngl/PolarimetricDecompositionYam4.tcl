...
if {"$config"=="true"} {
    if {"$VarWarning"=="ok"} {
        ...
        if {"$DecompFonction"=="Yamaguchi4"} {
            ...
            TextEditorRunTrace "Arguments: -id \x22$DecompDirInput\x22 -od \x22$DecompDirOutput\x22 -iodf $DecompDecompositionFonction -mod $DecompYam4Final -nwr $NwinDecompL -nwc $NwinDecompC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/data_process_sngl/yamaguchi_4components_decomposition.exe -id \x22$DecompDirInput\x22 -od \x22$DecompDirOutput\x22 -iodf $DecompDecompositionFonction -mod $DecompYam4Final -nwr $NwinDecompL -nwc $NwinDecompC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
        ...
        if {"$DecompFonction"=="Singh4"} {
            ...
            TextEditorRunTrace "Arguments: -id \x22$DecompDirInput\x22 -od \x22$DecompDirOutput\x22 -iodf $DecompDecompositionFonction -mod $DecompYam4Final -nwr $NwinDecompL -nwc $NwinDecompC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/data_process_sngl/singh_4components_decomposition.exe -id \x22$DecompDirInput\x22 -od \x22$DecompDirOutput\x22 -iodf $DecompDecompositionFonction -mod $DecompYam4Final -nwr $NwinDecompL -nwc $NwinDecompC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
            if {$DecompYam4Final == "G4U1"} {
                if [file exists "$DecompDirOutput/Singh4_G4U1_Odd.bin"] {EnviWriteConfig "$DecompDirOutput/Singh4_G4U1_Odd.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh4_G4U1_Dbl.bin"] {EnviWriteConfig "$DecompDirOutput/Singh4_G4U1_Dbl.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh4_G4U1_Vol.bin"] {EnviWriteConfig "$DecompDirOutput/Singh4_G4U1_Vol.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh4_G4U1_Hlx.bin"] {EnviWriteConfig "$DecompDirOutput/Singh4_G4U1_Hlx.bin" $FinalNlig $FinalNcol 4}
                } 
        ...
        if {"$DecompFonction"=="Singh6"} {
            set Fonction2 "of the Singh Decomposition"
            set ProgressLine "0"
            WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
            update
            TextEditorRunTrace "Process The Function Soft/bin/data_process_sngl/singh_6components_decomposition.exe" "k"
            ...
            set f [ open "| Soft/bin/data_process_sngl/singh_6components_decomposition.exe -id \x22$DecompDirInput\x22 -od \x22$DecompDirOutput\x22 -iodf $DecompDecompositionFonction -nwr $NwinDecompL -nwc $NwinDecompC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
            if {$DecompYam4Final == "i6SD"} {
                if [file exists "$DecompDirOutput/Singh_i6SD_Odd.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_i6SD_Odd.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_i6SD_Dbl.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_i6SD_Dbl.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_i6SD_Vol.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_i6SD_Vol.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_i6SD_Hlx.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_i6SD_Hlx.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_i6SD_OD.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_i6SD_OD.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Singh_i6SD_CD.bin"] {EnviWriteConfig "$DecompDirOutput/Singh_i6SD_CD.bin" $FinalNlig $FinalNcol 4}
                } 
            }           
        if {"$DecompFonction"=="BhattacharyaFrery4"} {
            set Fonction2 "of the Bhattacharya & Frery Decomposition"
            set ProgressLine "0"
            WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
            update
            TextEditorRunTrace "Process The Function Soft/bin/data_process_sngl/bhattacharya_frery_4components_decomposition.exe" "k"
            TextEditorRunTrace "Arguments: -id \x22$DecompDirInput\x22 -od \x22$DecompDirOutput\x22 -iodf $DecompDecompositionFonction -nwr $NwinDecompL -nwc $NwinDecompC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/data_process_sngl/bhattacharya_frery_4components_decomposition.exe -id \x22$DecompDirInput\x22 -od \x22$DecompDirOutput\x22 -iodf $DecompDecompositionFonction -nwr $NwinDecompL -nwc $NwinDecompC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
            if {$DecompYam4Final == "BF4"} {
                if [file exists "$DecompDirOutput/Bhattacharya_Frery_BF4_Odd.bin"] {EnviWriteConfig "$DecompDirOutput/Bhattacharya_Frery_BF4_Odd.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Bhattacharya_Frery_BF4_Dbl.bin"] {EnviWriteConfig "$DecompDirOutput/Bhattacharya_Frery_BF4_Dbl.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Bhattacharya_Frery_BF4_Vol.bin"] {EnviWriteConfig "$DecompDirOutput/Bhattacharya_Frery_BF4_Vol.bin" $FinalNlig $FinalNcol 4}
                if [file exists "$DecompDirOutput/Bhattacharya_Frery_BF4_Hlx.bin"] {EnviWriteConfig "$DecompDirOutput/Bhattacharya_Frery_BF4_Hlx.bin" $FinalNlig $FinalNcol 4}
                } 
            }
        }
        #TestVar
...
global RGBPolarDecomp TMPDecompDir TMPMemoryAllocError DecompYam4Final
global TestVarError TestVarName TestVarType TestVarValue TestVarMin TestVarMax
global Fonction Fonction2 VarFunction VarWarning WarningMessage WarningMessage2 VarError ErrorMessage ProgressLine 
...
if {"$RGBPolarDecomp"=="1"} {
    if {"$VarWarning"=="ok"} {
        ...
        if {$DecompYam4Final == "i6SD"} {
            set FileInputBlue "$DecompDirOutput/Singh_i6SD_Odd.bin"
            set FileInputGreen "$DecompDirOutput/Singh_i6SD_Vol.bin"
            set FileInputRed "$DecompDirOutput/Singh_i6SD_Dbl.bin"
            set RGBFileOutput "$DecompDirOutput/Singh_i6SD_RGB.bmp"
            }

        if {$DecompYam4Final == "BF4"} {
            set FileInputBlue "$DecompDirOutput/Bhattacharya_Frery_BF4_Odd.bin"
            set FileInputGreen "$DecompDirOutput/Bhattacharya_Frery_BF4_Vol.bin"
            set FileInputRed "$DecompDirOutput/Bhattacharya_Frery_BF4_Dbl.bin"
            set RGBFileOutput "$DecompDirOutput/Bhattacharya_Frery_BF4_RGB.bmp"
            }
        ...
        TextEditorRunTrace "Arguments: -ifb \x22$FileInputBlue\x22 -ifg \x22$FileInputGreen\x22 -ifr \x22$FileInputRed\x22 -of \x22$RGBFileOutput\x22 -inc $FinalNcol -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd -auto 1" "k"
        set f [ open "| Soft/bin/bmp_process/create_rgb_file.exe -ifb \x22$FileInputBlue\x22 -ifg \x22$FileInputGreen\x22 -ifr \x22$FileInputRed\x22 -of \x22$RGBFileOutput\x22 -inc $FinalNcol -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd -auto 1" r]
        PsPprogressBar $f
        TextEditorRunTrace "Check RunTime Errors" "r"
        CheckRunTimeError
...
#############################################################################
## Procedure:  DecompSingh6RGB

proc ::DecompSingh6RGB {} {
global DecompDirInput DecompDirOutput
global DecompDecompositionFonction DecompFonction
global RGBPolarDecomp TMPDecompDir TMPMemoryAllocError DecompYam4Final
global TestVarError TestVarName TestVarType TestVarValue TestVarMin TestVarMax
...
if {"$RGBPolarDecomp"=="1"} {
    if {"$VarWarning"=="ok"} {
        ...
        set FileInputGreen "$DecompDirOutput/Singh_i6SD_Vol.bin"
        set FileInputRed "$DecompDirOutput/Singh_i6SD_Dbl.bin"
        set RGBFileOutput "$DecompDirOutput/Singh_6SD1_RGB.bmp"
        set Fonction2 "$RGBFileOutput"    
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
        ...
        set FileInputBlue "$DecompDirOutput/Singh_i6SD_CD.bin"
        set FileInputGreen "$DecompDirOutput/Singh_i6SD_OD.bin"
        set FileInputRed "$DecompDirOutput/Singh_i6SD_Hlx.bin"
        set RGBFileOutput "$DecompDirOutput/Singh_6SD2_RGB.bmp"
        set Fonction2 "$RGBFileOutput"    
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
        ...
        set FileInputBlue "$DecompDirOutput/Singh_6SD_Blue.bin"
        set FileInputGreen "$DecompDirOutput/Singh_6SD_Green.bin"
        set FileInputRed "$DecompDirOutput/Singh_6SD_Red.bin"
        set RGBFileOutput "$DecompDirOutput/Singh_6SD_RGB.bmp"
        set Fonction2 "$RGBFileOutput"    
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
...
if {"$BMPPolarDecomp"=="1"} {
    if {"$VarWarning"=="ok"} {
        ...
        if {$DecompYam4Final == "i6SD"} {
            set BMPFileInput "$DecompDirOutput/Singh_i6SD_Odd.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_i6SD_Odd_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Singh_i6SD_Dbl.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_i6SD_Dbl_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Singh_i6SD_Vol.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_i6SD_Vol_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Singh_i6SD_Hlx.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_i6SD_Hlx_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Singh_i6SD_OD.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_i6SD_OD_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Singh_i6SD_CD.bin"
            set BMPFileOutput "$DecompDirOutput/Singh_i6SD_CD_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            }

        if {$DecompYam4Final == "BF4"} {
            set BMPFileInput "$DecompDirOutput/Bhattacharya_Frery_BF4_Odd.bin"
            set BMPFileOutput "$DecompDirOutput/Bhattacharya_Frery_BF4_Odd_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Bhattacharya_Frery_BF4_Dbl.bin"
            set BMPFileOutput "$DecompDirOutput/Bhattacharya_Frery_BF4_Dbl_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Bhattacharya_Frery_BF4_Vol.bin"
            set BMPFileOutput "$DecompDirOutput/Bhattacharya_Frery_BF4_Vol_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            set BMPFileInput "$DecompDirOutput/Bhattacharya_Frery_BF4_Hlx.bin"
            set BMPFileOutput "$DecompDirOutput/Bhattacharya_Frery_BF4_Hlx_dB.bmp"
            PSPcreate_bmp_file black $BMPFileInput $BMPFileOutput float db10 gray $FinalNcol  $OffsetLig  $OffsetCol  $FinalNlig  $FinalNcol $MinMaxBMPDecomp $MinBMPDecomp $MaxBMPDecomp
            }
...
#############################################################################
## Procedure:  DecompYam4CIE

proc ::DecompYam4CIE {} {
global DecompDirInput DecompDirOutput
global DecompDecompositionFonction DecompFonction
global CIEPolarDecomp TMPDecompDir TMPMemoryAllocError DecompYam4Final
global TestVarError TestVarName TestVarType TestVarValue TestVarMin TestVarMax
global Fonction Fonction2 VarFunction VarWarning WarningMessage WarningMessage2 VarError ErrorMessage ProgressLine 
global NligInit NligFullSize NcolInit NcolFullSize NligEnd NcolEnd FinalNlig FinalNcol PSPViewGimpBMP
...
if {"$CIEPolarDecomp"=="1"} {
    if {"$VarWarning"=="ok"} {
        ...
        if {$DecompYam4Final == "Y4O"} {
            set FileInputOdd "$DecompDirOutput/Yamaguchi4_Y4O_Odd.bin"
            set FileInputVol "$DecompDirOutput/Yamaguchi4_Y4O_Vol.bin"
            set FileInputDbl "$DecompDirOutput/Yamaguchi4_Y4O_Dbl.bin"
            set FileInputHlx "$DecompDirOutput/Yamaguchi4_Y4O_Hlx.bin"
            set RGBFileOutput "$DecompDirOutput/Yamaguchi4_Y4O_CIE-Lab.bmp"
            }

        if {$DecompYam4Final == "Y4R"} {
            set FileInputOdd "$DecompDirOutput/Yamaguchi4_Y4R_Odd.bin"
            set FileInputVol "$DecompDirOutput/Yamaguchi4_Y4R_Vol.bin"
            set FileInputDbl "$DecompDirOutput/Yamaguchi4_Y4R_Dbl.bin"
            set FileInputHlx "$DecompDirOutput/Yamaguchi4_Y4R_Hlx.bin"
            set RGBFileOutput "$DecompDirOutput/Yamaguchi4_Y4R_CIE-Lab.bmp"
            }

        if {$DecompYam4Final == "S4R"} {
            set FileInputOdd "$DecompDirOutput/Yamaguchi4_S4R_Odd.bin"
            set FileInputVol "$DecompDirOutput/Yamaguchi4_S4R_Vol.bin"
            set FileInputDbl "$DecompDirOutput/Yamaguchi4_S4R_Dbl.bin"
            set FileInputHlx "$DecompDirOutput/Yamaguchi4_S4R_Hlx.bin"
            set RGBFileOutput "$DecompDirOutput/Yamaguchi4_S4R_CIE-Lab.bmp"
            }

        if {$DecompYam4Final == "G4U1"} {
            set FileInputOdd "$DecompDirOutput/Singh4_G4U1_Odd.bin"
            set FileInputVol "$DecompDirOutput/Singh4_G4U1_Vol.bin"
            set FileInputDbl "$DecompDirOutput/Singh4_G4U1_Dbl.bin"
            set FileInputHlx "$DecompDirOutput/Singh4_G4U1_Hlx.bin"
            set RGBFileOutput "$DecompDirOutput/Singh4_G4U1_CIE-Lab.bmp"
            }

        if {$DecompYam4Final == "G4U2"} {
            set FileInputOdd "$DecompDirOutput/Singh4_G4U2_Odd.bin"
            set FileInputVol "$DecompDirOutput/Singh4_G4U2_Vol.bin"
            set FileInputDbl "$DecompDirOutput/Singh4_G4U2_Dbl.bin"
            set FileInputHlx "$DecompDirOutput/Singh4_G4U2_Hlx.bin"
            set RGBFileOutput "$DecompDirOutput/Singh4_G4U2_CIE-Lab.bmp"
            }

        if {$DecompYam4Final == "i6SD"} {
            set FileInputOdd "$DecompDirOutput/Singh_i6SD_Odd.bin"
            set FileInputVol "$DecompDirOutput/Singh_i6SD_Vol.bin"
            set FileInputDbl "$DecompDirOutput/Singh_i6SD_Dbl.bin"
            set FileInputHlx "$DecompDirOutput/Singh_i6SD_Hlx.bin"
            set RGBFileOutput "$DecompDirOutput/Singh_i6SD_CIE-Lab.bmp"
            }

        if {$DecompYam4Final == "BF4"} {
            set FileInputOdd "$DecompDirOutput/Bhattacharya_Frery_BF4_Odd.bin"
            set FileInputVol "$DecompDirOutput/Bhattacharya_Frery_BF4_Vol.bin"
            set FileInputDbl "$DecompDirOutput/Bhattacharya_Frery_BF4_Dbl.bin"
            set FileInputHlx "$DecompDirOutput/Bhattacharya_Frery_BF4_Hlx.bin"
            set RGBFileOutput "$DecompDirOutput/Bhattacharya_Frery_BF4_CIE-Lab.bmp"
            }
        ...
        TextEditorRunTrace "Arguments: -ifo \x22$FileInputOdd\x22 -ifd \x22$FileInputDbl\x22 -ifv \x22$FileInputVol\x22 -ifh \x22$FileInputHlx\x22 -of \x22$RGBFileOutput\x22 -inr $FinalNlig -inc $FinalNcol -lv 0.01 -lab 15.0 -bin 32768 -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
        set f [ open "| Soft/bin/bmp_process/create_cielab_file.exe -ifo \x22$FileInputOdd\x22 -ifd \x22$FileInputDbl\x22 -ifv \x22$FileInputVol\x22 -ifh \x22$FileInputHlx\x22 -of \x22$RGBFileOutput\x22 -inr $FinalNlig -inc $FinalNcol -lv 0.01 -lab 15.0 -bin 32768 -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
        PsPprogressBar $f
        TextEditorRunTrace "Check RunTime Errors" "r"
        CheckRunTimeError
        set BMPDirInput $DecompDirOutput
...
proc vTclWindow.top426 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 500x497+10+110; update
...
if {$DirName != ""} {
    ...
    entry $site_3_0.ent25 \
		-background white -disabledbackground {#ffffff} \
		-disabledforeground {#0000ff} -foreground {#0000ff} -justify center \
		-state disabled -textvariable DecompType -width 60 
...
$widget(TitleFrame426_4) configure -state disable
...
set DecompYam4 "Y4R"
$widget(TitleFrame426_4) configure -state normal
...
#    set DecompOutputDir $DecompDirOutput
    ...
    frame $site_4_0.cpd68 \
		-height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd68" "Frame21" vTcl:WidgetProc "Toplevel426" 1
    set site_5_0 $site_4_0.cpd68
    radiobutton $site_5_0.rad69 \
		\
		-command {global DecompDirOutput DecompDirOutputTmp DecompOutputDir
...
set DecompVolume 0
set DecompYam4Final "i6SD"} \
		-text {Six Component Decomposition ( i6SD )} -value i6SD \
		-variable DecompYam4 
    vTcl:DefineAlias "$site_5_0.rad69" "Radiobutton426_5" vTcl:WidgetProc "Toplevel426" 1
    pack $site_5_0.rad69 \
		-in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.cpd70 \
		-in $site_4_0 -anchor center -expand 0 -fill x -side top 
    ...
    TitleFrame $top.cpd67 \
		-ipad 2 -text {Bhattacharya & Frery Decomposition} 
    vTcl:DefineAlias "$top.cpd67" "TitleFrame426_3" vTcl:WidgetProc "Toplevel426" 1
    ...
    frame $site_4_0.fra68 \
		-height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra68" "Frame8" vTcl:WidgetProc "Toplevel426" 1
    set site_5_0 $site_4_0.fra68
    radiobutton $site_5_0.rad69 \
		\
		-command {global DecompDirOutput DecompDirOutputTmp DecompOutputDir
...
#set DecompDirOutput $DecompDirOutputTmp; append DecompDirOutput "_BF4"
set DecompOutputDir $DecompDirOutput
set DecompYam4 "BF4"
set DecompYam4Final "BF4"
$widget(TitleFrame426_4) configure -state disable
$widget(Checkbutton426_2) configure -state disable} \
		-text {Four Component Decomposition with stochastic distance} \
		-value BF4 -variable DecompYam4 
    vTcl:DefineAlias "$site_5_0.rad69" "Radiobutton426_4" vTcl:WidgetProc "Toplevel426" 1
    pack $site_5_0.rad69 \
		-in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.fra68 \
		-in $site_4_0 -anchor center -expand 0 -fill x -side top 
    ...
    vTcl:DefineAlias "$top.tit67" "TitleFrame426_4" vTcl:WidgetProc "Toplevel426" 1
...
set MaxBMPDecomp "Auto"
    ...
    frame $site_5_0.cpd44 \
		-borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd44" "Frame442" vTcl:WidgetProc "Toplevel426" 1
    set site_6_0 $site_5_0.cpd44
    label $site_6_0.lab79 \
		-foreground {#008000} \
		-image [vTcl:image:get_image [file join . GUI Images CIE-lab.gif]] \
		-text . 
    vTcl:DefineAlias "$site_6_0.lab79" "Label426_4" vTcl:WidgetProc "Toplevel426" 1
    bindtags $site_6_0.lab79 "$site_6_0.lab79 Label $top all _vTclBalloon"
    bind $site_6_0.lab79 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Target Generators RGB Image}
    }
    checkbutton $site_6_0.che78 \
		-foreground {#000000} -text CIE-Lab -variable CIEPolarDecomp 
    vTcl:DefineAlias "$site_6_0.che78" "Checkbutton426_4" vTcl:WidgetProc "Toplevel426" 1
    bindtags $site_6_0.che78 "$site_6_0.che78 Checkbutton $top all _vTclBalloon"
    bind $site_6_0.che78 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Target Generators CIE-Lab RGB Image}
    }
    pack $site_6_0.lab79 \
		-in $site_6_0 -anchor center -expand 0 -fill x -side left 
    pack $site_6_0.che78 \
...
global Fonction Fonction2 VarFunction VarWarning WarningMessage WarningMessage2 VarError ErrorMessage ProgressLine 
global DecompDecompositionFonction DecompFonction PolarDecomp RGBDecomp CIEDecomp BMPDecomp OpenDirFile
...
set config "false"
if {"$RGBPolarDecomp"=="1"} { set config "true" }
if {"$CIEPolarDecomp"=="1"} { set config "true" }
if {"$BMPPolarDecomp"=="1"} { set config "true" }
if {"$config"=="true"} {
    set TestVarErrorTGT ""
    DecompYam4TGT
    ...
    $widget(Checkbutton426_4) configure -state normal
    $widget(Label426_4) configure -state normal
