...
proc vTclWindow.top248a {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel248a" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.tit71" "TitleFrame1" vTcl:WidgetProc "Toplevel248a" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd72" "Entry248a_149" vTcl:WidgetProc "Toplevel248a" 1
    frame $site_4_0.cpd75 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd75" "Frame16" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.cpd75
    entry $site_5_0.cpd73 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SubAptSubNum -width 2 
    vTcl:DefineAlias "$site_5_0.cpd73" "Entry5" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_5_0.cpd73 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    frame $site_4_0.cpd76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd76" "Frame17" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.cpd76
    label $site_5_0.lab73 \
        -text / 
    vTcl:DefineAlias "$site_5_0.lab73" "Label2" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_5_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SubAptSubDir -width 3 
    vTcl:DefineAlias "$site_5_0.cpd75" "Entry6" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_5_0.lab73 \
    ...
    frame $site_4_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame1" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.cpd74
    button $site_5_0.but75 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_5_0.but75" "Button1" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_5_0.but75 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    pack $site_4_0.cpd72 \
    ...
    vTcl:DefineAlias "$top.tit76" "TitleFrame2" vTcl:WidgetProc "Toplevel248a" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd82" "Entry248a_73" vTcl:WidgetProc "Toplevel248a" 1
    frame $site_4_0.cpd71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd71" "Frame15" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.cpd71
    entry $site_5_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SubAptOutputDirSub -width 5 
    vTcl:DefineAlias "$site_5_0.cpd75" "Entry2" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_5_0.cpd73 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SubAptSubNum -width 2 
    vTcl:DefineAlias "$site_5_0.cpd73" "Entry3" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_5_0.cpd75 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd73 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    frame $site_4_0.cpd72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd72" "Frame13" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.cpd72
    label $site_5_0.lab73 \
        -text / 
    vTcl:DefineAlias "$site_5_0.lab73" "Label1" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_5_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SubAptSubDir -width 3 
    vTcl:DefineAlias "$site_5_0.cpd75" "Entry1" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_5_0.lab73 \
        -in $site_5_0 -anchor center -expand 1 -fill x -side left 
    pack $site_5_0.cpd75 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    frame $site_4_0.cpd84 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd84" "Frame2" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.cpd84
...
if {$DirName != "" } {
    ...
    set SubAptOutputDir $BSubAptOutputDirTmp
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd85" "Button248a_92" vTcl:WidgetProc "Toplevel248a" 1
    ...
    vTcl:DefineAlias "$top.fra74" "Frame9" vTcl:WidgetProc "Toplevel248a" 1
    set site_3_0 $top.fra74
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label248a_01" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry248a_01" vTcl:WidgetProc "Toplevel248a" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label248a_02" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry248a_02" vTcl:WidgetProc "Toplevel248a" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label248a_03" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry248a_03" vTcl:WidgetProc "Toplevel248a" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label248a_04" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry248a_04" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.tit77" "TitleFrame3" vTcl:WidgetProc "Toplevel248a" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd83" "Frame218" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.cpd83
    label $site_5_0.lab23 \
        -padx 1 -text {Nb of Sub-Apertures} 
    vTcl:DefineAlias "$site_5_0.lab23" "Label248a_11" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_5_0.ent24 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SubAptSubIm -width 5 
    vTcl:DefineAlias "$site_5_0.ent24" "Entry248a_5" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_5_0.lab23 \
    ...
    frame $site_4_0.cpd82 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_4_0.cpd82" "Frame215" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.cpd82
    label $site_5_0.lab23 \
        -padx 1 -text {Initial Sub-Aperture} 
    vTcl:DefineAlias "$site_5_0.lab23" "Label248a_12" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_5_0.ent24 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable SubAptInit -width 5 
    vTcl:DefineAlias "$site_5_0.ent24" "Entry248a_6" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_5_0.lab23 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 10 -side left 
    pack $site_5_0.ent24 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    frame $site_4_0.cpd74 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame217" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.cpd74
    label $site_5_0.lab23 \
        -padx 1 -text {Final Sub-Aperture} 
    vTcl:DefineAlias "$site_5_0.lab23" "Label248a_13" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_5_0.ent24 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable SubAptFin -width 5 
    vTcl:DefineAlias "$site_5_0.ent24" "Entry248a_7" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_5_0.lab23 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 10 -side left 
    pack $site_5_0.ent24 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.cpd73" "TitleFrame4" vTcl:WidgetProc "Toplevel248a" 1
    ...
    checkbutton $site_4_0.cpd79 \
        \
        -command {global SubAptBMP SubAptComp1 SubAptComp2 SubAptSpan

if {"$SubAptBMP"=="0"} {
    set SubAptComp1 0
    set SubAptComp2 0
    set SubAptSpan 0
    $widget(Checkbutton248a_2) configure -state disable
    $widget(Checkbutton248a_3) configure -state disable
    $widget(Checkbutton248a_4) configure -state disable
    $widget(Label248a_1) configure -state disable
    $widget(Label248a_2) configure -state disable
    $widget(Label248a_3) configure -state disable
    $widget(Label248a_4) configure -state disable
    $widget(Label248a_5) configure -state disable
    $widget(Label248a_6) configure -state disable
    } else {
    $widget(Checkbutton248a_2) configure -state normal
    $widget(Checkbutton248a_3) configure -state normal
    $widget(Checkbutton248a_4) configure -state normal
    $widget(Label248a_1) configure -state normal
    $widget(Label248a_2) configure -state normal
    $widget(Label248a_3) configure -state normal
    $widget(Label248a_4) configure -state normal
    $widget(Label248a_5) configure -state normal
    $widget(Label248a_6) configure -state normal
    }} \
        -variable SubAptBMP 
    vTcl:DefineAlias "$site_4_0.cpd79" "Checkbutton248a_1" vTcl:WidgetProc "Toplevel248a" 1
    frame $site_4_0.fra89 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra89" "Frame26" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.fra89
    frame $site_5_0.fra90 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra90" "Frame27" vTcl:WidgetProc "Toplevel248a" 1
    set site_6_0 $site_5_0.fra90
    checkbutton $site_6_0.che75 \
        -text {RGB Color Composition 1} -variable SubAptComp1 
    vTcl:DefineAlias "$site_6_0.che75" "Checkbutton248a_2" vTcl:WidgetProc "Toplevel248a" 1
    frame $site_6_0.fra76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra76" "Frame29" vTcl:WidgetProc "Toplevel248a" 1
    set site_7_0 $site_6_0.fra76
    label $site_7_0.lab77 \
        -foreground #0000ff -text {|Channel 1|} 
    vTcl:DefineAlias "$site_7_0.lab77" "Label248a_1" vTcl:WidgetProc "Toplevel248a" 1
    label $site_7_0.lab78 \
        -foreground #009900 -text {|Channel 1 - Channel 2|} 
    vTcl:DefineAlias "$site_7_0.lab78" "Label248a_2" vTcl:WidgetProc "Toplevel248a" 1
    label $site_7_0.lab79 \
        -foreground #ff0000 -text {|Channel 2|} 
    vTcl:DefineAlias "$site_7_0.lab79" "Label248a_3" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_7_0.lab77 \
    ...
    frame $site_5_0.cpd80 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd80" "Frame30" vTcl:WidgetProc "Toplevel248a" 1
    set site_6_0 $site_5_0.cpd80
    checkbutton $site_6_0.che75 \
        -text {RGB Color Composition 2} -variable SubAptComp2 
    vTcl:DefineAlias "$site_6_0.che75" "Checkbutton248a_3" vTcl:WidgetProc "Toplevel248a" 1
    frame $site_6_0.fra76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra76" "Frame31" vTcl:WidgetProc "Toplevel248a" 1
    set site_7_0 $site_6_0.fra76
    label $site_7_0.lab77 \
        -foreground #0000ff -text {|Channel 2|} 
    vTcl:DefineAlias "$site_7_0.lab77" "Label248a_4" vTcl:WidgetProc "Toplevel248a" 1
    label $site_7_0.lab78 \
        -foreground #009900 -text {|Channel 1 - Channel 2|} 
    vTcl:DefineAlias "$site_7_0.lab78" "Label248a_5" vTcl:WidgetProc "Toplevel248a" 1
    label $site_7_0.lab79 \
        -foreground #ff0000 -text {|Channel 1|} 
    vTcl:DefineAlias "$site_7_0.lab79" "Label248a_6" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_7_0.lab77 \
        -in $site_7_0 -anchor center -expand 1 -fill none -side left 
    pack $site_7_0.lab78 \
        -in $site_7_0 -anchor center -expand 1 -fill none -side left 
    ...
    vTcl:DefineAlias "$site_4_0.che81" "Checkbutton248a_4" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_4_0.cpd79 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.fra89 \
        -in $site_4_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.fra82 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra82" "Frame6" vTcl:WidgetProc "Toplevel248a" 1
...
if {"$SubAptHAAlp"=="0"} {
    ...
    $widget(Label248a_7a) configure -state disable
    $widget(Entry248a_1a) configure -state disable
    set SubAptHAAlpNwinC ""
    $widget(Label248a_7b) configure -state disable
    $widget(Entry248a_1b) configure -state disable
    } else {
    set SubAptHAAlpNwinL "?"
    $widget(Label248a_7a) configure -state normal
    $widget(Entry248a_1a) configure -state normal
    set SubAptHAAlpNwinC "?"
    $widget(Label248a_7b) configure -state normal
    $widget(Entry248a_1b) configure -state normal
    }} \
        -text {H / A / Alpha Decomposition + Span (lin)} \
        -variable SubAptHAAlp 
    vTcl:DefineAlias "$site_3_0.che83" "Checkbutton248a_5" vTcl:WidgetProc "Toplevel248a" 1
    frame $site_3_0.cpd84 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_3_0.cpd84" "Frame244" vTcl:WidgetProc "Toplevel248a" 1
    set site_4_0 $site_3_0.cpd84
    label $site_4_0.lab23 \
        -padx 1 -text {Window Size Col} 
    vTcl:DefineAlias "$site_4_0.lab23" "Label248a_7b" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_4_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable SubAptHAAlpNwinC -width 5 
    vTcl:DefineAlias "$site_4_0.ent24" "Entry248a_1b" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_4_0.lab23 \
    ...
    frame $site_3_0.cpd66 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_3_0.cpd66" "Frame247" vTcl:WidgetProc "Toplevel248a" 1
    set site_4_0 $site_3_0.cpd66
    label $site_4_0.lab23 \
        -padx 1 -text {Window Size Row} 
    vTcl:DefineAlias "$site_4_0.lab23" "Label248a_7a" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_4_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable SubAptHAAlpNwinL -width 5 
    vTcl:DefineAlias "$site_4_0.ent24" "Entry248a_1a" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_4_0.lab23 \
        -in $site_4_0 -anchor center -expand 0 -fill none -padx 2 -side left 
    pack $site_4_0.ent24 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.tit92" "TitleFrame5" vTcl:WidgetProc "Toplevel248a" 1
    ...
    frame $site_4_0.fra72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra72" "Frame5" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.fra72
...
if {"$SubAptCVH"=="1"} {
    set SubAptCVNwinL "?"
    $widget(Label248a_8a) configure -state normal
    $widget(Entry248a_2a) configure -state normal
    set SubAptCVNwinC "?"
    $widget(Label248a_8b) configure -state normal
    $widget(Entry248a_2b) configure -state normal
    } else {
    set config "false"
    ...
    if {$config == "false"} {
        set SubAptCVNwinL ""
        $widget(Label248a_8a) configure -state disable
        $widget(Entry248a_2a) configure -state disable
        set SubAptCVNwinC ""
        $widget(Label248a_8b) configure -state disable
        $widget(Entry248a_2b) configure -state disable
        }
    }} \
        -text {Entropy (H)} -variable SubAptCVH 
    vTcl:DefineAlias "$site_5_0.cpd73" "Checkbutton248a_6" vTcl:WidgetProc "Toplevel248a" 1
...
if {"$SubAptCVAlp"=="1"} {
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Checkbutton248a_7" vTcl:WidgetProc "Toplevel248a" 1
...
if {"$SubAptCVA"=="1"} {
    ...
    vTcl:DefineAlias "$site_5_0.cpd86" "Checkbutton248a_8" vTcl:WidgetProc "Toplevel248a" 1
...
if {"$SubAptCVSpan"=="1"} {
    ...
    vTcl:DefineAlias "$site_5_0.cpd87" "Checkbutton248a_9" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_5_0.cpd73 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd85 \
    ...
    frame $site_4_0.cpd67 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd67" "Frame7" vTcl:WidgetProc "Toplevel248a" 1
    set site_5_0 $site_4_0.cpd67
    frame $site_5_0.cpd75 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_5_0.cpd75" "Frame248a" vTcl:WidgetProc "Toplevel248a" 1
    set site_6_0 $site_5_0.cpd75
    label $site_6_0.lab23 \
        -padx 1 -text {Window Size Row} 
    vTcl:DefineAlias "$site_6_0.lab23" "Label248a_8a" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_6_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable SubAptCVNwinL -width 5 
    vTcl:DefineAlias "$site_6_0.ent24" "Entry248a_2a" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_6_0.lab23 \
    ...
    frame $site_5_0.cpd68 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_5_0.cpd68" "Frame249" vTcl:WidgetProc "Toplevel248a" 1
    set site_6_0 $site_5_0.cpd68
    label $site_6_0.lab23 \
        -padx 1 -text {Window Size Col} 
    vTcl:DefineAlias "$site_6_0.lab23" "Label248a_8b" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_6_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable SubAptCVNwinC -width 5 
    vTcl:DefineAlias "$site_6_0.ent24" "Entry248a_2b" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_6_0.lab23 \
        -in $site_6_0 -anchor center -expand 0 -fill none -padx 2 -side left 
    pack $site_6_0.ent24 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    ...
    frame $top.cpd88 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd88" "Frame8" vTcl:WidgetProc "Toplevel248a" 1
...
if {"$SubAptNSM"=="0"} {
    set SubAptNSMNwinL ""
    $widget(Label248a_9a) configure -state disable
    $widget(Entry248a_3a) configure -state disable
    set SubAptNSMNwinC ""
    $widget(Label248a_9b) configure -state disable
    $widget(Entry248a_3b) configure -state disable
    set SubAptNSMNlook ""
    $widget(Label248a_10) configure -state disable
    $widget(Entry248a_4) configure -state disable
    } else {
    set SubAptNSMNwinL "?"
    $widget(Label248a_9a) configure -state normal
    $widget(Entry248a_3a) configure -state normal
    set SubAptNSMNwinC "?"
    $widget(Label248a_9b) configure -state normal
    $widget(Entry248a_3b) configure -state normal
    set SubAptNSMNlook "?"
    $widget(Label248a_10) configure -state normal
    $widget(Entry248a_4) configure -state normal
    }} \
        -text {Non Stationary Map} -variable SubAptNSM 
    vTcl:DefineAlias "$site_3_0.che83" "Checkbutton248a_10" vTcl:WidgetProc "Toplevel248a" 1
    frame $site_3_0.cpd84 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_3_0.cpd84" "Frame245" vTcl:WidgetProc "Toplevel248a" 1
    set site_4_0 $site_3_0.cpd84
    label $site_4_0.lab23 \
        -padx 1 -text {Window Size Col} 
    vTcl:DefineAlias "$site_4_0.lab23" "Label248a_9b" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_4_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable SubAptNSMNwinC -width 5 
    vTcl:DefineAlias "$site_4_0.ent24" "Entry248a_3b" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_4_0.lab23 \
        -in $site_4_0 -anchor center -expand 0 -fill none -padx 2 -side left 
    pack $site_4_0.ent24 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    frame $site_3_0.cpd71 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_3_0.cpd71" "Frame246" vTcl:WidgetProc "Toplevel248a" 1
    set site_4_0 $site_3_0.cpd71
    label $site_4_0.lab23 \
        -padx 1 -text {Nb of Looks} 
    vTcl:DefineAlias "$site_4_0.lab23" "Label248a_10" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_4_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable SubAptNSMNlook -width 5 
    vTcl:DefineAlias "$site_4_0.ent24" "Entry248a_4" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_4_0.lab23 \
        -in $site_4_0 -anchor center -expand 0 -fill none -padx 2 -side left 
    pack $site_4_0.ent24 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    frame $site_3_0.cpd69 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_3_0.cpd69" "Frame250" vTcl:WidgetProc "Toplevel248a" 1
    set site_4_0 $site_3_0.cpd69
    label $site_4_0.lab23 \
        -padx 1 -text {Window Size Row} 
    vTcl:DefineAlias "$site_4_0.lab23" "Label248a_9a" vTcl:WidgetProc "Toplevel248a" 1
    entry $site_4_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable SubAptNSMNwinL -width 5 
    vTcl:DefineAlias "$site_4_0.ent24" "Entry248a_3a" vTcl:WidgetProc "Toplevel248a" 1
    pack $site_4_0.lab23 \
        -in $site_4_0 -anchor center -expand 0 -fill none -padx 2 -side left 
    pack $site_4_0.ent24 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.fra83" "Frame20" vTcl:WidgetProc "Toplevel248a" 1
...
global SubAptBMP SubAptComp1 SubAptComp2 SubAptSpan
...
for {set j 0} {$j < $SubAptSubIm} {incr j} {
    ...
    if {$SubAptSubDir == ""} {
        if {$SubAptComp1 == "1"} {
            set SubAptFileOutput "$SubAptDirOutput/RGB1.bmp" 
            ...
            TextEditorRunTrace "Arguments: -id \x22$SubAptDirInput\x22 -of \x22$SubAptFileOutput\x22 -iodf SPP -ofr 0 -ofc 0 -fnr $FinalNlig  -fnc $FinalNcol -auto 1 -rgbf RGB1  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/bmp_process/create_rgb_file_SPPIPPC2.exe -id \x22$SubAptDirInput\x22 -of \x22$SubAptFileOutput\x22 -iodf SPP -ofr 0 -ofc 0 -fnr $FinalNlig  -fnc $FinalNcol -auto 1 -rgbf RGB1  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
        ...
        if {$SubAptComp2 == "1"} {
            set SubAptFileOutput "$SubAptDirOutput/RGB2.bmp" 
            set Fonction "Creation of the RGB BMP File :"
            set Fonction2 "$SubAptFileOutput"    
            set MaskCmd ""
            set MaskFile "$SubAptDirInput/mask_valid_pixels.bin"
            ...
            update
            TextEditorRunTrace "Process The Function Soft/bin/bmp_process/create_rgb_file_SPPIPPC2.exe" "k"
            TextEditorRunTrace "Arguments: -id \x22$SubAptDirInput\x22 -of \x22$SubAptFileOutput\x22 -iodf SPP -ofr 0 -ofc 0 -fnr $FinalNlig  -fnc $FinalNcol -auto 1 -rgbf RGB2  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/bmp_process/create_rgb_file_SPPIPPC2.exe -id \x22$SubAptDirInput\x22 -of \x22$SubAptFileOutput\x22 -iodf SPP -ofr 0 -ofc 0 -fnr $FinalNlig  -fnc $FinalNcol -auto 1 -rgbf RGB2  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            if {$PSPViewGimpBMP != 0} { GimpMapAlgebra $SubAptFileOutput }
        ...
        if {$SubAptSpan == "1"} {
            ...
            TextEditorRunTrace "Arguments: -id \x22$SubAptDirInput\x22 -od \x22$SubAptDirOutput\x22 -iodf SPP -fmt db -nwr 1 -nwc 1 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/data_process_sngl/process_span.exe -id \x22$SubAptDirInput\x22 -od \x22$SubAptDirOutput\x22 -iodf SPP -fmt db -nwr 1 -nwc 1 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
    ...
    if {$SubAptSubDir == "C2"} {
        if {$SubAptComp1 == "1"} {
            ...
            update
            TextEditorRunTrace "Process The Function Soft/bin/bmp_process/create_rgb_file_SPPIPPC2.exe" "k"
            TextEditorRunTrace "Arguments: -id \x22$SubAptDirInput\x22 -of \x22$SubAptFileOutput\x22 -iodf C2 -ofr 0 -ofc 0 -fnr $FinalNlig  -fnc $FinalNcol -auto 1 -rgbf RGB1  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/bmp_process/create_rgb_file_SPPIPPC2.exe -id \x22$SubAptDirInput\x22 -of \x22$SubAptFileOutput\x22 -iodf C2 -ofr 0 -ofc 0 -fnr $FinalNlig  -fnc $FinalNcol -auto 1 -rgbf RGB1  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            if {$PSPViewGimpBMP != 0} { GimpMapAlgebra $SubAptFileOutput }
        ...
        if {$SubAptComp2 == "1"} {
            ...
            update
            TextEditorRunTrace "Process The Function Soft/bin/bmp_process/create_rgb_file_SPPIPPC2.exe" "k"
            TextEditorRunTrace "Arguments: -id \x22$SubAptDirInput\x22 -of \x22$SubAptFileOutput\x22 -iodf C2 -ofr 0 -ofc 0 -fnr $FinalNlig  -fnc $FinalNcol -auto 1 -rgbf RGB2  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/bmp_process/create_rgb_file_SPPIPPC2.exe -id \x22$SubAptDirInput\x22 -of \x22$SubAptFileOutput\x22 -iodf C2 -ofr 0 -ofc 0 -fnr $FinalNlig  -fnc $FinalNcol -auto 1 -rgbf RGB2  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            if {$PSPViewGimpBMP != 0} { GimpMapAlgebra $SubAptFileOutput }
        ...
        if {$SubAptSpan == "1"} {
            ...
            update
            TextEditorRunTrace "Process The Function Soft/bin/data_process_sngl/process_span.exe" "k"
            TextEditorRunTrace "Arguments: -id \x22$SubAptDirInput\x22 -od \x22$SubAptDirOutput\x22 -iodf C2 -fmt db -nwr 1 -nwc 1 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/data_process_sngl/process_span.exe -id \x22$SubAptDirInput\x22 -od \x22$SubAptDirOutput\x22 -iodf C2 -fmt db -nwr 1 -nwc 1 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            EnviWriteConfig "$SubAptDirOutput/span_db.bin" $FinalNlig $FinalNcol 4
...
if {$config == "false"} {
    ...
    for {set j 0} {$j < $SubAptSubIm} {incr j} {
        ...
        set MaskFile "$SubAptDirInput/mask_valid_pixels.bin"
        if [file exists $MaskFile] {set MaskCmd "-mask \x22$MaskFile\x22"}
        if {$SubAptSubDir == ""} { set SubAptF "SPP" }
        if {$SubAptSubDir == "C2"} { set SubAptF "C2" }
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
        TextEditorRunTrace "Process The Function Soft/bin/data_process_sngl/h_a_alpha_decompositionSPPC2.exe" "k"
        TextEditorRunTrace "Arguments: -id \x22$SubAptDirInput\x22 -od \x22$SubAptDirOutput\x22 -iodf $SubAptF -nwr $SubAptHAAlpNwinL -nwc $SubAptHAAlpNwinC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -fl1 0 -fl2 0 -fl3 0 -fl4 0 -fl5 0 -fl6 1 -fl7 0 -fl8 0 -fl9 1 -fl10 1 -fl11 0 -fl12 0 -fl13 0 -fl14 0 -fl15 0  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
        set f [ open "| Soft/bin/data_process_sngl/h_a_alpha_decompositionSPPC2.exe -id \x22$SubAptDirInput\x22 -od \x22$SubAptDirOutput\x22 -iodf $SubAptF -nwr $SubAptHAAlpNwinL -nwc $SubAptHAAlpNwinC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -fl1 0 -fl2 0 -fl3 0 -fl4 0 -fl5 0 -fl6 1 -fl7 0 -fl8 0 -fl9 1 -fl10 1 -fl11 0 -fl12 0 -fl13 0 -fl14 0 -fl15 0  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
        PsPprogressBar $f
        TextEditorRunTrace "Check RunTime Errors" "r"
        CheckRunTimeError
        WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
...
if {$config == "false"} {
    ...
    if {$SubAptSubDir == "C2"} { set SubAptVal 1}
...
if {$config == "true"} {
    ...
    WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
    update
    TextEditorRunTrace "Process The Function Soft/bin/data_process_sngl/sub_aperture_anisotropySPPC2.exe" "k"
    ...
    set f [ open "| Soft/bin/data_process_sngl/sub_aperture_anisotropySPPC2.exe -id \x22$SubAptDirInput\x22 -od \x22$SubAptDirOutput\x22 -iodf $SubAptF -subi $SubAptInit -subn $SubAptSubIm -nwr $SubAptNSMNwinL -nwc $SubAptNSMNwinC -nlk $SubAptNSMNlook -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
    PsPprogressBar $f
    TextEditorRunTrace "Check RunTime Errors" "r"
    CheckRunTimeError
    WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
...
if {"$VarWarningFinal"=="no"} {Window hide $widget(Toplevel248a); TextEditorRunTrace "Close Window Sub-Aperture Applications" "b"}
}
#WarningFinal
}
...
#OpenDirFile} \
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel248a" 1
    ...
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel248a" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel248a); TextEditorRunTrace "Close Window Sub-Aperture Applications" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel248a" 1
