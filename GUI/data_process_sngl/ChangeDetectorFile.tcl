...
proc vTclWindow.top440 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel440" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd72" "Frame1" vTcl:WidgetProc "Toplevel440" 1
    set site_3_0 $top.cpd72
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Reference Input File} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel440" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel440" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame12" vTcl:WidgetProc "Toplevel440" 1
    set site_6_0 $site_5_0.cpd91
...
if {$FileName != ""} {
    ...
    if [file exists $FileNameHdr] {
        ...
        if {[string first "PolSARpro" $tmp] != "-1"} {
            ...
            WidgetShow $widget(Toplevel44); TextEditorRunTrace "Open Window Error" "b"
            tkwait variable VarError
            if {$VarError == "cancel"} {Window hide $widget(Toplevel440); TextEditorRunTrace "Close Window Change Detector File" "b"}
            set ChangeDetectorInputFile1 ""
            }    
        close $f
        } else {
        ...
        WidgetShow $widget(Toplevel44); TextEditorRunTrace "Open Window Error" "b"
        tkwait variable VarError
        if {$VarError == "cancel"} {Window hide $widget(Toplevel440); TextEditorRunTrace "Close Window PolSARpro Change Detector File" "b"}
        }    
    }} \
    ...
    vTcl:DefineAlias "$top.fra56" "Frame9" vTcl:WidgetProc "Toplevel440" 1
    set site_3_0 $top.fra56
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel440" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInitFile1 -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel440" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel440" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEndFile1 -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel440" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel440" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInitFile1 -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel440" 1
    label $site_3_0.lab63 \
        -padx 1 -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel440" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEndFile1 -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel440" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.cpd66 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd66" "Frame2" vTcl:WidgetProc "Toplevel440" 1
    set site_3_0 $top.cpd66
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Test Input File} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame6" vTcl:WidgetProc "Toplevel440" 1
    bind $site_3_0.cpd98 <Destroy> {
        Widget::destroy %W; rename %W {}
    }
    set site_5_0 [$site_3_0.cpd98 getframe]
    entry $site_5_0.cpd85 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable ChangeDetectorInputFile2 
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh7" vTcl:WidgetProc "Toplevel440" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame13" vTcl:WidgetProc "Toplevel440" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd87 \
        \
        -command {global ChangeDetectorInputFile2
...
if {$FileName != ""} {
    ...
    if [file exists $FileNameHdr] {
        ...
        gets $f tmp
        if {[string first "PolSARpro" $tmp] != "-1"} {
            gets $f tmp; set NcolEndFile2 [string range $tmp [expr [string first "=" $tmp] + 2 ] [string length $tmp] ]
            gets $f tmp; set NligEndFile2 [string range $tmp [expr [string first "=" $tmp] + 2 ] [string length $tmp] ]
            set ChangeDetectorInputFile2 $FileName
            set NligInitFile2 1
            set NcolInitFile2 1
            gets $f tmp
            gets $f tmp
            ...
            if {$tmp != "data type = 4"} {
                ...
                WidgetShow $widget(Toplevel44); TextEditorRunTrace "Open Window Error" "b"
                tkwait variable VarError
                set NligInitFile2 ""; set NligEndFile2 ""
                set NcolInitFile2 ""; set NcolEndFile2 ""
                set ChangeDetectorInputFile2 ""             
                }
            } else {
            set ErrorMessage "NOT A PolSARpro BINARY DATA FILE"
    ...
    frame $top.cpd67 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd67" "Frame10" vTcl:WidgetProc "Toplevel440" 1
    set site_3_0 $top.cpd67
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label14" vTcl:WidgetProc "Toplevel440" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInitFile2 -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry10" vTcl:WidgetProc "Toplevel440" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label15" vTcl:WidgetProc "Toplevel440" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEndFile2 -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry11" vTcl:WidgetProc "Toplevel440" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label16" vTcl:WidgetProc "Toplevel440" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInitFile2 -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry12" vTcl:WidgetProc "Toplevel440" 1
    label $site_3_0.lab63 \
        -padx 1 -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label17" vTcl:WidgetProc "Toplevel440" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEndFile2 -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry13" vTcl:WidgetProc "Toplevel440" 1
    pack $site_3_0.lab57 \
        -in $site_3_0 -anchor center -expand 1 -fill none -padx 10 -side left 
    pack $site_3_0.ent58 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.cpd69 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd69" "Frame3" vTcl:WidgetProc "Toplevel440" 1
    set site_3_0 $top.cpd69
    TitleFrame $site_3_0.cpd98 \
        -ipad 2 -text {Output File} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame7" vTcl:WidgetProc "Toplevel440" 1
    bind $site_3_0.cpd98 <Destroy> {
        Widget::destroy %W; rename %W {}
    }
    set site_5_0 [$site_3_0.cpd98 getframe]
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel440" 1
    pack $site_5_0.cpd85 \
        -in $site_5_0 -anchor center -expand 1 -fill x -padx 5 -side left 
    pack $site_3_0.cpd98 \
    ...
    frame $top.fra78 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.fra78" "Frame4" vTcl:WidgetProc "Toplevel440" 1
    set site_3_0 $top.fra78
    TitleFrame $site_3_0.cpd81 \
        -text {Change Detector} 
    vTcl:DefineAlias "$site_3_0.cpd81" "TitleFrame2" vTcl:WidgetProc "Toplevel440" 1
...
append ChangeDetectorOutputFile "_CD_MRD.bin"} \
        -text {Mean Ratio Detector (MRD)} -value mrd \
        -variable ChangeDetectorName 
    vTcl:DefineAlias "$site_6_0.rad71" "Radiobutton5" vTcl:WidgetProc "Toplevel440" 1
    pack $site_6_0.rad71 \
...
set ChangeDetectorOutputFile [file rootname $ChangeDetectorInputFile1]
append ChangeDetectorOutputFile "_CD_GKLD.bin"} \
        -text {Gaussian Kullback Liebler Detector (GKLD)} -value gkld \
        -variable ChangeDetectorName 
    vTcl:DefineAlias "$site_6_0.cpd72" "Radiobutton9" vTcl:WidgetProc "Toplevel440" 1
    pack $site_6_0.cpd72 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
...
set ChangeDetectorOutputFile [file rootname $ChangeDetectorInputFile1]
append ChangeDetectorOutputFile "_CD_CKLD.bin"} \
        -text {Cumulant Kullback Liebler Detector (CKLD)} -value ckld \
        -variable ChangeDetectorName 
    vTcl:DefineAlias "$site_6_0.cpd74" "Radiobutton13" vTcl:WidgetProc "Toplevel440" 1
    pack $site_6_0.cpd74 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd75 \
    ...
    frame $site_3_0.fra82 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra82" "Frame5" vTcl:WidgetProc "Toplevel440" 1
    set site_4_0 $site_3_0.fra82
    frame $site_4_0.fra83 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra83" "Frame6" vTcl:WidgetProc "Toplevel440" 1
    set site_5_0 $site_4_0.fra83
    label $site_5_0.lab84 \
        -text {Window Size Row} -width 15 
    vTcl:DefineAlias "$site_5_0.lab84" "Label1" vTcl:WidgetProc "Toplevel440" 1
    entry $site_5_0.ent85 \
        -background white -foreground #ff0000 -justify center \
        -textvariable ChangeDetectorNwinL -width 5 
    vTcl:DefineAlias "$site_5_0.ent85" "Entry1" vTcl:WidgetProc "Toplevel440" 1
    pack $site_5_0.lab84 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.ent85 \
    ...
    frame $site_4_0.cpd86 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd86" "Frame7" vTcl:WidgetProc "Toplevel440" 1
    set site_5_0 $site_4_0.cpd86
    label $site_5_0.lab84 \
        -text {Window Size Col} -width 15 
    vTcl:DefineAlias "$site_5_0.lab84" "Label2" vTcl:WidgetProc "Toplevel440" 1
    entry $site_5_0.ent85 \
        -background white -foreground #ff0000 -justify center \
        -textvariable ChangeDetectorNwinC -width 5 
    vTcl:DefineAlias "$site_5_0.ent85" "Entry2" vTcl:WidgetProc "Toplevel440" 1
    pack $site_5_0.lab84 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.ent85 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 10 -side left 
    ...
    vTcl:DefineAlias "$site_4_0.che87" "Checkbutton1" vTcl:WidgetProc "Toplevel440" 1
    pack $site_4_0.fra83 \
    ...
    vTcl:DefineAlias "$top.fra92" "Frame20" vTcl:WidgetProc "Toplevel440" 1
...
global NligInitFile1 NligEndFile1 NcolInitFile1 NcolEndFile1
global NligInitFile2 NligEndFile2 NcolInitFile2 NcolEndFile2
global PSPMemory TMPMemoryAllocError ChangeDetectorBMP

if {$OpenDirFile == 0} {

set config "true"
if {$ChangeDetectorInputFile1 == ""} { set config "false" }
if {$ChangeDetectorInputFile2 == ""} { set config "false" }
if {$config == "true"} {
    ...
    if {$TestVarError == "ok"} {
        ...
        if {$config == "true"} {
            ...
            update
            TextEditorRunTrace "Process The Function Soft/data_process_sngl/change_detector.exe" "k"
            TextEditorRunTrace "Arguments: -if1 \x22$ChangeDetectorInputFile1\x22 -if2 \x22$ChangeDetectorInputFile2\x22 -of \x22$ChangeDetectorOutputFile\x22 -det $ChangeDetectorName -nwr $ChangeDetectorNwinL -nwc $ChangeDetectorNwinC -ofr 0 -ofc 0 -fnr $FinalNlig -fnc $FinalNcol -inc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/data_process_sngl/change_detector.exe -if1 \x22$ChangeDetectorInputFile1\x22 -if2 \x22$ChangeDetectorInputFile2\x22 -of \x22$ChangeDetectorOutputFile\x22 -det $ChangeDetectorName -nwr $ChangeDetectorNwinL -nwc $ChangeDetectorNwinC -ofr 0 -ofc 0 -fnr $FinalNlig -fnc $FinalNcol -inc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            ...
            Window hide $widget(Toplevel440); TextEditorRunTrace "Close Window Change Detector File" "b"
            } else {
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel440" 1
    ...
    button $site_3_0.but24 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/ChangeDetectorFile.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -padx 4 -pady 2 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel440" 1
...
Window hide $widget(Toplevel440); TextEditorRunTrace "Close Window Change Detector File" "b"
    ...
    vTcl:DefineAlias "$site_3_0.cpd68" "Button17" vTcl:WidgetProc "Toplevel440" 1
