...
if {$PolSARapForestOutputSubDir != ""} {append PolSARapForestDirOutput "/$PolSARapForestOutputSubDir"}
    ...
    #####################################################################
    #Create Directory
    set PolSARapForestDirOutput [PSPCreateDirectoryMask $PolSARapForestDirOutput $PolSARapForestOutputDir $PolSARapForestDirMasterInput]
    #####################################################################       
...
if {"$VarWarning"=="ok"} {
    ...
    if {$TestVarError == "ok"} {
        ...
        update
        TextEditorRunTrace "Process The Function Soft/bin/PolSARap/PolSARap_Forest_Height_Estimation_Dual_Baseline.exe" "k"
        if {$DataFormatActive2 == "S2"} {
            TextEditorRunTrace "Arguments: -idm $PolSARapForestDirMasterInput -ids1 $PolSARapForestDirSlave1Input -ids2 $PolSARapForestDirSlave2Input -od $PolSARapForestDirOutput -iodf S2T6 -ikz1 \x22$PolSARapForestKz1File\x22 -ikz2 \x22$PolSARapForestKz2File\x22 -hmin $PolSARapForestMinHeight -hmax $PolSARapForestMaxHeight -hdel $PolSARapForestDelHeight -smin $PolSARapForestMinSigma -smax $PolSARapForestMaxSigma -sdel $PolSARapForestDelSigma -nwr $PolSARapForestNwinL -nwc $PolSARapForestNwinC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/PolSARap/PolSARap_Forest_Height_Estimation_Dual_Baseline.exe -idm $PolSARapForestDirMasterInput -ids1 $PolSARapForestDirSlave1Input -ids2 $PolSARapForestDirSlave2Input -od $PolSARapForestDirOutput -iodf S2T6 -ikz1 \x22$PolSARapForestKz1File\x22 -ikz2 \x22$PolSARapForestKz2File\x22 -hmin $PolSARapForestMinHeight -hmax $PolSARapForestMaxHeight -hdel $PolSARapForestDelHeight -smin $PolSARapForestMinSigma -smax $PolSARapForestMaxSigma -sdel $PolSARapForestDelSigma -nwr $PolSARapForestNwinL -nwc $PolSARapForestNwinC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            }
        if {$DataFormatActive2 == "T6"} {
            TextEditorRunTrace "Arguments: -idm $PolSARapForestDirMasterInput -ids1 $PolSARapForestDirSlave1Input -od $PolSARapForestDirOutput -iodf T6 -ikz1 \x22$PolSARapForestKz1File\x22 -ikz2 \x22$PolSARapForestKz2File\x22 -hmin $PolSARapForestMinHeight -hmax $PolSARapForestMaxHeight -hdel $PolSARapForestDelHeight -smin $PolSARapForestMinSigma -smax $PolSARapForestMaxSigma -sdel $PolSARapForestDelSigma -nwr $PolSARapForestNwinL -nwc $PolSARapForestNwinC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/PolSARap/PolSARap_Forest_Height_Estimation_Dual_Baseline.exe -idm $PolSARapForestDirMasterInput -ids1 $PolSARapForestDirSlave1Input -od $PolSARapForestDirOutput -iodf T6 -ikz1 \x22$PolSARapForestKz1File\x22 -ikz2 \x22$PolSARapForestKz2File\x22 -hmin $PolSARapForestMinHeight -hmax $PolSARapForestMaxHeight -hdel $PolSARapForestDelHeight -smin $PolSARapForestMinSigma -smax $PolSARapForestMaxSigma -sdel $PolSARapForestDelSigma -nwr $PolSARapForestNwinL -nwc $PolSARapForestNwinC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            }
        PsPprogressBar $f
