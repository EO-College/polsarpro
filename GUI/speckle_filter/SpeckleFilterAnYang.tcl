...
proc vTclWindow.top429 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel429" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd73 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd73" "Frame2" vTcl:WidgetProc "Toplevel429" 1
    set site_3_0 $top.cpd73
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame4" vTcl:WidgetProc "Toplevel429" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh2" vTcl:WidgetProc "Toplevel429" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame13" vTcl:WidgetProc "Toplevel429" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd86 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd86" "Button34" vTcl:WidgetProc "Toplevel429" 1
    pack $site_6_0.cpd86 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel429" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel429" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame1" vTcl:WidgetProc "Toplevel429" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab72 \
        -text / 
    vTcl:DefineAlias "$site_6_0.lab72" "Label2" vTcl:WidgetProc "Toplevel429" 1
    entry $site_6_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable FilterOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd75" "Entry1" vTcl:WidgetProc "Toplevel429" 1
    pack $site_6_0.lab72 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame14" vTcl:WidgetProc "Toplevel429" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != ""} {
    ...
    vTcl:DefineAlias "$top.fra29" "Frame9" vTcl:WidgetProc "Toplevel429" 1
    set site_3_0 $top.fra29
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel429" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel429" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel429" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel429" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel429" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel429" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel429" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel429" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.lab77" "Label1" vTcl:WidgetProc "Toplevel429" 1
    TitleFrame $top.tit78 \
        -text {Output Format} 
    vTcl:DefineAlias "$top.tit78" "TitleFrame429_1" vTcl:WidgetProc "Toplevel429" 1
...
set FilterOutputSubDir "T3"} \
    ...
    vTcl:DefineAlias "$site_4_0.rad81" "Radiobutton429_1" vTcl:WidgetProc "Toplevel429" 1
    radiobutton $site_4_0.rad82 \
        -command {global FilterOutputSubDir

set FilterOutputSubDir "C3"} \
        -text {[S2] >> [C3]} -value S2C3 -variable FilterFonc 
    vTcl:DefineAlias "$site_4_0.rad82" "Radiobutton429_2" vTcl:WidgetProc "Toplevel429" 1
...
if {$PolarCase == "bistatic"} {
    ...
    vTcl:DefineAlias "$site_4_0.cpd84" "Radiobutton429_3" vTcl:WidgetProc "Toplevel429" 1
...
if {$PolarCase == "bistatic"} {
    ...
    vTcl:DefineAlias "$site_4_0.cpd85" "Radiobutton429_4" vTcl:WidgetProc "Toplevel429" 1
    pack $site_4_0.rad81 \
    ...
    frame $top.fra66 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra66" "Frame3" vTcl:WidgetProc "Toplevel429" 1
    set site_3_0 $top.fra66
    frame $site_3_0.fra67 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra67" "Frame4" vTcl:WidgetProc "Toplevel429" 1
    set site_4_0 $site_3_0.fra67
    frame $site_4_0.fra69 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra69" "Frame6" vTcl:WidgetProc "Toplevel429" 1
    set site_5_0 $site_4_0.fra69
    label $site_5_0.cpd70 \
        -padx 1 -text {Number of Looks} 
    vTcl:DefineAlias "$site_5_0.cpd70" "Label204" vTcl:WidgetProc "Toplevel429" 1
    frame $site_5_0.fra71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra71" "Frame7" vTcl:WidgetProc "Toplevel429" 1
    set site_6_0 $site_5_0.fra71
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NlookAnYang -width 5 
    vTcl:DefineAlias "$site_6_0.cpd72" "Entry204" vTcl:WidgetProc "Toplevel429" 1
    pack $site_6_0.cpd72 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd70 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    ...
    frame $site_4_0.cpd76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd76" "Frame8" vTcl:WidgetProc "Toplevel429" 1
    set site_5_0 $site_4_0.cpd76
    label $site_5_0.cpd70 \
        -padx 1 -text {Patch Window Size Row} 
    vTcl:DefineAlias "$site_5_0.cpd70" "Label205" vTcl:WidgetProc "Toplevel429" 1
    frame $site_5_0.fra71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra71" "Frame10" vTcl:WidgetProc "Toplevel429" 1
    set site_6_0 $site_5_0.fra71
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NwinLAnYang -width 5 
    vTcl:DefineAlias "$site_6_0.cpd72" "Entry205" vTcl:WidgetProc "Toplevel429" 1
    pack $site_6_0.cpd72 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd70 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    ...
    frame $site_4_0.cpd68 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd68" "Frame19" vTcl:WidgetProc "Toplevel429" 1
    set site_5_0 $site_4_0.cpd68
    label $site_5_0.cpd70 \
        -padx 1 -text {Patch Window Size Col} 
    vTcl:DefineAlias "$site_5_0.cpd70" "Label209" vTcl:WidgetProc "Toplevel429" 1
    frame $site_5_0.fra71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra71" "Frame21" vTcl:WidgetProc "Toplevel429" 1
    set site_6_0 $site_5_0.fra71
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NwinCAnYang -width 5 
    vTcl:DefineAlias "$site_6_0.cpd72" "Entry209" vTcl:WidgetProc "Toplevel429" 1
    pack $site_6_0.cpd72 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd70 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    ...
    frame $site_3_0.cpd77 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd77" "Frame5" vTcl:WidgetProc "Toplevel429" 1
    set site_4_0 $site_3_0.cpd77
    frame $site_4_0.fra69 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra69" "Frame11" vTcl:WidgetProc "Toplevel429" 1
    set site_5_0 $site_4_0.fra69
    frame $site_5_0.fra71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra71" "Frame12" vTcl:WidgetProc "Toplevel429" 1
    set site_6_0 $site_5_0.fra71
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable KAnYang -width 5 
    vTcl:DefineAlias "$site_6_0.cpd72" "Entry206" vTcl:WidgetProc "Toplevel429" 1
    pack $site_6_0.cpd72 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    label $site_5_0.cpd70 \
        -padx 1 -text {K Coefficient} 
    vTcl:DefineAlias "$site_5_0.cpd70" "Label206" vTcl:WidgetProc "Toplevel429" 1
    pack $site_5_0.fra71 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side right 
    pack $site_5_0.cpd70 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side right 
    frame $site_4_0.cpd76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd76" "Frame15" vTcl:WidgetProc "Toplevel429" 1
    set site_5_0 $site_4_0.cpd76
    label $site_5_0.cpd70 \
        -padx 1 -text {Searching Window Size Row} 
    vTcl:DefineAlias "$site_5_0.cpd70" "Label207" vTcl:WidgetProc "Toplevel429" 1
    frame $site_5_0.fra71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra71" "Frame16" vTcl:WidgetProc "Toplevel429" 1
    set site_6_0 $site_5_0.fra71
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable SwinLAnYang -width 5 
    vTcl:DefineAlias "$site_6_0.cpd72" "Entry207" vTcl:WidgetProc "Toplevel429" 1
    pack $site_6_0.cpd72 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd70 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    ...
    frame $site_4_0.cpd67 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd67" "Frame17" vTcl:WidgetProc "Toplevel429" 1
    set site_5_0 $site_4_0.cpd67
    label $site_5_0.cpd70 \
        -padx 1 -text {Searching Window Size Col} 
    vTcl:DefineAlias "$site_5_0.cpd70" "Label208" vTcl:WidgetProc "Toplevel429" 1
    frame $site_5_0.fra71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra71" "Frame18" vTcl:WidgetProc "Toplevel429" 1
    set site_6_0 $site_5_0.fra71
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable SwinCAnYang -width 5 
    vTcl:DefineAlias "$site_6_0.cpd72" "Entry208" vTcl:WidgetProc "Toplevel429" 1
    pack $site_6_0.cpd72 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd70 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.fra36" "Frame20" vTcl:WidgetProc "Toplevel429" 1
...
if {"$VarWarning"=="ok"} {
    ...
    set TestVarName(4) "Number of Looks"; set TestVarType(4) "int"; set TestVarValue(4) $NlookAnYang; set TestVarMin(4) "1"; set TestVarMax(4) "100"
    set TestVarName(5) "Patch Window Size Row"; set TestVarType(5) "int"; set TestVarValue(5) $NwinLAnYang; set TestVarMin(5) "1"; set TestVarMax(5) "100"
    set TestVarName(6) "Patch Window Size Col"; set TestVarType(6) "int"; set TestVarValue(6) $NwinCAnYang; set TestVarMin(6) "1"; set TestVarMax(6) "100"
    set TestVarName(7) "Searching Window Size Row"; set TestVarType(7) "int"; set TestVarValue(7) $SwinLAnYang; set TestVarMin(7) "1"; set TestVarMax(7) "100"
    set TestVarName(8) "Searching Window Size Col"; set TestVarType(8) "int"; set TestVarValue(8) $SwinCAnYang; set TestVarMin(8) "1"; set TestVarMax(8) "100"
    set TestVarName(9) "K Coefficient"; set TestVarType(9) "int"; set TestVarValue(9) $KAnYang; set TestVarMin(9) "1"; set TestVarMax(9) "100"
    TestVar 10
    if {$TestVarError == "ok"} {
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel429); TextEditorRunTrace "Close Window Speckle Filter" "b"}
    }
}
...
if {"$VarWarning"=="ok"} {
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel429" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/SpeckleFilterAnYang.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel429" 1
...
Window hide $widget(Toplevel429); TextEditorRunTrace "Close Window Speckle Filter" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel429" 1
    ...
    vTcl:DefineAlias "$top.che66" "Checkbutton429_1" vTcl:WidgetProc "Toplevel429" 1
    menu $top.m66 \
