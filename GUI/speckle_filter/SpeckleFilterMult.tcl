...
proc vTclWindow.top501 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel501" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd71 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd71" "Frame2" vTcl:WidgetProc "Toplevel501" 1
    set site_3_0 $top.cpd71
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame4" vTcl:WidgetProc "Toplevel501" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh2" vTcl:WidgetProc "Toplevel501" 1
    pack $site_5_0.cpd85 \
        -in $site_5_0 -anchor center -expand 1 -fill x -padx 5 -side left 
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Output Directory} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel501" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel501" 1
    frame $site_5_0.cpd95 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd95" "Frame1" vTcl:WidgetProc "Toplevel501" 1
    set site_6_0 $site_5_0.cpd95
    label $site_6_0.cpd97 \
        -text / 
    vTcl:DefineAlias "$site_6_0.cpd97" "Label2" vTcl:WidgetProc "Toplevel501" 1
    entry $site_6_0.ent94 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable FilterOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.ent94" "Entry1" vTcl:WidgetProc "Toplevel501" 1
    pack $site_6_0.cpd97 \
    ...
    vTcl:DefineAlias "$top.fra29" "Frame9" vTcl:WidgetProc "Toplevel501" 1
    set site_3_0 $top.fra29
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel501" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel501" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel501" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel501" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel501" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel501" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel501" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel501" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.lab75" "Label1" vTcl:WidgetProc "Toplevel501" 1
    frame $top.fra30 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra30" "Frame149" vTcl:WidgetProc "Toplevel501" 1
    set site_3_0 $top.fra30
    frame $site_3_0.fra22 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra22" "Frame248" vTcl:WidgetProc "Toplevel501" 1
    set site_4_0 $site_3_0.fra22
    frame $site_4_0.fra25 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra25" "Frame249" vTcl:WidgetProc "Toplevel501" 1
    set site_5_0 $site_4_0.fra25
    label $site_5_0.lab28 \
        -padx 1 -text {Number of Looks} 
    vTcl:DefineAlias "$site_5_0.lab28" "Label501_1" vTcl:WidgetProc "Toplevel501" 1
    entry $site_5_0.ent29 \
        -background white -foreground #ff0000 -justify center \
        -textvariable Nlook -width 5 
    vTcl:DefineAlias "$site_5_0.ent29" "Entry501_1" vTcl:WidgetProc "Toplevel501" 1
    pack $site_5_0.lab28 \
    ...
    frame $site_4_0.cpd66 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd66" "Frame250" vTcl:WidgetProc "Toplevel501" 1
    set site_5_0 $site_4_0.cpd66
    label $site_5_0.lab25 \
        -padx 1 -text {Window Size Row} 
    vTcl:DefineAlias "$site_5_0.lab25" "Label501_2" vTcl:WidgetProc "Toplevel501" 1
    entry $site_5_0.ent26 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinFilterL -width 5 
    vTcl:DefineAlias "$site_5_0.ent26" "Entry501_2" vTcl:WidgetProc "Toplevel501" 1
    pack $site_5_0.lab25 \
        -in $site_5_0 -anchor center -expand 1 -fill none -ipadx 5 -side left 
    pack $site_5_0.ent26 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    frame $site_4_0.cpd67 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd67" "Frame251" vTcl:WidgetProc "Toplevel501" 1
    set site_5_0 $site_4_0.cpd67
    label $site_5_0.lab25 \
        -padx 1 -text {Window Size Col} 
    vTcl:DefineAlias "$site_5_0.lab25" "Label501_3" vTcl:WidgetProc "Toplevel501" 1
    entry $site_5_0.ent26 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinFilterC -width 5 
    vTcl:DefineAlias "$site_5_0.ent26" "Entry501_3" vTcl:WidgetProc "Toplevel501" 1
    pack $site_5_0.lab25 \
        -in $site_5_0 -anchor center -expand 1 -fill none -ipadx 5 -side left 
    pack $site_5_0.ent26 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.fra36" "Frame20" vTcl:WidgetProc "Toplevel501" 1
...
if {"$VarWarning"=="ok"} {
    ...
    if {$TestVarError == "ok"} {
        ...
        for {set ii 1} {$ii <= $NDataDirMult} {incr ii} {
            ...
            if {$FilterFonction == "BOXCAR Speckle Filter"} { append FilterOutputDir "_BOX" }
            if {$FilterFonction == "GAUSSIAN Speckle Filter"} { append FilterOutputDir "_GSS" }
            if {$FilterFonction == "IDAN Speckle Filter"} { append FilterOutputDir "_IDAN" }
            if {$FilterFonction == "LEE Refined Speckle Filter"} { append FilterOutputDir "_LEE" }
            set FilterDirOutput $FilterOutputDir
            if {$FilterOutputSubDir != ""} {append FilterDirOutput "/$FilterOutputSubDir"}
        ...
        Window hide $widget(Toplevel501); TextEditorRunTrace "Close Window Speckle Filter Mult" "b"
        }
    } else {
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel501); TextEditorRunTrace "Close Window Speckle Filter Mult" "b"}
    }
}} \
        -cursor {} -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel501" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/SpeckleFilterMult.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel501" 1
...
Window hide $widget(Toplevel501); TextEditorRunTrace "Close Window Speckle Filter Mult" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel501" 1
