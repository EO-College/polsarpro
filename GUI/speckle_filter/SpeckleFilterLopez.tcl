...
proc vTclWindow.top365 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel365" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd73 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd73" "Frame2" vTcl:WidgetProc "Toplevel365" 1
    set site_3_0 $top.cpd73
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame4" vTcl:WidgetProc "Toplevel365" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh2" vTcl:WidgetProc "Toplevel365" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame13" vTcl:WidgetProc "Toplevel365" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd86 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd86" "Button34" vTcl:WidgetProc "Toplevel365" 1
    pack $site_6_0.cpd86 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel365" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel365" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame1" vTcl:WidgetProc "Toplevel365" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab72 \
        -text / 
    vTcl:DefineAlias "$site_6_0.lab72" "Label2" vTcl:WidgetProc "Toplevel365" 1
    entry $site_6_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable FilterOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd75" "Entry1" vTcl:WidgetProc "Toplevel365" 1
    pack $site_6_0.lab72 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame14" vTcl:WidgetProc "Toplevel365" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != ""} {
    ...
    vTcl:DefineAlias "$top.fra29" "Frame9" vTcl:WidgetProc "Toplevel365" 1
    set site_3_0 $top.fra29
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel365" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel365" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel365" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel365" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel365" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel365" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel365" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel365" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.lab77" "Label1" vTcl:WidgetProc "Toplevel365" 1
    TitleFrame $top.tit78 \
        -text {Output Format} 
    vTcl:DefineAlias "$top.tit78" "TitleFrame365_1" vTcl:WidgetProc "Toplevel365" 1
...
$widget(Checkbutton365_1) configure -state disable} \
    ...
    vTcl:DefineAlias "$site_4_0.rad81" "Radiobutton365_1" vTcl:WidgetProc "Toplevel365" 1
...
$widget(Checkbutton365_1) configure -state disable} \
    ...
    vTcl:DefineAlias "$site_4_0.rad82" "Radiobutton365_2" vTcl:WidgetProc "Toplevel365" 1
...
if {$PolarCase == "bistatic"} {
    ...
    vTcl:DefineAlias "$site_4_0.cpd84" "Radiobutton365_3" vTcl:WidgetProc "Toplevel365" 1
...
if {$PolarCase == "bistatic"} {
    ...
    vTcl:DefineAlias "$site_4_0.cpd85" "Radiobutton365_4" vTcl:WidgetProc "Toplevel365" 1
    pack $site_4_0.rad81 \
    ...
    frame $top.fra30 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra30" "Frame149" vTcl:WidgetProc "Toplevel365" 1
    set site_3_0 $top.fra30
    frame $site_3_0.fra22 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra22" "Frame248" vTcl:WidgetProc "Toplevel365" 1
    set site_4_0 $site_3_0.fra22
    frame $site_4_0.fra25 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra25" "Frame249" vTcl:WidgetProc "Toplevel365" 1
    set site_5_0 $site_4_0.fra25
    label $site_5_0.lab25 \
        -padx 1 -text {Window Size Row} 
    vTcl:DefineAlias "$site_5_0.lab25" "Label365_2" vTcl:WidgetProc "Toplevel365" 1
    ...
    vTcl:DefineAlias "$site_5_0.ent26" "Entry365_2" vTcl:WidgetProc "Toplevel365" 1
    pack $site_5_0.lab25 \
    ...
    frame $site_4_0.cpd66 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd66" "Frame250" vTcl:WidgetProc "Toplevel365" 1
    set site_5_0 $site_4_0.cpd66
    label $site_5_0.lab28 \
        -padx 1 -text {Number of Iterations [ 1 ... 3 ]} 
    vTcl:DefineAlias "$site_5_0.lab28" "Label365" vTcl:WidgetProc "Toplevel365" 1
    entry $site_5_0.ent29 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NitFilter -width 5 
    vTcl:DefineAlias "$site_5_0.ent29" "Entry365" vTcl:WidgetProc "Toplevel365" 1
    pack $site_5_0.lab28 \
    ...
    frame $site_4_0.cpd68 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd68" "Frame254" vTcl:WidgetProc "Toplevel365" 1
    set site_5_0 $site_4_0.cpd68
    label $site_5_0.lab25 \
        -padx 1 -text {Window Size Col} 
    vTcl:DefineAlias "$site_5_0.lab25" "Label369" vTcl:WidgetProc "Toplevel365" 1
    entry $site_5_0.ent26 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable NwinFilterC -width 5 
    vTcl:DefineAlias "$site_5_0.ent26" "Entry369" vTcl:WidgetProc "Toplevel365" 1
    pack $site_5_0.lab25 \
        -in $site_5_0 -anchor center -expand 1 -fill none -ipadx 5 -side left 
    pack $site_5_0.ent26 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $site_3_0.cpd67 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd67" "Frame251" vTcl:WidgetProc "Toplevel365" 1
    set site_4_0 $site_3_0.cpd67
    checkbutton $site_4_0.cpd67 \
        -text {Improved Filter} -variable ImprovedFilter 
    vTcl:DefineAlias "$site_4_0.cpd67" "Checkbutton365" vTcl:WidgetProc "Toplevel365" 1
    frame $site_4_0.fra25 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra25" "Frame252" vTcl:WidgetProc "Toplevel365" 1
    set site_5_0 $site_4_0.fra25
    label $site_5_0.lab25 \
        -padx 1 -text {Total Weight for the Bias [ 0 ... 1 ]} 
    vTcl:DefineAlias "$site_5_0.lab25" "Label367" vTcl:WidgetProc "Toplevel365" 1
    entry $site_5_0.ent26 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable WeightFilter -width 5 
    vTcl:DefineAlias "$site_5_0.ent26" "Entry367" vTcl:WidgetProc "Toplevel365" 1
    pack $site_5_0.lab25 \
        -in $site_5_0 -anchor center -expand 1 -fill none -ipadx 2 -side left 
    pack $site_5_0.ent26 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    frame $site_4_0.cpd66 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd66" "Frame253" vTcl:WidgetProc "Toplevel365" 1
    set site_5_0 $site_4_0.cpd66
    label $site_5_0.lab28 \
        -padx 1 -text {Strong Reduction [ 0 ... 1 ]} 
    vTcl:DefineAlias "$site_5_0.lab28" "Label368" vTcl:WidgetProc "Toplevel365" 1
    entry $site_5_0.ent29 \
        -background white -foreground #ff0000 -justify center \
        -textvariable StrgFilter -width 5 
    vTcl:DefineAlias "$site_5_0.ent29" "Entry368" vTcl:WidgetProc "Toplevel365" 1
    pack $site_5_0.lab28 \
        -in $site_5_0 -anchor center -expand 1 -fill none -ipadx 2 -side left 
    pack $site_5_0.ent29 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.che66" "Checkbutton365_1" vTcl:WidgetProc "Toplevel365" 1
    frame $top.fra36 \
        -relief groove -height 35 -width 125 
    vTcl:DefineAlias "$top.fra36" "Frame20" vTcl:WidgetProc "Toplevel365" 1
...
if {"$VarWarning"=="ok"} {
    ...
    if {$TestVarError == "ok"} {
        ...
        update
        TextEditorRunTrace "Process The Function Soft/speckle_filter/lopez_filter.exe" "k"
        TextEditorRunTrace "Arguments: -id \x22$FilterDirInput\x22 -od \x22$FilterDirOutput\x22 -iodf $FilterFonc -nwr $NwinFilterL -nwc $NwinFilterC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nit $NitFilter -rho $ImprovedFilter -fcw $WeightFilter -str $StrgFilter -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
        set f [ open "| Soft/speckle_filter/lopez_filter.exe -id \x22$FilterDirInput\x22 -od \x22$FilterDirOutput\x22 -iodf $FilterFonc -nwr $NwinFilterL -nwc $NwinFilterC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nit $NitFilter -rho $ImprovedFilter -fcw $WeightFilter -str $StrgFilter -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
        PsPprogressBar $f
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel365); TextEditorRunTrace "Close Window Speckle Filter" "b"}
    }
}
...
if {"$VarWarning"=="ok"} {
    ...
    if {$TestVarError == "ok"} {
        ...
        update
        TextEditorRunTrace "Process The Function Soft/speckle_filter/lopez_filter.exe" "k"
        TextEditorRunTrace "Arguments: -id \x22$FilterDirInput\x22 -od \x22$FilterDirOutputTmp\x22 -iodf $FilterFonc -nwr $NwinFilterL -nwc $NwinFilterC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nit $NitFilter -rho $ImprovedFilter -fcw $WeightFilter -str $StrgFilter -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
        set f [ open "| Soft/speckle_filter/lopez_filter.exe -id \x22$FilterDirInput\x22 -od \x22$FilterDirOutputTmp\x22 -iodf $FilterFonc -nwr $NwinFilterL -nwc $NwinFilterC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nit $NitFilter -rho $ImprovedFilter -fcw $WeightFilter -str $StrgFilter -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
        PsPprogressBar $f
        TextEditorRunTrace "Check RunTime Errors" "r"
        CheckRunTimeError
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel365" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/SpeckleFilterLopez.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel365" 1
...
Window hide $widget(Toplevel365); TextEditorRunTrace "Close Window Speckle Filter" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel365" 1
