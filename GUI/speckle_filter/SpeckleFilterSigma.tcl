...
proc vTclWindow.top352 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel352" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd73 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd73" "Frame2" vTcl:WidgetProc "Toplevel352" 1
    set site_3_0 $top.cpd73
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame4" vTcl:WidgetProc "Toplevel352" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh2" vTcl:WidgetProc "Toplevel352" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame13" vTcl:WidgetProc "Toplevel352" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd86 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd86" "Button34" vTcl:WidgetProc "Toplevel352" 1
    pack $site_6_0.cpd86 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame5" vTcl:WidgetProc "Toplevel352" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh6" vTcl:WidgetProc "Toplevel352" 1
    frame $site_5_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd73" "Frame1" vTcl:WidgetProc "Toplevel352" 1
    set site_6_0 $site_5_0.cpd73
    label $site_6_0.lab72 \
        -text / 
    vTcl:DefineAlias "$site_6_0.lab72" "Label2" vTcl:WidgetProc "Toplevel352" 1
    entry $site_6_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable FilterOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd75" "Entry1" vTcl:WidgetProc "Toplevel352" 1
    pack $site_6_0.lab72 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame14" vTcl:WidgetProc "Toplevel352" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != ""} {
    ...
    vTcl:DefineAlias "$top.fra29" "Frame9" vTcl:WidgetProc "Toplevel352" 1
    set site_3_0 $top.fra29
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel352" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel352" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel352" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel352" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel352" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel352" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel352" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel352" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.lab77" "Label1" vTcl:WidgetProc "Toplevel352" 1
    TitleFrame $top.tit78 \
        -text {Output Format} 
    vTcl:DefineAlias "$top.tit78" "TitleFrame352_1" vTcl:WidgetProc "Toplevel352" 1
...
set FilterOutputSubDir "T3"} \
    ...
    vTcl:DefineAlias "$site_4_0.rad81" "Radiobutton352_1" vTcl:WidgetProc "Toplevel352" 1
    radiobutton $site_4_0.rad82 \
        -command {global FilterOutputSubDir

set FilterOutputSubDir "C3"} \
        -text {[S2] >> [C3]} -value S2C3 -variable FilterFonc 
    vTcl:DefineAlias "$site_4_0.rad82" "Radiobutton352_2" vTcl:WidgetProc "Toplevel352" 1
...
if {$PolarCase == "bistatic"} {
    ...
    vTcl:DefineAlias "$site_4_0.cpd84" "Radiobutton352_3" vTcl:WidgetProc "Toplevel352" 1
...
if {$PolarCase == "bistatic"} {
    ...
    vTcl:DefineAlias "$site_4_0.cpd85" "Radiobutton352_4" vTcl:WidgetProc "Toplevel352" 1
    pack $site_4_0.rad81 \
    ...
    frame $top.fra66 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra66" "Frame3" vTcl:WidgetProc "Toplevel352" 1
    set site_3_0 $top.fra66
    frame $site_3_0.fra67 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra67" "Frame4" vTcl:WidgetProc "Toplevel352" 1
    set site_4_0 $site_3_0.fra67
    frame $site_4_0.fra69 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra69" "Frame6" vTcl:WidgetProc "Toplevel352" 1
    set site_5_0 $site_4_0.fra69
    label $site_5_0.cpd70 \
        -padx 1 -text {Number of Looks} 
    vTcl:DefineAlias "$site_5_0.cpd70" "Label204" vTcl:WidgetProc "Toplevel352" 1
    frame $site_5_0.fra71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra71" "Frame7" vTcl:WidgetProc "Toplevel352" 1
    set site_6_0 $site_5_0.fra71
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NlookSigma -width 5 
    vTcl:DefineAlias "$site_6_0.cpd72" "Entry204" vTcl:WidgetProc "Toplevel352" 1
...
if {$NlookSigma == 5} { set NlookSigma 1 }} \
    ...
    vTcl:DefineAlias "$site_6_0.but73" "Button1" vTcl:WidgetProc "Toplevel352" 1
...
if {$NlookSigma == 0} { set NlookSigma 4 }} \
        ...
        -pady 0 
    vTcl:DefineAlias "$site_6_0.cpd75" "Button2" vTcl:WidgetProc "Toplevel352" 1
    pack $site_6_0.cpd72 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.but73 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    ...
    frame $site_4_0.cpd76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd76" "Frame8" vTcl:WidgetProc "Toplevel352" 1
    set site_5_0 $site_4_0.cpd76
    label $site_5_0.cpd70 \
        -padx 1 -text {Window Size (Target)} 
    vTcl:DefineAlias "$site_5_0.cpd70" "Label205" vTcl:WidgetProc "Toplevel352" 1
    frame $site_5_0.fra71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra71" "Frame10" vTcl:WidgetProc "Toplevel352" 1
    set site_6_0 $site_5_0.fra71
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NwinTgt -width 5 
    vTcl:DefineAlias "$site_6_0.cpd72" "Entry205" vTcl:WidgetProc "Toplevel352" 1
    button $site_6_0.but73 \
        \
...
if {$NwinTgt == 7} { set NwinTgt 3 }} \
        -image [vTcl:image:get_image [file join . GUI Images up.gif]] -pady 0 
    vTcl:DefineAlias "$site_6_0.but73" "Button3" vTcl:WidgetProc "Toplevel352" 1
    button $site_6_0.cpd75 \
        \
        -command {global NwinTgt
...
if {$NwinTgt == 1} { set NwinTgt 5 }} \
        -image [vTcl:image:get_image [file join . GUI Images down.gif]] \
        -pady 0 
    vTcl:DefineAlias "$site_6_0.cpd75" "Button4" vTcl:WidgetProc "Toplevel352" 1
    pack $site_6_0.cpd72 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.but73 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    ...
    frame $site_3_0.cpd77 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd77" "Frame5" vTcl:WidgetProc "Toplevel352" 1
    set site_4_0 $site_3_0.cpd77
    frame $site_4_0.fra69 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra69" "Frame11" vTcl:WidgetProc "Toplevel352" 1
    set site_5_0 $site_4_0.fra69
    label $site_5_0.cpd70 \
        -padx 1 -text Sigma 
    vTcl:DefineAlias "$site_5_0.cpd70" "Label206" vTcl:WidgetProc "Toplevel352" 1
    frame $site_5_0.fra71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra71" "Frame12" vTcl:WidgetProc "Toplevel352" 1
    set site_6_0 $site_5_0.fra71
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable Sigma -width 5 
    vTcl:DefineAlias "$site_6_0.cpd72" "Entry206" vTcl:WidgetProc "Toplevel352" 1
    button $site_6_0.but73 \
        \
...
if {$Sigma == 1.0} { set Sigma 0.5 }} \
        -image [vTcl:image:get_image [file join . GUI Images up.gif]] -pady 0 
    vTcl:DefineAlias "$site_6_0.but73" "Button5" vTcl:WidgetProc "Toplevel352" 1
    button $site_6_0.cpd75 \
        \
        -command {global Sigma
...
if {$Sigma == 0.4} { set Sigma 0.9 }} \
        -image [vTcl:image:get_image [file join . GUI Images down.gif]] \
        -pady 0 
    vTcl:DefineAlias "$site_6_0.cpd75" "Button6" vTcl:WidgetProc "Toplevel352" 1
    pack $site_6_0.cpd72 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.but73 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    ...
    frame $site_4_0.cpd76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd76" "Frame15" vTcl:WidgetProc "Toplevel352" 1
    set site_5_0 $site_4_0.cpd76
    label $site_5_0.cpd70 \
        -padx 1 -text {Window Size (Filter)} 
    vTcl:DefineAlias "$site_5_0.cpd70" "Label207" vTcl:WidgetProc "Toplevel352" 1
    frame $site_5_0.fra71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra71" "Frame16" vTcl:WidgetProc "Toplevel352" 1
    set site_6_0 $site_5_0.fra71
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NwinFilter -width 5 
    vTcl:DefineAlias "$site_6_0.cpd72" "Entry207" vTcl:WidgetProc "Toplevel352" 1
    button $site_6_0.but73 \
        \
...
if {$NwinFilter == 13} { set NwinFilter 7 }} \
        -image [vTcl:image:get_image [file join . GUI Images up.gif]] -pady 0 
    vTcl:DefineAlias "$site_6_0.but73" "Button7" vTcl:WidgetProc "Toplevel352" 1
    button $site_6_0.cpd75 \
        \
        -command {global NwinFilter
...
if {$NwinFilter == 5} { set NwinFilter 11 }} \
        -image [vTcl:image:get_image [file join . GUI Images down.gif]] \
        -pady 0 
    vTcl:DefineAlias "$site_6_0.cpd75" "Button8" vTcl:WidgetProc "Toplevel352" 1
    pack $site_6_0.cpd72 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.but73 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.fra36" "Frame20" vTcl:WidgetProc "Toplevel352" 1
...
global NlookSigma Sigma NwinTgt NwinFilter PSPMemory TMPMemoryAllocError DataFormatActive
...
if {"$VarWarning"=="ok"} {
    ...
    if {$TestVarError == "ok"} {
        ...
        TextEditorRunTrace "Arguments: -id \x22$FilterDirInput\x22 -od \x22$FilterDirOutput\x22 -iodf $FilterFonc -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nlk $NlookSigma -sig $Sigma0 -nwe $NwinFilter -nwt $NwinTgt -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
        set f [ open "| Soft/speckle_filter/lee_sigma_filter.exe -id \x22$FilterDirInput\x22 -od \x22$FilterDirOutput\x22 -iodf $FilterFonc -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nlk $NlookSigma -sig $Sigma0 -nwe $NwinFilter -nwt $NwinTgt -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
        PsPprogressBar $f
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel352); TextEditorRunTrace "Close Window Speckle Filter" "b"}
    }
}
...
if {"$VarWarning"=="ok"} {
    ...
    if {$TestVarError == "ok"} {
        ...
        update
        TextEditorRunTrace "Process The Function Soft/speckle_filter/lee_sigma_filter.exe" "k"
        TextEditorRunTrace "Arguments: -id \x22$FilterDirInput\x22 -od \x22$FilterDirOutputTmp\x22 -iodf $FilterFonc -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nlk $NlookSigma -sig $Sigma0 -nwe $NwinFilter -nwt $NwinTgt -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
        set f [ open "| Soft/speckle_filter/lee_sigma_filter.exe -id \x22$FilterDirInput\x22 -od \x22$FilterDirOutputTmp\x22 -iodf $FilterFonc -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nlk $NlookSigma -sig $Sigma0 -nwe $NwinFilter -nwt $NwinTgt -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
        PsPprogressBar $f
        TextEditorRunTrace "Check RunTime Errors" "r"
        CheckRunTimeError
        WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel352" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/SpeckleFilterSigma.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel352" 1
...
Window hide $widget(Toplevel352); TextEditorRunTrace "Close Window Speckle Filter" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel352" 1
    ...
    vTcl:DefineAlias "$top.che68" "Checkbutton352_1" vTcl:WidgetProc "Toplevel352" 1
    ###################
    # SETTING GEOMETRY
    ###################
    pack $top.cpd73 \
