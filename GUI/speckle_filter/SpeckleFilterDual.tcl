...
proc vTcl:project:info {} {
    ...
    namespace eval ::widgets::$site_5_0.fra80 {
        array set save {-borderwidth 1 -height 1 -width 1}
    }
    set site_6_0 $site_5_0.fra80
...
proc vTclWindow.top303 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel303" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd71 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd71" "Frame2" vTcl:WidgetProc "Toplevel303" 1
    set site_3_0 $top.cpd71
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Master Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame303_1" vTcl:WidgetProc "Toplevel303" 1
    ...
    entry $site_5_0.cpd85 \
        ...
        -textvariable FilterMasterDirInput 
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry303_01" vTcl:WidgetProc "Toplevel303" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame13" vTcl:WidgetProc "Toplevel303" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd86 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd86" "Button34" vTcl:WidgetProc "Toplevel303" 1
    pack $site_6_0.cpd86 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd81" "TitleFrame303_2" vTcl:WidgetProc "Toplevel303" 1
    ...
    entry $site_5_0.cpd85 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable FilterSlaveDirInput 
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry303_02" vTcl:WidgetProc "Toplevel303" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel303" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd86 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd86" "Button35" vTcl:WidgetProc "Toplevel303" 1
    pack $site_6_0.cpd86 \
        -in $site_6_0 -anchor center -expand 1 -fill none -side top 
    pack $site_5_0.cpd85 \
        -in $site_5_0 -anchor center -expand 1 -fill x -side left 
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame303_3" vTcl:WidgetProc "Toplevel303" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry303_03" vTcl:WidgetProc "Toplevel303" 1
    frame $site_5_0.cpd95 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd95" "Frame1" vTcl:WidgetProc "Toplevel303" 1
    set site_6_0 $site_5_0.cpd95
    label $site_6_0.cpd97 \
        -text / 
    vTcl:DefineAlias "$site_6_0.cpd97" "Label303_01" vTcl:WidgetProc "Toplevel303" 1
    entry $site_6_0.ent94 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable FilterOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.ent94" "Entry303_04" vTcl:WidgetProc "Toplevel303" 1
    pack $site_6_0.cpd97 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame14" vTcl:WidgetProc "Toplevel303" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd72 \
        \
        -command {global DirName DataDirChannel1 FilterDirOutput FilterOutputDir FilterOutputSubDir
...
if {$DirName != ""} {
    ...
    vTcl:DefineAlias "$site_6_0.cpd72" "Button303_01" vTcl:WidgetProc "Toplevel303" 1
    ...
    vTcl:DefineAlias "$top.fra29" "Frame9" vTcl:WidgetProc "Toplevel303" 1
    set site_3_0 $top.fra29
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel303" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel303" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel303" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel303" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel303" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel303" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel303" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel303" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.lab75" "Label1" vTcl:WidgetProc "Toplevel303" 1
    frame $top.fra30 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra30" "Frame149" vTcl:WidgetProc "Toplevel303" 1
    set site_3_0 $top.fra30
    frame $site_3_0.fra22 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra22" "Frame248" vTcl:WidgetProc "Toplevel303" 1
    set site_4_0 $site_3_0.fra22
    frame $site_4_0.fra25 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra25" "Frame249" vTcl:WidgetProc "Toplevel303" 1
    set site_5_0 $site_4_0.fra25
    frame $site_5_0.fra77 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra77" "Frame3" vTcl:WidgetProc "Toplevel303" 1
    set site_6_0 $site_5_0.fra77
    label $site_6_0.cpd78 \
        -padx 1 -text {Number of Looks} 
    vTcl:DefineAlias "$site_6_0.cpd78" "Label303_1" vTcl:WidgetProc "Toplevel303" 1
    entry $site_6_0.cpd79 \
        -background white -foreground #ff0000 -justify center \
        -textvariable Nlook -width 5 
    vTcl:DefineAlias "$site_6_0.cpd79" "Entry303_1" vTcl:WidgetProc "Toplevel303" 1
    pack $site_6_0.cpd78 \
        -in $site_6_0 -anchor center -expand 1 -fill none -side left 
    pack $site_6_0.cpd79 \
        -in $site_6_0 -anchor center -expand 1 -fill none -padx 10 -side left 
    frame $site_5_0.fra80 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra80" "Frame4" vTcl:WidgetProc "Toplevel303" 1
    set site_6_0 $site_5_0.fra80
    label $site_6_0.cpd81 \
        -padx 1 -text {Window Size Row} 
    vTcl:DefineAlias "$site_6_0.cpd81" "Label303_2" vTcl:WidgetProc "Toplevel303" 1
    entry $site_6_0.cpd82 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinFilterL -width 5 
    vTcl:DefineAlias "$site_6_0.cpd82" "Entry303_2" vTcl:WidgetProc "Toplevel303" 1
    pack $site_6_0.cpd81 \
        -in $site_6_0 -anchor center -expand 1 -fill none -side left 
    pack $site_6_0.cpd82 \
        -in $site_6_0 -anchor center -expand 1 -fill none -padx 10 -side left 
    frame $site_5_0.cpd67 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd67" "Frame5" vTcl:WidgetProc "Toplevel303" 1
    set site_6_0 $site_5_0.cpd67
    label $site_6_0.cpd81 \
        -padx 1 -text {Window Size Col} 
    vTcl:DefineAlias "$site_6_0.cpd81" "Label303_3" vTcl:WidgetProc "Toplevel303" 1
    entry $site_6_0.cpd82 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinFilterC -width 5 
    vTcl:DefineAlias "$site_6_0.cpd82" "Entry303_3" vTcl:WidgetProc "Toplevel303" 1
    pack $site_6_0.cpd81 \
        -in $site_6_0 -anchor center -expand 1 -fill none -side left 
    pack $site_6_0.cpd82 \
        -in $site_6_0 -anchor center -expand 1 -fill none -padx 10 -side left 
    ...
    vTcl:DefineAlias "$top.fra36" "Frame20" vTcl:WidgetProc "Toplevel303" 1
    set site_3_0 $top.fra36
    button $site_3_0.but93 \
        -background #ffff00 \
        -command {global DataDirChannel1 DataDirChannel2 DirName
global FilterMasterDirInput FilterSlaveDirInput FilterDirOutput FilterOutputDir FilterOutputSubDir
...
if {"$VarWarning"=="ok"} {
    ...
    if {$TestVarError == "ok"} {
        ...
        set MaskCmd ""
        if {$FilterFonc == "SPPT4" || $FilterFonc == "S2T6"} {
            set MaskFileOut "$FilterDirOutput/mask_valid_pixels.bin"
            if [file exists $MaskFileOut] {
                set MaskCmd "-mask \x22$MaskFileOut\x22"
                } else {
                set MaskFile1 "$FilterMasterDirInput/mask_valid_pixels.bin"
                set MaskFile2 "$FilterSlaveDirInput/mask_valid_pixels.bin"
        ...
        if {$FilterFonc == "T4" || $FilterFonc == "T6"} {
            set MaskFile "$FilterMasterDirInput/mask_valid_pixels.bin"
        ...
        LoadConfig
        if {"$ErrorMessage" == ""} {
            EnviWriteConfigT $FilterDirOutput $NligFullSize $NcolFullSize
            set DataDirChannel1 $FilterOutputDir
            set DataDirChannel2 $FilterOutputDir
            MenuOn
            if {$FilterFonc == "SPPT4" || $FilterFonc == "T4"} { set DataFormatActive "T4"}
            if {$FilterFonc == "S2T6"  || $FilterFonc == "T6"} { set DataFormatActive "T6"}
            } else {
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel303); TextEditorRunTrace "Close Window Speckle Filter Dual" "b"}
    }
}} \
        -cursor {} -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel303" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/SpeckleFilterDual.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel303" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel303); TextEditorRunTrace "Close Window Speckle Filter Dual" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel303" 1
