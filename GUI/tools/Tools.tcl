...
proc vTclWindow.top29 {base} {
    ...
    wm resizable $top 1 1
    wm title $top "Tools"
    vTcl:DefineAlias "$top" "Toplevel29" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd95 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd95" "Frame3" vTcl:WidgetProc "Toplevel29" 1
    set site_3_0 $top.cpd95
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame6" vTcl:WidgetProc "Toplevel29" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh3" vTcl:WidgetProc "Toplevel29" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame13" vTcl:WidgetProc "Toplevel29" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button38" vTcl:WidgetProc "Toplevel29" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame7" vTcl:WidgetProc "Toplevel29" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh7" vTcl:WidgetProc "Toplevel29" 1
    frame $site_5_0.cpd72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd72" "Frame1" vTcl:WidgetProc "Toplevel29" 1
    set site_6_0 $site_5_0.cpd72
    label $site_6_0.lab73 \
        -text / 
    vTcl:DefineAlias "$site_6_0.lab73" "Label1" vTcl:WidgetProc "Toplevel29" 1
    entry $site_6_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ToolsOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd75" "Entry1" vTcl:WidgetProc "Toplevel29" 1
    pack $site_6_0.lab73 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame14" vTcl:WidgetProc "Toplevel29" 1
    set site_6_0 $site_5_0.cpd91
...
if {$DirName != "" } {
    ...
    vTcl:DefineAlias "$top.fra27" "Frame9" vTcl:WidgetProc "Toplevel29" 1
    set site_3_0 $top.fra27
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel29" 1
    entry $site_3_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel29" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel29" 1
    entry $site_3_0.ent60 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel29" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel29" 1
    entry $site_3_0.ent62 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel29" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel29" 1
    entry $site_3_0.ent64 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel29" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.fra32 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra32" "Frame247" vTcl:WidgetProc "Toplevel29" 1
    set site_3_0 $top.fra32
    frame $site_3_0.fra33 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra33" "Frame94" vTcl:WidgetProc "Toplevel29" 1
    set site_4_0 $site_3_0.fra33
    label $site_4_0.lab37 \
        -image [vTcl:image:get_image [file join . GUI Images Warning.gif]] \
        -text label 
    vTcl:DefineAlias "$site_4_0.lab37" "Label91" vTcl:WidgetProc "Toplevel29" 1
...
if {"$ToolsErase"=="0"} {
    ...
    vTcl:DefineAlias "$site_4_0.che40" "Checkbutton44" vTcl:WidgetProc "Toplevel29" 1
    pack $site_4_0.lab37 \
    ...
    vTcl:DefineAlias "$site_3_0.ent34" "Entry175" vTcl:WidgetProc "Toplevel29" 1
    pack $site_3_0.fra33 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    pack $site_3_0.ent34 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.fra41" "Frame20" vTcl:WidgetProc "Toplevel29" 1
...
if {"$VarWarning"=="ok"} {
    ...
    if {$FormatTools == "sinclair"} {
        if [file exists "$ToolsDirInput/s11.bin"] {
            ...
            TextEditorRunTrace "Arguments: -id \x22$ToolsDirInput\x22 -od \x22$ToolsDirOutput\x22 -if \x22$ToolsFileInput\x22 -of \x22$ToolsFileOutput\x22 -op $ToolsOperation -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol" "k"
            set f [ open "| $ToolsFunction -id \x22$ToolsDirInput\x22 -od \x22$ToolsDirOutput\x22 -if \x22$ToolsFileInput\x22 -of \x22$ToolsFileOutput\x22 -op $ToolsOperation -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol" r]
            PsPprogressBar $f
    ...
    if {"$ToolsErase"=="0"} {
        if {$ToolsOperation == "ieee"} { append DataDir "_IEEE" }
        if {$ToolsOperation == "extract"} { append DataDir "_SUB" }
        if {$ToolsOperation == "rot90l"} { append DataDir "_L90" }
        if {$ToolsOperation == "rot90r"} { append DataDir "_R90" }
        if {$ToolsOperation == "rot180"} { append DataDir "_R180" }
        if {$ToolsOperation == "flipud"} { append DataDir "_FUD" }
        if {$ToolsOperation == "fliplr"} { append DataDir "_FLR" }
        if {$ToolsOperation == "transp"} { append DataDir "_TRP" }
        if {$ToolsOperation == "fft"} { append DataDir "_FFT" }
        }
        
    WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
    Window hide $widget(Toplevel29); TextEditorRunTrace "Close Window Tools" "b"
    } else {
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel29); TextEditorRunTrace "Close Window Tools" "b"}
    }
}} \
        -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel29" 1
    ...
    button $site_3_0.but23 \
        ...
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel29" 1
...
Window hide $widget(Toplevel29); TextEditorRunTrace "Close Window Tools" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel29" 1
