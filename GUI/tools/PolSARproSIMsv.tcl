...
global PSPSIMRandom PSPSIMNrows PSPSIMNcols PSPSIMConfig PSPSIMVegHeight
...
puts $f [format "%-*.4f%s" 12 $PSPSIMVegHeight "/* Mean vegetation height in metres                              */"]
close $f
}
}
#############################################################################
## Procedure:  PSPSIMsv_RGB_S2

proc ::PSPSIMsv_RGB_S2 {DirInputOutput} {
...
#############################################################################
## Procedure:  PSPSIMsv_RGB_SPP

proc ::PSPSIMsv_RGB_SPP {DirInputOutput} {
...
proc vTclWindow.top404 {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "PolSARpro Ground + Small vegetation Simulator"
    vTcl:DefineAlias "$top" "Toplevel404" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.fra69" "Frame1" vTcl:WidgetProc "Toplevel404" 1
...
global PSPSIMSurface PSPSIMMoisture PSPSIMAzSlope PSPSIMRgSlope
global PSPSIMTreeSpecies PSPSIMTreeHeight PSPSIMForestArea PSPSIMForestDensity
global PSPSIMSurfArea PSPSIMVegHeight
...
set TestVarName(9) "Forest Stand Area"; set TestVarType(9) "float"; set TestVarValue(9) $PSPSIMForestArea; set TestVarMin(9) "0"; set TestVarMax(9) ""
set TestVarName(10) "Random Number Generator"; set TestVarType(10) "int"; set TestVarValue(10) $PSPSIMRandom; set TestVarMin(10) "0"; set TestVarMax(10) "65535"
set TestVarName(11) "Vegetation Height"; set TestVarType(11) "float"; set TestVarValue(11) $PSPSIMVegHeight; set TestVarMin(11) "0.05"; set TestVarMax(11) ""
TestVar 12
...
if {$OpenDirFile == 0} {
    ...
    if {$config == "okok"} {
        ...
        set Fonction "PolSARpro Ground + Vegetation Simulator"
        set Fonction2 ""
        set ProgressLine "0"
        WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
        update
        TextEditorRunTrace "Process The Function Soft/bin/PolSARproSIMsv/PolSARproSim_sv.exe" "k"
        TextEditorRunTrace "Arguments: \x22$PSPSIMConfig\x22 \x22$PSPSIMChannel1\x22 \x22$PSPSIMChannel2\x22" "k"
        set f [ open "| Soft/bin/PolSARproSIMsv/PolSARproSim_sv.exe \x22$PSPSIMConfig\x22 \x22$PSPSIMChannel1\x22 \x22$PSPSIMChannel2\x22" r]
        PsPprogressBar $f
        TextEditorRunTrace "Check RunTime Errors" "r"
        CheckRunTimeError
        WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
        ...
        if {"$ErrorMessage" == ""} {
            ...
            if {$PSPOutputFormat == "quad"} {
                PSPSIMsv_RGB_S2 $PSPSIMChannel1
                } else {
                PSPSIMsv_RGB_SPP $PSPSIMChannel1
                }
        ...
        if {"$ErrorMessage" == ""} {
            ...
            if {$PSPOutputFormat == "quad"} {
                PSPSIMsv_RGB_S2 $PSPSIMChannel2
                } else {
                PSPSIMsv_RGB_SPP $PSPSIMChannel2
                }
        ...
        if {$config == "masterslave"} {
            ...
            WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
            update
            TextEditorRunTrace "Process The Function Soft/bin/PolSARproSIMsv/PolSARproSim_FE_Kz.exe" "k"
            ...
            set f [ open "| Soft/bin/PolSARproSIMsv/PolSARproSim_FE_Kz.exe \x22$PSPSIMChannel2\x22 $PSPSIMNrows $PSPSIMNcols $PSPSIMDy $PSPSIMFrequency $PSPSIMIncAngle1 $PSPSIMAltitude $PSPSIMHorBaseline $PSPSIMVerBaseline" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
        ...
        Window hide $widget(Toplevel404); TextEditorRunTrace "Close PolSARpro Ground + Small Vegetation Simulator" "b"
        } else {
        if {$config =="nono"} {Window hide $widget(Toplevel404); TextEditorRunTrace "Close PolSARpro Ground + Small Vegetation Simulator" "b"}
        }
    }
}} \
        -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.cpd122" "Button404_0" vTcl:WidgetProc "Toplevel404" 1
    ...
    button $site_3_0.cpd71 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/tools/PolSARproSIMsv.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -padx 1 -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.cpd71" "Button3" vTcl:WidgetProc "Toplevel404" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel404); TextEditorRunTrace "Close Window PolSARpro Ground + Small Vegetation Simulator" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.cpd70" "Button2" vTcl:WidgetProc "Toplevel404" 1
    ...
    vTcl:DefineAlias "$top.tit92" "TitleFrame1" vTcl:WidgetProc "Toplevel404" 1
    ...
    frame $site_4_0.fra81 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra81" "Frame5" vTcl:WidgetProc "Toplevel404" 1
    set site_5_0 $site_4_0.fra81
...
if {$DirName != ""} {
    ...
    set PSPSIMChannel1 $DataDirTmp
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd82" "Button404_1" vTcl:WidgetProc "Toplevel404" 1
...
set PSPSIMChannel1 [file dirname $PSPSIMChannel1]
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd72" "Button404_2" vTcl:WidgetProc "Toplevel404" 1
...
set PSPSIMChannel1 $env(HOME)
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd73" "Button404_3" vTcl:WidgetProc "Toplevel404" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd79" "Entry100" vTcl:WidgetProc "Toplevel404" 1
    ...
    vTcl:DefineAlias "$top.cpd82" "TitleFrame3" vTcl:WidgetProc "Toplevel404" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd79" "Entry200" vTcl:WidgetProc "Toplevel404" 1
    bindtags $site_4_0.cpd79 "$site_4_0.cpd79 Entry $top all _vTclBalloon"
    bind $site_4_0.cpd79 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Main Directory}
    }
    frame $site_4_0.fra81 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra81" "Frame8" vTcl:WidgetProc "Toplevel404" 1
    set site_5_0 $site_4_0.fra81
    button $site_5_0.cpd82 \
        \
...
if {$DirName != ""} {
    ...
    set PSPSIMChannel2 $DataDirTmp
        ...
        -image [vTcl:image:get_image [file join . GUI Images OpenDir.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd82" "Button404_4" vTcl:WidgetProc "Toplevel404" 1
    bindtags $site_5_0.cpd82 "$site_5_0.cpd82 Button $top all _vTclBalloon"
    bind $site_5_0.cpd82 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Open File}
    }
...
set PSPSIMChannel2 [file dirname $PSPSIMChannel2]
        ...
        -image [vTcl:image:get_image [file join . GUI Images DecrDir.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd72" "Button404_5" vTcl:WidgetProc "Toplevel404" 1
    bindtags $site_5_0.cpd72 "$site_5_0.cpd72 Button $top all _vTclBalloon"
    bind $site_5_0.cpd72 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Parent Directory}
    }
...
set PSPSIMChannel2 $env(HOME)
        ...
        -image [vTcl:image:get_image [file join . GUI Images HomeDir.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd73" "Button404_6" vTcl:WidgetProc "Toplevel404" 1
    bindtags $site_5_0.cpd73 "$site_5_0.cpd73 Button $top all _vTclBalloon"
    bind $site_5_0.cpd73 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Home Directory}
    }
    ...
    TitleFrame $top.tit95 \
        -text {Geometric Configuration} 
    vTcl:DefineAlias "$top.tit95" "TitleFrame2" vTcl:WidgetProc "Toplevel404" 1
    ...
    frame $site_4_0.cpd87 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd87" "Frame4" vTcl:WidgetProc "Toplevel404" 1
    set site_5_0 $site_4_0.cpd87
    frame $site_5_0.fra81 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra81" "Frame14" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.fra81
    label $site_6_0.lab83 \
        -text {Platform Altitude ( m )} 
    vTcl:DefineAlias "$site_6_0.lab83" "Label1" vTcl:WidgetProc "Toplevel404" 1
    ...
    vTcl:DefineAlias "$site_6_0.ent84" "Entry1" vTcl:WidgetProc "Toplevel404" 1
    pack $site_6_0.lab83 \
    ...
    frame $site_5_0.cpd85 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd85" "Frame16" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd85
    label $site_6_0.lab83 \
        -text {Incidence Angle ( deg )  } 
    vTcl:DefineAlias "$site_6_0.lab83" "Label6" vTcl:WidgetProc "Toplevel404" 1
    entry $site_6_0.ent84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PSPSIMIncAngle1 -width 10 
    vTcl:DefineAlias "$site_6_0.ent84" "Entry2" vTcl:WidgetProc "Toplevel404" 1
    pack $site_6_0.lab83 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.ent84 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side right 
    ...
    frame $site_4_0.cpd88 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd88" "Frame12" vTcl:WidgetProc "Toplevel404" 1
    set site_5_0 $site_4_0.cpd88
    frame $site_5_0.fra81 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra81" "Frame15" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.fra81
    label $site_6_0.lab83 \
        -text {Horizontal Baseline ( m )  } 
    vTcl:DefineAlias "$site_6_0.lab83" "Label7" vTcl:WidgetProc "Toplevel404" 1
    entry $site_6_0.ent84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PSPSIMHorBaseline -width 10 
    vTcl:DefineAlias "$site_6_0.ent84" "Entry3" vTcl:WidgetProc "Toplevel404" 1
    pack $site_6_0.lab83 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.ent84 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side right 
    frame $site_5_0.cpd85 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd85" "Frame17" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd85
    label $site_6_0.lab83 \
        -text {Vertical Baseline ( m )} 
    vTcl:DefineAlias "$site_6_0.lab83" "Label8" vTcl:WidgetProc "Toplevel404" 1
    entry $site_6_0.ent84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PSPSIMVerBaseline -width 10 
    vTcl:DefineAlias "$site_6_0.ent84" "Entry4" vTcl:WidgetProc "Toplevel404" 1
    pack $site_6_0.lab83 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.ent84 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side right 
    ...
    vTcl:DefineAlias "$top.cpd91" "TitleFrame5" vTcl:WidgetProc "Toplevel404" 1
    ...
    frame $site_4_0.cpd76 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd76" "Frame18" vTcl:WidgetProc "Toplevel404" 1
    set site_5_0 $site_4_0.cpd76
    frame $site_5_0.cpd78 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd78" "Frame44" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd78
    label $site_6_0.lab83 \
        -text {Centre Frequency ( GHz )  } 
    vTcl:DefineAlias "$site_6_0.lab83" "Label34" vTcl:WidgetProc "Toplevel404" 1
    entry $site_6_0.ent84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PSPSIMFrequency -width 10 
    vTcl:DefineAlias "$site_6_0.ent84" "Entry14" vTcl:WidgetProc "Toplevel404" 1
    pack $site_6_0.lab83 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.ent84 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side right 
    ...
    frame $site_4_0.cpd77 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd77" "Frame37" vTcl:WidgetProc "Toplevel404" 1
    set site_5_0 $site_4_0.cpd77
    frame $site_5_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd74" "Frame42" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd74
    frame $site_6_0.cpd84 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd84" "Frame45" vTcl:WidgetProc "Toplevel404" 1
    set site_7_0 $site_6_0.cpd84
    label $site_7_0.lab83 \
        -text {Azimuth Resolution ( m )   } 
    vTcl:DefineAlias "$site_7_0.lab83" "Label35" vTcl:WidgetProc "Toplevel404" 1
    pack $site_7_0.lab83 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.cpd85 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd85" "Frame47" vTcl:WidgetProc "Toplevel404" 1
    set site_7_0 $site_6_0.cpd85
    label $site_7_0.cpd83 \
        -text {Slant Range Resolution ( m ) } 
    vTcl:DefineAlias "$site_7_0.cpd83" "Label39" vTcl:WidgetProc "Toplevel404" 1
    pack $site_7_0.cpd83 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.cpd84 \
    ...
    frame $site_5_0.cpd80 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd80" "Frame46" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd80
    entry $site_6_0.ent84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PSPSIMAzResol -width 10 
    vTcl:DefineAlias "$site_6_0.ent84" "Entry17" vTcl:WidgetProc "Toplevel404" 1
    entry $site_6_0.cpd81 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PSPSIMRgResol -width 10 
    vTcl:DefineAlias "$site_6_0.cpd81" "Entry18" vTcl:WidgetProc "Toplevel404" 1
    pack $site_6_0.ent84 \
    ...
    TitleFrame $top.cpd72 \
        -text {Ground Surface Configuration} 
    vTcl:DefineAlias "$top.cpd72" "TitleFrame4" vTcl:WidgetProc "Toplevel404" 1
    ...
    frame $site_5_0.cpd87 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd87" "Frame6" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd87
    frame $site_6_0.fra81 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra81" "Frame21" vTcl:WidgetProc "Toplevel404" 1
    set site_7_0 $site_6_0.fra81
    label $site_7_0.lab83 \
        -text {Surface Properties} 
    vTcl:DefineAlias "$site_7_0.lab83" "Label3" vTcl:WidgetProc "Toplevel404" 1
    pack $site_7_0.lab83 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.cpd85 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd85" "Frame26" vTcl:WidgetProc "Toplevel404" 1
    set site_7_0 $site_6_0.cpd85
    label $site_7_0.lab83 \
        -text {Ground Moisture Content} 
    vTcl:DefineAlias "$site_7_0.lab83" "Label18" vTcl:WidgetProc "Toplevel404" 1
    pack $site_7_0.lab83 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.fra81 \
        -in $site_6_0 -anchor center -expand 1 -fill x -side top 
    ...
    frame $site_5_0.cpd88 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd88" "Frame27" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd88
    frame $site_6_0.fra81 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra81" "Frame28" vTcl:WidgetProc "Toplevel404" 1
    set site_7_0 $site_6_0.fra81
    label $site_7_0.lab83 \
        -text {(  Smoothest = 0} 
    vTcl:DefineAlias "$site_7_0.lab83" "Label19" vTcl:WidgetProc "Toplevel404" 1
    label $site_7_0.cpd73 \
        -text {(  Driest = 0} 
    vTcl:DefineAlias "$site_7_0.cpd73" "Label27" vTcl:WidgetProc "Toplevel404" 1
    pack $site_7_0.lab83 \
    ...
    frame $site_6_0.cpd85 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd85" "Frame29" vTcl:WidgetProc "Toplevel404" 1
    set site_7_0 $site_6_0.cpd85
    label $site_7_0.lab83 \
        -text {  .....  } 
    vTcl:DefineAlias "$site_7_0.lab83" "Label20" vTcl:WidgetProc "Toplevel404" 1
    label $site_7_0.cpd74 \
        -text {  .....  } 
    vTcl:DefineAlias "$site_7_0.cpd74" "Label29" vTcl:WidgetProc "Toplevel404" 1
    pack $site_7_0.lab83 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side top 
    pack $site_7_0.cpd74 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side top 
    frame $site_6_0.cpd75 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd75" "Frame34" vTcl:WidgetProc "Toplevel404" 1
    set site_7_0 $site_6_0.cpd75
    label $site_7_0.lab83 \
        -text {Roughest = 10  )} 
    vTcl:DefineAlias "$site_7_0.lab83" "Label31" vTcl:WidgetProc "Toplevel404" 1
    label $site_7_0.cpd74 \
        -text {Wettest = 10  )} 
    vTcl:DefineAlias "$site_7_0.cpd74" "Label32" vTcl:WidgetProc "Toplevel404" 1
    pack $site_7_0.lab83 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side top 
    pack $site_7_0.cpd74 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side top 
    ...
    frame $site_5_0.cpd100 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd100" "Frame2" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd100
    frame $site_6_0.cpd101 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd101" "Frame10" vTcl:WidgetProc "Toplevel404" 1
    set site_7_0 $site_6_0.cpd101
    ...
    vTcl:DefineAlias "$site_7_0.cpd72" "Label11" vTcl:WidgetProc "Toplevel404" 1
...
if {$PSPSIMSurface == "11" } { set PSPSIMSurface "0" }} \
        ...
        -text button 
    vTcl:DefineAlias "$site_7_0.but75" "Button13" vTcl:WidgetProc "Toplevel404" 1
...
if {$PSPSIMSurface == "-1" } { set PSPSIMSurface "10" }} \
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_7_0.but76" "Button14" vTcl:WidgetProc "Toplevel404" 1
    label $site_7_0.cpd108 \
        -width 5 
    vTcl:DefineAlias "$site_7_0.cpd108" "Label5" vTcl:WidgetProc "Toplevel404" 1
    pack $site_7_0.cpd72 \
    ...
    frame $site_6_0.cpd102 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd102" "Frame11" vTcl:WidgetProc "Toplevel404" 1
    set site_7_0 $site_6_0.cpd102
    label $site_7_0.cpd72 \
        -background #ffffff -disabledforeground #ffffff -foreground #0000ff \
        -relief sunken -textvariable PSPSIMMoisture -width 5 
    vTcl:DefineAlias "$site_7_0.cpd72" "Label22" vTcl:WidgetProc "Toplevel404" 1
    bindtags $site_7_0.cpd72 "$site_7_0.cpd72 Label $top all _vTclBalloon"
    bind $site_7_0.cpd72 <<SetBalloon>> {
        set ::vTcl::balloon::%W {DIsplay Screen Width Size}
    }
...
if {$PSPSIMMoisture == "11" } { set PSPSIMMoisture "0" }} \
        -image [vTcl:image:get_image [file join . GUI Images up.gif]] -pady 0 \
        -text button 
    vTcl:DefineAlias "$site_7_0.but75" "Button15" vTcl:WidgetProc "Toplevel404" 1
    button $site_7_0.but76 \
        \
        -command {global PSPSIMMoisture
...
if {$PSPSIMMoisture == "-1" } { set PSPSIMMoisture "10" }} \
        -image [vTcl:image:get_image [file join . GUI Images down.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_7_0.but76" "Button16" vTcl:WidgetProc "Toplevel404" 1
    label $site_7_0.cpd109 \
        -width 5 
    vTcl:DefineAlias "$site_7_0.cpd109" "Label9" vTcl:WidgetProc "Toplevel404" 1
    pack $site_7_0.cpd72 \
        -in $site_7_0 -anchor center -expand 1 -fill none -side left 
    pack $site_7_0.but75 \
        -in $site_7_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $site_4_0.cpd95 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd95" "Frame22" vTcl:WidgetProc "Toplevel404" 1
    set site_5_0 $site_4_0.cpd95
    frame $site_5_0.cpd85 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd85" "Frame24" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd85
    label $site_6_0.lab83 \
        -text {Azimuth Ground Slope ( % )   } 
    vTcl:DefineAlias "$site_6_0.lab83" "Label16" vTcl:WidgetProc "Toplevel404" 1
    entry $site_6_0.ent84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PSPSIMAzSlope -width 10 
    vTcl:DefineAlias "$site_6_0.ent84" "Entry9" vTcl:WidgetProc "Toplevel404" 1
    pack $site_6_0.lab83 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.ent84 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side right 
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame25" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd92
    label $site_6_0.lab83 \
        -text {Range Ground Slope ( % ) } 
    vTcl:DefineAlias "$site_6_0.lab83" "Label17" vTcl:WidgetProc "Toplevel404" 1
    entry $site_6_0.ent84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PSPSIMRgSlope -width 10 
    vTcl:DefineAlias "$site_6_0.ent84" "Entry10" vTcl:WidgetProc "Toplevel404" 1
    pack $site_6_0.lab83 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.ent84 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side right 
    ...
    frame $site_4_0.cpd66 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd66" "Frame23" vTcl:WidgetProc "Toplevel404" 1
    set site_5_0 $site_4_0.cpd66
    frame $site_5_0.cpd85 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd85" "Frame31" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd85
    label $site_6_0.lab83 \
        -text {Ground Surface Square Area ( Ha )   } 
    vTcl:DefineAlias "$site_6_0.lab83" "Label23" vTcl:WidgetProc "Toplevel404" 1
    entry $site_6_0.ent84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PSPSIMSurfArea -width 10 
    vTcl:DefineAlias "$site_6_0.ent84" "Entry11" vTcl:WidgetProc "Toplevel404" 1
    pack $site_6_0.lab83 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.ent84 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side right 
    ...
    TitleFrame $top.cpd106 \
        -text {Small Vegetation Configuration} 
    vTcl:DefineAlias "$top.cpd106" "TitleFrame6" vTcl:WidgetProc "Toplevel404" 1
    ...
    frame $site_4_0.cpd71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd71" "Frame41" vTcl:WidgetProc "Toplevel404" 1
    set site_5_0 $site_4_0.cpd71
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame43" vTcl:WidgetProc "Toplevel404" 1
    set site_6_0 $site_5_0.cpd92
    label $site_6_0.lab83 \
        -text {Mean Vegetation Height ( m )   } 
    vTcl:DefineAlias "$site_6_0.lab83" "Label30" vTcl:WidgetProc "Toplevel404" 1
    entry $site_6_0.ent84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PSPSIMVegHeight -width 10 
    vTcl:DefineAlias "$site_6_0.ent84" "Entry15" vTcl:WidgetProc "Toplevel404" 1
    pack $site_6_0.lab83 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.ent84 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side right 
    ...
    frame $top.fra112 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra112" "Frame9" vTcl:WidgetProc "Toplevel404" 1
    set site_3_0 $top.fra112
    frame $site_3_0.fra113 \
        -borderwidth 4 -relief sunken -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra113" "Frame30" vTcl:WidgetProc "Toplevel404" 1
    set site_4_0 $site_3_0.fra113
    label $site_4_0.cpd118 \
        -width 1 
    vTcl:DefineAlias "$site_4_0.cpd118" "Label25" vTcl:WidgetProc "Toplevel404" 1
    label $site_4_0.lab115 \
        -text {Random Number Generator   } 
    vTcl:DefineAlias "$site_4_0.lab115" "Label21" vTcl:WidgetProc "Toplevel404" 1
    entry $site_4_0.ent116 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -relief ridge -textvariable PSPSIMRandom -width 10 
    vTcl:DefineAlias "$site_4_0.ent116" "Entry8" vTcl:WidgetProc "Toplevel404" 1
    label $site_4_0.cpd117 \
        -width 1 
    vTcl:DefineAlias "$site_4_0.cpd117" "Label24" vTcl:WidgetProc "Toplevel404" 1
...
set PSPSIMForestArea [expr (3.1415926 * $PSPSIMSurfArea) / 4.0]
...
if {$TestVarError == "ok"} {
    TextEditorRunTrace "Process The Function Soft/bin/PolSARproSIMsv/PolSARproSimSV_ImgSize.exe" "k"
    ...
    set f [ open "| Soft/bin/PolSARproSIMsv/PolSARproSimSV_ImgSize.exe \x22$TMPPolSARproSIM\x22 $PSPSIMTreeSpecies $PSPSIMTreeHeight $PSPSIMIncAngle1 $PSPSIMAzResol $PSPSIMRgResol $PSPSIMForestArea" r]
    PsPprogressBar $f
    TextEditorRunTrace "Check RunTime Errors" "r"
    CheckRunTimeError
    ...
    if [file exists $ConfigFile] {
        $widget(Label404_1) configure -state normal
        $widget(Entry404_1) configure -disabledbackground #FFFFFF
        $widget(Label404_2) configure -state normal
        $widget(Entry404_2) configure -disabledbackground #FFFFFF
    ...
    $widget(TitleFrame404_1) configure -state normal
    $widget(Entry404_3) configure -state normal
    $widget(Entry404_3) configure -disabledbackground #FFFFFF
    $widget(Button404_0) configure -state normal
    set PSPSIMConfig "$PSPSIMChannel1/pspsim_config"
    }
}} \
        -padx 4 -pady 2 -text {Save Config} 
    vTcl:DefineAlias "$site_3_0.but114" "Button1" vTcl:WidgetProc "Toplevel404" 1
    ...
    frame $top.fra119 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra119" "Frame33" vTcl:WidgetProc "Toplevel404" 1
    set site_3_0 $top.fra119
    frame $site_3_0.cpd120 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd120" "Frame39" vTcl:WidgetProc "Toplevel404" 1
    set site_4_0 $site_3_0.cpd120
    label $site_4_0.lab83 \
        -text {Final Image Number of Rows   } 
    vTcl:DefineAlias "$site_4_0.lab83" "Label404_1" vTcl:WidgetProc "Toplevel404" 1
    entry $site_4_0.ent84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable PSPSIMNrows -width 7 
    vTcl:DefineAlias "$site_4_0.ent84" "Entry404_1" vTcl:WidgetProc "Toplevel404" 1
    pack $site_4_0.lab83 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent84 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side right 
    frame $site_3_0.cpd121 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd121" "Frame40" vTcl:WidgetProc "Toplevel404" 1
    set site_4_0 $site_3_0.cpd121
    label $site_4_0.lab83 \
        -text {Final Image Number of Columns   } 
    vTcl:DefineAlias "$site_4_0.lab83" "Label404_2" vTcl:WidgetProc "Toplevel404" 1
    entry $site_4_0.ent84 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable PSPSIMNcols -width 7 
    vTcl:DefineAlias "$site_4_0.ent84" "Entry404_2" vTcl:WidgetProc "Toplevel404" 1
    pack $site_4_0.lab83 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent84 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side right 
    ...
    vTcl:DefineAlias "$top.cpd123" "TitleFrame404_1" vTcl:WidgetProc "Toplevel404" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd79" "Entry404_3" vTcl:WidgetProc "Toplevel404" 1
    bindtags $site_4_0.cpd79 "$site_4_0.cpd79 Entry $top all _vTclBalloon"
    bind $site_4_0.cpd79 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Main Directory}
    }
    ...
    vTcl:DefineAlias "$top.tit71" "TitleFrame7" vTcl:WidgetProc "Toplevel404" 1
    ...
    vTcl:DefineAlias "$site_4_0.rad72" "Radiobutton1" vTcl:WidgetProc "Toplevel404" 1
    radiobutton $site_4_0.cpd73 \
        -text {Dual - Pol ( HH, VH )} -value dualpp1 \
        -variable PSPOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd73" "Radiobutton2" vTcl:WidgetProc "Toplevel404" 1
    radiobutton $site_4_0.cpd74 \
        -text {Dual - Pol ( HV, VV )} -value dualpp2 \
        -variable PSPOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd74" "Radiobutton3" vTcl:WidgetProc "Toplevel404" 1
    radiobutton $site_4_0.cpd75 \
        -text {Dual - Pol ( HH, VV )} -value dualpp3 \
        -variable PSPOutputFormat 
    vTcl:DefineAlias "$site_4_0.cpd75" "Radiobutton4" vTcl:WidgetProc "Toplevel404" 1
    pack $site_4_0.rad72 \
        -in $site_4_0 -anchor center -expand 1 -fill none -side left 
    pack $site_4_0.cpd73 \
        -in $site_4_0 -anchor center -expand 1 -fill none -side left 
