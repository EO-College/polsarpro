	...
	set VarBatch "bad"
        ...
        if {$TestVarError == "ok"} {
            ...
            if {$BatchFilterCase == "box"} {
                ...
                TextEditorRunTrace "Arguments: -id \x22$BatchFilterDirInput\x22 -od \x22$BatchFilterDirOutput\x22 -iodf $BatchFilterFonction -nwr $BatchNwinFilterL -nwc $BatchNwinFilterC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                set f [ open "| Soft/bin/speckle_filter/boxcar_filter.exe -id \x22$BatchFilterDirInput\x22 -od \x22$BatchFilterDirOutput\x22 -iodf $BatchFilterFonction -nwr $BatchNwinFilterL -nwc $BatchNwinFilterC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                }
            if {$BatchFilterCase == "lee"} {
                ...
                TextEditorRunTrace "Process The Function $BatchFilterFunction" "k"
                TextEditorRunTrace "Arguments: -id \x22$BatchFilterDirInput\x22 -od \x22$BatchFilterDirOutput\x22 -iodf $BatchFilterFonction -nw $BatchNwinFilterL -nlk $BatchNlook -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                set f [ open "| Soft/bin/speckle_filter/lee_refined_filter.exe -id \x22$BatchFilterDirInput\x22 -od \x22$BatchFilterDirOutput\x22 -iodf $BatchFilterFonction -nw $BatchNwinFilterL -nlk $BatchNlook -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                }
            PsPprogressBar $f
	...
	set VarBatch "bad"
        ...
        if {"$config"=="true"} {
            ...
            if {$TestVarError == "ok"} {
                ...
                set f [ open "| Soft/bin/data_process_sngl/wishart_h_a_alpha_classifier.exe -id \x22$BatchWishartDirInput\x22 -od \x22$BatchWishartDirOutput\x22 -iodf $BatchProcessF -nwr $BatchNwinWishartL -nwc $BatchNwinWishartC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -pct $BatchWishartPourcentage -nit $BatchWishartIteration -bmp $BatchBMPWishart -co8 \x22$ColorMapWishart8\x22 -co16 \x22$ColorMapWishart16\x22 -hf \x22$WishartEntropyFile\x22 -af \x22$WishartAnisotropyFile\x22 -alf \x22$WishartAlphaFile\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                PsPprogressBar $f
                TextEditorRunTrace "Check RunTime Errors" "r"
                CheckRunTimeError
                WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
