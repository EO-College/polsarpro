...
proc vTcl:project:info {} {
    ...
    namespace eval ::widgets::$site_6_0.fra95 {
        array set save {-borderwidth 1 -height 1 -width 1}
    }
    set site_7_0 $site_6_0.fra95
    ...
    namespace eval ::widgets::$site_7_0.lab97 {
        array set save {-text 1}
    }
...
proc vTclWindow.top234 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel234" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.tit71" "TitleFrame1" vTcl:WidgetProc "Toplevel234" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd72" "Entry234_149" vTcl:WidgetProc "Toplevel234" 1
    frame $site_4_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame1" vTcl:WidgetProc "Toplevel234" 1
    set site_5_0 $site_4_0.cpd74
    button $site_5_0.but75 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_5_0.but75" "Button1" vTcl:WidgetProc "Toplevel234" 1
    pack $site_5_0.but75 \
    ...
    vTcl:DefineAlias "$top.tit76" "TitleFrame2" vTcl:WidgetProc "Toplevel234" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd82" "Entry234_73" vTcl:WidgetProc "Toplevel234" 1
    frame $site_4_0.cpd72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd72" "Frame13" vTcl:WidgetProc "Toplevel234" 1
    set site_5_0 $site_4_0.cpd72
    label $site_5_0.lab73 \
        -text / 
    vTcl:DefineAlias "$site_5_0.lab73" "Label1" vTcl:WidgetProc "Toplevel234" 1
    entry $site_5_0.cpd75 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable BatchOutputSubDir -width 3 
    vTcl:DefineAlias "$site_5_0.cpd75" "Entry1" vTcl:WidgetProc "Toplevel234" 1
    pack $site_5_0.lab73 \
    ...
    frame $site_4_0.cpd84 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd84" "Frame2" vTcl:WidgetProc "Toplevel234" 1
    set site_5_0 $site_4_0.cpd84
...
if {$DirName != "" } {
    ...
    set BatchOutputDir $BatchOutputDirTmp
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd85" "Button234_92" vTcl:WidgetProc "Toplevel234" 1
    ...
    vTcl:DefineAlias "$top.fra74" "Frame9" vTcl:WidgetProc "Toplevel234" 1
    set site_3_0 $top.fra74
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label234_01" vTcl:WidgetProc "Toplevel234" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry234_01" vTcl:WidgetProc "Toplevel234" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label234_02" vTcl:WidgetProc "Toplevel234" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry234_02" vTcl:WidgetProc "Toplevel234" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label234_03" vTcl:WidgetProc "Toplevel234" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry234_03" vTcl:WidgetProc "Toplevel234" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label234_04" vTcl:WidgetProc "Toplevel234" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry234_04" vTcl:WidgetProc "Toplevel234" 1
    pack $site_3_0.lab57 \
    ...
    TitleFrame $top.tit77 \
        -text {Speckle Filter} 
    vTcl:DefineAlias "$top.tit77" "TitleFrame3" vTcl:WidgetProc "Toplevel234" 1
    ...
    checkbutton $site_4_0.cpd79 \
        \
        -command {global BatchFilter BatchDataDir BatchOutputDir BatchOutputSubDir
global BatchConvert BatchFilterCase BatchNlook BatchNwinFilterL BatchNwinFilterC BatchProcessFonction
...
if {"$BatchFilter"=="0"} {
    ...
    .top234.tit78 configure -text "Output Format"
    $widget(Radiobutton234_3) configure -state normal
    $widget(Radiobutton234_4) configure -state normal
    if {$BatchProcessFonction == "S2m"} {
        $widget(Radiobutton234_5) configure -state normal
        $widget(Radiobutton234_6) configure -state normal
        $widget(Radiobutton234_7) configure -state disable
        $widget(Radiobutton234_8) configure -state disable
        }
    if {$BatchProcessFonction == "S2b"} {
        $widget(Radiobutton234_5) configure -state normal
        $widget(Radiobutton234_6) configure -state normal
        $widget(Radiobutton234_7) configure -state normal
        $widget(Radiobutton234_8) configure -state normal
        }
    $widget(Label234_3) configure -state normal
    $widget(Entry234_3) configure -state normal
    $widget(Label234_4a) configure -state normal
    $widget(Entry234_4a) configure -state normal
    $widget(Label234_4b) configure -state disable
    $widget(Entry234_4b) configure -state disable
    ...
    vTcl:DefineAlias "$site_4_0.cpd79" "Checkbutton234_3" vTcl:WidgetProc "Toplevel234" 1
    frame $site_4_0.fra89 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra89" "Frame3" vTcl:WidgetProc "Toplevel234" 1
    set site_5_0 $site_4_0.fra89
    frame $site_5_0.fra90 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra90" "Frame4" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra90
    radiobutton $site_6_0.cpd92 \
        \
        -command {global BatchDataDir BatchOutputDir BatchOutputSubDir
global BatchNlook BatchNwinFilterL BatchNwinFilterC BatchProcessFonction
...
$widget(Label234_4a) configure -state normal
$widget(Entry234_4a) configure -state normal
$widget(Label234_4b) configure -state normal
$widget(Entry234_4b) configure -state normal
set BatchNlook 1
set BatchNwinFilterL 7
set BatchNwinFilterC 7} \
        -text {BoxCar Filter} -value box -variable BatchFilterCase 
    vTcl:DefineAlias "$site_6_0.cpd92" "Radiobutton234_3" vTcl:WidgetProc "Toplevel234" 1
    pack $site_6_0.cpd92 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame7" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.cpd91
...
set BatchNwinFilterC 1} \
    ...
    vTcl:DefineAlias "$site_6_0.cpd93" "Radiobutton234_4" vTcl:WidgetProc "Toplevel234" 1
    pack $site_6_0.cpd93 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.fra90 \
    ...
    vTcl:DefineAlias "$site_4_0.cpd83" "Frame218" vTcl:WidgetProc "Toplevel234" 1
    set site_5_0 $site_4_0.cpd83
    label $site_5_0.lab23 \
        -padx 1 -text {Nb of Looks} 
    vTcl:DefineAlias "$site_5_0.lab23" "Label234_3" vTcl:WidgetProc "Toplevel234" 1
    entry $site_5_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable BatchNlook -width 3 
    vTcl:DefineAlias "$site_5_0.ent24" "Entry234_3" vTcl:WidgetProc "Toplevel234" 1
    pack $site_5_0.lab23 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.ent24 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    frame $site_4_0.cpd82 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_4_0.cpd82" "Frame215" vTcl:WidgetProc "Toplevel234" 1
    set site_5_0 $site_4_0.cpd82
    label $site_5_0.lab23 \
        -padx 1 -text {Window Size : Row} 
    vTcl:DefineAlias "$site_5_0.lab23" "Label234_4a" vTcl:WidgetProc "Toplevel234" 1
    entry $site_5_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable BatchNwinFilterL -width 3 
    vTcl:DefineAlias "$site_5_0.ent24" "Entry234_4a" vTcl:WidgetProc "Toplevel234" 1
    label $site_5_0.cpd75 \
        -padx 1 -text Col 
    vTcl:DefineAlias "$site_5_0.cpd75" "Label234_4b" vTcl:WidgetProc "Toplevel234" 1
    entry $site_5_0.cpd76 \
        -background white -foreground #ff0000 -justify center \
        -textvariable BatchNwinFilterC -width 3 
    vTcl:DefineAlias "$site_5_0.cpd76" "Entry234_4b" vTcl:WidgetProc "Toplevel234" 1
    pack $site_5_0.lab23 \
    ...
    TitleFrame $top.tit78 \
        -ipad 2 
    vTcl:DefineAlias "$top.tit78" "TitleFrame4" vTcl:WidgetProc "Toplevel234" 1
    bind $top.tit78 <Destroy> {
        Widget::destroy %W; rename %W {}
    }
    set site_4_0 [$top.tit78 getframe]
    radiobutton $site_4_0.cpd80 \
        -text {S2 >> T3} -value T3 -variable BatchOutputSubDir 
    vTcl:DefineAlias "$site_4_0.cpd80" "Radiobutton234_5" vTcl:WidgetProc "Toplevel234" 1
    radiobutton $site_4_0.cpd81 \
        -text {S2 >> C3} -value C3 -variable BatchOutputSubDir 
    vTcl:DefineAlias "$site_4_0.cpd81" "Radiobutton234_6" vTcl:WidgetProc "Toplevel234" 1
    radiobutton $site_4_0.cpd82 \
        -text {S2 >> T4} -value T4 -variable BatchOutputSubDir 
    vTcl:DefineAlias "$site_4_0.cpd82" "Radiobutton234_7" vTcl:WidgetProc "Toplevel234" 1
    radiobutton $site_4_0.cpd83 \
        -text {S2 >> C4} -value C4 -variable BatchOutputSubDir 
    vTcl:DefineAlias "$site_4_0.cpd83" "Radiobutton234_8" vTcl:WidgetProc "Toplevel234" 1
    pack $site_4_0.cpd80 \
        -in $site_4_0 -anchor center -expand 1 -fill none -side left 
    pack $site_4_0.cpd81 \
        -in $site_4_0 -anchor center -expand 1 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.tit92" "TitleFrame5" vTcl:WidgetProc "Toplevel234" 1
    ...
    frame $site_4_0.fra72 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra72" "Frame5" vTcl:WidgetProc "Toplevel234" 1
    set site_5_0 $site_4_0.fra72
...
global ColorMapPlanes9 RedPalette GreenPalette BluePalette PSPBackgroundColor
...
if {"$BatchDecomp"=="0"} {
    ...
    $widget(Checkbutton234_5) configure -state normal
    $widget(Label234_9) configure -state normal
    $widget(Label234_5a) configure -state normal
    $widget(Entry234_5a) configure -state normal
    $widget(Label234_5b) configure -state normal
    $widget(Entry234_5b) configure -state normal
    $widget(Label234_13) configure -state normal
    $widget(Entry234_13) configure -state normal
    $widget(Entry234_13) configure -disabledbackground #FFFFFF
    $widget(Button234_7) configure -state normal
    $widget(Button234_1) configure -state normal
    set BatchBMPDecomp 1
    set BatchNwinDecompL 3
    set BatchNwinDecompC 3
    set BatchHAalpha_planes 1
    set ColorMapPlanes9 "ColorMap/Planes_H_A_Alpha_ColorMap9.pal"
    ...
    vTcl:DefineAlias "$site_5_0.cpd73" "Checkbutton234_4" vTcl:WidgetProc "Toplevel234" 1
    frame $site_5_0.fra94 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra94" "Frame8" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra94
    frame $site_6_0.fra95 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra95" "Frame10" vTcl:WidgetProc "Toplevel234" 1
    set site_7_0 $site_6_0.fra95
    checkbutton $site_7_0.cpd98 \
        -text {H / A / Alpha Planes (BMP)} -variable BatchHAalpha_planes 
    vTcl:DefineAlias "$site_7_0.cpd98" "Checkbutton234_5" vTcl:WidgetProc "Toplevel234" 1
    pack $site_7_0.cpd98 \
        -in $site_7_0 -anchor center -expand 0 -fill none -side left 
    frame $site_6_0.cpd96 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd96" "Frame11" vTcl:WidgetProc "Toplevel234" 1
    set site_7_0 $site_6_0.cpd96
    label $site_7_0.lab97 \
        -text {+ Classifier (Bin + BMP)} 
    vTcl:DefineAlias "$site_7_0.lab97" "Label234_9" vTcl:WidgetProc "Toplevel234" 1
    pack $site_7_0.lab97 \
    ...
    frame $site_5_0.cpd77 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_5_0.cpd77" "Frame216" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.cpd77
    label $site_6_0.lab23 \
        -padx 1 -text {Window Size : Row} 
    vTcl:DefineAlias "$site_6_0.lab23" "Label234_5a" vTcl:WidgetProc "Toplevel234" 1
    entry $site_6_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable BatchNwinDecompL -width 3 
    vTcl:DefineAlias "$site_6_0.ent24" "Entry234_5a" vTcl:WidgetProc "Toplevel234" 1
    label $site_6_0.cpd75 \
        -padx 1 -text Col 
    vTcl:DefineAlias "$site_6_0.cpd75" "Label234_5b" vTcl:WidgetProc "Toplevel234" 1
    entry $site_6_0.cpd76 \
        -background white -foreground #ff0000 -justify center \
        -textvariable BatchNwinDecompC -width 3 
    vTcl:DefineAlias "$site_6_0.cpd76" "Entry234_5b" vTcl:WidgetProc "Toplevel234" 1
    pack $site_6_0.lab23 \
    ...
    vTcl:DefineAlias "$site_4_0.cpd76" "Frame111" vTcl:WidgetProc "Toplevel234" 1
    set site_5_0 $site_4_0.cpd76
    frame $site_5_0.fra86 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra86" "Frame15" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra86
    label $site_6_0.cpd87 \
        -text {ColorMap 9  } 
    vTcl:DefineAlias "$site_6_0.cpd87" "Label234_13" vTcl:WidgetProc "Toplevel234" 1
    pack $site_6_0.cpd87 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    frame $site_5_0.fra88 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra88" "Frame16" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra88
    entry $site_6_0.cpd89 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable ColorMapPlanes9 -width 40 
    vTcl:DefineAlias "$site_6_0.cpd89" "Entry234_13" vTcl:WidgetProc "Toplevel234" 1
    pack $site_6_0.cpd89 \
        -in $site_6_0 -anchor center -expand 1 -fill x -side top 
    frame $site_5_0.fra90 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra90" "Frame17" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra90
...
if {$FileName != ""} {
    set ColorMapPlanes9 $FileName
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd72" "Button234_1" vTcl:WidgetProc "Toplevel234" 1
...
WidgetShowFromWidget $widget(Toplevel234) $widget(Toplevel38); TextEditorRunTrace "Open Window Colormap" "b"
tkwait variable VarColorMap
if {"$VarColorMap"=="ok"} {
   set ColorMapSupervised16 $ColorMapOut
   }}] \
        -padx 4 -pady 2 -text Edit 
    vTcl:DefineAlias "$site_6_0.cpd91" "Button234_7" vTcl:WidgetProc "Toplevel234" 1
    ...
    vTcl:DefineAlias "$top.tit99" "TitleFrame6" vTcl:WidgetProc "Toplevel234" 1
    ...
    frame $site_4_0.fra77 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra77" "Frame6" vTcl:WidgetProc "Toplevel234" 1
    set site_5_0 $site_4_0.fra77
    checkbutton $site_5_0.cpd78 \
        \
        -command {global BatchWishart BatchWishartPourcentage BatchWishartIteration BatchNwinWishartL BatchNwinWishartC BatchBMPWishart
global ColorMapWishart8 ColorMapWishart16 RedPalette GreenPalette BluePalette PSPBackgroundColor
...
if {"$BatchWishart"=="0"} {
    ...
    $widget(Label234_6) configure -state normal
    $widget(Entry234_6) configure -state normal
    $widget(Label234_7) configure -state normal
    $widget(Entry234_7) configure -state normal
    $widget(Label234_8a) configure -state normal
    $widget(Entry234_8a) configure -state normal
    $widget(Label234_8b) configure -state normal
    $widget(Entry234_8b) configure -state normal
    $widget(Label234_12) configure -state normal
    $widget(Entry234_12) configure -state normal
    $widget(Entry234_12) configure -disabledbackground #FFFFFF
    $widget(Button234_6) configure -state normal
    $widget(Button234_2) configure -state normal
    $widget(Label234_14) configure -state normal
    $widget(Entry234_14) configure -state normal
    $widget(Entry234_14) configure -disabledbackground #FFFFFF
    $widget(Button234_8) configure -state normal
    $widget(Button234_3) configure -state normal
    ...
    set ColorMapWishart8 "ColorMap/Wishart_ColorMap8.pal"
    set ColorMapWishart16 "ColorMap/Wishart_ColorMap16.pal"
    for {set i 0} {$i < 256} {incr i} {
        set RedPalette($i) 1
        set GreenPalette($i) 1
        set BluePalette($i) 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd78" "Checkbutton234_6" vTcl:WidgetProc "Toplevel234" 1
    frame $site_5_0.fra99 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra99" "Frame12" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra99
    frame $site_6_0.fra100 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra100" "Frame14" vTcl:WidgetProc "Toplevel234" 1
    set site_7_0 $site_6_0.fra100
    frame $site_7_0.cpd102 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.cpd102" "Frame234" vTcl:WidgetProc "Toplevel234" 1
    set site_8_0 $site_7_0.cpd102
    label $site_8_0.lab23 \
        -padx 1 -text {% of Pixels Switching Class} 
    vTcl:DefineAlias "$site_8_0.lab23" "Label234_6" vTcl:WidgetProc "Toplevel234" 1
    entry $site_8_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable BatchWishartPourcentage -width 3 
    vTcl:DefineAlias "$site_8_0.ent24" "Entry234_6" vTcl:WidgetProc "Toplevel234" 1
    pack $site_8_0.lab23 \
    ...
    frame $site_6_0.cpd101 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.cpd101" "Frame18" vTcl:WidgetProc "Toplevel234" 1
    set site_7_0 $site_6_0.cpd101
    frame $site_7_0.cpd103 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.cpd103" "Frame231" vTcl:WidgetProc "Toplevel234" 1
    set site_8_0 $site_7_0.cpd103
    label $site_8_0.lab23 \
        -padx 1 -text {Maximum Number of Iterations} 
    vTcl:DefineAlias "$site_8_0.lab23" "Label234_7" vTcl:WidgetProc "Toplevel234" 1
    entry $site_8_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable BatchWishartIteration -width 3 
    vTcl:DefineAlias "$site_8_0.ent24" "Entry234_7" vTcl:WidgetProc "Toplevel234" 1
    pack $site_8_0.lab23 \
        -in $site_8_0 -anchor center -expand 0 -fill none -side left 
    pack $site_8_0.ent24 \
        -in $site_8_0 -anchor center -expand 0 -fill none -side right 
    ...
    frame $site_5_0.cpd79 \
        -borderwidth 2 -height 75 
    vTcl:DefineAlias "$site_5_0.cpd79" "Frame217" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.cpd79
    label $site_6_0.lab23 \
        -padx 1 -text {Window Size : Row} 
    vTcl:DefineAlias "$site_6_0.lab23" "Label234_8a" vTcl:WidgetProc "Toplevel234" 1
    entry $site_6_0.ent24 \
        -background white -foreground #ff0000 -justify center \
        -textvariable BatchNwinWishartL -width 3 
    vTcl:DefineAlias "$site_6_0.ent24" "Entry234_8a" vTcl:WidgetProc "Toplevel234" 1
    label $site_6_0.cpd75 \
        -padx 1 -text Col 
    vTcl:DefineAlias "$site_6_0.cpd75" "Label234_8b" vTcl:WidgetProc "Toplevel234" 1
    entry $site_6_0.cpd76 \
        -background white -foreground #ff0000 -justify center \
        -textvariable BatchNwinWishartC -width 3 
    vTcl:DefineAlias "$site_6_0.cpd76" "Entry234_8b" vTcl:WidgetProc "Toplevel234" 1
    pack $site_6_0.lab23 \
        -in $site_6_0 -anchor center -expand 0 -fill none -ipadx 2 -side left 
    pack $site_6_0.ent24 \
        -in $site_6_0 -anchor center -expand 0 -fill none -ipadx 2 -side left 
    ...
    frame $site_4_0.cpd82 \
        -borderwidth 2 -height 75 -width 159 
    vTcl:DefineAlias "$site_4_0.cpd82" "Frame112" vTcl:WidgetProc "Toplevel234" 1
    set site_5_0 $site_4_0.cpd82
    frame $site_5_0.fra92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra92" "Frame19" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra92
    label $site_6_0.cpd97 \
        -text {ColorMap 8  } 
    vTcl:DefineAlias "$site_6_0.cpd97" "Label234_12" vTcl:WidgetProc "Toplevel234" 1
    pack $site_6_0.cpd97 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side top 
    frame $site_5_0.fra93 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra93" "Frame21" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra93
    entry $site_6_0.cpd96 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable ColorMapWishart8 -width 40 
    vTcl:DefineAlias "$site_6_0.cpd96" "Entry234_12" vTcl:WidgetProc "Toplevel234" 1
    pack $site_6_0.cpd96 \
        -in $site_6_0 -anchor center -expand 1 -fill x -side top 
    frame $site_5_0.fra94 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra94" "Frame22" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra94
...
if {$FileName != ""} {
    set ColorMapWishart8 $FileName
        ...
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd73" "Button234_2" vTcl:WidgetProc "Toplevel234" 1
...
if {"$VarColorMap"=="ok"} {
   set ColorMapWishart8 $ColorMapOut
        ...
        -padx 4 -pady 2 -text Edit 
    vTcl:DefineAlias "$site_6_0.cpd95" "Button234_6" vTcl:WidgetProc "Toplevel234" 1
    ...
    frame $site_4_0.cpd83 \
        -borderwidth 2 -height 75 -width 159 
    vTcl:DefineAlias "$site_4_0.cpd83" "Frame235" vTcl:WidgetProc "Toplevel234" 1
    set site_5_0 $site_4_0.cpd83
    frame $site_5_0.fra98 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra98" "Frame23" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra98
    label $site_6_0.cpd104 \
        -text {ColorMap 16} 
    vTcl:DefineAlias "$site_6_0.cpd104" "Label234_14" vTcl:WidgetProc "Toplevel234" 1
    pack $site_6_0.cpd104 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side top 
    frame $site_5_0.fra99 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra99" "Frame24" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra99
    entry $site_6_0.cpd102 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable ColorMapWishart16 -width 40 
    vTcl:DefineAlias "$site_6_0.cpd102" "Entry234_14" vTcl:WidgetProc "Toplevel234" 1
    pack $site_6_0.cpd102 \
        -in $site_6_0 -anchor center -expand 1 -fill x -side top 
    frame $site_5_0.fra100 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra100" "Frame25" vTcl:WidgetProc "Toplevel234" 1
    set site_6_0 $site_5_0.fra100
...
if {$FileName != ""} {
    set ColorMapWishart16 $FileName
        ...
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd74" "Button234_3" vTcl:WidgetProc "Toplevel234" 1
...
if {"$VarColorMap"=="ok"} {
   set ColorMapWishart16 $ColorMapOut
        ...
        -padx 4 -pady 2 -text Edit 
    vTcl:DefineAlias "$site_6_0.cpd101" "Button234_8" vTcl:WidgetProc "Toplevel234" 1
    ...
    vTcl:DefineAlias "$top.fra83" "Frame20" vTcl:WidgetProc "Toplevel234" 1
...
global ColorMapPlanes9 ColorMapWishart8 ColorMapWishart16
...
if {$BatchFilter=="1"} {
	...
	set VarBatch "bad"
        ...
        if {$TestVarError == "ok"} {
            ...
            if {$BatchOutputSubDir== "T3"} {set BatchFilterFonction "S2T3"}
            if {$BatchOutputSubDir== "C3"} {set BatchFilterFonction "S2C3"}
            if {$BatchOutputSubDir== "T4"} {set BatchFilterFonction "S2T4"}
            if {$BatchOutputSubDir== "C4"} {set BatchFilterFonction "S2C4"}
            ...
            if {$BatchFilterCase == "box"} {
                ...
                TextEditorRunTrace "Arguments: -id \x22$BatchFilterDirInput\x22 -od \x22$BatchFilterDirOutput\x22 -iodf $BatchFilterFonction -nwr $BatchNwinFilterL -nwc $BatchNwinFilterC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                set f [ open "| Soft/speckle_filter/boxcar_filter.exe -id \x22$BatchFilterDirInput\x22 -od \x22$BatchFilterDirOutput\x22 -iodf $BatchFilterFonction -nwr $BatchNwinFilterL -nwc $BatchNwinFilterC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                }
            if {$BatchFilterCase == "lee"} {
                ...
                TextEditorRunTrace "Process The Function $BatchFilterFunction" "k"
                TextEditorRunTrace "Arguments: -id \x22$BatchFilterDirInput\x22 -od \x22$BatchFilterDirOutput\x22 -iodf $BatchFilterFonction -nw $BatchNwinFilterL -nlk $BatchNlook -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                set f [ open "| Soft/speckle_filter/lee_refined_filter.exe -id \x22$BatchFilterDirInput\x22 -od \x22$BatchFilterDirOutput\x22 -iodf $BatchFilterFonction -nw $BatchNwinFilterL -nlk $BatchNlook -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                }
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
            if {$BatchOutputSubDir== "T3"} {EnviWriteConfigT $BatchFilterDirOutput $FinalNlig $FinalNcol}
            if {$BatchOutputSubDir== "C3"} {EnviWriteConfigC $BatchFilterDirOutput $FinalNlig $FinalNcol}
            if {$BatchOutputSubDir== "T4"} {EnviWriteConfigT $BatchFilterDirOutput $FinalNlig $FinalNcol}
            if {$BatchOutputSubDir== "C4"} {EnviWriteConfigC $BatchFilterDirOutput $FinalNlig $FinalNcol}
...
if {$BatchDecomp=="1"} {
	...
	set VarBatch "bad"
        ...
        if {$TestVarError == "ok"} {
            ...
            WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
            update
            set BatchProcessF $BatchOutputSubDir
            if {$BatchOutputSubDir== ""} {
                if {"$BatchProcessFonction" == "S2"} { set BatchProcessF "S2T3" }
                if {"$BatchProcessFonction" == "S2m"} { set BatchProcessF "S2T3" }
                if {"$BatchProcessFonction" == "S2b"} { set BatchProcessF "S2T4" }
                }
            if {"$BatchOutputSubDir" == "C3"} { set BatchProcessF "C3T3" }
            if {"$BatchOutputSubDir" == "C4"} { set BatchProcessF "C4T4" }
            ...
            if {$BatchHAalpha_planes==1} {
                ...
                if {"$config"=="true"} {
                    ...
                    PsPScatterPlot "$BatchDecompDirOutput/entropy.bin" "$BatchDecompDirOutput/mask_valid_pixels.bin" float real 0 0 1 "$BatchDecompDirOutput/alpha.bin" "$BatchDecompDirOutput/mask_valid_pixels.bin" float real 0 0 90 $OffsetLig $OffsetCol $FinalNlig $FinalNcol HAlpha "Entropy" "Alpha (deg)" "H - Alpha Plane" 1 .top234
                    PsPScatterPlot "$BatchDecompDirOutput/entropy.bin" "$BatchDecompDirOutput/mask_valid_pixels.bin" float real 0 0 1 "$BatchDecompDirOutput/anisotropy.bin" "$BatchDecompDirOutput/mask_valid_pixels.bin" float real 0 0 1 $OffsetLig $OffsetCol $FinalNlig $FinalNcol HA "Entropy" "Anisotropy" "H - A Plane" 3 .top234
                    PsPScatterPlot "$BatchDecompDirOutput/anisotropy.bin" "$BatchDecompDirOutput/mask_valid_pixels.bin" float real 0 0 1 "$BatchDecompDirOutput/alpha.bin" "$BatchDecompDirOutput/mask_valid_pixels.bin" float real 0 0 90 $OffsetLig $OffsetCol $FinalNlig $FinalNcol AAlpha "Anisotropy" "Alpha (deg)" "A - Alpha Plane" 2 .top234
...
if {$BatchWishart=="1"} {
	...
	set VarBatch "bad"
        ...
        if {"$config"=="true"} {
            ...
            if {$TestVarError == "ok"} {
                ...
                set BatchProcessF $BatchOutputSubDir
                if {$BatchOutputSubDir== ""} {
                    if {"$BatchProcessFonction" == "S2"} { set BatchProcessF "S2" }
                    if {"$BatchProcessFonction" == "S2m"} { set BatchProcessF "S2" }
                    if {"$BatchProcessFonction" == "S2b"} { set BatchProcessF "S2" }
                    }
                TextEditorRunTrace "Process The Function Soft/data_process_sngl/wishart_h_a_alpha_classifier.exe" "k"
                TextEditorRunTrace "Arguments: -id \x22$BatchWishartDirInput\x22 -od \x22$BatchWishartDirOutput\x22 -iodf $BatchProcessF -nwr $BatchNwinWishartL -nwc $BatchNwinWishartC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -pct $BatchWishartPourcentage -nit $BatchWishartIteration -bmp $BatchBMPWishart -co8 \x22$ColorMapWishart8\x22 -co16 \x22$ColorMapWishart16\x22 -hf \x22$WishartEntropyFile\x22 -af \x22$WishartAnisotropyFile\x22 -alf \x22$WishartAlphaFile\x22 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                set f [ open "| Soft/data_process_sngl/wishart_h_a_alpha_classifier.exe -id \x22$BatchWishartDirInput\x22 -od \x22$BatchWishartDirOutput\x22 -iodf $BatchProcessF -nwr $BatchNwinWishartL -nwc $BatchNwinWishartC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -pct $BatchWishartPourcentage -nit $BatchWishartIteration -bmp $BatchBMPWishart -co8 \x22$ColorMapWishart8\x22 -co16 \x22$ColorMapWishart16\x22 -hf \x22$WishartEntropyFile\x22 -af \x22$WishartAnisotropyFile\x22 -alf \x22$WishartAlphaFile\x22 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                PsPprogressBar $f
                TextEditorRunTrace "Check RunTime Errors" "r"
                CheckRunTimeError
                WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel234" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/BatchProcessS2.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -text ? -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel234" 1
...
Window hide $widget(Toplevel234); TextEditorRunTrace "Close Window Batch Procedure" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel234" 1
