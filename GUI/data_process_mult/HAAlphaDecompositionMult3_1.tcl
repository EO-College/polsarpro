...
proc vTclWindow.top505 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel505" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd86 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd86" "Frame4" vTcl:WidgetProc "Toplevel505" 1
    set site_3_0 $top.cpd86
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame8" vTcl:WidgetProc "Toplevel505" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel505" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel505" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button40" vTcl:WidgetProc "Toplevel505" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame9" vTcl:WidgetProc "Toplevel505" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel505" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame16" vTcl:WidgetProc "Toplevel505" 1
    set site_6_0 $site_5_0.cpd91
    label $site_6_0.cpd81 \
        -padx 1 -text / 
    vTcl:DefineAlias "$site_6_0.cpd81" "Label14" vTcl:WidgetProc "Toplevel505" 1
    entry $site_6_0.cpd80 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable HAAlpOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd80" "EntryTopXXCh9" vTcl:WidgetProc "Toplevel505" 1
    pack $site_6_0.cpd81 \
    ...
    frame $site_5_0.cpd79 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd79" "Frame17" vTcl:WidgetProc "Toplevel505" 1
    set site_6_0 $site_5_0.cpd79
    ...
    vTcl:DefineAlias "$top.fra36" "Frame9" vTcl:WidgetProc "Toplevel505" 1
    set site_3_0 $top.fra36
    label $site_3_0.lab57 \
        -padx 1 -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel505" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel505" 1
    label $site_3_0.lab59 \
        -padx 1 -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel505" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel505" 1
    label $site_3_0.lab61 \
        -padx 1 -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel505" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel505" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel505" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel505" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.fra45" "Frame39" vTcl:WidgetProc "Toplevel505" 1
    set site_3_0 $top.fra45
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$alpbetdelgam"=="1"} {
    $widget(Checkbutton505_1) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton21" vTcl:WidgetProc "Toplevel505" 1
    checkbutton $site_3_0.che39 \
        -command {} -padx 1 -text BMP -variable BMPalpbetdelgam 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton505_1" vTcl:WidgetProc "Toplevel505" 1
    pack $site_3_0.che38 \
    ...
    frame $top.cpd72 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd72" "Frame44" vTcl:WidgetProc "Toplevel505" 1
    set site_3_0 $top.cpd72
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$lambda"=="1"} {
    $widget(Checkbutton505_2) configure -state normal
    } else {
    $widget(Checkbutton505_2) configure -state disable
    set BMPlambda "0"
    }} \
        -padx 1 -text Lambda -variable lambda 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton24" vTcl:WidgetProc "Toplevel505" 1
    checkbutton $site_3_0.che39 \
        -command {} -padx 1 -text BMP -variable BMPlambda 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton505_2" vTcl:WidgetProc "Toplevel505" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra46 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra46" "Frame40" vTcl:WidgetProc "Toplevel505" 1
    set site_3_0 $top.fra46
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$alpha"=="1"} {
    $widget(Checkbutton505_3) configure -state normal
    } else {
    $widget(Checkbutton505_3) configure -state disable
    set BMPalpha "0"
    }} \
        -padx 1 -text Alpha -variable alpha 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton23" vTcl:WidgetProc "Toplevel505" 1
    checkbutton $site_3_0.che39 \
        -command {} -padx 1 -text BMP -variable BMPalpha 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton505_3" vTcl:WidgetProc "Toplevel505" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra47 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra47" "Frame41" vTcl:WidgetProc "Toplevel505" 1
    set site_3_0 $top.fra47
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$entropy"=="1"} {
    $widget(Checkbutton505_4) configure -state normal
    } else {
    $widget(Checkbutton505_4) configure -state disable
    set BMPentropy "0"
    }} \
        -padx 1 -text {Entropy ( H )} -variable entropy 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton25" vTcl:WidgetProc "Toplevel505" 1
    checkbutton $site_3_0.che39 \
        -command {} -padx 1 -text BMP -variable BMPentropy 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton505_4" vTcl:WidgetProc "Toplevel505" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra48 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra48" "Frame42" vTcl:WidgetProc "Toplevel505" 1
    set site_3_0 $top.fra48
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$anisotropy"=="1"} {
    $widget(Checkbutton505_5) configure -state normal
    } else {
    $widget(Checkbutton505_5) configure -state disable
    set BMPanisotropy "0"
    }} \
        -padx 1 -text {Anisotropy  ( A )} -variable anisotropy 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton27" vTcl:WidgetProc "Toplevel505" 1
    checkbutton $site_3_0.che39 \
        -command {} -padx 1 -text BMP -variable BMPanisotropy 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton505_5" vTcl:WidgetProc "Toplevel505" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra109 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra109" "Frame660" vTcl:WidgetProc "Toplevel505" 1
...
if {$combinationsHA == "1"} {
    $widget(Checkbutton505_6) configure -state normal
    $widget(Checkbutton505_7) configure -state normal
    $widget(Checkbutton505_8) configure -state normal
    $widget(Checkbutton505_9) configure -state normal
    }
if {$combinationsHA == "0"} {
    set CombHA "0"
    set CombH1mA "0"
    ...
    vTcl:DefineAlias "$site_3_0.che110" "Checkbutton617" vTcl:WidgetProc "Toplevel505" 1
    frame $site_3_0.fra111 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra111" "Frame661" vTcl:WidgetProc "Toplevel505" 1
    set site_4_0 $site_3_0.fra111
...
if {$CombHA == "1"} {
    $widget(Checkbutton505_10) configure -state normal
    } else {
    set config "0"
    ...
    vTcl:DefineAlias "$site_4_0.che112" "Checkbutton505_6" vTcl:WidgetProc "Toplevel505" 1
...
if {$CombH1mA == "1"} {
    ...
    vTcl:DefineAlias "$site_4_0.che113" "Checkbutton505_7" vTcl:WidgetProc "Toplevel505" 1
    ...
    frame $site_3_0.fra117 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra117" "Frame662" vTcl:WidgetProc "Toplevel505" 1
    set site_4_0 $site_3_0.fra117
...
if {$Comb1mHA == "1"} {
    ...
    vTcl:DefineAlias "$site_4_0.che114" "Checkbutton505_8" vTcl:WidgetProc "Toplevel505" 1
...
if {$Comb1mH1mA == "1"} {
    ...
    vTcl:DefineAlias "$site_4_0.che115" "Checkbutton505_9" vTcl:WidgetProc "Toplevel505" 1
    ...
    vTcl:DefineAlias "$site_3_0.che116" "Checkbutton505_10" vTcl:WidgetProc "Toplevel505" 1
    ...
    vTcl:DefineAlias "$top.fra55" "Frame47" vTcl:WidgetProc "Toplevel505" 1
    set site_3_0 $top.fra55
    frame $site_3_0.fra72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra72" "Frame5" vTcl:WidgetProc "Toplevel505" 1
    set site_4_0 $site_3_0.fra72
    frame $site_4_0.cpd73 \
        -borderwidth 2 -cursor {} -height 75 -width 216 
    vTcl:DefineAlias "$site_4_0.cpd73" "Frame49" vTcl:WidgetProc "Toplevel505" 1
    set site_5_0 $site_4_0.cpd73
    label $site_5_0.lab57 \
        -padx 1 -text {Window Size Row} -width 15 
    vTcl:DefineAlias "$site_5_0.lab57" "Label506" vTcl:WidgetProc "Toplevel505" 1
    ...
    vTcl:DefineAlias "$site_5_0.ent58" "Entry23" vTcl:WidgetProc "Toplevel505" 1
    pack $site_5_0.lab57 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.ent58 \
    ...
    frame $site_4_0.cpd74 \
        -borderwidth 2 -cursor {} -height 75 -width 216 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame50" vTcl:WidgetProc "Toplevel505" 1
    set site_5_0 $site_4_0.cpd74
    label $site_5_0.lab57 \
        -padx 1 -text {Window Size Col} -width 15 
    vTcl:DefineAlias "$site_5_0.lab57" "Label507" vTcl:WidgetProc "Toplevel505" 1
    entry $site_5_0.ent58 \
        -background white -disabledforeground #ff0000 -foreground #ff0000 \
        -justify center -textvariable NwinHAAlpC -width 5 
    vTcl:DefineAlias "$site_5_0.ent58" "Entry24" vTcl:WidgetProc "Toplevel505" 1
    pack $site_5_0.lab57 \
...
$widget(Checkbutton505_10) configure -state normal} \
    ...
    vTcl:DefineAlias "$site_3_0.but25" "Button103" vTcl:WidgetProc "Toplevel505" 1
...
$widget(Checkbutton505_10) configure -state disable} \
    ...
    vTcl:DefineAlias "$site_3_0.cpd85" "Button104" vTcl:WidgetProc "Toplevel505" 1
    ...
    frame $site_3_0.fra71 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra71" "Frame1" vTcl:WidgetProc "Toplevel505" 1
    set site_4_0 $site_3_0.fra71
    frame $site_4_0.fra72 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra72" "Frame2" vTcl:WidgetProc "Toplevel505" 1
    set site_5_0 $site_4_0.fra72
    checkbutton $site_5_0.che75 \
        -text {Equivalence between [ T ]  and} -variable EquivHAAlpDecomp 
    vTcl:DefineAlias "$site_5_0.che75" "Checkbutton505_11" vTcl:WidgetProc "Toplevel505" 1
    pack $site_5_0.che75 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    frame $site_4_0.fra73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra73" "Frame3" vTcl:WidgetProc "Toplevel505" 1
    set site_5_0 $site_4_0.fra73
    label $site_5_0.lab76 \
        -text {[ C ] eigen-decompositions. } 
    vTcl:DefineAlias "$site_5_0.lab76" "Label505_20" vTcl:WidgetProc "Toplevel505" 1
    pack $site_5_0.lab76 \
    ...
    vTcl:DefineAlias "$top.fra59" "Frame20" vTcl:WidgetProc "Toplevel505" 1
...
if {"$config"=="true"} {
    ...
    if {"$VarWarning"=="ok"} {
        ...
        for {set ii 1} {$ii <= $NDataDirMult} {incr ii} {
            ...
            set f [ open "| Soft/data_process_sngl/h_a_alpha_decomposition.exe -id \x22$HAAlpDirInput\x22 -od \x22$HAAlpDirOutput\x22 -iodf $HAAlphaDecompositionF -nwr $NwinHAAlpL -nwc $NwinHAAlpC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -fl1 $alpbetdelgam -fl2 $lambda -fl3 $alpha -fl4 $entropy -fl5 $anisotropy -fl6 $CombHA -fl7 $CombH1mA -fl8 $Comb1mHA -fl9 $Comb1mH1mA -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
        ...
        if {"$VarWarning"=="no"} {Window hide $widget(Toplevel505); TextEditorRunTrace "Close Window H A Alpha Decomposition Parameters 3 Mult" "b"}
        }
    }
}} \
        -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel505" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/HAAlphaDecompositionMult3_1.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel505" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel505); TextEditorRunTrace "Close Window H A Alpha Decomposition Parameters 3 Mult" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel505" 1
