...
proc vTclWindow.top523a {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 500x210+10+110; update
    wm maxsize $top 1604 1184
    wm minsize $top 116 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Polarimetric Tomography ( Pol-TomSAR ) - Generators"
    vTcl:DefineAlias "$top" "Toplevel523a" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.cpd67" "TitleFrame523a_1" vTcl:WidgetProc "Toplevel523a" 1
...
if {$PTOMgeneDEM == 1} {
    ...
    $widget(TitleFrame523a_1) configure -state normal; $widget(TitleFrame523a_2) configure -state normal; $widget(TitleFrame523a_3) configure -state normal
    $widget(Radiobutton523a_1) configure -state normal; $widget(Radiobutton523a_2) configure -state normal
    $widget(Label523a_1) configure -state normal; $widget(Label523a_2) configure -state normal
    $widget(Entry523a_1) configure -state normal; $widget(Entry523a_2) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_4_0.cpd67" "Checkbutton523a_1" vTcl:WidgetProc "Toplevel523a" 1
    frame $site_4_0.cpd75 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd75" "Frame70" vTcl:WidgetProc "Toplevel523a" 1
    set site_5_0 $site_4_0.cpd75
    frame $site_5_0.cpd68 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd68" "Frame77" vTcl:WidgetProc "Toplevel523a" 1
    set site_6_0 $site_5_0.cpd68
    entry $site_6_0.cpd71 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable PTOMDEMFile 
    vTcl:DefineAlias "$site_6_0.cpd71" "Entry523a_01" vTcl:WidgetProc "Toplevel523a" 1
    pack $site_6_0.cpd71 \
        -in $site_6_0 -anchor center -expand 1 -fill x -side left 
    frame $site_5_0.cpd69 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd69" "Frame78" vTcl:WidgetProc "Toplevel523a" 1
    set site_6_0 $site_5_0.cpd69
    TitleFrame $site_6_0.cpd72 \
        -ipad 2 -text {Slant-Range axis} 
    vTcl:DefineAlias "$site_6_0.cpd72" "TitleFrame523a_2" vTcl:WidgetProc "Toplevel523a" 1
    ...
    frame $site_8_0.cpd71 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd71" "Frame23" vTcl:WidgetProc "Toplevel523a" 1
    set site_9_0 $site_8_0.cpd71
...
if {$PTOMSlice == "col"} { 
    ...
    vTcl:DefineAlias "$site_9_0.cpd75" "Radiobutton523a_1" vTcl:WidgetProc "Toplevel523a" 1
...
if {$PTOMSlice == "lig"} { 
    ...
    vTcl:DefineAlias "$site_9_0.cpd74" "Radiobutton523a_2" vTcl:WidgetProc "Toplevel523a" 1
    pack $site_9_0.cpd75 \
    ...
    vTcl:DefineAlias "$site_6_0.cpd73" "TitleFrame523a_3" vTcl:WidgetProc "Toplevel523a" 1
    ...
    frame $site_8_0.cpd73 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd73" "Frame76" vTcl:WidgetProc "Toplevel523a" 1
    set site_9_0 $site_8_0.cpd73
    label $site_9_0.lab76 \
        -text {Near Range} 
    vTcl:DefineAlias "$site_9_0.lab76" "Label523a_1" vTcl:WidgetProc "Toplevel523a" 1
    entry $site_9_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PTOMNRvalDEM -width 7 
    vTcl:DefineAlias "$site_9_0.ent78" "Entry523a_1" vTcl:WidgetProc "Toplevel523a" 1
    pack $site_9_0.lab76 \
        -in $site_9_0 -anchor center -expand 1 -fill none -side left 
    pack $site_9_0.ent78 \
    ...
    frame $site_8_0.cpd74 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd74" "Frame79" vTcl:WidgetProc "Toplevel523a" 1
    set site_9_0 $site_8_0.cpd74
    label $site_9_0.lab76 \
        -text {Far Range} 
    vTcl:DefineAlias "$site_9_0.lab76" "Label523a_2" vTcl:WidgetProc "Toplevel523a" 1
    entry $site_9_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PTOMFRvalDEM -width 7 
    vTcl:DefineAlias "$site_9_0.ent78" "Entry523a_2" vTcl:WidgetProc "Toplevel523a" 1
    pack $site_9_0.lab76 \
        -in $site_9_0 -anchor center -expand 1 -fill none -side left 
    pack $site_9_0.ent78 \
        -in $site_9_0 -anchor center -expand 1 -fill none -side right 
    ...
    vTcl:DefineAlias "$top.cpd74" "TitleFrame523a_4" vTcl:WidgetProc "Toplevel523a" 1
...
if {$PTOMgeneHeight == 1} {
    ...
    $widget(TitleFrame523a_4) configure -state normal; $widget(TitleFrame523a_5) configure -state normal; $widget(TitleFrame523a_6) configure -state normal
    $widget(Radiobutton523a_3) configure -state normal; $widget(Radiobutton523a_4) configure -state normal
    $widget(Label523a_3) configure -state normal; $widget(Label523a_4) configure -state normal
    $widget(Entry523a_3) configure -state normal; $widget(Entry523a_4) configure -state normal 
    } else {
    ...
    vTcl:DefineAlias "$site_4_0.cpd67" "Checkbutton523a_2" vTcl:WidgetProc "Toplevel523a" 1
    frame $site_4_0.cpd75 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd75" "Frame72" vTcl:WidgetProc "Toplevel523a" 1
    set site_5_0 $site_4_0.cpd75
    frame $site_5_0.cpd68 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd68" "Frame80" vTcl:WidgetProc "Toplevel523a" 1
    set site_6_0 $site_5_0.cpd68
    entry $site_6_0.cpd71 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable PTOMHeightFile 
    vTcl:DefineAlias "$site_6_0.cpd71" "Entry523a_02" vTcl:WidgetProc "Toplevel523a" 1
    pack $site_6_0.cpd71 \
        -in $site_6_0 -anchor center -expand 1 -fill x -side left 
    frame $site_5_0.cpd69 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd69" "Frame81" vTcl:WidgetProc "Toplevel523a" 1
    set site_6_0 $site_5_0.cpd69
    TitleFrame $site_6_0.cpd72 \
        -ipad 2 -text {Slant-Range axis} 
    vTcl:DefineAlias "$site_6_0.cpd72" "TitleFrame523a_5" vTcl:WidgetProc "Toplevel523a" 1
    bind $site_6_0.cpd72 <Destroy> {
        Widget::destroy %W; rename %W {}
    }
    set site_8_0 [$site_6_0.cpd72 getframe]
    frame $site_8_0.cpd71 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd71" "Frame24" vTcl:WidgetProc "Toplevel523a" 1
    set site_9_0 $site_8_0.cpd71
    radiobutton $site_9_0.cpd75 \
        -borderwidth 0 \
        -command {global PTOMDirInput PTOMOutputDir PTOMSlice PTOMDEM
...
if {$PTOMSlice == "col"} { 
    ...
    vTcl:DefineAlias "$site_9_0.cpd75" "Radiobutton523a_3" vTcl:WidgetProc "Toplevel523a" 1
    radiobutton $site_9_0.cpd74 \
        -borderwidth 0 \
        -command {global PTOMDirInput PTOMOutputDir PTOMSlice PTOMDEM
global BMPPTOMX BMPPTOMY
...
if {$PTOMSlice == "lig"} { 
    ...
    vTcl:DefineAlias "$site_9_0.cpd74" "Radiobutton523a_4" vTcl:WidgetProc "Toplevel523a" 1
    pack $site_9_0.cpd75 \
        -in $site_9_0 -anchor center -expand 1 -fill none -side left 
    pack $site_9_0.cpd74 \
        -in $site_9_0 -anchor center -expand 1 -fill none -side left 
    ...
    TitleFrame $site_6_0.cpd73 \
        -ipad 2 -text {Slant-Range values} 
    vTcl:DefineAlias "$site_6_0.cpd73" "TitleFrame523a_6" vTcl:WidgetProc "Toplevel523a" 1
    bind $site_6_0.cpd73 <Destroy> {
        Widget::destroy %W; rename %W {}
    }
    set site_8_0 [$site_6_0.cpd73 getframe]
    frame $site_8_0.cpd73 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd73" "Frame82" vTcl:WidgetProc "Toplevel523a" 1
    set site_9_0 $site_8_0.cpd73
    label $site_9_0.lab76 \
        -text {Near Range} 
    vTcl:DefineAlias "$site_9_0.lab76" "Label523a_3" vTcl:WidgetProc "Toplevel523a" 1
    entry $site_9_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PTOMNRvalHeight -width 7 
    vTcl:DefineAlias "$site_9_0.ent78" "Entry523a_3" vTcl:WidgetProc "Toplevel523a" 1
    pack $site_9_0.lab76 \
        -in $site_9_0 -anchor center -expand 1 -fill none -side left 
    pack $site_9_0.ent78 \
        -in $site_9_0 -anchor center -expand 1 -fill none -side right 
    frame $site_8_0.cpd74 \
        -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd74" "Frame83" vTcl:WidgetProc "Toplevel523a" 1
    set site_9_0 $site_8_0.cpd74
    label $site_9_0.lab76 \
        -text {Far Range} 
    vTcl:DefineAlias "$site_9_0.lab76" "Label523a_4" vTcl:WidgetProc "Toplevel523a" 1
    entry $site_9_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable PTOMFRvalHeight -width 7 
    vTcl:DefineAlias "$site_9_0.ent78" "Entry523a_4" vTcl:WidgetProc "Toplevel523a" 1
    pack $site_9_0.lab76 \
        -in $site_9_0 -anchor center -expand 1 -fill none -side left 
    pack $site_9_0.ent78 \
        -in $site_9_0 -anchor center -expand 1 -fill none -side right 
    ...
    vTcl:DefineAlias "$top.fra92" "Frame20" vTcl:WidgetProc "Toplevel523a" 1
...
Window hide $widget(Toplevel523a); TextEditorRunTrace "Close Window Polarimetric Tomography Generator" "b"    
    ...
    vTcl:DefineAlias "$site_3_0.cpd67" "Button523_3" vTcl:WidgetProc "Toplevel523a" 1
    pack $site_3_0.cpd67 \
