...
#############################################################################
## Procedure:  WidgetOn519aMult

proc ::WidgetOn519aMult {} {
...
global ParaNwin ParaBMP ParametersFonction ParametersFonctionPP
...
set ButHHHV .top519a.tit68.f.cpd92.che78; set ButHVHH .top519a.tit68.f.cpd92.che79
set ButHHVV .top519a.tit68.f.cpd92.che80; set ButVVHH .top519a.tit68.f.cpd92.che81
set ButHVVV .top519a.tit68.f.cpd92.che82; set ButVVHV .top519a.tit68.f.cpd92.che83

set ButHHVH .top519a.tit68.f.cpd93.che78; set ButVHHH .top519a.tit68.f.cpd93.che79
set ButHVVH .top519a.tit68.f.cpd93.che80; set ButVHHV .top519a.tit68.f.cpd93.che81
set ButVHVV .top519a.tit68.f.cpd93.che82; set ButVVVH .top519a.tit68.f.cpd93.che83
...
proc vTclWindow.top519a {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel519a" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd74 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd74" "Frame4" vTcl:WidgetProc "Toplevel519a" 1
    set site_3_0 $top.cpd74
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame8" vTcl:WidgetProc "Toplevel519a" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel519a" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel519a" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button40" vTcl:WidgetProc "Toplevel519a" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame9" vTcl:WidgetProc "Toplevel519a" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel519a" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame16" vTcl:WidgetProc "Toplevel519a" 1
    set site_6_0 $site_5_0.cpd91
    label $site_6_0.cpd73 \
        -text / 
    vTcl:DefineAlias "$site_6_0.cpd73" "Label14" vTcl:WidgetProc "Toplevel519a" 1
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ParametersOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd72" "EntryTopXXCh9" vTcl:WidgetProc "Toplevel519a" 1
    pack $site_6_0.cpd73 \
    ...
    frame $site_5_0.cpd71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd71" "Frame17" vTcl:WidgetProc "Toplevel519a" 1
    set site_6_0 $site_5_0.cpd71
...
if {$DirName != "" } {
    ...
    set ParametersOutputDir $ParametersDirOutputTmp
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd75" "Button82" vTcl:WidgetProc "Toplevel519a" 1
    ...
    vTcl:DefineAlias "$top.fra102" "Frame9" vTcl:WidgetProc "Toplevel519a" 1
    set site_3_0 $top.fra102
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel519a" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel519a" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel519a" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel519a" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel519a" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel519a" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel519a" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel519a" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.fra109" "Frame20" vTcl:WidgetProc "Toplevel519a" 1
...
if {"$VarWarning"=="ok"} {
    ...
    for {set i 1} {$i < $Nratio} {incr i} {
        ...
        update
        TextEditorRunTrace "Process The Function Soft/data_process_sngl/ratio_elements.exe" "k"
        ...
        set f [ open "| Soft/data_process_sngl/ratio_elements.exe -id \x22$ParametersDirInput\x22 -od \x22$ParametersDirOutput\x22 -iodf $ParametersF -nwr $ParaNwinL -nwc $ParaNwinC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -rat $ParaRatio($i) -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
        PsPprogressBar $f
    ...
    if {"$VarWarning"=="no"} {
        Window hide $widget(Toplevel519a)
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel519a" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/ParametersPRMult.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel519a" 1
...
if {$ParametersFonction == "SPP"} {TextEditorRunTrace "Close Window SPP Parameters" "b"}
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel519a" 1
    ...
    vTcl:DefineAlias "$top.tit68" "TitleFrame1" vTcl:WidgetProc "Toplevel519a" 1
    ...
    frame $site_4_0.cpd92 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd92" "Frame8" vTcl:WidgetProc "Toplevel519a" 1
    set site_5_0 $site_4_0.cpd92
    checkbutton $site_5_0.che78 \
        -text {11 / 12} -variable ParaHHovHV 
    vTcl:DefineAlias "$site_5_0.che78" "Checkbutton29" vTcl:WidgetProc "Toplevel519a" 1
    checkbutton $site_5_0.che79 \
        -text {12 / 11} -variable ParaHVovHH 
    vTcl:DefineAlias "$site_5_0.che79" "Checkbutton30" vTcl:WidgetProc "Toplevel519a" 1
    checkbutton $site_5_0.che80 \
        -text {11 / 22} -variable ParaHHovVV 
    vTcl:DefineAlias "$site_5_0.che80" "Checkbutton31" vTcl:WidgetProc "Toplevel519a" 1
    checkbutton $site_5_0.che81 \
        -text {22 / 11} -variable ParaVVovHH 
    vTcl:DefineAlias "$site_5_0.che81" "Checkbutton32" vTcl:WidgetProc "Toplevel519a" 1
    checkbutton $site_5_0.che82 \
        -text {12 / 22} -variable ParaHVovVV 
    vTcl:DefineAlias "$site_5_0.che82" "Checkbutton33" vTcl:WidgetProc "Toplevel519a" 1
    checkbutton $site_5_0.che83 \
        -text {22 / 12} -variable ParaVVovHV 
    vTcl:DefineAlias "$site_5_0.che83" "Checkbutton34" vTcl:WidgetProc "Toplevel519a" 1
    pack $site_5_0.che78 \
    ...
    frame $site_4_0.cpd93 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd93" "Frame10" vTcl:WidgetProc "Toplevel519a" 1
    set site_5_0 $site_4_0.cpd93
    checkbutton $site_5_0.che78 \
        -text {11 / 21} -variable ParaHHovVH 
    vTcl:DefineAlias "$site_5_0.che78" "Checkbutton35" vTcl:WidgetProc "Toplevel519a" 1
    checkbutton $site_5_0.che79 \
        -text {21 / 11} -variable ParaVHovHH 
    vTcl:DefineAlias "$site_5_0.che79" "Checkbutton36" vTcl:WidgetProc "Toplevel519a" 1
    checkbutton $site_5_0.che80 \
        -text {12 / 21} -variable ParaHVovVH 
    vTcl:DefineAlias "$site_5_0.che80" "Checkbutton37" vTcl:WidgetProc "Toplevel519a" 1
    checkbutton $site_5_0.che81 \
        -text {21 / 12} -variable ParaVHovHV 
    vTcl:DefineAlias "$site_5_0.che81" "Checkbutton38" vTcl:WidgetProc "Toplevel519a" 1
    checkbutton $site_5_0.che82 \
        -text {21 / 22} -variable ParaVHovVV 
    vTcl:DefineAlias "$site_5_0.che82" "Checkbutton39" vTcl:WidgetProc "Toplevel519a" 1
    checkbutton $site_5_0.che83 \
        -text {22 / 21} -variable ParaVVovVH 
    vTcl:DefineAlias "$site_5_0.che83" "Checkbutton40" vTcl:WidgetProc "Toplevel519a" 1
    pack $site_5_0.che78 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 10 -side left 
    pack $site_5_0.che79 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.cpd88 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd88" "Frame51" vTcl:WidgetProc "Toplevel519a" 1
    set site_3_0 $top.cpd88
    checkbutton $site_3_0.cpd66 \
        -padx 1 -text BMP -variable ParaBMP 
    vTcl:DefineAlias "$site_3_0.cpd66" "Checkbutton468" vTcl:WidgetProc "Toplevel519a" 1
    frame $site_3_0.fra24 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.fra24" "Frame52" vTcl:WidgetProc "Toplevel519a" 1
    set site_4_0 $site_3_0.fra24
    label $site_4_0.lab57 \
        -text {Window Size Row} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label36" vTcl:WidgetProc "Toplevel519a" 1
    entry $site_4_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable ParaNwinL -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry24" vTcl:WidgetProc "Toplevel519a" 1
    pack $site_4_0.lab57 \
    ...
    frame $site_3_0.cpd68 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.cpd68" "Frame53" vTcl:WidgetProc "Toplevel519a" 1
    set site_4_0 $site_3_0.cpd68
    label $site_4_0.lab57 \
        -text {Window Size Col} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label37" vTcl:WidgetProc "Toplevel519a" 1
    entry $site_4_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable ParaNwinC -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry25" vTcl:WidgetProc "Toplevel519a" 1
    pack $site_4_0.lab57 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent58 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
...
if {$ParametersFonction == "SPP"} {
    ...
    vTcl:DefineAlias "$site_3_0.cpd67" "Button18" vTcl:WidgetProc "Toplevel519a" 1
...
set ParaBMP 0} \
    ...
    vTcl:DefineAlias "$site_3_0.cpd91" "Button17" vTcl:WidgetProc "Toplevel519a" 1
