...
proc vTcl:project:info {} {
    ...
    namespace eval ::widgets::$base.lab82 {
        array set save {-background 1 -foreground 1 -relief 1 -textvariable 1 -width 1}
    }
    ...
    namespace eval ::widgets::$site_6_0.but81 {
...
proc vTclWindow.top517 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel517" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd88 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd88" "Frame5" vTcl:WidgetProc "Toplevel517" 1
    set site_3_0 $top.cpd88
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame8" vTcl:WidgetProc "Toplevel517" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel517" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame19" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button43" vTcl:WidgetProc "Toplevel517" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame9" vTcl:WidgetProc "Toplevel517" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel517" 1
    frame $site_5_0.cpd90 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd90" "Frame1" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.cpd90
    label $site_6_0.lab88 \
        -text / 
    vTcl:DefineAlias "$site_6_0.lab88" "Label2" vTcl:WidgetProc "Toplevel517" 1
    entry $site_6_0.cpd92 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SupervisedOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd92" "Entry1" vTcl:WidgetProc "Toplevel517" 1
    pack $site_6_0.lab88 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame21" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.cpd91
    ...
    vTcl:DefineAlias "$top.fra55" "Frame9" vTcl:WidgetProc "Toplevel517" 1
    set site_3_0 $top.fra55
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel517" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel517" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel517" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel517" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel517" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel517" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel517" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel517" 1
    pack $site_3_0.lab57 \
    ...
    label $top.lab82 \
        ...
        -textvariable Fonction -width 50 
    vTcl:DefineAlias "$top.lab82" "Label1" vTcl:WidgetProc "Toplevel517" 1
    TitleFrame $top.tit109 \
        -ipad 0 -text {Classification Configuration} 
    vTcl:DefineAlias "$top.tit109" "TitleFrame3" vTcl:WidgetProc "Toplevel517" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd110" "Frame260" vTcl:WidgetProc "Toplevel517" 1
    set site_5_0 $site_4_0.cpd110
    frame $site_5_0.fra23 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra23" "Frame265" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.fra23
    checkbutton $site_6_0.che24 \
        -text BMP -variable BMPSupervised 
    vTcl:DefineAlias "$site_6_0.che24" "Checkbutton84" vTcl:WidgetProc "Toplevel517" 1
    frame $site_6_0.fra25 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_6_0.fra25" "Frame266" vTcl:WidgetProc "Toplevel517" 1
    set site_7_0 $site_6_0.fra25
    label $site_7_0.lab57 \
        -padx 1 -text {Window Size : Row} -width 15 
    vTcl:DefineAlias "$site_7_0.lab57" "Label272" vTcl:WidgetProc "Toplevel517" 1
    entry $site_7_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinSupervisedL -width 5 
    vTcl:DefineAlias "$site_7_0.ent58" "Entry187" vTcl:WidgetProc "Toplevel517" 1
    label $site_7_0.cpd81 \
        -padx 1 -text Col 
    vTcl:DefineAlias "$site_7_0.cpd81" "Label273" vTcl:WidgetProc "Toplevel517" 1
    entry $site_7_0.cpd82 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinSupervisedC -width 5 
    vTcl:DefineAlias "$site_7_0.cpd82" "Entry190" vTcl:WidgetProc "Toplevel517" 1
    pack $site_7_0.lab57 \
    ...
    frame $site_5_0.fra26 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra26" "Frame267" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.fra26
...
if {$RejectClass == "1"} {
    $widget(Label517_7) configure -state normal
    $widget(Entry517_1) configure -state normal
    set RejectRatio "5.0"
    } else {
    ...
    vTcl:DefineAlias "$site_6_0.che27" "Checkbutton85" vTcl:WidgetProc "Toplevel517" 1
    frame $site_6_0.fra28 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_6_0.fra28" "Frame261" vTcl:WidgetProc "Toplevel517" 1
    set site_7_0 $site_6_0.fra28
    label $site_7_0.lab57 \
        -padx 1 -text {Reject Ratio} -width 10 
    vTcl:DefineAlias "$site_7_0.lab57" "Label517_7" vTcl:WidgetProc "Toplevel517" 1
    entry $site_7_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable RejectRatio -width 5 
    vTcl:DefineAlias "$site_7_0.ent58" "Entry517_1" vTcl:WidgetProc "Toplevel517" 1
    pack $site_7_0.lab57 \
    ...
    frame $site_5_0.fra29 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra29" "Frame268" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.fra29
    checkbutton $site_6_0.che30 \
        -text {Confusion Matrix} -variable ConfusionMatrix 
    vTcl:DefineAlias "$site_6_0.che30" "Checkbutton83" vTcl:WidgetProc "Toplevel517" 1
...
if {$ConfusionMatrix == 1} {
    ...
    TextEditorFromWidget .top517 $ConfusionMatrixFile
    }
}} \
        -padx 4 -pady 2 -text {CM Editor} 
    vTcl:DefineAlias "$site_6_0.but31" "Button517_1" vTcl:WidgetProc "Toplevel517" 1
...
if {$ConfusionMatrix == 1} {
    ...
    vTcl:DefineAlias "$site_6_0.but22" "Button517_2" vTcl:WidgetProc "Toplevel517" 1
    ...
    vTcl:DefineAlias "$top.cpd100" "TitleFrame2" vTcl:WidgetProc "Toplevel517" 1
    ...
    frame $site_4_0.fra90 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra90" "Frame2" vTcl:WidgetProc "Toplevel517" 1
    set site_5_0 $site_4_0.fra90
    frame $site_5_0.fra91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra91" "Frame8" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.fra91
    label $site_6_0.cpd95 \
        -text {ColorMap 16} 
    vTcl:DefineAlias "$site_6_0.cpd95" "Label126" vTcl:WidgetProc "Toplevel517" 1
    pack $site_6_0.cpd95 \
        -in $site_6_0 -anchor center -expand 1 -fill none -side top 
    frame $site_5_0.fra92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra92" "Frame10" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.fra92
...
if {$FileName != ""} {
    set ColorMapSupervised16 $FileName
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.but81" "Button1" vTcl:WidgetProc "Toplevel517" 1
    bindtags $site_6_0.but81 "$site_6_0.but81 Button $top all _vTclBalloon"
    bind $site_6_0.but81 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Open File}
    }
    button $site_6_0.cpd102 \
        -background #ffff00 \
        -command [list vTcl:DoCmdOption $site_6_0.cpd102 {global ColorMapSupervised16 VarColorMap
...
WidgetShowFromWidget $widget(Toplevel517) $widget(Toplevel38); TextEditorRunTrace "Open Window Colormap" "b"
...
if {"$VarColorMap"=="ok"} {
   set ColorMapSupervised16 $ColorMapOut
    ...
    vTcl:DefineAlias "$site_6_0.cpd102" "Button42" vTcl:WidgetProc "Toplevel517" 1
    ...
    frame $site_5_0.fra93 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra93" "Frame11" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.fra93
    entry $site_6_0.cpd97 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable ColorMapSupervised16 -width 40 
    vTcl:DefineAlias "$site_6_0.cpd97" "Entry53" vTcl:WidgetProc "Toplevel517" 1
    pack $site_6_0.cpd97 \
    ...
    frame $site_4_0.cpd101 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd101" "Frame660" vTcl:WidgetProc "Toplevel517" 1
    set site_5_0 $site_4_0.cpd101
    checkbutton $site_5_0.che24 \
        \
        -command {global ColorMapSupervisedCoded ColorMapSupervisedCoded1 ColorMapSupervisedCoded2
...
if {$ColorMapSupervisedCoded == "1"} {
    $widget(Checkbutton517_1) configure -state normal
    $widget(Checkbutton517_2) configure -state normal
    $widget(Label517_1) configure -state normal
    $widget(Label517_2) configure -state normal
    $widget(Label517_3) configure -state normal
    $widget(Label517_4) configure -state normal
    $widget(Label517_5) configure -state normal
    $widget(Label517_6) configure -state normal
    }
} \
        -text {Coded Colormap} -variable ColorMapSupervisedCoded 
    vTcl:DefineAlias "$site_5_0.che24" "Checkbutton638" vTcl:WidgetProc "Toplevel517" 1
    frame $site_5_0.fra25 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra25" "Frame70" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.fra25
    frame $site_6_0.fra38 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra38" "Frame87" vTcl:WidgetProc "Toplevel517" 1
    set site_7_0 $site_6_0.fra38
    checkbutton $site_7_0.che29 \
        -text {Comb 1} -variable ColorMapSupervisedCoded1 
    vTcl:DefineAlias "$site_7_0.che29" "Checkbutton517_1" vTcl:WidgetProc "Toplevel517" 1
    checkbutton $site_7_0.che31 \
        -text {Comb 2} -variable ColorMapSupervisedCoded2 
    vTcl:DefineAlias "$site_7_0.che31" "Checkbutton517_2" vTcl:WidgetProc "Toplevel517" 1
    pack $site_7_0.che29 \
    ...
    frame $site_6_0.fra39 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_6_0.fra39" "Frame88" vTcl:WidgetProc "Toplevel517" 1
    set site_7_0 $site_6_0.fra39
    frame $site_7_0.fra42 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.fra42" "Frame71" vTcl:WidgetProc "Toplevel517" 1
    set site_8_0 $site_7_0.fra42
    label $site_8_0.lab47 \
        -foreground #0000ff -text |Chx1| 
    vTcl:DefineAlias "$site_8_0.lab47" "Label517_1" vTcl:WidgetProc "Toplevel517" 1
    label $site_8_0.lab48 \
        -foreground #008000 -text |Chx1-Chx2| 
    vTcl:DefineAlias "$site_8_0.lab48" "Label517_2" vTcl:WidgetProc "Toplevel517" 1
    label $site_8_0.lab49 \
        -foreground #ff0000 -text |Chx2| 
    vTcl:DefineAlias "$site_8_0.lab49" "Label517_3" vTcl:WidgetProc "Toplevel517" 1
    pack $site_8_0.lab47 \
    ...
    frame $site_7_0.fra43 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_7_0.fra43" "Frame72" vTcl:WidgetProc "Toplevel517" 1
    set site_8_0 $site_7_0.fra43
    label $site_8_0.lab52 \
        -foreground #0000ff -text |Chx2| 
    vTcl:DefineAlias "$site_8_0.lab52" "Label517_4" vTcl:WidgetProc "Toplevel517" 1
    label $site_8_0.lab53 \
        -foreground #008000 -text |Chx1-Chx2| 
    vTcl:DefineAlias "$site_8_0.lab53" "Label517_5" vTcl:WidgetProc "Toplevel517" 1
    label $site_8_0.lab54 \
        -foreground #ff0000 -text |Chx1| 
    vTcl:DefineAlias "$site_8_0.lab54" "Label517_6" vTcl:WidgetProc "Toplevel517" 1
    pack $site_8_0.lab52 \
        -in $site_8_0 -anchor center -expand 0 -fill none -side left 
    pack $site_8_0.lab53 \
        -in $site_8_0 -anchor center -expand 0 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.cpd103" "TitleFrame1" vTcl:WidgetProc "Toplevel517" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd93" "Frame270" vTcl:WidgetProc "Toplevel517" 1
    set site_5_0 $site_4_0.cpd93
    label $site_5_0.lab42 \
        -text {Areas File  } 
    vTcl:DefineAlias "$site_5_0.lab42" "Label275" vTcl:WidgetProc "Toplevel517" 1
    entry $site_5_0.ent44 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable FileTrainingArea 
    vTcl:DefineAlias "$site_5_0.ent44" "Entry188" vTcl:WidgetProc "Toplevel517" 1
    frame $site_5_0.cpd94 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd94" "Frame22" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.cpd94
...
if [file exists $FileTrainingArea] {
    ...
    if {$tmp == "NB_TRAINING_CLASSES"} {
        ...
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd105" "Button19" vTcl:WidgetProc "Toplevel517" 1
    ...
    frame $site_4_0.cpd106 \
        -borderwidth 2 -height 123 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd106" "Frame279" vTcl:WidgetProc "Toplevel517" 1
    set site_5_0 $site_4_0.cpd106
    frame $site_5_0.fra23 \
        -borderwidth 2 -height 123 -width 125 
    vTcl:DefineAlias "$site_5_0.fra23" "Frame474" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.fra23
...
if [file exists $FileTrainingArea] {
    ...
    $widget(Button517_3) configure -state normal
    }
...
if {"$VarTrainingArea"=="no"} {
    ...
    vTcl:DefineAlias "$site_6_0.but67" "Button642" vTcl:WidgetProc "Toplevel517" 1
...
if {"$VarWarning"=="ok"} {
    ...
    for {set ii 1} {$ii <= $NDataDirMult} {incr ii} {
        ...
        update
        TextEditorRunTrace "Process The Function Soft/bin/data_process_sngl/wishart_training_set_sampler.exe" "k"
        TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -iodf $SupervisedFonction -af \x22$FileTrainingArea\x22 -cf \x22$FileTrainingSet\x22 -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
        set f [ open "| Soft/bin/data_process_sngl/wishart_training_set_sampler.exe -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -iodf $SupervisedFonction -af \x22$FileTrainingArea\x22 -cf \x22$FileTrainingSet\x22 -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
        PsPprogressBar $f
        TextEditorRunTrace "Check RunTime Errors" "r"
        CheckRunTimeError
        WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
        $widget(Button517_4) configure -state normal
        }
    ...
    if {"$VarWarning"=="no"} {Window hide $widget(Toplevel517); TextEditorRunTrace "Close Window Wishart Supervised Classification Mult" "b"}
    }
} else {
set WarningMessage "TRAINING AREAS MUST BE DEFINED FIRST"
set WarningMessage2 "BEFORE RUNNING THE TRAINING PROCESS"
set VarWarning ""
Window show $widget(Toplevel32); TextEditorRunTrace "Open Window Warning" "b"
tkwait variable VarWarning
}
    ...
    vTcl:DefineAlias "$site_5_0.but68" "Button517_3" vTcl:WidgetProc "Toplevel517" 1
    ...
    frame $site_4_0.cpd107 \
        -relief groove -height 77 -width 437 
    vTcl:DefineAlias "$site_4_0.cpd107" "Frame271" vTcl:WidgetProc "Toplevel517" 1
    set site_5_0 $site_4_0.cpd107
    label $site_5_0.lab42 \
        -text {  Set File     } 
    vTcl:DefineAlias "$site_5_0.lab42" "Label276" vTcl:WidgetProc "Toplevel517" 1
    entry $site_5_0.ent44 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable FileTrainingSet 
    vTcl:DefineAlias "$site_5_0.ent44" "Entry189" vTcl:WidgetProc "Toplevel517" 1
    frame $site_5_0.cpd94 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd94" "Frame23" vTcl:WidgetProc "Toplevel517" 1
    set site_6_0 $site_5_0.cpd94
...
if {$FileName != ""} {
    ...
    if [file exists $FileTrainingArea] {
        ...
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd108" "Button20" vTcl:WidgetProc "Toplevel517" 1
    ...
    vTcl:DefineAlias "$top.fra59" "Frame20" vTcl:WidgetProc "Toplevel517" 1
    set site_3_0 $top.fra59
    button $site_3_0.but93 \
        -background #ffff00 \
        -command {global DataDirMult NDataDirMult
global SupervisedDirInput SupervisedDirOutput SupervisedOutputDir SupervisedOutputSubDir
global SupervisedTrainingProcess SupervisedClusterFonction SupervisedClassifierFonction
...
if {"$VarWarning"=="ok"} {
    ...
    for {set ii 1} {$ii <= $NDataDirMult} {incr ii} {
        ...
        if [file exists $FileTrainingSet] {
            ...
            WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
            update
            TextEditorRunTrace "Process The Function Soft/bin/data_process_sngl/wishart_supervised_classifier.exe" "k"
            TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -iodf $SupervisedFonction -af \x22$FileTrainingArea\x22 -nwr $NwinSupervisedL -nwc $NwinSupervisedC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -rej $RejectRatio -std $RejectClass -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22 -cf \x22$FileTrainingSet\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
            set f [ open "| Soft/bin/data_process_sngl/wishart_supervised_classifier.exe -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -iodf $SupervisedFonction -af \x22$FileTrainingArea\x22 -nwr $NwinSupervisedL -nwc $NwinSupervisedC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -rej $RejectRatio -std $RejectClass -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22 -cf \x22$FileTrainingSet\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
            ...
            if {$ConfusionMatrix == "1"} {
                ...
                if [file exists $MaskFile] {set MaskCmd "-mask \x22$MaskFile\x22"}
                WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
                TextEditorRunTrace "Process The Function Soft/bin/data_process_sngl/wishart_confusion_matrix.exe" "k"
                TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -af \x22$FileTrainingArea\x22 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nwr $NwinSupervisedL -nwc $NwinSupervisedC -bmp $BMPSupervised -rej 0 -col \x22$ColorMapSupervised16\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                set f [ open "| Soft/bin/data_process_sngl/wishart_confusion_matrix.exe -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -af \x22$FileTrainingArea\x22 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nwr $NwinSupervisedL -nwc $NwinSupervisedC -bmp $BMPSupervised -rej 0 -col \x22$ColorMapSupervised16\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                TextEditorRunTrace "Check RunTime Errors" "r"
                CheckRunTimeError
                WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
                if {$RejectClass == "1"} {
                    ...
                    WidgetShowTop28; TextEditorRunTrace "Open Window Message" "b"
                    TextEditorRunTrace "Process The Function Soft/bin/data_process_sngl/wishart_confusion_matrix.exe" "k"
                    TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -af \x22$FileTrainingArea\x22 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nwr $NwinSupervisedL -nwc $NwinSupervisedC -bmp $BMPSupervised -rej 1 -col \x22$ColorMapSupervised16\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                    set f [ open "| Soft/bin/data_process_sngl/wishart_confusion_matrix.exe -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -af \x22$FileTrainingArea\x22 -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -nwr $NwinSupervisedL -nwc $NwinSupervisedC -bmp $BMPSupervised -rej 1 -col \x22$ColorMapSupervised16\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                    TextEditorRunTrace "Check RunTime Errors" "r"
                    CheckRunTimeError
                    WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
                    $widget(Button517_2) configure -state normal
                    }
                $widget(Button517_1) configure -state normal
                }        
            if {$ColorMapSupervisedCoded == "1"} {
                set BMPDirInput $SuperDirOutput
                set ClassificationFile "$SuperDirOutput/wishart_supervised_class_"
                append ClassificationFile $NwinSupervisedL; append ClassificationFile "x"; append ClassificationFile $NwinSupervisedC
                set ClassificationInputFile "$ClassificationFile.bin"
                if [file exists $ClassificationInputFile] {
                    if {$ColorMapSupervisedCoded1 == "1"} {
                        set Fonction "Creation of the Supervised Classification BMP File"
                        set Fonction2 "Using an automatic color coded (RGB1) ColorMap"
                        set MaskCmd ""
                        set MaskFile "$SuperDirInput/mask_valid_pixels.bin"
                        if [file exists $MaskFile] {set MaskCmd "-mask \x22$MaskFile\x22"}
                        set ProgressLine "0"
                        ...
                        TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedFonction -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -rgbf RGB1  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                        set f [ open "| Soft/bin/bmp_process/classification_colormap_SPPIPPC2.exe -id \x22$SuperDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedFonction -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -rgbf RGB1  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                        PsPprogressBar $f
                        TextEditorRunTrace "Check RunTime Errors" "r"
                        CheckRunTimeError
                        WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
                        }
                    if {$ColorMapSupervisedCoded2 == "1"} {
                        set Fonction "Creation of the Supervised Classification BMP File"
                        set Fonction2 "Using an automatic color coded (RGB2) ColorMap"
                        set MaskCmd ""
                        set MaskFile "$SuperDirInput/mask_valid_pixels.bin"
                        if [file exists $MaskFile] {set MaskCmd "-mask \x22$MaskFile\x22"}
                        set ProgressLine "0"
                        ...
                        TextEditorRunTrace "Process The Function Soft/bin/bmp_process/classification_colormap_SPPIPPC2.exe" "k"
                        TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedFonction -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -rgbf RGB2  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                        set f [ open "| Soft/bin/bmp_process/classification_colormap_SPPIPPC2.exe -id \x22$SuperDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedFonction -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -rgbf RGB2  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                        PsPprogressBar $f
                        TextEditorRunTrace "Check RunTime Errors" "r"
                        CheckRunTimeError
                        WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button517_4" vTcl:WidgetProc "Toplevel517" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/WishartSupervisedClassificationMult_PP.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel517" 1
...
if {$BMPImageOpen == 0} {
    Window hide $widget(Toplevel517); TextEditorRunTrace "Close Window Wishart Supervised Classification Mult" "b"
    }
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel517" 1
