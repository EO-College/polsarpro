...
WidgetShowFromWidget $widget(Toplevel517) $widget(Toplevel47); TextEditorRunTrace "Open Window Training Areas Graphic Editor" "b"
...
MouseActiveFunction ""
if {"$VarTrainingArea"=="ok"} { $widget(Button517_3) configure -state normal }
...
TextEditorFromWidget .top517 $FileTrainingArea

}} \
        -padx 4 -pady 2 -text {Text Editor} 
    vTcl:DefineAlias "$site_6_0.but68" "Button643" vTcl:WidgetProc "Toplevel517" 1
...
if {"$VarWarning"=="ok"} {
    ...
    for {set ii 1} {$ii <= $NDataDirMult} {incr ii} {
        ...
        TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -iodf $SupervisedFonction -af \x22$FileTrainingArea\x22 -cf \x22$FileTrainingSet\x22 -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
        set f [ open "| Soft/data_process_sngl/wishart_training_set_sampler.exe -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -iodf $SupervisedFonction -af \x22$FileTrainingArea\x22 -cf \x22$FileTrainingSet\x22 -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
        PsPprogressBar $f
            ...
            if {$ColorMapSupervisedCoded == "1"} {
                ...
                if [file exists $ClassificationInputFile] {
                    if {$ColorMapSupervisedCoded1 == "1"} {
                        ...
                        TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedFonction -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -rgbf RGB1 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                        set f [ open "| Soft/bmp_process/classification_colormap_SPPIPPC2.exe -id \x22$SuperDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedFonction -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -rgbf RGB1 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                        PsPprogressBar $f
                        TextEditorRunTrace "Check RunTime Errors" "r"
                        CheckRunTimeError
                        WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
                    ...
                    if {$ColorMapSupervisedCoded2 == "1"} {
                        ...
                        TextEditorRunTrace "Process The Function Soft/bmp_process/classification_colormap_SPPIPPC2.exe" "k"
                        TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedFonction -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -rgbf RGB2 -mem $PSPMemory -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
