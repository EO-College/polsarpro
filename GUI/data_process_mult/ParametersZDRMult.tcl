...
#############################################################################
## Procedure:  WidgetOn519bMult

proc ::WidgetOn519bMult {} {
...
set ButZHHHV .top519b.cpd86.f.cpd94.che78; set ButZHVHH .top519b.cpd86.f.cpd94.che79
set ButZHHVV .top519b.cpd86.f.cpd94.che80; set ButZVVHH .top519b.cpd86.f.cpd94.che81
set ButZHVVV .top519b.cpd86.f.cpd94.che82; set ButZVVHV .top519b.cpd86.f.cpd94.che83

set ButZHHVH .top519b.cpd86.f.cpd95.che78; set ButZVHHH .top519b.cpd86.f.cpd95.che79
set ButZHVVH .top519b.cpd86.f.cpd95.che80; set ButZVHHV .top519b.cpd86.f.cpd95.che81
set ButZVHVV .top519b.cpd86.f.cpd95.che82; set ButZVVVH .top519b.cpd86.f.cpd95.che83
...
proc vTclWindow.top519b {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel519b" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd74 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd74" "Frame4" vTcl:WidgetProc "Toplevel519b" 1
    set site_3_0 $top.cpd74
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame8" vTcl:WidgetProc "Toplevel519b" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel519b" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel519b" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button40" vTcl:WidgetProc "Toplevel519b" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame9" vTcl:WidgetProc "Toplevel519b" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel519b" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame16" vTcl:WidgetProc "Toplevel519b" 1
    set site_6_0 $site_5_0.cpd91
    label $site_6_0.cpd73 \
        -text / 
    vTcl:DefineAlias "$site_6_0.cpd73" "Label14" vTcl:WidgetProc "Toplevel519b" 1
    entry $site_6_0.cpd72 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ParametersOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd72" "EntryTopXXCh9" vTcl:WidgetProc "Toplevel519b" 1
    pack $site_6_0.cpd73 \
    ...
    frame $site_5_0.cpd71 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd71" "Frame17" vTcl:WidgetProc "Toplevel519b" 1
    set site_6_0 $site_5_0.cpd71
...
if {$DirName != "" } {
    ...
    set ParametersOutputDir $ParametersDirOutputTmp
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd75" "Button82" vTcl:WidgetProc "Toplevel519b" 1
    ...
    vTcl:DefineAlias "$top.fra102" "Frame9" vTcl:WidgetProc "Toplevel519b" 1
    set site_3_0 $top.fra102
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel519b" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel519b" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel519b" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel519b" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel519b" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel519b" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel519b" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel519b" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.fra109" "Frame20" vTcl:WidgetProc "Toplevel519b" 1
...
if {"$VarWarning"=="ok"} {
    ...
    if {"$VarWarning"=="no"} {
        Window hide $widget(Toplevel519b)
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel519b" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/ParametersZDRMult.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel519b" 1
...
if {$ParametersFonction == "SPP"} {TextEditorRunTrace "Close Window SPP Parameters" "b"}
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel519b" 1
    ...
    vTcl:DefineAlias "$top.cpd86" "TitleFrame2" vTcl:WidgetProc "Toplevel519b" 1
    ...
    frame $site_4_0.cpd94 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd94" "Frame11" vTcl:WidgetProc "Toplevel519b" 1
    set site_5_0 $site_4_0.cpd94
    checkbutton $site_5_0.che78 \
        -text 11_12 -variable ParaZDRHHHV 
    vTcl:DefineAlias "$site_5_0.che78" "Checkbutton41" vTcl:WidgetProc "Toplevel519b" 1
    checkbutton $site_5_0.che79 \
        -text 12_11 -variable ParaZDRHVHH 
    vTcl:DefineAlias "$site_5_0.che79" "Checkbutton42" vTcl:WidgetProc "Toplevel519b" 1
    checkbutton $site_5_0.che80 \
        -text 11_22 -variable ParaZDRHHVV 
    vTcl:DefineAlias "$site_5_0.che80" "Checkbutton43" vTcl:WidgetProc "Toplevel519b" 1
    checkbutton $site_5_0.che81 \
        -text 22_11 -variable ParaZDRVVHH 
    vTcl:DefineAlias "$site_5_0.che81" "Checkbutton44" vTcl:WidgetProc "Toplevel519b" 1
    checkbutton $site_5_0.che82 \
        -text 12_22 -variable ParaZDRHVVV 
    vTcl:DefineAlias "$site_5_0.che82" "Checkbutton45" vTcl:WidgetProc "Toplevel519b" 1
    checkbutton $site_5_0.che83 \
        -text 22_12 -variable ParaZDRVVHV 
    vTcl:DefineAlias "$site_5_0.che83" "Checkbutton46" vTcl:WidgetProc "Toplevel519b" 1
    pack $site_5_0.che78 \
    ...
    frame $site_4_0.cpd95 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd95" "Frame12" vTcl:WidgetProc "Toplevel519b" 1
    set site_5_0 $site_4_0.cpd95
    checkbutton $site_5_0.che78 \
        -text 11_21 -variable ParaZDRHHVH 
    vTcl:DefineAlias "$site_5_0.che78" "Checkbutton47" vTcl:WidgetProc "Toplevel519b" 1
    checkbutton $site_5_0.che79 \
        -text 21_11 -variable ParaZDRVHHH 
    vTcl:DefineAlias "$site_5_0.che79" "Checkbutton48" vTcl:WidgetProc "Toplevel519b" 1
    checkbutton $site_5_0.che80 \
        -text 12_21 -variable ParaZDRHVVH 
    vTcl:DefineAlias "$site_5_0.che80" "Checkbutton49" vTcl:WidgetProc "Toplevel519b" 1
    checkbutton $site_5_0.che81 \
        -text 21_12 -variable ParaZDRVHHV 
    vTcl:DefineAlias "$site_5_0.che81" "Checkbutton50" vTcl:WidgetProc "Toplevel519b" 1
    checkbutton $site_5_0.che82 \
        -text 21_22 -variable ParaZDRVHVV 
    vTcl:DefineAlias "$site_5_0.che82" "Checkbutton51" vTcl:WidgetProc "Toplevel519b" 1
    checkbutton $site_5_0.che83 \
        -text 22_21 -variable ParaZDRVVVH 
    vTcl:DefineAlias "$site_5_0.che83" "Checkbutton52" vTcl:WidgetProc "Toplevel519b" 1
    pack $site_5_0.che78 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 10 -side left 
    pack $site_5_0.che79 \
        -in $site_5_0 -anchor center -expand 1 -fill none -side left 
    ...
    frame $top.cpd88 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd88" "Frame51" vTcl:WidgetProc "Toplevel519b" 1
    set site_3_0 $top.cpd88
    checkbutton $site_3_0.cpd66 \
        -padx 1 -text BMP -variable ParaBMP 
    vTcl:DefineAlias "$site_3_0.cpd66" "Checkbutton468" vTcl:WidgetProc "Toplevel519b" 1
    frame $site_3_0.fra24 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.fra24" "Frame52" vTcl:WidgetProc "Toplevel519b" 1
    set site_4_0 $site_3_0.fra24
    label $site_4_0.lab57 \
        -text {Window Size Row} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label36" vTcl:WidgetProc "Toplevel519b" 1
    entry $site_4_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable ParaNwinL -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry24" vTcl:WidgetProc "Toplevel519b" 1
    pack $site_4_0.lab57 \
    ...
    frame $site_3_0.cpd69 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.cpd69" "Frame53" vTcl:WidgetProc "Toplevel519b" 1
    set site_4_0 $site_3_0.cpd69
    label $site_4_0.lab57 \
        -text {Window Size Col} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label37" vTcl:WidgetProc "Toplevel519b" 1
    entry $site_4_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable ParaNwinC -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry25" vTcl:WidgetProc "Toplevel519b" 1
    pack $site_4_0.lab57 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent58 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
...
if {$ParametersFonction == "SPP"} {
    ...
    vTcl:DefineAlias "$site_3_0.cpd67" "Button18" vTcl:WidgetProc "Toplevel519b" 1
...
set ParaBMP 0} \
    ...
    vTcl:DefineAlias "$site_3_0.cpd91" "Button17" vTcl:WidgetProc "Toplevel519b" 1
