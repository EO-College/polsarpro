...
if [file exists $FileTrainingArea] {
    ...
    $widget(Button516_3) configure -state normal
    }
...
if {"$VarWarning"=="ok"} {
    ...
    for {set ii 1} {$ii <= $NDataDirMult} {incr ii} {
        ...
        TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -iodf $SupervisedF -af \x22$FileTrainingArea\x22 -cf \x22$FileTrainingSet\x22 -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
        set f [ open "| Soft/bin/data_process_sngl/wishart_training_set_sampler.exe -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -iodf $SupervisedF -af \x22$FileTrainingArea\x22 -cf \x22$FileTrainingSet\x22 -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
        PsPprogressBar $f
...
if {"$VarWarning"=="ok"} {
    ...
    for {set ii 1} {$ii <= $NDataDirMult} {incr ii} {
        ...
        if [file exists $FileTrainingSet] {
            ...
            set f [ open "| Soft/bin/data_process_sngl/wishart_supervised_classifier.exe -id \x22$SuperDirInput\x22 -od \x22$SuperDirOutput\x22 -iodf $SupervisedF -af \x22$FileTrainingArea\x22 -nwr $NwinSupervisedL -nwc $NwinSupervisedC -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol -rej $RejectRatio -std $RejectClass -bmp $BMPSupervised -col \x22$ColorMapSupervised16\x22 -cf \x22$FileTrainingSet\x22  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
            PsPprogressBar $f
            TextEditorRunTrace "Check RunTime Errors" "r"
            CheckRunTimeError
            WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
            ...
            if {$ColorMapSupervisedCoded == "1"} {
                ...
                if [file exists $ClassificationInputFile] {
                    if {$ColorMapSupervisedCodedPauli == "1"} {
                        ...
                        TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedF -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                        set f [ open "| Soft/bin/bmp_process/classification_colormap_pauli.exe -id \x22$SuperDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedF -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                        PsPprogressBar $f
                        TextEditorRunTrace "Check RunTime Errors" "r"
                        CheckRunTimeError
                        WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
                    ...
                    if {$ColorMapSupervisedCodedSinclair == "1"} {
                        ...
                        TextEditorRunTrace "Arguments: -id \x22$SuperDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedF -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" "k"
                        set f [ open "| Soft/bin/bmp_process/classification_colormap_sinclair.exe -id \x22$SuperDirInput\x22 -if \x22$ClassificationInputFile\x22 -of \x22$ClassificationOutputFile\x22 -iodf $SupervisedF -ofr $OffsetLig -ofc $OffsetCol -fnr $FinalNlig -fnc $FinalNcol  -errf \x22$TMPMemoryAllocError\x22 $MaskCmd" r]
                        PsPprogressBar $f
                        TextEditorRunTrace "Check RunTime Errors" "r"
                        CheckRunTimeError
                        WidgetHideTop28; TextEditorRunTrace "Close Window Message" "b"
