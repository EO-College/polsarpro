...
proc vTclWindow.top513 {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Data Animation"
    vTcl:DefineAlias "$top" "Toplevel513" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.tit71" "TitleFrame1" vTcl:WidgetProc "Toplevel513" 1
    ...
    entry $site_4_0.cpd72 \
        ...
        -textvariable MultAnimDirInput 
    vTcl:DefineAlias "$site_4_0.cpd72" "Entry513_149" vTcl:WidgetProc "Toplevel513" 1
    frame $site_4_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame1" vTcl:WidgetProc "Toplevel513" 1
    set site_5_0 $site_4_0.cpd74
    button $site_5_0.but75 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_5_0.but75" "Button1" vTcl:WidgetProc "Toplevel513" 1
    pack $site_5_0.but75 \
    ...
    vTcl:DefineAlias "$top.fra74" "Frame9" vTcl:WidgetProc "Toplevel513" 1
    set site_3_0 $top.fra74
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label513_01" vTcl:WidgetProc "Toplevel513" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry513_01" vTcl:WidgetProc "Toplevel513" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label513_02" vTcl:WidgetProc "Toplevel513" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry513_02" vTcl:WidgetProc "Toplevel513" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label513_03" vTcl:WidgetProc "Toplevel513" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry513_03" vTcl:WidgetProc "Toplevel513" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label513_04" vTcl:WidgetProc "Toplevel513" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry513_04" vTcl:WidgetProc "Toplevel513" 1
    pack $site_3_0.lab57 \
    ...
    vTcl:DefineAlias "$top.cpd81" "TitleFrame6" vTcl:WidgetProc "Toplevel513" 1
    ...
    frame $site_4_0.cpd76 \
        -height 75 -width 159 
    vTcl:DefineAlias "$site_4_0.cpd76" "Frame112" vTcl:WidgetProc "Toplevel513" 1
    set site_5_0 $site_4_0.cpd76
    frame $site_5_0.fra88 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra88" "Frame18" vTcl:WidgetProc "Toplevel513" 1
    set site_6_0 $site_5_0.fra88
    entry $site_6_0.cpd89 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable MultAnimBMPFile -width 40 
    vTcl:DefineAlias "$site_6_0.cpd89" "Entry234" vTcl:WidgetProc "Toplevel513" 1
    pack $site_6_0.cpd89 \
        -in $site_6_0 -anchor center -expand 1 -fill x -side top 
    frame $site_5_0.fra90 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra90" "Frame19" vTcl:WidgetProc "Toplevel513" 1
    set site_6_0 $site_5_0.fra90
    button $site_6_0.cpd72 \
        \
        -command {global FileName MultAnimDirInput MultAnimBMPFile MultAnimGIFFile
global NDataDirMult DataDirMult MultAnimFonction
...
set MultAnimGIFFile ""
set FileName ""
OpenFile "$MultAnimDirInput" $types "BMP FILE"
if {$FileName != ""} {
    set config "true"
    for {set ii 1} {$ii <= $NDataDirMult} {incr ii} {
        set MultAnimBMPFileTmp "$DataDirMult($ii)/"
        if {$MultAnimFonction == "T3"} {append MultAnimBMPFileTmp "T3/" }
        if {$MultAnimFonction == "C2"} {append MultAnimBMPFileTmp "C2/" }
        append MultAnimBMPFileTmp [file tail $FileName]
        if [file exists $MultAnimBMPFileTmp] {
            } else {
            set config "false"
            set VarError ""
            set ErrorMessage "THE BMP FILE $MultAnimBMPFileTmp DOES NOT EXIST" 
    ...
    if {$config == "true"} {
        if [file exists $ImageMagickMaker] {
            set MultAnimBMPFile [file tail $FileName]
            $widget(Button513_0) configure -state normal

            set MultAnimGIFFile [file rootname $FileName]
            append MultAnimGIFFile "_anim.gif"
            } else {
            #error message
            set VarError ""
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd72" "Button4" vTcl:WidgetProc "Toplevel513" 1
    ...
    vTcl:DefineAlias "$top.cpd66" "TitleFrame2" vTcl:WidgetProc "Toplevel513" 1
    ...
    entry $site_4_0.cpd72 \
        ...
        -textvariable MultAnimGIFFile 
    vTcl:DefineAlias "$site_4_0.cpd72" "Entry513" vTcl:WidgetProc "Toplevel513" 1
    frame $site_4_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame2" vTcl:WidgetProc "Toplevel513" 1
    set site_5_0 $site_4_0.cpd74
    button $site_5_0.but75 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_5_0.but75" "Button2" vTcl:WidgetProc "Toplevel513" 1
    pack $site_5_0.but75 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    pack $site_4_0.cpd72 \
        -in $site_4_0 -anchor center -expand 1 -fill x -side left 
    ...
    frame $top.fra66 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra66" "Frame3" vTcl:WidgetProc "Toplevel513" 1
    set site_3_0 $top.fra66
    label $site_3_0.lab67 \
        -image [vTcl:image:get_image [file join . GUI Images Warning.gif]] \
        -text label 
    vTcl:DefineAlias "$site_3_0.lab67" "Label1" vTcl:WidgetProc "Toplevel513" 1
    label $site_3_0.lab68 \
        \
        -text {Creating an animation from huge and / or 24 bits BMP images can take time} 
    vTcl:DefineAlias "$site_3_0.lab68" "Label2" vTcl:WidgetProc "Toplevel513" 1
    label $site_3_0.cpd69 \
        -image [vTcl:image:get_image [file join . GUI Images Warning.gif]] \
        -text label 
    vTcl:DefineAlias "$site_3_0.cpd69" "Label3" vTcl:WidgetProc "Toplevel513" 1
    pack $site_3_0.lab67 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    pack $site_3_0.lab68 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    ...
    vTcl:DefineAlias "$top.fra83" "Frame20" vTcl:WidgetProc "Toplevel513" 1
    set site_3_0 $top.fra83
    button $site_3_0.but93 \
        -background #ffff00 \
        -command {global ImageMagickMaker MultAnimDirInput MultAnimBMPFile MultAnimGIFFile MultAnimFonction
...
if {$OpenDirFile == 0} {
    ...
    #####################################################################
    #Create Directory
    set MultAnimDirInput [PSPCreateDirectoryMask $MultAnimDirInput $MultAnimDirInput $MultAnimDirInput]
    #####################################################################       
...
if {"$VarWarning"=="ok"} {
    ...
    if {$TestVarError == "ok"} {
        ...
        for {set ii 1} {$ii <= $NDataDirMult} {incr ii} {
            ...
            if {$MultAnimFonction == "T3"} {append MultAnimBMPFileTmp "T3/" }
            if {$MultAnimFonction == "C2"} {append MultAnimBMPFileTmp "C2/" }
            append MultAnimBMPFileTmp $MultAnimBMPFile
            append ImageMagickCommand " \x22$MultAnimBMPFileTmp\x22"
            }
        append ImageMagickCommand " -loop 0 \x22$MultAnimGIFFile\x22"
    ...
    if {$config == "nono"} {Window hide $widget(Toplevel513); TextEditorRunTrace "Close Window Mult Data Animation" "b"}
    }
}} \
        -cursor {} -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but93" "Button513_0" vTcl:WidgetProc "Toplevel513" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/DataAnimationMult.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -text ? -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel513" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel513); TextEditorRunTrace "Close Window Mult Data Animation" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel513" 1
