...
proc vTclWindow.top526 {base} {
    ...
    wm withdraw $top
    wm focusmodel $top passive
    wm geometry $top 500x160+10+110; update
    wm maxsize $top 1604 1184
    wm minsize $top 120 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "Polarimetric Tomography ( Pol-TomSAR ) - Generator DEM"
    vTcl:DefineAlias "$top" "Toplevel526" vTcl:Toplevel:WidgetProc "" 1
    ...
    vTcl:DefineAlias "$top.fra66" "Frame1" vTcl:WidgetProc "Toplevel526" 1
    set site_3_0 $top.fra66
    label $site_3_0.lab67 \
		-text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab67" "Label1" vTcl:WidgetProc "Toplevel526" 1
    entry $site_3_0.ent71 \
		-background white -disabledbackground {#ffffff} \
		-disabledforeground {#0000ff} -foreground {#0000ff} -justify center \
		-state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent71" "Entry1" vTcl:WidgetProc "Toplevel526" 1
    label $site_3_0.cpd68 \
		-text {End Row} 
    vTcl:DefineAlias "$site_3_0.cpd68" "Label2" vTcl:WidgetProc "Toplevel526" 1
    entry $site_3_0.cpd72 \
		-background white -disabledbackground {#ffffff} \
		-disabledforeground {#0000ff} -foreground {#0000ff} -justify center \
		-state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.cpd72" "Entry2" vTcl:WidgetProc "Toplevel526" 1
    label $site_3_0.cpd69 \
		-text {Init Col} 
    vTcl:DefineAlias "$site_3_0.cpd69" "Label3" vTcl:WidgetProc "Toplevel526" 1
    entry $site_3_0.cpd73 \
		-background white -disabledbackground {#ffffff} \
		-disabledforeground {#0000ff} -foreground {#0000ff} -justify center \
		-state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.cpd73" "Entry3" vTcl:WidgetProc "Toplevel526" 1
    label $site_3_0.cpd70 \
		-text {End Col} 
    vTcl:DefineAlias "$site_3_0.cpd70" "Label4" vTcl:WidgetProc "Toplevel526" 1
    entry $site_3_0.cpd74 \
		-background white -disabledbackground {#ffffff} \
		-disabledforeground {#0000ff} -foreground {#0000ff} -justify center \
		-state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.cpd74" "Entry4" vTcl:WidgetProc "Toplevel526" 1
    pack $site_3_0.lab67 \
    ...
    vTcl:DefineAlias "$top.cpd67" "TitleFrame526_1" vTcl:WidgetProc "Toplevel526" 1
...
if {$PTOMgeneDEM == 1} {
    ...
    $widget(TitleFrame526_1) configure -state normal; $widget(TitleFrame526_2) configure -state normal; $widget(TitleFrame526_3) configure -state normal
    $widget(Radiobutton526_1) configure -state normal; $widget(Radiobutton526_2) configure -state normal
    $widget(Label526_1) configure -state normal; $widget(Label526_2) configure -state normal
    $widget(Entry526_1) configure -state normal; $widget(Entry526_2) configure -state normal
    } else {
    ...
    vTcl:DefineAlias "$site_4_0.cpd67" "Checkbutton526_1" vTcl:WidgetProc "Toplevel526" 1
    frame $site_4_0.cpd75 \
		-relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd75" "Frame70" vTcl:WidgetProc "Toplevel526" 1
    set site_5_0 $site_4_0.cpd75
    frame $site_5_0.cpd68 \
		-relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd68" "Frame77" vTcl:WidgetProc "Toplevel526" 1
    set site_6_0 $site_5_0.cpd68
    entry $site_6_0.cpd71 \
		-background white -disabledbackground {#ffffff} \
		-disabledforeground {#0000ff} -foreground {#0000ff} -state disabled \
		-textvariable PTOMDEMFile 
    vTcl:DefineAlias "$site_6_0.cpd71" "Entry526_01" vTcl:WidgetProc "Toplevel526" 1
    pack $site_6_0.cpd71 \
		-in $site_6_0 -anchor center -expand 1 -fill x -side left 
    frame $site_5_0.cpd69 \
		-relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd69" "Frame78" vTcl:WidgetProc "Toplevel526" 1
    set site_6_0 $site_5_0.cpd69
    TitleFrame $site_6_0.cpd72 \
		-ipad 2 -text {Slant-Range axis} 
    vTcl:DefineAlias "$site_6_0.cpd72" "TitleFrame526_2" vTcl:WidgetProc "Toplevel526" 1
    ...
    frame $site_8_0.cpd71 \
		-height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd71" "Frame23" vTcl:WidgetProc "Toplevel526" 1
    set site_9_0 $site_8_0.cpd71
...
if {$PTOMSlice == "col"} { 
    ...
    vTcl:DefineAlias "$site_9_0.cpd75" "Radiobutton526_1" vTcl:WidgetProc "Toplevel526" 1
...
if {$PTOMSlice == "lig"} { 
    ...
    vTcl:DefineAlias "$site_9_0.cpd74" "Radiobutton526_2" vTcl:WidgetProc "Toplevel526" 1
    pack $site_9_0.cpd75 \
    ...
    vTcl:DefineAlias "$site_6_0.cpd73" "TitleFrame526_3" vTcl:WidgetProc "Toplevel526" 1
    ...
    frame $site_8_0.cpd73 \
		-relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd73" "Frame76" vTcl:WidgetProc "Toplevel526" 1
    set site_9_0 $site_8_0.cpd73
    label $site_9_0.lab76 \
		-text {Near Range} 
    vTcl:DefineAlias "$site_9_0.lab76" "Label526_1" vTcl:WidgetProc "Toplevel526" 1
    entry $site_9_0.ent78 \
		-background white -disabledbackground {#ffffff} \
		-disabledforeground {#ff0000} -foreground {#ff0000} -justify center \
		-textvariable PTOMNRvalDEM -width 7 
    vTcl:DefineAlias "$site_9_0.ent78" "Entry526_1" vTcl:WidgetProc "Toplevel526" 1
    pack $site_9_0.lab76 \
		-in $site_9_0 -anchor center -expand 1 -fill none -side left 
    pack $site_9_0.ent78 \
    ...
    frame $site_8_0.cpd74 \
		-relief groove -height 75 -width 125 
    vTcl:DefineAlias "$site_8_0.cpd74" "Frame79" vTcl:WidgetProc "Toplevel526" 1
    set site_9_0 $site_8_0.cpd74
    label $site_9_0.lab76 \
		-text {Far Range} 
    vTcl:DefineAlias "$site_9_0.lab76" "Label526_2" vTcl:WidgetProc "Toplevel526" 1
    entry $site_9_0.ent78 \
		-background white -disabledbackground {#ffffff} \
		-disabledforeground {#ff0000} -foreground {#ff0000} -justify center \
		-textvariable PTOMFRvalDEM -width 7 
    vTcl:DefineAlias "$site_9_0.ent78" "Entry526_2" vTcl:WidgetProc "Toplevel526" 1
    pack $site_9_0.lab76 \
		-in $site_9_0 -anchor center -expand 1 -fill none -side left 
    pack $site_9_0.ent78 \
		-in $site_9_0 -anchor center -expand 1 -fill none -side right 
    ...
    vTcl:DefineAlias "$top.fra92" "Frame20" vTcl:WidgetProc "Toplevel526" 1
...
Window hide $widget(Toplevel526); TextEditorRunTrace "Close Window Polarimetric Tomography - Generator DEM" "b"    
}} \
		-padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.cpd67" "Button523_3" vTcl:WidgetProc "Toplevel526" 1
    pack $site_3_0.cpd67 \
		-in $site_3_0 -anchor center -expand 1 -fill none -side left 
    menu $top.m71 \
