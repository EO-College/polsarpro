...
proc vTcl:project:info {} {
    ...
    namespace eval ::widgets::$site_3_0.but508 {
        array set save {-_tooltip 1 -background 1 -command 1 -padx 1 -pady 1 -text 1}
    }
...
proc vTclWindow.top508 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel508" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd84 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd84" "Frame4" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.cpd84
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame8" vTcl:WidgetProc "Toplevel508" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel508" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel508" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd84 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -padx 1 -pady 0 -relief flat -text {    } 
    vTcl:DefineAlias "$site_6_0.cpd84" "Button40" vTcl:WidgetProc "Toplevel508" 1
    pack $site_6_0.cpd84 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame9" vTcl:WidgetProc "Toplevel508" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel508" 1
    frame $site_5_0.cpd84 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd84" "Frame1" vTcl:WidgetProc "Toplevel508" 1
    set site_6_0 $site_5_0.cpd84
    label $site_6_0.lab82 \
        -text / 
    vTcl:DefineAlias "$site_6_0.lab82" "Label1" vTcl:WidgetProc "Toplevel508" 1
    entry $site_6_0.cpd86 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable HAAlpOutputSubDir -width 3 
    vTcl:DefineAlias "$site_6_0.cpd86" "Entry1" vTcl:WidgetProc "Toplevel508" 1
    pack $site_6_0.lab82 \
    ...
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame16" vTcl:WidgetProc "Toplevel508" 1
    set site_6_0 $site_5_0.cpd91
    ...
    vTcl:DefineAlias "$top.fra36" "Frame9" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.fra36
    label $site_3_0.lab57 \
        -text {Init Row} 
    vTcl:DefineAlias "$site_3_0.lab57" "Label10" vTcl:WidgetProc "Toplevel508" 1
    entry $site_3_0.ent58 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent58" "Entry6" vTcl:WidgetProc "Toplevel508" 1
    label $site_3_0.lab59 \
        -text {End Row} 
    vTcl:DefineAlias "$site_3_0.lab59" "Label11" vTcl:WidgetProc "Toplevel508" 1
    entry $site_3_0.ent60 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent60" "Entry7" vTcl:WidgetProc "Toplevel508" 1
    label $site_3_0.lab61 \
        -text {Init Col} 
    vTcl:DefineAlias "$site_3_0.lab61" "Label12" vTcl:WidgetProc "Toplevel508" 1
    entry $site_3_0.ent62 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolInit -width 5 
    vTcl:DefineAlias "$site_3_0.ent62" "Entry8" vTcl:WidgetProc "Toplevel508" 1
    label $site_3_0.lab63 \
        -text {End Col} 
    vTcl:DefineAlias "$site_3_0.lab63" "Label13" vTcl:WidgetProc "Toplevel508" 1
    entry $site_3_0.ent64 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolEnd -width 5 
    vTcl:DefineAlias "$site_3_0.ent64" "Entry9" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.lab57 \
    ...
    frame $top.fra37 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra37" "Frame33" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.fra37
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$eigenvalues"=="1"} { $widget(Checkbutton508_1) configure -state normal
} else {
$widget(Checkbutton508_1) configure -state disable
set BMPeigenvalues "0"
}} \
        -padx 1 -text {EigenValues (L1, L2) } -variable eigenvalues 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton190" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPeigenvalues 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton508_1" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.che38 \
    ...
    frame $top.fra40 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra40" "Frame34" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.fra40
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$probabilities"=="1"} { $widget(Checkbutton508_2) configure -state normal 
} else {
...
set BMPprobabilities "0"
    ...
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton192" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPprobabilities 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton508_2" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra41 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra41" "Frame35" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.fra41
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$alpha12"=="1"} { $widget(Checkbutton508_3) configure -state normal 
} else {
$widget(Checkbutton508_3) configure -state disable
set BMPalpha12 "0"
}} \
        -padx 1 -text {Alpha1, Alpha2} -variable alpha12 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton194" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPalpha12 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton508_3" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra43 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra43" "Frame37" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.fra43
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$delta12"=="1"} { $widget(Checkbutton508_4) configure -state normal
} else {
$widget(Checkbutton508_4) configure -state disable
set BMPdelta12 "0"
}} \
        -padx 1 -text {Delta1, Delta2} -variable delta12 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton196" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPdelta12 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton508_4" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra45 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra45" "Frame39" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.fra45
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$alpdel"=="1"} { $widget(Checkbutton508_5) configure -state normal
} else {
$widget(Checkbutton508_5) configure -state disable
set BMPalpdel "0"
}} \
        -padx 1 -text {Alpha, Delta, Lambda} -variable alpdel 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton198" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPalpdel 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton508_5" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.cpd73 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd73" "Frame43" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.cpd73
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$lambda"=="1"} { $widget(Checkbutton508_14) configure -state normal
} else {
$widget(Checkbutton508_14) configure -state disable
set BMPlambda "0"
}} \
        -padx 1 -text Lambda -variable lambda 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton201" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPlambda 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton508_14" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra46 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra46" "Frame40" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.fra46
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$alpha"=="1"} { $widget(Checkbutton508_6) configure -state normal
} else {
$widget(Checkbutton508_6) configure -state disable
set BMPalpha "0"
}} \
        -padx 1 -text Alpha -variable alpha 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton200" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPalpha 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton508_6" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.cpd66 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd66" "Frame45" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.cpd66
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$delta"=="1"} { $widget(Checkbutton508_16) configure -state normal
} else {
$widget(Checkbutton508_16) configure -state disable
set BMPdelta "0"
}} \
        -padx 1 -text Delta -variable delta 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton205" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPdelta 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton508_16" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra47 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra47" "Frame41" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.fra47
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$entropy"=="1"} { $widget(Checkbutton508_7) configure -state normal
} else {
$widget(Checkbutton508_7) configure -state disable
set BMPentropy "0"
}} \
        -padx 1 -text {Entropy  (H)} -variable entropy 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton202" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPentropy 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton508_7" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra48 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra48" "Frame42" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.fra48
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$anisotropy"=="1"} { $widget(Checkbutton508_8) configure -state normal
} else {
...
set BMPanisotropy "0"
        ...
        -variable anisotropy 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton204" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPanisotropy 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton508_8" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    frame $top.fra26 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.fra26" "Frame660" vTcl:WidgetProc "Toplevel508" 1
...
if {$combinationsHA == "1"} {
    $widget(Checkbutton508_9) configure -state normal
    $widget(Checkbutton508_10) configure -state normal
    $widget(Checkbutton508_11) configure -state normal
    $widget(Checkbutton508_12) configure -state normal
    $widget(Checkbutton508_13) configure -state normal
    }
if {$combinationsHA == "0"} {
    set CombHA "0"
    set CombH1mA "0"
    ...
    vTcl:DefineAlias "$site_3_0.che110" "Checkbutton646" vTcl:WidgetProc "Toplevel508" 1
    frame $site_3_0.fra111 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra111" "Frame661" vTcl:WidgetProc "Toplevel508" 1
    set site_4_0 $site_3_0.fra111
    checkbutton $site_4_0.che112 \
        -padx 1 -text {H A} -variable CombHA 
    vTcl:DefineAlias "$site_4_0.che112" "Checkbutton508_9" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_4_0.che113 \
        -text {H (1 - A)} -variable CombH1mA 
    vTcl:DefineAlias "$site_4_0.che113" "Checkbutton508_10" vTcl:WidgetProc "Toplevel508" 1
    ...
    frame $site_3_0.fra117 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra117" "Frame662" vTcl:WidgetProc "Toplevel508" 1
    set site_4_0 $site_3_0.fra117
    checkbutton $site_4_0.che114 \
        -text {(1 - H) A} -variable Comb1mHA 
    vTcl:DefineAlias "$site_4_0.che114" "Checkbutton508_11" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_4_0.che115 \
        -text {(1 - H) (1 - A)} -variable Comb1mH1mA 
    vTcl:DefineAlias "$site_4_0.che115" "Checkbutton508_12" vTcl:WidgetProc "Toplevel508" 1
    ...
    vTcl:DefineAlias "$site_3_0.che116" "Checkbutton508_13" vTcl:WidgetProc "Toplevel508" 1
    ...
    frame $top.cpd74 \
        -borderwidth 2 -relief groove -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd74" "Frame44" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.cpd74
    checkbutton $site_3_0.che38 \
        \
        -command {if {"$shannon"=="1"} { $widget(Checkbutton508_15) configure -state normal
} else {
$widget(Checkbutton508_15) configure -state disable
set BMPshannon "0"
}} \
        -padx 1 -text {Shannon Entropy  (H = Hi + Hp)} -variable shannon 
    vTcl:DefineAlias "$site_3_0.che38" "Checkbutton203" vTcl:WidgetProc "Toplevel508" 1
    checkbutton $site_3_0.che39 \
        -padx 1 -text BMP -variable BMPshannon 
    vTcl:DefineAlias "$site_3_0.che39" "Checkbutton508_15" vTcl:WidgetProc "Toplevel508" 1
    pack $site_3_0.che38 \
        -in $site_3_0 -anchor center -expand 0 -fill none -padx 20 -side left 
    pack $site_3_0.che39 \
        -in $site_3_0 -anchor center -expand 0 -fill none -side right 
    ...
    vTcl:DefineAlias "$top.fra55" "Frame47" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.fra55
    frame $site_3_0.fra24 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.fra24" "Frame48" vTcl:WidgetProc "Toplevel508" 1
    set site_4_0 $site_3_0.fra24
    label $site_4_0.lab57 \
        -text {Window Size Row} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label34" vTcl:WidgetProc "Toplevel508" 1
    entry $site_4_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinHAAlpL -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry22" vTcl:WidgetProc "Toplevel508" 1
    pack $site_4_0.lab57 \
    ...
    frame $site_3_0.cpd70 \
        -borderwidth 2 -height 75 -width 216 
    vTcl:DefineAlias "$site_3_0.cpd70" "Frame49" vTcl:WidgetProc "Toplevel508" 1
    set site_4_0 $site_3_0.cpd70
    label $site_4_0.lab57 \
        -text {Window Size Col} -width 15 
    vTcl:DefineAlias "$site_4_0.lab57" "Label35" vTcl:WidgetProc "Toplevel508" 1
    entry $site_4_0.ent58 \
        -background white -foreground #ff0000 -justify center \
        -textvariable NwinHAAlpC -width 5 
    vTcl:DefineAlias "$site_4_0.ent58" "Entry23" vTcl:WidgetProc "Toplevel508" 1
    pack $site_4_0.lab57 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.ent58 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
...
set BMPshannon "1"
$widget(Checkbutton508_1) configure -state normal
$widget(Checkbutton508_2) configure -state normal
$widget(Checkbutton508_3) configure -state normal
$widget(Checkbutton508_4) configure -state normal
$widget(Checkbutton508_5) configure -state normal
$widget(Checkbutton508_6) configure -state normal
$widget(Checkbutton508_7) configure -state normal
$widget(Checkbutton508_8) configure -state normal
$widget(Checkbutton508_9) configure -state normal
$widget(Checkbutton508_10) configure -state normal
$widget(Checkbutton508_11) configure -state normal
$widget(Checkbutton508_12) configure -state normal
$widget(Checkbutton508_13) configure -state normal
$widget(Checkbutton508_14) configure -state normal
$widget(Checkbutton508_15) configure -state normal
$widget(Checkbutton508_16) configure -state normal} \
        -padx 4 -pady 2 -text {Select All} 
    vTcl:DefineAlias "$site_3_0.but25" "Button103" vTcl:WidgetProc "Toplevel508" 1
...
$widget(Checkbutton508_16) configure -state disable} \
    ...
    vTcl:DefineAlias "$site_3_0.cpd84" "Button104" vTcl:WidgetProc "Toplevel508" 1
    bindtags $site_3_0.cpd84 "$site_3_0.cpd84 Button $top all _vTclBalloon"
    bind $site_3_0.cpd84 <<SetBalloon>> {
    ...
    vTcl:DefineAlias "$top.fra59" "Frame20" vTcl:WidgetProc "Toplevel508" 1
    set site_3_0 $top.fra59
    button $site_3_0.but508 \
        -background #ffff00 \
...
if {"$config"=="true"} {
    ...
    if {"$VarWarning"=="ok"} {
        ...
        for {set ii 1} {$ii <= $NDataDirMult} {incr ii} {
            ...
            set HAAlpDirOutput $DataDirMult($ii)
            if {$HAAlpOutputSubDir != ""} {append HAAlpDirOutput "/$HAAlpOutputSubDir"}
        ...
        if {"$VarWarning"=="no"} {Window hide $widget(Toplevel508); TextEditorRunTrace "Close Window H A Alpha Decomposition 2 Mult" "b"}
        }
    }
}} \
        -padx 4 -pady 2 -text Run 
    vTcl:DefineAlias "$site_3_0.but508" "Button13" vTcl:WidgetProc "Toplevel508" 1
    bindtags $site_3_0.but508 "$site_3_0.but508 Button $top all _vTclBalloon"
    bind $site_3_0.but508 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Run the Function}
    }
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/HAAlphaDecompositionMult2.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel508" 1
...
if {$OpenDirFile == 0} {
Window hide $widget(Toplevel508); TextEditorRunTrace "Close Window H A Alpha Decomposition 2 Mult" "b"
}} \
        -padx 4 -pady 2 -text Exit 
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel508" 1
    bindtags $site_3_0.but24 "$site_3_0.but24 Button $top all _vTclBalloon"
    bind $site_3_0.but24 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Exit the Function}
    }
    pack $site_3_0.but508 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    pack $site_3_0.but23 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    pack $site_3_0.but24 \
