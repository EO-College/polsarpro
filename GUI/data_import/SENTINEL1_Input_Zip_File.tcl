...
proc vTclWindow.top453a {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "SENTINEL1 Input Zip Data File"
    vTcl:DefineAlias "$top" "Toplevel453a" vTcl:Toplevel:WidgetProc "" 1
    ...
    label $top.lab66 \
        ...
        -text label 
    vTcl:DefineAlias "$top.lab66" "Label281" vTcl:WidgetProc "Toplevel453a" 1
    frame $top.cpd79 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd79" "Frame1" vTcl:WidgetProc "Toplevel453a" 1
    set site_3_0 $top.cpd79
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame4" vTcl:WidgetProc "Toplevel453a" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh2" vTcl:WidgetProc "Toplevel453a" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame11" vTcl:WidgetProc "Toplevel453a" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd114 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_6_0.cpd114" "Button39" vTcl:WidgetProc "Toplevel453a" 1
    ...
    frame $top.cpd77 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd77" "Frame3" vTcl:WidgetProc "Toplevel453a" 1
    set site_3_0 $top.cpd77
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Input Zip Data File} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame453a_1" vTcl:WidgetProc "Toplevel453a" 1
    ...
    entry $site_5_0.cpd85 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable SENTINEL1ZipFileInput 
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry453a_1" vTcl:WidgetProc "Toplevel453a" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame25" vTcl:WidgetProc "Toplevel453a" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd119 \
        \
        -command {global FileName SENTINEL1ZipFileInput
global SENTINEL1DirInput SENTINEL1DirOutput SENTINEL1FileInputFlag 
global SENTINEL1ZipFileInputFlag SENTINEL1ZipFileInput TMPDir PlatForm
...
set NcolInit ""
set NcolEnd ""
set SENTINEL1ZipFileInput "SELECT A ZIP DATA FILE"
set SENTINEL1DirOutput ""
set SENTINEL1DirInput $DataDir; set SENTINEL1FileInputFlag 0
...
$widget(Button453a_04) configure -state disable
set SENTINEL1FUD 0
set SENTINEL1Acq ""
$widget(Entry453a_02) configure -disabledbackground $PSPBackgroundColor; $widget(Label453a_02) configure -state disable
$widget(Entry453a_03) configure -disabledbackground $PSPBackgroundColor; $widget(Label453a_03) configure -state disable
$widget(Entry453a_04) configure -disabledbackground $PSPBackgroundColor; $widget(Label453a_04) configure -state disable
$widget(Entry453a_07) configure -disabledbackground $PSPBackgroundColor; $widget(Label453a_07) configure -state disable
$widget(Entry453a_08) configure -disabledbackground $PSPBackgroundColor; $widget(Label453a_08) configure -state disable
$widget(Button453a_6) configure -state disable

DeleteFile $TMPSentinel1Config
set SentinelPreview "$TMPDir/product-preview.html"
DeleteFile $SentinelPreview

set types {
    {{ZIP Files}        {.zip}        }
    }
set FileName ""
OpenFile $SENTINEL1DirInput $types "INPUT ZIP DATA FILE"
if {$FileName == ""} {
    set SENTINEL1ZipFileInput "SELECT A ZIP DATA FILE"
    } else {
    set SENTINEL1ZipFileInput $FileName
    set SENTINEL1DirOutput [file rootname $SENTINEL1ZipFileInput]
    if {$PlatForm == "windows"} {
    ...
    set f [ open "| $UnzipFunction e \x22$SENTINEL1ZipFileInput\x22 -o$TMPDir *.html -r -y" r]
    PsPprogressBar $f
    TextEditorRunTrace "Check RunTime Errors" "r"
    CheckRunTimeError
    WaitUntilCreated $SentinelPreview

    TextEditorRunTrace "Process The Function Soft/bin/data_import/sentinel1_product_preview.exe" "k"
    TextEditorRunTrace "Arguments: -if \x22$SentinelPreview\x22 -of \x22$TMPSentinel1Config\x22" "k"
    set f [ open "| Soft/bin/data_import/sentinel1_product_preview.exe -if \x22$SentinelPreview\x22 -of \x22$TMPSentinel1Config\x22" r]
    PsPprogressBar $f
    TextEditorRunTrace "Check RunTime Errors" "r"
    CheckRunTimeError
    ...
    DeleteFile $SentinelPreview
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd119" "Button453a_1" vTcl:WidgetProc "Toplevel453a" 1
    ...
    vTcl:DefineAlias "$top.cpd71" "TitleFrame453a" vTcl:WidgetProc "Toplevel453a" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd85" "Entry453a" vTcl:WidgetProc "Toplevel453a" 1
    frame $site_4_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd91" "Frame29" vTcl:WidgetProc "Toplevel453a" 1
    set site_5_0 $site_4_0.cpd91
...
if {$DirName != "" } {
    ...
    set SENTINEL1DirOutput $SENTINEL1OutputDirTmp
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd119" "Button453a" vTcl:WidgetProc "Toplevel453a" 1
    ...
    vTcl:DefineAlias "$top.fra66" "Frame2" vTcl:WidgetProc "Toplevel453a" 1
    set site_3_0 $top.fra66
    frame $site_3_0.fra67 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra67" "Frame7" vTcl:WidgetProc "Toplevel453a" 1
    set site_4_0 $site_3_0.fra67
    frame $site_4_0.cpd68 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd68" "Frame8" vTcl:WidgetProc "Toplevel453a" 1
    set site_5_0 $site_4_0.cpd68
    label $site_5_0.lab82 \
        -text Mission 
    vTcl:DefineAlias "$site_5_0.lab82" "Label453a" vTcl:WidgetProc "Toplevel453a" 1
    entry $site_5_0.ent83 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SENTINEL1Mission -width 5 
    vTcl:DefineAlias "$site_5_0.ent83" "Entry454" vTcl:WidgetProc "Toplevel453a" 1
    pack $site_5_0.lab82 \
    ...
    frame $site_4_0.cpd69 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd69" "Frame9" vTcl:WidgetProc "Toplevel453a" 1
    set site_5_0 $site_4_0.cpd69
    label $site_5_0.lab82 \
        -text Acquisition 
    vTcl:DefineAlias "$site_5_0.lab82" "Label454" vTcl:WidgetProc "Toplevel453a" 1
    entry $site_5_0.ent83 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SENTINEL1Mode -width 5 
    vTcl:DefineAlias "$site_5_0.ent83" "Entry455" vTcl:WidgetProc "Toplevel453a" 1
    pack $site_5_0.lab82 \
        -in $site_5_0 -anchor center -expand 1 -fill none -padx 2 -side left 
    pack $site_5_0.ent83 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 2 -pady 2 \
    ...
    frame $site_4_0.cpd73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd73" "Frame13" vTcl:WidgetProc "Toplevel453a" 1
    set site_5_0 $site_4_0.cpd73
    label $site_5_0.lab82 \
        -text Product 
    vTcl:DefineAlias "$site_5_0.lab82" "Label457" vTcl:WidgetProc "Toplevel453a" 1
    entry $site_5_0.ent83 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SENTINEL1Product -width 5 
    vTcl:DefineAlias "$site_5_0.ent83" "Entry458" vTcl:WidgetProc "Toplevel453a" 1
    pack $site_5_0.lab82 \
        -in $site_5_0 -anchor center -expand 1 -fill none -padx 2 -side left 
    pack $site_5_0.ent83 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 2 -pady 2 \
    ...
    frame $site_4_0.cpd74 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd74" "Frame14" vTcl:WidgetProc "Toplevel453a" 1
    set site_5_0 $site_4_0.cpd74
    label $site_5_0.lab82 \
        -text Level 
    vTcl:DefineAlias "$site_5_0.lab82" "Label458" vTcl:WidgetProc "Toplevel453a" 1
    entry $site_5_0.ent83 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SENTINEL1Level -width 5 
    vTcl:DefineAlias "$site_5_0.ent83" "Entry459" vTcl:WidgetProc "Toplevel453a" 1
    pack $site_5_0.lab82 \
        -in $site_5_0 -anchor center -expand 1 -fill none -padx 2 -side left 
    pack $site_5_0.ent83 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 2 -pady 2 \
    ...
    frame $site_4_0.cpd70 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd70" "Frame10" vTcl:WidgetProc "Toplevel453a" 1
    set site_5_0 $site_4_0.cpd70
    label $site_5_0.lab82 \
        -text Polarisation 
    vTcl:DefineAlias "$site_5_0.lab82" "Label455" vTcl:WidgetProc "Toplevel453a" 1
    entry $site_5_0.ent83 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable PolarType -width 5 
    vTcl:DefineAlias "$site_5_0.ent83" "Entry456" vTcl:WidgetProc "Toplevel453a" 1
    pack $site_5_0.lab82 \
        -in $site_5_0 -anchor center -expand 1 -fill none -padx 2 -side left 
    pack $site_5_0.ent83 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 2 -pady 2 \
    ...
    frame $top.fra75 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra75" "Frame15" vTcl:WidgetProc "Toplevel453a" 1
    set site_3_0 $top.fra75
    TitleFrame $site_3_0.tit77 \
        -text Swath 
    vTcl:DefineAlias "$site_3_0.tit77" "TitleFrame1" vTcl:WidgetProc "Toplevel453a" 1
    ...
    vTcl:DefineAlias "$site_5_0.ent78" "Entry1" vTcl:WidgetProc "Toplevel453a" 1
...
if {$SENTINEL1Swath > $SENTINEL1SwathMax} { set SENTINEL1Swath 1 }} \
        ...
        -text button 
    vTcl:DefineAlias "$site_5_0.cpd80" "Button3" vTcl:WidgetProc "Toplevel453a" 1
...
if {$SENTINEL1Swath == 0} { set SENTINEL1Swath $SENTINEL1SwathMax }} \
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.but79" "Button2" vTcl:WidgetProc "Toplevel453a" 1
    button $site_5_0.cpd81 \
        -background #ffff00 \
        -command {global SENTINEL1DirInput SENTINEL1DirOutput SENTINEL1FileInputFlag SENTINEL1ZipFileInput
...
global SENTINEL1Acq SENTINEL1FUD
global FileInput1 FileInput2 TMPDir PlatForm
...
set SENTINEL1FileProduct "$TMPDir/"
append SENTINEL1FileProduct "$SENTINEL1ProductFile($SwathNum).xml"
DeleteFile $SENTINEL1FileProduct
set SENTINEL1FileProductXml "$SENTINEL1ProductFile($SwathNum).xml"
if {$PlatForm == "windows"} {
    set UnzipFunction "Soft/bin/lib/unzip/7zG_win64.exe"
    } else {
    set UnzipFunction "Soft/bin/lib/unzip/7za_linux.exe"
...
set f [ open "| $UnzipFunction e \x22$SENTINEL1ZipFileInput\x22 -o$TMPDir $SENTINEL1FileProductXml -r -y" r]
PsPprogressBar $f
TextEditorRunTrace "Check RunTime Errors" "r"
CheckRunTimeError
WaitUntilCreated $SENTINEL1FileProduct
...
if [file exists $SENTINEL1File] {
    ...
    if [file exists $TMPSentinel1Config] {
        ...
        close $f
        $widget(Label453a_02) configure -state normal; $widget(Entry453a_02) configure -disabledbackground #FFFFFF
        $widget(Label453a_03) configure -state normal; $widget(Entry453a_03) configure -disabledbackground #FFFFFF
        $widget(Label453a_04) configure -state normal; $widget(Entry453a_04) configure -disabledbackground #FFFFFF
        $widget(Label453a_07) configure -state normal; $widget(Entry453a_07) configure -disabledbackground #FFFFFF
        $widget(Label453a_08) configure -state normal; $widget(Entry453a_08) configure -disabledbackground #FFFFFF
        ...
        $widget(Button453a_6) configure -state normal
        } else {
    ...
    if [file exists $TMPGoogle] {
        ...
        gets $f GoogleLongNN
        close $f
        $widget(Button453a_04) configure -state normal
        }
        #TMPGoogle Exists
    }
    #ProductFile Exists
...
#OpenDirFile} \
    ...
    vTcl:DefineAlias "$site_5_0.cpd81" "Button4" vTcl:WidgetProc "Toplevel453a" 1
    pack $site_5_0.ent78 \
...
if [file exists $SENTINEL1File] {
    ...
    vTcl:DefineAlias "$site_3_0.cpd83" "Button453a_04" vTcl:WidgetProc "Toplevel453a" 1
    ...
    frame $top.fra67 \
        -borderwidth 2 -relief sunken -height 75 -width 125 
    vTcl:DefineAlias "$top.fra67" "Frame12" vTcl:WidgetProc "Toplevel453a" 1
    set site_3_0 $top.fra67
    frame $site_3_0.cpd68 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd68" "Frame17" vTcl:WidgetProc "Toplevel453a" 1
    set site_4_0 $site_3_0.cpd68
    frame $site_4_0.cpd84 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd84" "Frame18" vTcl:WidgetProc "Toplevel453a" 1
    set site_5_0 $site_4_0.cpd84
    label $site_5_0.lab77 \
        -text {Azimut Pixel Spacing} 
    vTcl:DefineAlias "$site_5_0.lab77" "Label453a_02" vTcl:WidgetProc "Toplevel453a" 1
    entry $site_5_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SENTINEL1PixAz -width 7 
    vTcl:DefineAlias "$site_5_0.ent78" "Entry453a_02" vTcl:WidgetProc "Toplevel453a" 1
    pack $site_5_0.lab77 \
    ...
    frame $site_4_0.cpd90 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd90" "Frame31" vTcl:WidgetProc "Toplevel453a" 1
    set site_5_0 $site_4_0.cpd90
    label $site_5_0.lab77 \
        -text {Range Pixel Spacing} 
    vTcl:DefineAlias "$site_5_0.lab77" "Label453a_03" vTcl:WidgetProc "Toplevel453a" 1
    entry $site_5_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SENTINEL1PixRg -width 7 
    vTcl:DefineAlias "$site_5_0.ent78" "Entry453a_03" vTcl:WidgetProc "Toplevel453a" 1
    pack $site_5_0.lab77 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 2 -side left 
    pack $site_5_0.ent78 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 3 -side right 
    ...
    frame $site_3_0.cpd69 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd69" "Frame19" vTcl:WidgetProc "Toplevel453a" 1
    set site_4_0 $site_3_0.cpd69
    label $site_4_0.lab79 \
        -text {Incidence Angle} 
    vTcl:DefineAlias "$site_4_0.lab79" "Label453a_04" vTcl:WidgetProc "Toplevel453a" 1
    entry $site_4_0.ent80 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SENTINEL1IncAngle -width 7 
    vTcl:DefineAlias "$site_4_0.ent80" "Entry453a_04" vTcl:WidgetProc "Toplevel453a" 1
    pack $site_4_0.lab79 \
    ...
    frame $site_3_0.cpd70 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd70" "Frame26" vTcl:WidgetProc "Toplevel453a" 1
    set site_4_0 $site_3_0.cpd70
    frame $site_4_0.cpd84 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd84" "Frame32" vTcl:WidgetProc "Toplevel453a" 1
    set site_5_0 $site_4_0.cpd84
    label $site_5_0.lab77 \
        -text {Number of Rows} 
    vTcl:DefineAlias "$site_5_0.lab77" "Label453a_07" vTcl:WidgetProc "Toplevel453a" 1
    entry $site_5_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SENTINEL1NligFinal -width 7 
    vTcl:DefineAlias "$site_5_0.ent78" "Entry453a_07" vTcl:WidgetProc "Toplevel453a" 1
    pack $site_5_0.lab77 \
    ...
    frame $site_4_0.cpd85 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd85" "Frame33" vTcl:WidgetProc "Toplevel453a" 1
    set site_5_0 $site_4_0.cpd85
    label $site_5_0.lab79 \
        -text {Number of Cols} 
    vTcl:DefineAlias "$site_5_0.lab79" "Label453a_08" vTcl:WidgetProc "Toplevel453a" 1
    entry $site_5_0.ent80 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable SENTINEL1NcolFinal -width 7 
    vTcl:DefineAlias "$site_5_0.ent80" "Entry453a_08" vTcl:WidgetProc "Toplevel453a" 1
    pack $site_5_0.lab79 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 10 -side left 
    pack $site_5_0.ent80 \
        -in $site_5_0 -anchor center -expand 0 -fill none -padx 3 -side right 
    ...
    vTcl:DefineAlias "$top.fra71" "Frame20" vTcl:WidgetProc "Toplevel453a" 1
...
Window hide $widget(Toplevel453a); TextEditorRunTrace "Close Window SENTINEL1 Input Zip File" "b"
}} \
        -padx 4 -pady 2 -text OK 
    vTcl:DefineAlias "$site_3_0.but93" "Button453a_6" vTcl:WidgetProc "Toplevel453a" 1
    ...
    button $site_3_0.but23 \
        ...
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel453a" 1
...
Window hide $widget(Toplevel453a); TextEditorRunTrace "Close Window SENTINEL1 Input Zip File" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel453a" 1
    ...
    pack $top.fra75 \
        -in $top -anchor center -expand 0 -fill x -side top 
    pack $top.fra67 \
        -in $top -anchor center -expand 0 -fill x -padx 3 -side top 
    pack $top.fra71 \
