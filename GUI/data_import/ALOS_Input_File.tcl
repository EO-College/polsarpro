...
proc vTclWindow.top218 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel218" vTcl:Toplevel:WidgetProc "" 1
    ...
    label $top.lab49 \
        ...
        -text label 
    vTcl:DefineAlias "$top.lab49" "Label73" vTcl:WidgetProc "Toplevel218" 1
    frame $top.cpd71 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd71" "Frame1" vTcl:WidgetProc "Toplevel218" 1
    set site_3_0 $top.cpd71
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame4" vTcl:WidgetProc "Toplevel218" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh2" vTcl:WidgetProc "Toplevel218" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame11" vTcl:WidgetProc "Toplevel218" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.but71 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_6_0.but71" "Button1" vTcl:WidgetProc "Toplevel218" 1
    pack $site_6_0.but71 \
    ...
    vTcl:DefineAlias "$site_3_0.cpd71" "TitleFrame5" vTcl:WidgetProc "Toplevel218" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh3" vTcl:WidgetProc "Toplevel218" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame12" vTcl:WidgetProc "Toplevel218" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.but71 \
        \
...
if {$DirName != "" } {
    ...
    set ALOSDirOutput $ALOSOutputDirTmp
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.but71" "Button2" vTcl:WidgetProc "Toplevel218" 1
    pack $site_6_0.but71 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side top 
    pack $site_5_0.cpd85 \
        -in $site_5_0 -anchor center -expand 1 -fill x -side left 
    ...
    vTcl:DefineAlias "$top.cpd72" "TitleFrame6" vTcl:WidgetProc "Toplevel218" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel218" 1
    frame $site_4_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd92" "Frame13" vTcl:WidgetProc "Toplevel218" 1
    set site_5_0 $site_4_0.cpd92
...
if {$LeaderFile == "LED"} {
    ...
    tkwait variable VarError
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.but71" "Button3" vTcl:WidgetProc "Toplevel218" 1
    pack $site_5_0.but71 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    pack $site_4_0.cpd85 \
    ...
    frame $top.fra88 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra88" "Frame30" vTcl:WidgetProc "Toplevel218" 1
...
global ALOSMode ALOSNode ALOSDataLevel ALOSMap
...
if {$config == "true"} {
    set LeaderDirName [file dirname $ALOSLeaderFile]
    set LeaderDirNameLength [string length $LeaderDirName]
    set index1 [expr ($LeaderDirNameLength + 5)]
    set index2 [string first "-" $ALOSLeaderFile $index1 ]
    set index3 [expr ($index2 - 1)]
    set index4 [expr ($index2 + 1)]
    set ALOSSceneID [string range $ALOSLeaderFile $index1 $index3]

    set LeaderFileLength [string length $ALOSLeaderFile]
    set ALOSProductID [string range $ALOSLeaderFile $index4 $LeaderFileLength]

    set ModeALOS [string range $ALOSProductID 0 0]
    set ALOSDataLevel [string range $ALOSProductID 1 3]
    set MapALOS [string range $ALOSProductID 5 5]
    set NodeALOS [string range $ALOSProductID 6 6]

    $widget(Label218_10) configure -state normal; $widget(Entry218_10) configure -disabledbackground #FFFFFF
    $widget(Label218_11) configure -state normal; $widget(Entry218_11) configure -disabledbackground #FFFFFF
    $widget(Label218_17) configure -state normal; $widget(Entry218_17) configure -disabledbackground #FFFFFF
    $widget(Label218_18) configure -state normal; $widget(Entry218_18) configure -disabledbackground #FFFFFF

    if {$ModeALOS == "P"} {
        set ALOSMode "Quad Pol Mode"
        set ModeALOS "quad"
        }
    if {$ModeALOS == "H"} {
        set ALOSMode "Dual Pol Fine Mode"
        set ModeALOS "dual"
        }
    if {$NodeALOS == "D"} { set ALOSNode "Descending" }
    if {$NodeALOS == "A"} { set ALOSNode "Ascending" }

    if {$ALOSDataLevel == "1.5"} {
        if {$MapALOS == "U"} { set ALOSMap "UTM" }
        if {$MapALOS == "P"} { set ALOSMap "PS" }
        if {$MapALOS == "M"} { set ALOSMap "MER" }
        if {$MapALOS == "L"} { set ALOSMap "LCC" }
        if {$MapALOS == "_"} { set ALOSMap "???" }
        $widget(Label218_19) configure -state normal; $widget(Entry218_19) configure -disabledbackground #FFFFFF
        } else {
        set ALOSMap ""
    ...
    if {$ALOSDataFormat != $ModeALOS} {
        set ErrorMessage "ERROR IN THE ALOS-PALSAR DATA MODE and/or LEVEL"
        Window show $widget(Toplevel44); TextEditorRunTrace "Open Window Error" "b"
        tkwait variable VarError
        MenuRAZ
        ClosePSPViewer
        ...
        if [file exists $ALOSFile] {
            ...
            if [file exists $TMPGoogle] {
                ...
                if {$Tmp != "ERRORGOOGLE"} {
                    ...
                    gets $f GoogleLatNN
                    gets $f GoogleLongNN
                    $widget(Button218_20) configure -state normal
                    } else  {
                    $widget(Button218_20) configure -state disable
                    }
                close $f
                }
            }
        ...
        set LedName [file tail $ALOSLeaderFile]
        set LedNameLength [string length $LedName]
        set ALOSFile [file dirname $ALOSLeaderFile]
        append ALOSFile "/"
        ...
        if [file exists $ALOSTrailerFile] {
            ...
            $widget(TitleFrame218_1) configure -state normal
            $widget(Entry218_12) configure -disabledbackground #FFFFFF
            ...
            if {$ModeALOS == "P"} {
                ...
                if {$config == "true"} {
                    $widget(TitleFrame218_2) configure -state normal
                    set FileInput1 $FileHH
                    $widget(Label218_13) configure -state normal; $widget(Entry218_13) configure -disabledbackground #FFFFFF
                    set FileInput2 $FileVH
                    $widget(Label218_14) configure -state normal; $widget(Entry218_14) configure -disabledbackground #FFFFFF
                    set FileInput3 $FileHV
                    $widget(Label218_15) configure -state normal; $widget(Entry218_15) configure -disabledbackground #FFFFFF
                    set FileInput4 $FileVV
                    $widget(Label218_16) configure -state normal; $widget(Entry218_16) configure -disabledbackground #FFFFFF
                    $widget(Button218_9) configure -state normal
                    } else {
    ...
    vTcl:DefineAlias "$site_3_0.cpd89" "Button219" vTcl:WidgetProc "Toplevel218" 1
...
if [file exists $ALOSFile] {
    GoogleEarth $ALOSFile
        ...
        -pady 2 
    vTcl:DefineAlias "$site_3_0.but66" "Button218_20" vTcl:WidgetProc "Toplevel218" 1
    frame $site_3_0.fra90 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra90" "Frame31" vTcl:WidgetProc "Toplevel218" 1
    set site_4_0 $site_3_0.fra90
    frame $site_4_0.fra91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.fra91" "Frame32" vTcl:WidgetProc "Toplevel218" 1
    set site_5_0 $site_4_0.fra91
    frame $site_5_0.fra93 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra93" "Frame34" vTcl:WidgetProc "Toplevel218" 1
    set site_6_0 $site_5_0.fra93
    label $site_6_0.cpd94 \
        -text {Scene ID   } 
    vTcl:DefineAlias "$site_6_0.cpd94" "Label218_10" vTcl:WidgetProc "Toplevel218" 1
    entry $site_6_0.cpd95 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ALOSSceneID 
    vTcl:DefineAlias "$site_6_0.cpd95" "Entry218_10" vTcl:WidgetProc "Toplevel218" 1
    pack $site_6_0.cpd94 \
    ...
    frame $site_5_0.cpd97 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd97" "Frame35" vTcl:WidgetProc "Toplevel218" 1
    set site_6_0 $site_5_0.cpd97
    label $site_6_0.cpd94 \
        -text Mode 
    vTcl:DefineAlias "$site_6_0.cpd94" "Label218_11" vTcl:WidgetProc "Toplevel218" 1
    entry $site_6_0.cpd95 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ALOSMode 
    vTcl:DefineAlias "$site_6_0.cpd95" "Entry218_11" vTcl:WidgetProc "Toplevel218" 1
    pack $site_6_0.cpd94 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.cpd95 \
        -in $site_6_0 -anchor center -expand 0 -fill none -padx 5 -side left 
    ...
    frame $site_4_0.cpd98 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd98" "Frame33" vTcl:WidgetProc "Toplevel218" 1
    set site_5_0 $site_4_0.cpd98
    frame $site_5_0.fra93 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.fra93" "Frame36" vTcl:WidgetProc "Toplevel218" 1
    set site_6_0 $site_5_0.fra93
    label $site_6_0.cpd94 \
        -text {Data Level } 
    vTcl:DefineAlias "$site_6_0.cpd94" "Label218_17" vTcl:WidgetProc "Toplevel218" 1
    entry $site_6_0.cpd95 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ALOSDataLevel -width 5 
    vTcl:DefineAlias "$site_6_0.cpd95" "Entry218_17" vTcl:WidgetProc "Toplevel218" 1
    pack $site_6_0.cpd94 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.cpd95 \
        -in $site_6_0 -anchor center -expand 0 -fill none -padx 5 -side left 
    frame $site_5_0.cpd97 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd97" "Frame37" vTcl:WidgetProc "Toplevel218" 1
    set site_6_0 $site_5_0.cpd97
    label $site_6_0.cpd94 \
        -text Node 
    vTcl:DefineAlias "$site_6_0.cpd94" "Label218_18" vTcl:WidgetProc "Toplevel218" 1
    entry $site_6_0.cpd95 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ALOSNode -width 12 
    vTcl:DefineAlias "$site_6_0.cpd95" "Entry218_18" vTcl:WidgetProc "Toplevel218" 1
    pack $site_6_0.cpd94 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.cpd95 \
        -in $site_6_0 -anchor center -expand 0 -fill none -padx 5 -side left 
    frame $site_5_0.cpd99 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd99" "Frame38" vTcl:WidgetProc "Toplevel218" 1
    set site_6_0 $site_5_0.cpd99
    label $site_6_0.cpd94 \
        -text {Projection Map} 
    vTcl:DefineAlias "$site_6_0.cpd94" "Label218_19" vTcl:WidgetProc "Toplevel218" 1
    entry $site_6_0.cpd95 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ALOSMap -width 5 
    vTcl:DefineAlias "$site_6_0.cpd95" "Entry218_19" vTcl:WidgetProc "Toplevel218" 1
    pack $site_6_0.cpd94 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_6_0.cpd95 \
        -in $site_6_0 -anchor center -expand 0 -fill none -padx 5 -side left 
    ...
    vTcl:DefineAlias "$top.cpd90" "TitleFrame218_1" vTcl:WidgetProc "Toplevel218" 1
    ...
    frame $site_4_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd92" "Frame14" vTcl:WidgetProc "Toplevel218" 1
    set site_5_0 $site_4_0.cpd92
    label $site_5_0.lab91 \
        -width 3 
    vTcl:DefineAlias "$site_5_0.lab91" "Label8" vTcl:WidgetProc "Toplevel218" 1
    pack $site_5_0.lab91 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    entry $site_4_0.cpd85 \
        -background white -disabledbackground #ffffff \
    ...
    vTcl:DefineAlias "$site_4_0.cpd85" "Entry218_12" vTcl:WidgetProc "Toplevel218" 1
    pack $site_4_0.cpd92 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side left 
    pack $site_4_0.cpd85 \
        -in $site_4_0 -anchor center -expand 1 -fill x -side left 
    ...
    vTcl:DefineAlias "$top.cpd92" "TitleFrame218_2" vTcl:WidgetProc "Toplevel218" 1
    ...
    frame $site_4_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd92" "Frame15" vTcl:WidgetProc "Toplevel218" 1
    set site_5_0 $site_4_0.cpd92
    label $site_5_0.lab91 \
        -text s11 -width 3 
    vTcl:DefineAlias "$site_5_0.lab91" "Label218_13" vTcl:WidgetProc "Toplevel218" 1
    entry $site_5_0.cpd96 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable FileInput1 
    vTcl:DefineAlias "$site_5_0.cpd96" "Entry218_13" vTcl:WidgetProc "Toplevel218" 1
    pack $site_5_0.lab91 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd96 \
        -in $site_5_0 -anchor center -expand 1 -fill x -side left 
    frame $site_4_0.cpd97 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd97" "Frame16" vTcl:WidgetProc "Toplevel218" 1
    set site_5_0 $site_4_0.cpd97
    label $site_5_0.lab91 \
        -text s12 -width 3 
    vTcl:DefineAlias "$site_5_0.lab91" "Label218_14" vTcl:WidgetProc "Toplevel218" 1
    entry $site_5_0.cpd96 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable FileInput2 
    vTcl:DefineAlias "$site_5_0.cpd96" "Entry218_14" vTcl:WidgetProc "Toplevel218" 1
    pack $site_5_0.lab91 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd96 \
        -in $site_5_0 -anchor center -expand 1 -fill x -side left 
    frame $site_4_0.cpd100 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd100" "Frame17" vTcl:WidgetProc "Toplevel218" 1
    set site_5_0 $site_4_0.cpd100
    label $site_5_0.lab91 \
        -text s21 -width 3 
    vTcl:DefineAlias "$site_5_0.lab91" "Label218_15" vTcl:WidgetProc "Toplevel218" 1
    entry $site_5_0.cpd96 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable FileInput3 
    vTcl:DefineAlias "$site_5_0.cpd96" "Entry218_15" vTcl:WidgetProc "Toplevel218" 1
    pack $site_5_0.lab91 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd96 \
        -in $site_5_0 -anchor center -expand 1 -fill x -side left 
    frame $site_4_0.cpd101 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd101" "Frame18" vTcl:WidgetProc "Toplevel218" 1
    set site_5_0 $site_4_0.cpd101
    label $site_5_0.lab91 \
        -text s22 -width 3 
    vTcl:DefineAlias "$site_5_0.lab91" "Label218_16" vTcl:WidgetProc "Toplevel218" 1
    entry $site_5_0.cpd96 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -state disabled \
        -textvariable FileInput4 
    vTcl:DefineAlias "$site_5_0.cpd96" "Entry218_16" vTcl:WidgetProc "Toplevel218" 1
    pack $site_5_0.lab91 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd96 \
        -in $site_5_0 -anchor center -expand 1 -fill x -side left 
    ...
    vTcl:DefineAlias "$top.cpd85" "Frame21" vTcl:WidgetProc "Toplevel218" 1
...
if [file exists $ConfigFile] {
    ...
    if {$TestVarError == "ok"} {
        ...
        $widget(Button218_9) configure -state normal; $widget(Menubutton218_1) configure -state normal
        if {$ALOSDataFormat == "quad1.1" } { $widget(Checkbutton218_1) configure -state normal }
        $widget(Entry218_20) configure -disabledbackground #FFFFFF
        $widget(Label218_1) configure -state normal; $widget(Entry218_1) configure -disabledbackground #FFFFFF
        $widget(Label218_2) configure -state normal; $widget(Entry218_2) configure -disabledbackground #FFFFFF
        $widget(Button218_10) configure -state normal
        } else {
...
if {$ALOSFileInputFlag == 0 } {
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button218_9" vTcl:WidgetProc "Toplevel218" 1
    ...
    vTcl:DefineAlias "$site_3_0.men90" "Menubutton218_1" vTcl:WidgetProc "Toplevel218" 1
...
if [file exists $ALOSFile] {
    ...
    vTcl:DefineAlias "$site_3_0.fra71" "Frame2" vTcl:WidgetProc "Toplevel218" 1
    set site_4_0 $site_3_0.fra71
    checkbutton $site_4_0.che72 \
        -text {Extract Uncalibrated Raw Binary Data} \
        -variable ALOSUnCalibration 
    vTcl:DefineAlias "$site_4_0.che72" "Checkbutton218_1" vTcl:WidgetProc "Toplevel218" 1
    pack $site_4_0.che72 \
    ...
    vTcl:DefineAlias "$top.cpd79" "Frame4" vTcl:WidgetProc "Toplevel218" 1
    set site_3_0 $top.cpd79
    frame $site_3_0.cpd102 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd102" "Frame114" vTcl:WidgetProc "Toplevel218" 1
    set site_4_0 $site_3_0.cpd102
    entry $site_4_0.cpd83 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable ALOSDataType -width 30 
    vTcl:DefineAlias "$site_4_0.cpd83" "Entry218_20" vTcl:WidgetProc "Toplevel218" 1
    pack $site_4_0.cpd83 \
        -in $site_4_0 -anchor center -expand 0 -fill none -side right 
    pack $site_3_0.cpd102 \
        -in $site_3_0 -anchor center -expand 1 -fill none -side left 
    frame $top.fra57 \
        -borderwidth 2 -relief groove -height 76 -width 200 
    vTcl:DefineAlias "$top.fra57" "Frame" vTcl:WidgetProc "Toplevel218" 1
    set site_3_0 $top.fra57
    frame $site_3_0.fra39 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra39" "Frame107" vTcl:WidgetProc "Toplevel218" 1
    set site_4_0 $site_3_0.fra39
    label $site_4_0.lab40 \
        -text {Initial Number of Rows} 
    vTcl:DefineAlias "$site_4_0.lab40" "Label218_1" vTcl:WidgetProc "Toplevel218" 1
    entry $site_4_0.ent41 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligFullSize -width 5 
    vTcl:DefineAlias "$site_4_0.ent41" "Entry218_1" vTcl:WidgetProc "Toplevel218" 1
    label $site_4_0.lab42 \
        -text {Initial Number of Cols} 
    vTcl:DefineAlias "$site_4_0.lab42" "Label218_2" vTcl:WidgetProc "Toplevel218" 1
    entry $site_4_0.ent43 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolFullSize -width 5 
    vTcl:DefineAlias "$site_4_0.ent43" "Entry218_2" vTcl:WidgetProc "Toplevel218" 1
    pack $site_4_0.lab40 \
    ...
    frame $top.fra59 \
        -relief groove -height 35 -width 125 
    vTcl:DefineAlias "$top.fra59" "Frame20" vTcl:WidgetProc "Toplevel218" 1
...
if {$OpenDirFile == 0} {
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button218_10" vTcl:WidgetProc "Toplevel218" 1
    bindtags $site_3_0.but93 "$site_3_0.but93 Button $top all _vTclBalloon"
    bind $site_3_0.but93 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Run and Exit the Function}
    }
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/ALOS_Input_File.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel218" 1
...
Window hide $widget(Toplevel218); TextEditorRunTrace "Close Window ALOS Input File" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel218" 1
