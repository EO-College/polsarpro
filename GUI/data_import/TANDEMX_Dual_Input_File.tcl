    ...
    if {"$VarWarning"=="ok"} {
        ...
        if [file exists $TMPTANDEMXConfig] {
            ...
            if {$PolarType != "full"} {
               ...
               set VarError ""
               set ErrorMessage "NOT A DUAL-POL TANDEMX PRODUCT"
...
if [file exists $TANDEMXFile] {
    ...
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Input Master Data File ( channel 1 )} 
...
OpenFile $TDXDirTmp $types "INPUT FILE (Channel 1)"
...
set FileInput1 $FileName} \
    ...
    TitleFrame $site_3_0.cpd116 \
        -ipad 0 -text {Input Master Data File ( channel 2 )} 
...
OpenFile $TDXDirTmp $types "INPUT FILE (Channel 2)"
...
set FileInput2 $FileName} \
    ...
    TitleFrame $site_3_0.cpd117 \
        -ipad 0 -text {Input Slave Data File ( channel 1 )} 
    ...
    button $site_6_0.cpd121 \
        \
        -command {global FileName TANDEMXDirInputSlave TANDEMXDataFormat FileInput3
...
set FileInput3 $FileName} \
    ...
    TitleFrame $site_3_0.cpd118 \
        -ipad 0 -text {Input Slave Data File ( channel 2 )} 
    ...
    button $site_6_0.cpd122 \
        \
        -command {global FileName TANDEMXDirInputSlave TANDEMXDataFormat FileInput4
