...
proc vTclWindow.top436 {base} {
    ...
    vTcl:DefineAlias "$top" "Toplevel436" vTcl:Toplevel:WidgetProc "" 1
    ...
    frame $top.cpd79 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd79" "Frame1" vTcl:WidgetProc "Toplevel436" 1
    set site_3_0 $top.cpd79
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame4" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh2" vTcl:WidgetProc "Toplevel436" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame11" vTcl:WidgetProc "Toplevel436" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd114 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_6_0.cpd114" "Button39" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$top.cpd72" "TitleFrame220" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd85" "Entry220" vTcl:WidgetProc "Toplevel436" 1
    frame $site_4_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd91" "Frame30" vTcl:WidgetProc "Toplevel436" 1
    set site_5_0 $site_4_0.cpd91
...
set TANDEMXProductFile $FileName} \
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd119" "Button220" vTcl:WidgetProc "Toplevel436" 1
    ...
    frame $top.cpd69 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd69" "Frame18" vTcl:WidgetProc "Toplevel436" 1
...
if {$TANDEMXProductFile != ""} {
    ...
    if {"$VarWarning"=="ok"} {
        ...
        if [file exists $TMPTANDEMXConfig] {
            ...
            set TDXPolar "Dual Pol : "; append TDXPolar $PolarType
            $widget(Button436_01) configure -state normal; 
            #TextEditorRunTrace "Process The Function Soft/data_import/tandemx_google.exe" "k"
            #TextEditorRunTrace "Arguments: -id \x22$TANDEMXDirInput\x22 -of \x22$TMPGoogle\x22" "k"
            #set f [ open "| Soft/data_import/tandemx_google.exe -id \x22$TANDEMXDirInput\x22 -of \x22$TMPGoogle\x22" r]
            #PsPprogressBar $f
            ...
            #    close $f
            #    }
            #$widget(Button436_02) configure -state normal
            ...
            if {$TANDEMXProductFileSlave != ""} {
                ...
                if {"$VarWarning"=="ok"} {
                    ...
                    if [file exists $TMPTANDEMXConfigSlave] {
                        ...
                        $widget(Entry436_3) configure -disabledbackground #FFFFFF; $widget(Button436_3) configure -state normal
                        $widget(TitleFrame436_3) configure -text "Input Slave Data File ($Channel1)"
                        $widget(Entry436_4) configure -disabledbackground #FFFFFF; $widget(Button436_4) configure -state normal
                        $widget(TitleFrame436_4) configure -text "Input Slave Data File ($Channel2)"
                        close $f
                        $widget(Button436_05) configure -state normal 
                        ...
                        set f [ open "| Soft/data_import/terrasarx_google.exe -id \x22$TANDEMXDirOutputSlave\x22 -of \x22$TMPGoogle\x22" r]
                        PsPprogressBar $f
                        TextEditorRunTrace "Check RunTime Errors" "r"
                        CheckRunTimeError
                        WaitUntilCreated $TMPGoogle
                        $widget(Button436_06) configure -state normal 
                        }
                    }
               }    
            ...
            if {$TANDEMXProductFileMaster != ""} {
                ...
                if {"$VarWarning"=="ok"} {
                    ...
                    if [file exists $TMPTANDEMXConfigMaster] {
                        ...
                        if {$PolarType == "pp3"} { set Channel1 "s11"; set Channel2 "s22" }
                        if {$PolarType == "pp0"} { set Channel1 "s12"; set Channel2 "s21" } 
                        $widget(Entry436_1) configure -disabledbackground #FFFFFF; $widget(Button436_1) configure -state normal
                        $widget(TitleFrame436_1) configure -text "Input Master Data File ($Channel1)"
                        $widget(Entry436_2) configure -disabledbackground #FFFFFF; $widget(Button436_2) configure -state normal
                        $widget(TitleFrame436_2) configure -text "Input Master Data File ($Channel2)"
                        close $f
                        $widget(Button436_03) configure -state normal 
                        TextEditorRunTrace "Process The Function Soft/data_import/terrasarx_google.exe" "k"
                        TextEditorRunTrace "Arguments: -id \x22$TANDEMXDirOutputMaster\x22 -of \x22$TMPGoogle\x22" "k"
                        set f [ open "| Soft/data_import/terrasarx_google.exe -id \x22$TANDEMXDirOutputMaster\x22 -of \x22$TMPGoogle\x22" r]
                        PsPprogressBar $f
                        TextEditorRunTrace "Check RunTime Errors" "r"
                        CheckRunTimeError
                        WaitUntilCreated $TMPGoogle
                        $widget(Button436_04) configure -state normal 
                        }
                    }
               }  
           $widget(Button436_6) configure -state normal 
           }
        #Warning
        }
    #ProductFile
...
#OpenDirFile
    ...
    vTcl:DefineAlias "$site_3_0.cpd83" "Button2" vTcl:WidgetProc "Toplevel436" 1
...
if [file exists $TANDEMXFile] {
    ...
    TextEditorFromWidget .top436 $TANDEMXFile
    }} \
        -padx 4 -pady 2 -text {Edit Header} 
    vTcl:DefineAlias "$site_3_0.cpd84" "Button436_01" vTcl:WidgetProc "Toplevel436" 1
    frame $site_3_0.cpd70 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.cpd70" "Frame19" vTcl:WidgetProc "Toplevel436" 1
    set site_4_0 $site_3_0.cpd70
    label $site_4_0.cpd93 \
        -text {Polarization Mode} 
    vTcl:DefineAlias "$site_4_0.cpd93" "Label5" vTcl:WidgetProc "Toplevel436" 1
    entry $site_4_0.cpd71 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable TDXPolar -width 15 
    vTcl:DefineAlias "$site_4_0.cpd71" "Entry5" vTcl:WidgetProc "Toplevel436" 1
    pack $site_4_0.cpd93 \
...
if [file exists $TANDEMXFile] {
    ...
    vTcl:DefineAlias "$site_3_0.cpd72" "Button436_02" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$top.cpd66" "TitleFrame5" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd85" "EntryTopXXCh3" vTcl:WidgetProc "Toplevel436" 1
    frame $site_4_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd92" "Frame16" vTcl:WidgetProc "Toplevel436" 1
    set site_5_0 $site_4_0.cpd92
    button $site_5_0.cpd114 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_5_0.cpd114" "Button40" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$top.cpd71" "TitleFrame436" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd85" "Entry436" vTcl:WidgetProc "Toplevel436" 1
    frame $site_4_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd91" "Frame29" vTcl:WidgetProc "Toplevel436" 1
    set site_5_0 $site_4_0.cpd91
    button $site_5_0.cpd119 \
        \
...
if {$DirName != "" } {
    ...
    set TANDEMXDirOutputMaster $TANDEMXOutputDirTmp
        ...
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd119" "Button436" vTcl:WidgetProc "Toplevel436" 1
    bindtags $site_5_0.cpd119 "$site_5_0.cpd119 Button $top all _vTclBalloon"
    bind $site_5_0.cpd119 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Open File}
    }
    ...
    vTcl:DefineAlias "$top.cpd67" "TitleFrame6" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd85" "EntryTopXXCh4" vTcl:WidgetProc "Toplevel436" 1
    frame $site_4_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd92" "Frame17" vTcl:WidgetProc "Toplevel436" 1
    set site_5_0 $site_4_0.cpd92
    button $site_5_0.cpd114 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_5_0.cpd114" "Button41" vTcl:WidgetProc "Toplevel436" 1
    pack $site_5_0.cpd114 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    pack $site_4_0.cpd85 \
        -in $site_4_0 -anchor center -expand 1 -fill x -side left 
    ...
    vTcl:DefineAlias "$top.cpd68" "TitleFrame437" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_4_0.cpd85" "Entry437" vTcl:WidgetProc "Toplevel436" 1
    frame $site_4_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd91" "Frame31" vTcl:WidgetProc "Toplevel436" 1
    set site_5_0 $site_4_0.cpd91
    button $site_5_0.cpd119 \
        \
...
if {$DirName != "" } {
    ...
    set TANDEMXDirOutputSlave $TANDEMXOutputDirTmp
        ...
        -image [vTcl:image:get_image [file join . GUI Images OpenDir.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_5_0.cpd119" "Button437" vTcl:WidgetProc "Toplevel436" 1
    bindtags $site_5_0.cpd119 "$site_5_0.cpd119 Button $top all _vTclBalloon"
    bind $site_5_0.cpd119 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Open File}
    }
    ...
    frame $top.fra73 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$top.fra73" "Frame4" vTcl:WidgetProc "Toplevel436" 1
    set site_3_0 $top.fra73
    TitleFrame $site_3_0.cpd74 \
        -ipad 2 -text {Master Directory} 
    vTcl:DefineAlias "$site_3_0.cpd74" "TitleFrame2" vTcl:WidgetProc "Toplevel436" 1
...
if [file exists $TANDEMXFile] {
    ...
    TextEditorFromWidget .top436 $TANDEMXFile
        ...
        -padx 4 -pady 2 -text {Edit Header} 
    vTcl:DefineAlias "$site_5_0.cpd75" "Button436_03" vTcl:WidgetProc "Toplevel436" 1
...
if [file exists $TANDEMXFile] {
    GoogleEarth $TANDEMXFile
        ...
        -image [vTcl:image:get_image [file join . GUI Images google_earth.gif]] \
        -padx 4 -pady 2 -relief raised -text Google 
    vTcl:DefineAlias "$site_5_0.cpd76" "Button436_04" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd84" "Frame13" vTcl:WidgetProc "Toplevel436" 1
    set site_4_0 $site_3_0.cpd84
    frame $site_4_0.cpd78 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd78" "Frame14" vTcl:WidgetProc "Toplevel436" 1
    set site_5_0 $site_4_0.cpd78
    frame $site_5_0.cpd79 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd79" "Frame15" vTcl:WidgetProc "Toplevel436" 1
    set site_6_0 $site_5_0.cpd79
    label $site_6_0.lab77 \
        -text {Initial Number of Rows} 
    vTcl:DefineAlias "$site_6_0.lab77" "Label439" vTcl:WidgetProc "Toplevel436" 1
    pack $site_6_0.lab77 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    frame $site_5_0.cpd80 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd80" "Frame21" vTcl:WidgetProc "Toplevel436" 1
    set site_6_0 $site_5_0.cpd80
    label $site_6_0.lab79 \
        -text {Initial Number of Cols} 
    vTcl:DefineAlias "$site_6_0.lab79" "Label442" vTcl:WidgetProc "Toplevel436" 1
    pack $site_6_0.lab79 \
        -in $site_6_0 -anchor center -expand 0 -fill none -side left 
    pack $site_5_0.cpd79 \
    ...
    frame $site_4_0.cpd81 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_4_0.cpd81" "Frame22" vTcl:WidgetProc "Toplevel436" 1
    set site_5_0 $site_4_0.cpd81
    frame $site_5_0.cpd82 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd82" "Frame23" vTcl:WidgetProc "Toplevel436" 1
    set site_6_0 $site_5_0.cpd82
    entry $site_6_0.ent78 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NligFullSize -width 6 
    vTcl:DefineAlias "$site_6_0.ent78" "Entry441" vTcl:WidgetProc "Toplevel436" 1
    pack $site_6_0.ent78 \
        -in $site_6_0 -anchor center -expand 1 -fill none -padx 5 -side left 
    frame $site_5_0.cpd83 \
        -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd83" "Frame24" vTcl:WidgetProc "Toplevel436" 1
    set site_6_0 $site_5_0.cpd83
    entry $site_6_0.ent80 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #0000ff -foreground #0000ff -justify center \
        -state disabled -textvariable NcolFullSize -width 6 
    vTcl:DefineAlias "$site_6_0.ent80" "Entry444" vTcl:WidgetProc "Toplevel436" 1
    pack $site_6_0.ent80 \
        -in $site_6_0 -anchor center -expand 1 -fill none -padx 5 -side left 
    pack $site_5_0.cpd82 \
        -in $site_5_0 -anchor center -expand 0 -fill none -side top 
    ...
    vTcl:DefineAlias "$site_3_0.cpd77" "TitleFrame3" vTcl:WidgetProc "Toplevel436" 1
...
if [file exists $TANDEMXFile] {
    ...
    TextEditorFromWidget .top436 $TANDEMXFile
        ...
        -padx 4 -pady 2 -text {Edit Header} 
    vTcl:DefineAlias "$site_5_0.cpd75" "Button436_05" vTcl:WidgetProc "Toplevel436" 1
    button $site_5_0.cpd76 \
        \
        -command {global FileName VarError ErrorMessage TANDEMXDirOutputSlave
...
if [file exists $TANDEMXFile] {
    GoogleEarth $TANDEMXFile
        ...
        -image [vTcl:image:get_image [file join . GUI Images google_earth.gif]] \
        -padx 4 -pady 2 -relief raised -text Google 
    vTcl:DefineAlias "$site_5_0.cpd76" "Button436_06" vTcl:WidgetProc "Toplevel436" 1
    bindtags $site_5_0.cpd76 "$site_5_0.cpd76 Button $top all _vTclBalloon"
    bind $site_5_0.cpd76 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Google Earth}
    }
    ...
    frame $top.cpd77 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd77" "Frame3" vTcl:WidgetProc "Toplevel436" 1
    set site_3_0 $top.cpd77
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Input Master Data File ( s11 )} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame436_1" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry436_1" vTcl:WidgetProc "Toplevel436" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame25" vTcl:WidgetProc "Toplevel436" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd119 \
        \
        -command {global FileName TANDEMXDirInput TANDEMXDataFormat FileInput1

set types {
    {{All Files}        *        }
    }
set FileName ""
if [file isdirectory "$TANDEMXDirInput/IMAGEDATA"] {
    set TDXDirTmp "$TANDEMXDirInput/IMAGEDATA"
    } else {
    set TDXDirTmp $TANDEMXDirInput
    }
if {$TANDEMXDataFormat == "quad"} {OpenFile $TDXDirTmp $types "HH INPUT FILE (s11)"}
if {$TANDEMXDataFormat == "dual"} {OpenFile $TDXDirTmp $types "INPUT FILE (Channel 1)"}
if {$FileName == "" } { set FileName $FileInput1 }
set FileInput1 $FileName} \
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd119" "Button436_1" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd116" "TitleFrame436_2" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry436_2" vTcl:WidgetProc "Toplevel436" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame26" vTcl:WidgetProc "Toplevel436" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd120 \
        \
        -command {global FileName TANDEMXDirInput TANDEMXDataFormat FileInput2
...
if {$TANDEMXDataFormat == "dual"} {OpenFile $TDXDirTmp $types "INPUT FILE (Channel 2)"}
if {$FileName == "" } { set FileName $FileInput2 }
set FileInput2 $FileName} \
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd120" "Button436_2" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd117" "TitleFrame436_3" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry436_3" vTcl:WidgetProc "Toplevel436" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame27" vTcl:WidgetProc "Toplevel436" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd121 \
        \
        -command {global FileName TANDEMXDirInput TANDEMXDataFormat FileInput3
...
set FileInput3 $FileName} \
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd121" "Button436_3" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd118" "TitleFrame436_4" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "Entry436_4" vTcl:WidgetProc "Toplevel436" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame28" vTcl:WidgetProc "Toplevel436" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd122 \
        \
        -command {global FileName TANDEMXDirInput TANDEMXDataFormat FileInput4
...
set FileInput4 $FileName} \
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd122" "Button436_4" vTcl:WidgetProc "Toplevel436" 1
    ...
    vTcl:DefineAlias "$top.fra71" "Frame20" vTcl:WidgetProc "Toplevel436" 1
...
global Load_CheckSizeBinaryDataFile
...
if {$TANDEMXFileFlag == 4} {set TANDEMXFileInputFlag 1}
...
if {$TANDEMXFileInputFlag == 1} {
    ...
    Window hide $widget(Toplevel436); TextEditorRunTrace "Close Window TANDEMX Input File" "b"
    } else {
    set TANDEMXFileInputFlag 0
...
if {$Load_CheckSizeBinaryDataFile == 1} { Window hide $widget(Toplevel438); TextEditorRunTrace "Close Window Check Binary Data Files" "b" }
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button436_6" vTcl:WidgetProc "Toplevel436" 1
    ...
    button $site_3_0.but23 \
        ...
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel436" 1
    ...
    button $site_3_0.but66 \
        \
        -command {global Load_CheckSizeBinaryDataFile PSPTopLevel
...
WidgetShowFromWidget $widget(Toplevel436) $widget(Toplevel438); TextEditorRunTrace "Open Window Check Binary Data Files" "b"
CheckBinRAZ
CheckTerrasarQuadSSC
}} \
        -image [vTcl:image:get_image [file join . GUI Images tools.gif]] \
        -pady 0 
    vTcl:DefineAlias "$site_3_0.but66" "Button1" vTcl:WidgetProc "Toplevel436" 1
...
Window hide $widget(Toplevel436); TextEditorRunTrace "Close Window TANDEMX Input File" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel436" 1
