...
foreach img {
        ...
        {{[file join . GUI Images CONVAIR.gif]} {user image} user {}}
...
proc vTclWindow.top224 {base} {
    ...
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm title $top "SAR580-CONVAIR Input Data File"
    vTcl:DefineAlias "$top" "Toplevel224" vTcl:Toplevel:WidgetProc "" 1
    bindtags $top "$top Toplevel all _TopLevel"
    vTcl:FireEvent $top <<Create>>
    wm protocol $top WM_DELETE_WINDOW "vTcl:FireEvent $top <<>>"

    label $top.lab66 \
        -image [vTcl:image:get_image [file join . GUI Images CONVAIR.gif]] \
        -text label 
    vTcl:DefineAlias "$top.lab66" "Label281" vTcl:WidgetProc "Toplevel224" 1
    frame $top.cpd79 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd79" "Frame1" vTcl:WidgetProc "Toplevel224" 1
    set site_3_0 $top.cpd79
    TitleFrame $site_3_0.cpd97 \
        -ipad 0 -text {Input Directory} 
    vTcl:DefineAlias "$site_3_0.cpd97" "TitleFrame4" vTcl:WidgetProc "Toplevel224" 1
    ...
    entry $site_5_0.cpd85 \
        ...
        -textvariable CONVAIRDirInput 
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh2" vTcl:WidgetProc "Toplevel224" 1
    frame $site_5_0.cpd92 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd92" "Frame11" vTcl:WidgetProc "Toplevel224" 1
    set site_6_0 $site_5_0.cpd92
    button $site_6_0.cpd114 \
        \
        -image [vTcl:image:get_image [file join . GUI Images Transparent_Button.gif]] \
        -pady 0 -relief flat -text button 
    vTcl:DefineAlias "$site_6_0.cpd114" "Button39" vTcl:WidgetProc "Toplevel224" 1
    ...
    frame $top.cpd80 \
        -height 75 -width 125 
    vTcl:DefineAlias "$top.cpd80" "Frame2" vTcl:WidgetProc "Toplevel224" 1
    set site_3_0 $top.cpd80
    TitleFrame $site_3_0.cpd98 \
        -ipad 0 -text {Input Data File ( s11 )} 
    vTcl:DefineAlias "$site_3_0.cpd98" "TitleFrame7" vTcl:WidgetProc "Toplevel224" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh7" vTcl:WidgetProc "Toplevel224" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame14" vTcl:WidgetProc "Toplevel224" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd119 \
        \
        -command {global FileName CONVAIRDirInput FileInputHH

set types {
    {{All Files}        *        }
    }
set FileName ""
OpenFile $CONVAIRDirInput $types "HH INPUT FILE (s11)"
set FileInputHH $FileName} \
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd119" "Button21" vTcl:WidgetProc "Toplevel224" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd116" "TitleFrame8" vTcl:WidgetProc "Toplevel224" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh8" vTcl:WidgetProc "Toplevel224" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame15" vTcl:WidgetProc "Toplevel224" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd120 \
        \
        -command {global FileName CONVAIRDirInput FileInputHV

set types {
    {{All Files}        *        }
    }
set FileName ""
OpenFile $CONVAIRDirInput $types "HV INPUT FILE (s12)"
set FileInputHV $FileName} \
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd120" "Button22" vTcl:WidgetProc "Toplevel224" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd117" "TitleFrame9" vTcl:WidgetProc "Toplevel224" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh9" vTcl:WidgetProc "Toplevel224" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame16" vTcl:WidgetProc "Toplevel224" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd121 \
        \
        -command {global FileName CONVAIRDirInput FileInputVH

set types {
    {{All Files}        *        }
    }
set FileName ""
OpenFile $CONVAIRDirInput $types "VH INPUT FILE (s21)"
set FileInputVH $FileName} \
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd121" "Button23" vTcl:WidgetProc "Toplevel224" 1
    ...
    vTcl:DefineAlias "$site_3_0.cpd118" "TitleFrame10" vTcl:WidgetProc "Toplevel224" 1
    ...
    vTcl:DefineAlias "$site_5_0.cpd85" "EntryTopXXCh10" vTcl:WidgetProc "Toplevel224" 1
    frame $site_5_0.cpd91 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_5_0.cpd91" "Frame17" vTcl:WidgetProc "Toplevel224" 1
    set site_6_0 $site_5_0.cpd91
    button $site_6_0.cpd122 \
        \
        -command {global FileName CONVAIRDirInput FileInputVV

set types {
    {{All Files}        *        }
    }
set FileName ""
OpenFile $CONVAIRDirInput $types "VV INPUT FILE (s22)"
set FileInputVV $FileName} \
        -image [vTcl:image:get_image [file join . GUI Images OpenFile.gif]] \
        -pady 0 -text button 
    vTcl:DefineAlias "$site_6_0.cpd122" "Button40" vTcl:WidgetProc "Toplevel224" 1
    ...
    vTcl:DefineAlias "$top.fra23" "Frame65" vTcl:WidgetProc "Toplevel224" 1
    set site_3_0 $top.fra23
    frame $site_3_0.fra39 \
        -borderwidth 2 -height 75 -width 125 
    vTcl:DefineAlias "$site_3_0.fra39" "Frame107" vTcl:WidgetProc "Toplevel224" 1
    set site_4_0 $site_3_0.fra39
    label $site_4_0.lab40 \
        -text {Initial Number of Rows} 
    vTcl:DefineAlias "$site_4_0.lab40" "Label49" vTcl:WidgetProc "Toplevel224" 1
    entry $site_4_0.ent41 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NligFullSize -width 5 
    vTcl:DefineAlias "$site_4_0.ent41" "Entry33" vTcl:WidgetProc "Toplevel224" 1
    label $site_4_0.lab42 \
        -text {Initial Number of Cols} 
    vTcl:DefineAlias "$site_4_0.lab42" "Label123" vTcl:WidgetProc "Toplevel224" 1
    entry $site_4_0.ent43 \
        -background white -disabledbackground #ffffff \
        -disabledforeground #ff0000 -foreground #ff0000 -justify center \
        -textvariable NcolFullSize -width 5 
    vTcl:DefineAlias "$site_4_0.ent43" "Entry51" vTcl:WidgetProc "Toplevel224" 1
    pack $site_4_0.lab40 \
    ...
    checkbutton $top.cpd76 \
        -text {Convert Input IEEE binary Format (LE<->BE)} \
        -variable IEEEFormat 
    vTcl:DefineAlias "$top.cpd76" "Checkbutton146" vTcl:WidgetProc "Toplevel224" 1
    frame $top.fra71 \
        -relief groove -height 35 -width 125 
    vTcl:DefineAlias "$top.fra71" "Frame20" vTcl:WidgetProc "Toplevel224" 1
    set site_3_0 $top.fra71
    button $site_3_0.but93 \
        -background #ffff00 \
        -command {global CONVAIRDirOutput CONVAIRFileInputFlag OpenDirFile
...
TestVar 2
if {$TestVarError == "ok"} {
    set CONVAIRFileInputFlag 0
    set CONVAIRFileFlag 0
    if {$FileInputHH != ""} {incr CONVAIRFileFlag}
    if {$FileInputHV != ""} {incr CONVAIRFileFlag}
    if {$FileInputVH != ""} {incr CONVAIRFileFlag}
    if {$FileInputVV != ""} {incr CONVAIRFileFlag}
    if {$CONVAIRFileFlag == 4} {set CONVAIRFileInputFlag 1}
    
    if {$CONVAIRFileInputFlag == 1} {
        set NligInit 1
        ...
        Window hide $widget(Toplevel224); TextEditorRunTrace "Close Window CONVAIR Input File" "b"
        } else {
        set CONVAIRFileInputFlag 0
        set ErrorMessage "ENTER THE CONVAIR DATA FILE NAMES"
        set VarError ""
    ...
    vTcl:DefineAlias "$site_3_0.but93" "Button13" vTcl:WidgetProc "Toplevel224" 1
    ...
    button $site_3_0.but23 \
        -background #ff8000 \
        -command {HelpPdfEdit "Help/CONVAIR_Input_File.pdf"} \
        -image [vTcl:image:get_image [file join . GUI Images help.gif]] \
        -pady 0 -width 20 
    vTcl:DefineAlias "$site_3_0.but23" "Button15" vTcl:WidgetProc "Toplevel224" 1
...
Window hide $widget(Toplevel224); TextEditorRunTrace "Close Window CONVAIR Input File" "b"
    ...
    vTcl:DefineAlias "$site_3_0.but24" "Button16" vTcl:WidgetProc "Toplevel224" 1
